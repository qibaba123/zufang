...
require_once dirname ( __FILE__ ).DIRECTORY_SEPARATOR.'./../../precreate/result/AlipayF2FPayResult.php';
require_once dirname ( __FILE__ ).DIRECTORY_SEPARATOR.'./../../precreate/result/AlipayF2FQueryResult.php';
require_once dirname ( __FILE__ ).DIRECTORY_SEPARATOR.'./../../precreate/result/AlipayF2FPrecreateResult.php';
require_once dirname ( __FILE__ ).DIRECTORY_SEPARATOR.'./../../precreate/result/AlipayF2FRefundResult.php';

class AlipayTradePrecreateService {
