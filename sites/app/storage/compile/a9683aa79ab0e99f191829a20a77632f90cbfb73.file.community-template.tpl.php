<?php /* Smarty version Smarty-3.1.17, created on 2019-12-06 16:47:04
         compiled from "/mnt/www/default/duodian/tdtinstall/sites/app/view/template/wxapp/community/community-template.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17552656565dea1588938468-36044793%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a9683aa79ab0e99f191829a20a77632f90cbfb73' => 
    array (
      0 => '/mnt/www/default/duodian/tdtinstall/sites/app/view/template/wxapp/community/community-template.tpl',
      1 => 1575621712,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17552656565dea1588938468-36044793',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5dea15889894f9_47753263',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5dea15889894f9_47753263')) {function content_5dea15889894f9_47753263($_smarty_tpl) {?><link rel="stylesheet" href="/public/manage/applet/applet-temp.css?2">
<style>
...
" class="btn btn-md btn-blue edit">编辑模版</a>
    ...
    <div class="page-header" style="min-height: 50px;<?php if ($_smarty_tpl->tpl_vars['appletCfg']->value['ac_type']!=8) {?>display: none;<?php }?>">
            <span style="">
                    首页购物车：
                    <label id="choose-onoff" class="choose-onoff">
                        <input name="sms_start" class="ace ace-switch ace-switch-5" id="cartOpen" data-type="cart" onchange="changeOpen()" type="checkbox" <?php if ($_smarty_tpl->tpl_vars['index']->value&&$_smarty_tpl->tpl_vars['index']->value['aci_index_cart']) {?> checked<?php }?>>
                    <span class="lbl"></span>
                    </label>
            </span>
    </div>
...
">启用</a>
                    <a href="/wxapp/community/indexTpl?tpl=<?php echo $_smarty_tpl->tpl_vars['val']->value['it_id'];?>
