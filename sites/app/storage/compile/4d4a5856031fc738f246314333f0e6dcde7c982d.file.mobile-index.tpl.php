<?php /* Smarty version Smarty-3.1.17, created on 2020-04-02 16:16:38
         compiled from "/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/mobile/mobile-index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1704370175e859f66aad552-82213229%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4d4a5856031fc738f246314333f0e6dcde7c982d' => 
    array (
      0 => '/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/mobile/mobile-index.tpl',
      1 => 1579405884,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1704370175e859f66aad552-82213229',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e859f66ae8651_26506157',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e859f66ae8651_26506157')) {function content_5e859f66ae8651_26506157($_smarty_tpl) {?><link rel="stylesheet" href="/public/wxapp/meal/temp1/css/spectrum.css">
    ...
    <div class="edit-right">
        <div class="edit-con">
            ...
            <div class="address" data-right-edit data-id="2">
                ...
                <div <?php if ($_smarty_tpl->tpl_vars['showHide']->value!=1) {?> style="display:none" <?php }?>>
                    <div class="input-group-box">
                ...
                -->
                 <div class="input-group-box">
                    ...
                    <textarea class="cus-input" style="width:100%;height:400px;visibility:hidden;" id ="agreement" name="agreement" placeholder="入驻协议"  rows="20" style=" text-align: left; resize:vertical;"><?php if ($_smarty_tpl->tpl_vars['row']->value&&$_smarty_tpl->tpl_vars['row']->value['ami_agreement']) {?><?php echo $_smarty_tpl->tpl_vars['row']->value['ami_agreement'];?>
<?php }?></textarea>
...
<script>
    ...
    app.controller('chCtrl',['$scope','$http','$timeout', function($scope,$http,$timeout){
        $scope.headerTitle = '<?php echo $_smarty_tpl->tpl_vars['row']->value['ami_title'];?>
'?'<?php echo $_smarty_tpl->tpl_vars['row']->value['ami_title'];?>
':"电话本";
        $scope.shopNum     = '<?php echo $_smarty_tpl->tpl_vars['row']->value['ami_shop_num'];?>
';
        $scope.browseNum   = '<?php echo $_smarty_tpl->tpl_vars['row']->value['ami_browse_num'];?>
';
        $scope.ischarge    = true;
        $scope.banners     =<?php if ($_smarty_tpl->tpl_vars['slide']->value) {?> <?php echo $_smarty_tpl->tpl_vars['slide']->value;?>
 <?php } else { ?>new Array()<?php }?>;
        $scope.searchShow ='<?php echo $_smarty_tpl->tpl_vars['row']->value['ami_show_search'];?>
' > 0 ?true:false;
        $scope.alertShow ='<?php echo $_smarty_tpl->tpl_vars['row']->value['ami_show_alert'];?>
' > 0 ?true:false;
