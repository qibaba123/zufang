<?php /* Smarty version Smarty-3.1.17, created on 2020-04-07 16:27:02
         compiled from "/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/limit/goods-group.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19934071255e8c3956cacee5-35720833%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ed7d6ccd7114996bdb0e9898e67d85dbd7f5508c' => 
    array (
      0 => '/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/limit/goods-group.tpl',
      1 => 1575621712,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19934071255e8c3956cacee5-35720833',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e8c3956d014e0_15262146',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e8c3956d014e0_15262146')) {function content_5e8c3956d014e0_15262146($_smarty_tpl) {?><link rel="stylesheet" href="/public/manage/groupControl/css/style.css">
...
?>
                        <tr id="tr_<?php echo $_smarty_tpl->tpl_vars['val']->value['alg_id'];?>
" <?php if (($_smarty_tpl->tpl_vars['key']->value%2==1)) {?>class="info"<?php } else { ?><?php }?>>
                            <td id="name_<?php echo $_smarty_tpl->tpl_vars['val']->value['alg_id'];?>
"><?php echo $_smarty_tpl->tpl_vars['val']->value['alg_name'];?>
</td>
                            <td>
                                <?php echo $_smarty_tpl->tpl_vars['val']->value['alg_total'];?>

                                <div class="pull-right" style="font-size:0">
                                    <?php if ($_smarty_tpl->tpl_vars['val']->value['alg_total']>0) {?>
                                    <a class="btn btn-xs btn-success btn-goods" href="javascript:;" data-mk="look" data-id="<?php echo $_smarty_tpl->tpl_vars['val']->value['alg_id'];?>
">查看</a>
                                    <?php }?>
                                    <a class="btn btn-xs btn-info btn-goods" href="javascript:;" data-mk="add"  data-id="<?php echo $_smarty_tpl->tpl_vars['val']->value['alg_id'];?>
">增加关联</a>
                                </div>
                            </td>
                            <td><?php echo date('Y-m-d H:i',$_smarty_tpl->tpl_vars['val']->value['alg_create_time']);?>
</td>
                            <td style="color:#ccc;">
                                <a class="btn-group" href="javascript:;" data-mk="edit" data-id="<?php echo $_smarty_tpl->tpl_vars['val']->value['alg_id'];?>
" data-name="<?php echo $_smarty_tpl->tpl_vars['val']->value['alg_name'];?>
" data-style="<?php echo $_smarty_tpl->tpl_vars['val']->value['alg_list_type'];?>
" data-img="<?php echo $_smarty_tpl->tpl_vars['val']->value['alg_bg'];?>
" data-brief="<?php echo $_smarty_tpl->tpl_vars['val']->value['alg_brief'];?>
">编辑</a>
                                -
                                <a class="btn-group" href="javascript:;" data-mk="del" data-id="<?php echo $_smarty_tpl->tpl_vars['val']->value['alg_id'];?>
" style="color:#f00;">删除</a>

                                <!--
                                - <a href="javascript:;" id="link_<?php echo $_smarty_tpl->tpl_vars['val']->value['alg_id'];?>
...
<script type="text/javascript">
    ...
    $('.btn-save-add').on('click',function(){
        ...
        if(data.name){
            ...
            $.ajax({
                'type'  : 'post',
                'url'   : '/wxapp/limit/saveActiveGroup',
                'data'  : data,
                'dataType' : 'json',
    ...
    function fetchGoodsHtml(data){
        ...
        for(var i=0 ; i < data.length ; i++){
            ...
            if(mk == 'look'){
                html += '<td><input type="number" data-id="'+data[i].algm_id+'" data-old="'+data[i].algm_weight+'" value="'+data[i].algm_weight+'" onblur="changeWeight(this)" size="2" style="width:50px;" class="form-control" ></td>';
    ...
    function dealGoods(ele){
        ...
        if(id && type){
            ...
            $.ajax({
                'type'  : 'post',
                'url'   : '/wxapp/limit/saveGoodsGroup',
                'data'  : data,
                'dataType' : 'json',
                'success'   : function(ret){
                    layer.close(index);
