<?php /* Smarty version Smarty-3.1.17, created on 2020-04-03 15:48:47
         compiled from "/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/print/ticket-set.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8398689165e86ea5faf7560-54440666%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd8091ad758ae7c9e63a11e2aa4ae65b62f7e9da9' => 
    array (
      0 => '/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/print/ticket-set.tpl',
      1 => 1575621712,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8398689165e86ea5faf7560-54440666',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e86ea5fb762b6_19722271',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e86ea5fb762b6_19722271')) {function content_5e86ea5fb762b6_19722271($_smarty_tpl) {?><link rel="stylesheet" href="/public/manage/centermanage/color-spectrum/spectrum.css">
                ...
                <div class="index-main">
                    <div class="mobile-content">
                        <ul class="user-operation">
                            <li class="print-title"><?php echo $_smarty_tpl->tpl_vars['curr_shop']->value['s_name'];?>
</li>
        ...
        <div class="edit-con" style="margin-top: 0">
            <div class="header-top" data-right-edit data-id="0" style="display:block;">
                <div class="showlist-manage">
                    ...
                    <?php }?>
                    <div class="check-row" <?php if ($_smarty_tpl->tpl_vars['showLegwork']->value==0) {?> style="display: none" <?php }?>>
                        <span>跑腿配送序号</span>
                        <div class="check-box">
                            <p>
...
<script>
    ...
    app.controller('chCtrl',  ['$scope', '$http', function($scope, $http){
        $scope.printtype = <?php echo $_smarty_tpl->tpl_vars['row']->value['apc_print_type'];?>
;
        $scope.printNum = <?php echo $_smarty_tpl->tpl_vars['row']->value['apc_print_num'];?>
;
        $scope.printCfg = {
            discounts:{
                isPrint:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_discounts_isprint'];?>
 > 0 ? true : false,
                isBold:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_discounts_bold'];?>
 > 0 ? true : false,
            },
            total:{
                isPrint:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_total_isprint'];?>
 > 0 ? true : false,
                isBold:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_total_bold'];?>
 > 0 ? true : false,
            },
            orderCode:{
                isPrint:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_code_isprint'];?>
 > 0 ? true : false,
                isBold:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_code_bold'];?>
 > 0 ? true : false
            },
            remark:{
                isPrint:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_remark_isprint'];?>
 > 0 ? true : false,
                isBold:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_remark_bold'];?>
 > 0 ? true : false
            },
            receiver:{
                isPrint:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_receiver_isprint'];?>
 > 0 ? true : false,
                isBold:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_receiver_bold'];?>
 > 0 ? true : false
            },
            address:{
                isPrint:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_address_isprint'];?>
 > 0 ? true : false,
                isBold:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_address_bold'];?>
 > 0 ? true : false
            },
            activity:{
                isPrint:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_activity_isprint'];?>
 > 0 ? true : false,
                    isBold:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_activity_bold'];?>
 > 0 ? true : false
            },
            community:{
                isPrint:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_community_isprint'];?>
 > 0 ? true : false,
                    isBold:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_community_bold'];?>
 > 0 ? true : false
            },
            leader:{
                isPrint:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_leader_isprint'];?>
 > 0 ? true : false,
                    isBold:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_leader_bold'];?>
 > 0 ? true : false
            },
            receivetime:{
                isPrint:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_receivetime_isprint'];?>
 > 0 ? true : false,
                    isBold:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_receivetime_bold'];?>
 > 0 ? true : false
            },
            senddate:{
                isPrint:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_senddate_isprint'];?>
 > 0 ? true : false,
                    isBold:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_senddate_bold'];?>
 > 0 ? true : false
            },
            esname:{
                isPrint:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_esname_isprint'];?>
 > 0 ? true : false,
                    isBold:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_esname_bold'];?>
 > 0 ? true : false
            },
            esphone:{
                isPrint:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_esphone_isprint'];?>
 > 0 ? true : false,
                    isBold:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_esphone_bold'];?>
 > 0 ? true : false
            },
            userdefined:{
                isPrint:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_customs_isprint'];?>
 > 0 ? true : false,
                isBold:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_customs_bold'];?>
 > 0 ? true : false
            },
            time:{
                isPrint:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_time_isprint'];?>
 > 0 ? true : false,
                isBold:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_time_bold'];?>
 > 0 ? true : false
            },
            comaddr:{
                isPrint:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_comaddr_isprint'];?>
 > 0 ? true : false,
                    isBold:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_comaddr_bold'];?>
 > 0 ? true : false
            },
            postfee:{
                isPrint:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_postfee_isprint'];?>
 > 0 ? true : false,
                    isBold:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_postfee_bold'];?>
 > 0 ? true : false
            },
            paytype:{
                isPrint:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_paytype_isprint'];?>
 > 0 ? true : false,
                    isBold:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_paytype_bold'];?>
 > 0 ? true : false
            },
            appletqrcode:{
                isPrint:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_qrcode_isprint'];?>
 > 0 ? true : false,
            },
            goods:{
                large:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_goods_large'];?>
 > 0 ? true : false,
            },
            legworknum:{
                isPrint:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_legworknum_isprint'];?>
 > 0 ? true : false,
                isBold:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_legworknum_bold'];?>
 > 0 ? true : false
            },
            tablenum:{
                large:<?php echo $_smarty_tpl->tpl_vars['row']->value['apc_tablenum_large'];?>
 > 0 ? true : false,
            },
        };
