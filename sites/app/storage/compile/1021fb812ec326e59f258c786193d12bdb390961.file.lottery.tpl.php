<?php /* Smarty version Smarty-3.1.17, created on 2020-04-07 16:11:20
         compiled from "/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/meeting/lottery.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11900165875e8c35a8a240b5-48350010%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1021fb812ec326e59f258c786193d12bdb390961' => 
    array (
      0 => '/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/meeting/lottery.tpl',
      1 => 1575621712,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11900165875e8c35a8a240b5-48350010',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e8c35a8a5c673_60510651',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e8c35a8a5c673_60510651')) {function content_5e8c35a8a5c673_60510651($_smarty_tpl) {?><link rel="stylesheet" href="/public/wxapp/setup/css/spectrum.css">
				...
				<div class="index-main">
					...
					<div class="service-wrap" data-left-preview data-id="2">
						...
						<div class="article-con" id="article-con" style="min-height: 100px;color: #fff">
							<?php echo $_smarty_tpl->tpl_vars['row']->value['amll_rule'];?>
			...
			<div data-right-edit data-id="2">
				<div>
					<div class="input-groups" style="margin-top: 10px;margin-bottom:15px">
						...
						<input type="number" id="shareGive" placeholder="请输入抽奖次数" maxlength="10" value="<?php echo $_smarty_tpl->tpl_vars['row']->value['amll_share_give'];?>
" style="border: 1px solid #ddd;padding: 0 10px;">
					...
					<div class="input-groups" style="margin-top: 10px;margin-bottom:15px">
						...
						<input type="number" id="frequency" placeholder="请输入抽奖次数" maxlength="10" <?php if ($_smarty_tpl->tpl_vars['row']->value['amll_status']==1) {?>disabled="disabled"<?php }?> value="<?php echo $_smarty_tpl->tpl_vars['row']->value['amll_frequency'];?>
" style="border: 1px solid #ddd;padding: 0 10px;">
					...
					<div class="input-groups" style="margin-top: 10px;margin-bottom:15px">
						...
						<input type="number" id="change-points" placeholder="请输入兑换一次抽奖所需积分" maxlength="10" value="<?php echo $_smarty_tpl->tpl_vars['row']->value['amll_change_points'];?>
" style="border: 1px solid #ddd;padding: 0 10px;">
						<label for="">（兑换一次抽奖次数所需积分）</label>
					</div>
					<div class="form-textarea">
						<textarea class="form-control" style="width:100%;height:350px;visibility:hidden;text-align: left; resize:vertical;"  id="content-detail" name="article-detail" placeholder="文章内容"  rows="20"><?php echo $_smarty_tpl->tpl_vars['row']->value['amll_rule'];?>
</textarea>
...
;
		$scope.showGoodsList = <?php echo $_smarty_tpl->tpl_vars['goodsList']->value;?>
;
		$scope.prizeList     = <?php echo $_smarty_tpl->tpl_vars['prizeList']->value;?>
;
		$scope.pointsOpen    = <?php echo $_smarty_tpl->tpl_vars['row']->value['amll_points_open'];?>
 ? true : false ;
		var start = {
