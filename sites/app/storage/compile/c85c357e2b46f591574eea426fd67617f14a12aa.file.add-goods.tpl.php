<?php /* Smarty version Smarty-3.1.17, created on 2020-02-20 11:05:17
         compiled from "/www/wwwroot/default/yingxiaosc/sites/app/view/template/wxapp/appointment/add-goods.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6912125825e4df76dac8e95-58961470%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c85c357e2b46f591574eea426fd67617f14a12aa' => 
    array (
      0 => '/www/wwwroot/default/yingxiaosc/sites/app/view/template/wxapp/appointment/add-goods.tpl',
      1 => 1575621712,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6912125825e4df76dac8e95-58961470',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e4df76db7ba04_96499308',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e4df76db7ba04_96499308')) {function content_5e4df76db7ba04_96499308($_smarty_tpl) {?><link rel="stylesheet" href="/public/manage/assets/css/datepicker.css">
                                                    ...
                                                    <div class="group-info">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="control-group">
                                                                <input type="text" class="form-control" id="g_name" name="g_name" placeholder="请填写项目名称" required="required" value="<?php if ($_smarty_tpl->tpl_vars['row']->value) {?><?php echo $_smarty_tpl->tpl_vars['row']->value['g_name'];?>
<?php }?>">
                                                            </div>
                                                        </div>
...
" <?php if ($_smarty_tpl->tpl_vars['key']->value==$_smarty_tpl->tpl_vars['row']->value['g_appointment_kind']) {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['val']->value;?>
</option>
                                                                <?php } ?>
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="control-group">
                                                                <input type="text" class="form-control" id="g_price" name="g_price" onblur="mathVIp()" placeholder="请填写项目售价"  value="<?php if ($_smarty_tpl->tpl_vars['row']->value) {?><?php echo $_smarty_tpl->tpl_vars['row']->value['g_price'];?>
                                                ...
                                                <div class="info-group-inner">
                                                    ...
                                                    <div class="group-info">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="control-group">
                                                                <input type="text" class="form-control" id="g_appointment_length" name="g_appointment_length" onblur="mathVIp()" placeholder="请填写预约时长"  value="<?php if ($_smarty_tpl->tpl_vars['row']->value) {?><?php echo $_smarty_tpl->tpl_vars['row']->value['g_appointment_length'];?>
<?php }?>"  style="width:160px;">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="control-group">
                                                                <input type="text" class="form-control" id="g_appointment_date" name="g_appointment_date" onblur="mathVIp()" placeholder="请填写预约日期"  value="<?php if ($_smarty_tpl->tpl_vars['row']->value) {?><?php echo $_smarty_tpl->tpl_vars['row']->value['g_appointment_date'];?>
<?php }?>"  style="width:160px;">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="control-group">
                                                                <input type="text" id="start_time" name="start_time" class="cus-input time form-control" style="width: 160px;float: left" value="<?php if ($_smarty_tpl->tpl_vars['row']->value&&$_smarty_tpl->tpl_vars['row']->value['g_appointment_time']) {?><?php echo $_smarty_tpl->tpl_vars['row']->value['g_appointment_time'][0];?>
<?php }?>"/>
                                                                <input type="text" id="end_time" name="end_time" class="cus-input time form-control" style="width: 160px"  value="<?php if ($_smarty_tpl->tpl_vars['row']->value&&$_smarty_tpl->tpl_vars['row']->value['g_appointment_time']) {?><?php echo $_smarty_tpl->tpl_vars['row']->value['g_appointment_time'][1];?>
<?php }?>"/>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                          ...
                                                          <div class='form-group'>
                                                            ...
                                                            <div class='control-group'>
                                                                <input class='form-control' type="number" name="g_pnumber_limit" style='width: 160px;' placeholder="报名人数" oninput="this.value=this.value.replace(/\D/g,'')" 
                                                                    value="<?php if ($_smarty_tpl->tpl_vars['row']->value&&$_smarty_tpl->tpl_vars['row']->value['g_number_limit']) {?><?php echo $_smarty_tpl->tpl_vars['row']->value['g_number_limit'];?>
<?php } else { ?>0<?php }?>"
                                                                >
                                                        ...
                                                        <div class='form-group'>
                                                            ...
                                                            <div class='control-group'>
                                                                <input class='form-control' type="number" name="g_limit" style='width: 160px;' placeholder="单人最多可报名次数" oninput="this.value=this.value.replace(/\D/g,'')" 
                                                                    value="<?php if ($_smarty_tpl->tpl_vars['row']->value&&$_smarty_tpl->tpl_vars['row']->value['g_limit']) {?><?php echo $_smarty_tpl->tpl_vars['row']->value['g_limit'];?>
<?php } else { ?>0<?php }?>"
                                                                >
                                                        ...
                                                        <div class='form-group'>
                                                            ...
                                                            <div class='control-group'>
                                                                <input class='form-control' type="number" name="g_day_limit" style='width: 160px;' placeholder="报名人数" oninput="this.value=this.value.replace(/\D/g,'')" 
                                                                    value="<?php if ($_smarty_tpl->tpl_vars['row']->value&&$_smarty_tpl->tpl_vars['row']->value['g_day_limit']) {?><?php echo $_smarty_tpl->tpl_vars['row']->value['g_day_limit'];?>
<?php } else { ?>0<?php }?>"
                                                                >
                                                                <p class='tip'>为空或者0时不限制</p>
                                                            </div>
                                                        ...
                                                        <div class='form-group'>
                                                            ...
                                                            <div class='control-group'>
                                                                <input class='form-control' type="number" name="g_show_num" style='width: 160px;' placeholder="阅读量" oninput="this.value=this.value.replace(/\D/g,'')" 
                                                                    value="<?php if ($_smarty_tpl->tpl_vars['row']->value&&$_smarty_tpl->tpl_vars['row']->value['g_show_num']) {?><?php echo $_smarty_tpl->tpl_vars['row']->value['g_show_num'];?>
<?php } else { ?>0<?php }?>"
                                                                >
                                                            </div>
                                                        </div>
                                                        <div class='form-group'>
                                                            ...
                                                            <div class='control-group'>
                                                                <input class='form-control' type="number" name="g_forward" style='width: 160px;' placeholder="转发量" oninput="this.value=this.value.replace(/\D/g,'')" 
                                                                    value="<?php if ($_smarty_tpl->tpl_vars['row']->value&&$_smarty_tpl->tpl_vars['row']->value['g_forward']) {?><?php echo $_smarty_tpl->tpl_vars['row']->value['g_forward'];?>
<?php } else { ?>0<?php }?>"
                                                                >
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="control-group">
                                                                <div class="radio-box">
                                                                    <span>
                                                                        ...
                                                                        <?php if ($_smarty_tpl->tpl_vars['row']->value&&$_smarty_tpl->tpl_vars['row']->value['g_show_join_list']==1) {?>
                                                                        checked
                                                                        <?php }?>
                                                                        >
                                                                    ...
                                                                    <span>
                                                                        ...
                                                                        <?php if ($_smarty_tpl->tpl_vars['row']->value&&$_smarty_tpl->tpl_vars['row']->value['g_show_join_list']==0) {?>
                                                                        checked
                                                                        <?php }?>
                                                                        >
                                                ...
                                                <div class="info-group-inner">
                                                    ...
                                                    <div class="group-info">
                                                        <div class="form-group">
                                                            ...
                                                            <div>
                                                                <img onclick="toUpload(this)" data-limit="1" data-width="640" data-height="365" data-dom-id="upload-cover" id="upload-cover"  src="<?php if ($_smarty_tpl->tpl_vars['row']->value&&$_smarty_tpl->tpl_vars['row']->value['g_cover']) {?><?php echo $_smarty_tpl->tpl_vars['row']->value['g_cover'];?>
                                                ...
                                                <div class="info-group-inner">
                                                    ...
                                                    <div class="group-info">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="control-group">
                                                                <textarea type="text" class="form-control" rows="5" id="g_brief" name="g_brief" placeholder="项目简介" style="max-width: 850px;"><?php if ($_smarty_tpl->tpl_vars['row']->value) {?><?php echo $_smarty_tpl->tpl_vars['row']->value['g_brief'];?>
<?php }?></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
...
;
        ...
        $scope.messageType = [
            ...
            <?php if (in_array($_smarty_tpl->tpl_vars['appletCfg']->value['ac_type'],array(21,27))) {?>
                {
                    'type': 'radio',
                    'name': '单选框'
                },
