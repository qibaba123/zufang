<?php /* Smarty version Smarty-3.1.17, created on 2020-04-08 00:31:44
         compiled from "/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/answer/subject-award-list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13298714865e8caaf00ee415-49647865%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bdd31fe8ccd4841c8c82c4ceab2d74d3ca3ecfbf' => 
    array (
      0 => '/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/answer/subject-award-list.tpl',
      1 => 1575621712,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13298714865e8caaf00ee415-49647865',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e8caaf0134d48_39253348',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e8caaf0134d48_39253348')) {function content_5e8caaf0134d48_39253348($_smarty_tpl) {?><link rel="stylesheet" href="/public/manage/css/bargain-list.css">
<style type="text/css">
...
?>
                            <tr>
                                <td style="white-space: normal;"><?php echo $_smarty_tpl->tpl_vars['val']->value['asa_name'];?>
</td>
                                <td style="white-space: normal;"><img src="<?php echo $_smarty_tpl->tpl_vars['val']->value['asa_cover'];?>
" alt="" style="height: 75px;"></td>
                                <td style="white-space: normal;"><?php echo $_smarty_tpl->tpl_vars['val']->value['asa_price'];?>
</td>
                                <td style="white-space: normal;">
                                    <?php if ($_smarty_tpl->tpl_vars['val']->value['asa_status']==1) {?>
                                    已选用
                                    <?php }?>
                                </td>
                                <td style="white-space: normal;"><?php echo date('Y-m-d H:i',$_smarty_tpl->tpl_vars['val']->value['asa_create_time']);?>
</td>
                                <td style="white-space: normal;" class="jg-line-color">
                                    <a class="add-award" href="#" data-toggle="modal" data-target="#myModal"  data-id="<?php echo $_smarty_tpl->tpl_vars['val']->value['asa_id'];?>
" data-name="<?php echo $_smarty_tpl->tpl_vars['val']->value['asa_name'];?>
" data-cover="<?php echo $_smarty_tpl->tpl_vars['val']->value['asa_cover'];?>
" data-price="<?php echo $_smarty_tpl->tpl_vars['val']->value['asa_price'];?>
" >编辑</a> -
                                    <a href="/wxapp/answer/awardRecordList?awardId=<?php echo $_smarty_tpl->tpl_vars['val']->value['asa_id'];?>
" class="award-record">查看获奖</a> -
                                    <a href="javascript:;" onclick="deleteSubject(this)" data-id="<?php echo $_smarty_tpl->tpl_vars['val']->value['asa_id'];?>
" class="btn-del" style="color:#f00;">删除</a>
                                </td>
                            </tr>
                        <?php } ?>
                        <tr><td colspan="6" style="text-align:right"><?php echo $_smarty_tpl->tpl_vars['paginator']->value;?>
</td></tr>
                    </table>
                </div>
            </div>
