<?php /* Smarty version Smarty-3.1.17, created on 2020-04-02 09:59:56
         compiled from "/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/mall/index-tpl_19.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13273873555e85471c48a333-95534429%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'da19bdd9e935301d6727eacf26b6d1a4e74824bd' => 
    array (
      0 => '/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/mall/index-tpl_19.tpl',
      1 => 1575621712,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13273873555e85471c48a333-95534429',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e85471c4e4665_60400673',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e85471c4e4665_60400673')) {function content_5e85471c4e4665_60400673($_smarty_tpl) {?><link rel="stylesheet" href="/public/wxapp/setup/css/spectrum.css">
...
<style>
.search-wrap { padding: 10px 12px; box-sizing: border-box; background-color: #f7f7f7; }
.search-container { border-radius: 5px; width: 96%; margin: 0 auto; padding: 4px 10px; box-sizing: border-box; text-align: left; border: 1px solid #dfdfdf; background-color: #fff;}
                    ...
                    <div class="good-show-wrap" data-left-preview data-id="4">
                        <div class="good-list-wrap" ng-repeat="goodfl in goodFlShow">
                            ...
                            <div class="title-img-wrap">
                                <div class="fl-img">
                                  <img src="{{goodfl.imgsrc}}" class="fade_in" />
                                </div>
                                <div class="title-con">
                                  <img src="/public/wxapp/mall/temp3/images/title_left.png" />
                                  <span>{{goodfl.title}}</span>
                                  <img src="/public/wxapp/mall/temp3/images/title_right.png" />
                                </div>
                            </div>
                                ...
                                <div class="good-item">
                                    <div class="item-wrap border-l border-b">
                                        ...
                                        <div class="good-intro">
                                            ...
                                            <div class="price-buy flex-wrap">
                                                ￥<p class="now-price">2999</p>
                                                <p class="flex-con sold">888人已付款</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="edit-right">
        <div class="edit-con">
            ...
            <div class="fenleinav" data-right-edit data-id="3">
                <label style="width: 100%">{{recommendtitle}}<span>(图片建议尺寸为400px*250px)</span></label>
                <div class="input-group-box" style="margin-bottom: 10px;">
            ...
            <div class="fenleinav" data-right-edit data-id="4">
                <label style="width: 100%">分类商品展示管理<span>(分类图片建议尺寸为750px*180px)</span></label>
                <div ui-sortable="sortableOptions" ng-model="goodFlShow">
                    <div class="fenleinav-manage recommend-manage" ng-repeat="goodfl in goodFlShow">
                        <div class="delete" ng-click="delIndex('goodFlShow',goodfl.index)">×</div>
                        <div class="edit-img">
                            <!--<div class="cropper-box" data-width="750" data-height="180" style="height:100%;">
                                <img ng-src="{{goodfl.imgsrc}}"  onload="changeSrc(this)"  imageonload="doThis('goodFlShow',goodfl.index)" alt="导航图标">
                                <input type="hidden" class="avatar-field bg-img" name="center_bg" ng-value="goodfl.imgsrc"/>
                            </div>-->
                            <div>
                                <img onclick="toUpload(this)"  data-limit="8" onload="changeSrc(this)" data-width="750" data-height="180" imageonload="doThis('goodFlShow',goodfl.index)" data-dom-id="upload-goodfl{{$index}}" id="upload-goodfl{{$index}}"  ng-src="{{goodfl.imgsrc}}"  height="100%" style="display:inline-block;margin-left:0;">
