<?php /* Smarty version Smarty-3.1.17, created on 2020-04-28 12:15:22
         compiled from "/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/member/member-list-new.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5205639405e86a04429d8d7-47439064%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '994dd9b46a88f07652f49b906dc88a8ba2b2066e' => 
    array (
      0 => '/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/member/member-list-new.tpl',
      1 => 1588047320,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5205639405e86a04429d8d7-47439064',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.17',
  'unifunc' => 'content_5e86a04440d340_41281192',
  'variables' => 
  array (
    'mLevel' => 0,
    'key' => 0,
...
<?php if ($_valid && !is_callable('content_5e86a04440d340_41281192')) {function content_5e86a04440d340_41281192($_smarty_tpl) {?><link rel="stylesheet" href="/public/manage/searchable/jquery.searchableSelect.css">
...
<div class="balance">
    <div class="balance-info">
        <div class="balance-content">
            <span class="money"><?php echo $_smarty_tpl->tpl_vars['statInfo']->value['totalToday'];?>
</span>
        </div>
    ...
    <div class="balance-info">
        ...
        <div class="balance-content">
            <span class="money"><?php echo $_smarty_tpl->tpl_vars['statInfo']->value['total7days'];?>
</span>
        </div>
    ...
    <?php if ($_smarty_tpl->tpl_vars['canBan']->value==1) {?>
    <div class="balance-info">
        <div class="balance-content">
            <span class="money"><?php echo $_smarty_tpl->tpl_vars['statInfo']->value['totalBan'];?>
</span>
        </div>
        <div class="balance-title">被封禁用户<span></span></div>
    </div>
    <?php }?>
    <?php if ($_smarty_tpl->tpl_vars['category']->value>0) {?>
    <div class="balance-info">
        <div class="balance-content">
            <span class="money"><?php echo $_smarty_tpl->tpl_vars['statInfo']->value['totalCate'];?>
</span>
        </div>
            ...
            <div class="search-input-item">
                <div class="input-item-group">
                    ...
                    <div class="input-form">
                        <input type="text" class="form-control" name="nickname" id="nickname" value="<?php echo $_smarty_tpl->tpl_vars['nickname']->value;?>
" placeholder="用户昵称">
                    </div>
                </div>
            </div>
            <div class="search-input-item">
                <div class="input-item-group">
                    ...
                    <div class="input-form">
                        <input type="text" class="form-control" name="mid" id="mid" value="<?php if ($_smarty_tpl->tpl_vars['mid']->value) {?><?php echo $_smarty_tpl->tpl_vars['mid']->value;?>
<?php }?>" placeholder="编号">
                    </div>
                </div>
            </div>
            <div class="search-input-item">
                <div class="input-item-group">
                    ...
                    <div class="input-form">
                        <input type="text" class="form-control" name="mobile" id="mobile" value="<?php if ($_smarty_tpl->tpl_vars['mobile']->value) {?><?php echo $_smarty_tpl->tpl_vars['mobile']->value;?>
<?php }?>" placeholder="手机号">
                    </div>
                </div>
            </div>
            <div class="search-input-item" style="display: none">
                <div class="input-item-group">
                    ...
                    <div class="input-form">
                        <input type="text" class="form-control" name="remark" id="remark" value="<?php if ($_smarty_tpl->tpl_vars['remark']->value) {?><?php echo $_smarty_tpl->tpl_vars['remark']->value;?>
<?php }?>" placeholder="备注">
                    </div>
                </div>
            </div>
...
?>
                        <option value="<?php echo $_smarty_tpl->tpl_vars['key']->value;?>
" <?php if ($_smarty_tpl->tpl_vars['key']->value==$_smarty_tpl->tpl_vars['searchlv']->value) {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['val']->value;?>
</option>
                            <?php } ?>
                        </select>
                    </div>
                ...
                <div class="input-item-group">
                    ...
                    <div class="input-form">
                        <select name="source" id="source" class="form-control">
                            <option value="0">全部</option>
                            <option value="1" <?php if ($_smarty_tpl->tpl_vars['source']->value==1) {?>selected<?php }?> >公众号</option>
                            <option value="2" <?php if ($_smarty_tpl->tpl_vars['source']->value==2) {?>selected<?php }?> >小程序</option>
                            <option value="5" <?php if ($_smarty_tpl->tpl_vars['source']->value==5) {?>selected<?php }?> >后台添加</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div class="search-input-item" <?php if ($_smarty_tpl->tpl_vars['cash']->value) {?> style="display:none;" <?php }?>>
            <div class="input-item-group">
...
?>
                    <option value="<?php echo $_smarty_tpl->tpl_vars['key']->value;?>
" <?php if ($_smarty_tpl->tpl_vars['key']->value==$_smarty_tpl->tpl_vars['category']->value) {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['val']->value['mc_name'];?>
</option>
                        <?php } ?>
                    </select>
                </div>
        ...
        <div class="input-item-group">
            ...
            <div class="input-form">
                <select name="authorization" id="authorization" class="form-control">
                    ...
                    <option value="0" <?php if ($_smarty_tpl->tpl_vars['authorization']->value==0) {?> selected <?php }?>>已授权</option>
                    <option value="1" <?php if ($_smarty_tpl->tpl_vars['authorization']->value==1) {?> selected <?php }?>>未授权</option>
                </select>
            </div>
        </div>
    </div>
...
" placeholder="开始时间" id="start-time" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" autocomplete="off">
            ...
            <div class="input-form">
                <input type="text" class="form-control" name="end" id="end-time" value="<?php echo $_smarty_tpl->tpl_vars['end']->value;?>
...
<div class="sort-type-box">
 ...
 $_smarty_tpl->tpl_vars['key'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['member_sort_type']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['item']->key => $_smarty_tpl->tpl_vars['item']->value) {
$_smarty_tpl->tpl_vars['item']->_loop = true;
 $_smarty_tpl->tpl_vars['key']->value = $_smarty_tpl->tpl_vars['item']->key;
?>
    <div class="sort-type-item" data-sorttype="<?php echo $_smarty_tpl->tpl_vars['key']->value;?>
_<?php echo $_smarty_tpl->tpl_vars['item']->value['sort'];?>
">
        <span class="sort-type" <?php if ($_smarty_tpl->tpl_vars['sort_type']->value==$_smarty_tpl->tpl_vars['key']->value) {?>style="color:#008cf6"<?php }?>><?php echo $_smarty_tpl->tpl_vars['item']->value['name'];?>

        <i class="icon-caret-up" <?php if ($_smarty_tpl->tpl_vars['item']->value['sort']=='desc') {?>style="display:inline-block"<?php }?>></i>
        <i class="icon-caret-down" <?php if ($_smarty_tpl->tpl_vars['item']->value['sort']=='asc') {?>style="display:inline-block"<?php }?>></i>
        </span>
    </div>
    <?php } ?>
</div>
...
"/>
                        ...
                        <!-- 头像 标签 -->
                        <td>
                            <?php if ($_smarty_tpl->tpl_vars['cash']->value) {?>
                        <img class="img-thumbnail" width="60" src="<?php if ($_smarty_tpl->tpl_vars['val']->value['m_avatar']) {?><?php echo $_smarty_tpl->tpl_vars['val']->value['m_avatar'];?>
<?php } else { ?>/public/wxapp/images/member-2.png<?php }?>" />
                            <?php } else { ?>
                        <img class="img-thumbnail" width="60" src="<?php if ($_smarty_tpl->tpl_vars['val']->value['m_avatar']) {?><?php echo $_smarty_tpl->tpl_vars['val']->value['m_avatar'];?>
<?php } else { ?>/public/manage/img/zhanwei/zw_fxb_45_45.png<?php }?>" />
                            <?php }?>


                            <!-- 标签 -->
                            <?php if ($_smarty_tpl->tpl_vars['val']->value['m_is_highest']>0) {?>
                            <span class="label label-sm label-success">
                                        <?php echo $_smarty_tpl->tpl_vars['deduct']->value[$_smarty_tpl->tpl_vars['val']->value['m_is_highest']];?>
</span>
                            <?php }?>
                            ...
                            <span class="label label-sm label-info">
                                        官方推荐人</span>
                            <?php }?>
                            <?php if ($_smarty_tpl->tpl_vars['val']->value['m_is_waiter']==1) {?>
                            <span class="label label-sm label-success">
                                        服务员</span>
                            <?php }?>
                            <?php if ($_smarty_tpl->tpl_vars['val']->value['asl_status']==2) {?>
                            <span class="label label-sm label-success">
                                        团长</span>
                            <?php }?>
                        </td>
                        ...
                        <td>
                            <div class="td-top-info" style="text-align: left;">
                                <p class="tab-txt left"><span class="lab-name left">昵称：</span><span class="lab-txt"><?php echo $_smarty_tpl->tpl_vars['val']->value['m_nickname'];?>
</span></p>
                                <p class="tab-txt left"><span class="lab-name left">编号：</span><span class="lab-txt"><?php echo $_smarty_tpl->tpl_vars['val']->value['m_show_id'];?>
</span></p>
                                <p class="tab-txt left"><span class="lab-name left">手机号：</span><span class="lab-txt"><?php if ($_smarty_tpl->tpl_vars['val']->value['m_mobile']) {?><?php echo $_smarty_tpl->tpl_vars['val']->value['m_mobile'];?>
<?php } else { ?>无<?php }?></span>
                                <p class="tab-txt left"><span class="lab-name left">姓名：</span><span class="lab-txt"><?php if ($_smarty_tpl->tpl_vars['val']->value['m_realname']) {?><?php echo $_smarty_tpl->tpl_vars['val']->value['m_realname'];?>
<?php } else { ?>无<?php }?></span></p>
                                <p class="tab-txt left"><span class="lab-name left">性别：</span><span class="lab-txt"><?php echo $_smarty_tpl->tpl_vars['val']->value['m_sex'];?>
</span></p>
                                <p class="tab-txt left"><span class="lab-name left">类别：</span><span class="lab-txt"><?php if ($_smarty_tpl->tpl_vars['val']->value['ame_cate']>0&&$_smarty_tpl->tpl_vars['memberCategory']->value[$_smarty_tpl->tpl_vars['val']->value['ame_cate']]) {?><?php echo $_smarty_tpl->tpl_vars['memberCategory']->value[$_smarty_tpl->tpl_vars['val']->value['ame_cate']]['mc_name'];?>
<?php } else { ?>无<?php }?></span>
                                <p class="tab-txt left"><span class="lab-name left">地区：</span><span class="lab-txt"><?php echo $_smarty_tpl->tpl_vars['val']->value['m_pro_name'];?>
-<?php echo $_smarty_tpl->tpl_vars['val']->value['m_city_name'];?>
-<?php echo $_smarty_tpl->tpl_vars['val']->value['m_area_name'];?>
-<?php echo $_smarty_tpl->tpl_vars['val']->value['m_street_name'];?>
</span></p>

                                <p class="tab-txt left"><span class="lab-name left">关注时间：</span><span class="lab-txt"><?php echo $_smarty_tpl->tpl_vars['val']->value['m_follow_time'];?>
</span></p>
                            </div>
                        </td>
                        <!-- 个人数据 -->
                        <td>
                            <div class="td-top-info" style="text-align: left;">
                                <p class="tab-txt left"><span class="lab-name left">积分：</span><span class="lab-txt"><?php echo $_smarty_tpl->tpl_vars['val']->value['m_points'];?>
</span></p>
                                <p class="tab-txt left"><span class="lab-name left">余额：</span><span class="lab-txt"><?php echo $_smarty_tpl->tpl_vars['val']->value['m_gold_coin'];?>
</span></p>
                                <p class="tab-txt left"><span class="lab-name left">收益：</span><span class="lab-txt"><?php echo $_smarty_tpl->tpl_vars['val']->value['m_deduct_ktx']+$_smarty_tpl->tpl_vars['val']->value['m_deduct_dsh']+$_smarty_tpl->tpl_vars['val']->value['m_deduct_ytx'];?>
</span>
                                <p class="tab-txt left"><span class="lab-name left">订单成交总数：</span><span class="lab-txt"><?php echo $_smarty_tpl->tpl_vars['val']->value['m_traded_num'];?>
</span></p>
                                <p class="tab-txt left"><span class="lab-name left">订单成交总额：</span><span class="lab-txt"><?php echo $_smarty_tpl->tpl_vars['val']->value['m_traded_money'];?>
</span></p>
                                <?php if ($_smarty_tpl->tpl_vars['val']->value['m_is_highest']>0) {?>

                                <p class="tab-txt left"><span class="lab-name left">分销地区： </span>
                                <?php  $_smarty_tpl->tpl_vars['vv'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['vv']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['val']->value['area']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['vv']->key => $_smarty_tpl->tpl_vars['vv']->value) {
$_smarty_tpl->tpl_vars['vv']->_loop = true;
?>
                                   <p class="lab-txt" style="max-width: 250px;"><?php echo $_smarty_tpl->tpl_vars['vv']->value['area'];?>
<a href="#" class="del-area" data-id="<?php echo $_smarty_tpl->tpl_vars['vv']->value['id'];?>
">   删除</a></p>
                                    <?php } ?>
                                </p>
                        ...
                        <td>
                            <div class="td-top-info" style="text-align: left;">
                                <?php if ($_smarty_tpl->tpl_vars['canBan']->value==1) {?>
                                <p class="tab-txt left"><span class="lab-name left">用户状态：</span><span class="lab-txt"><?php if ($_smarty_tpl->tpl_vars['val']->value['m_status']==0) {?><span style="color: #333;">正常</span><?php }?><?php if ($_smarty_tpl->tpl_vars['val']->value['m_status']==1) {?><span style="color: red">封禁中</span><?php }?></span></p>
                                <?php }?>
                                <?php if (!$_smarty_tpl->tpl_vars['hideLevel']->value) {?>
                                <p class="tab-txt left"><span class="lab-name left">用户等级：</span><span class="lab-txt member-level-text"><?php if (isset($_smarty_tpl->tpl_vars['mLevel']->value[$_smarty_tpl->tpl_vars['val']->value['m_level']])) {?><?php echo $_smarty_tpl->tpl_vars['mLevel']->value[$_smarty_tpl->tpl_vars['val']->value['m_level']];?>
<?php } else { ?>无<?php }?></span></p>
                                <?php }?>
                                <?php if ($_smarty_tpl->tpl_vars['addMember']->value==1) {?>
                                <p class="tab-txt left"><span class="lab-name left">用户来源：</span><span class="lab-txt"><?php echo $_smarty_tpl->tpl_vars['memberSource']->value[$_smarty_tpl->tpl_vars['val']->value['m_source']];?>
</span>

                                    <?php }?>
                                <p class="tab-txt left"><span class="lab-name left">进入渠道：</span><span class="lab-txt"><?php if ($_smarty_tpl->tpl_vars['val']->value['m_join_status']==1) {?>扫码进入<?php } else { ?>自然进入<?php }?></span>
                                <p class="tab-txt left"><span class="lab-name left">openid：</span><span class="lab-txt"><?php echo $_smarty_tpl->tpl_vars['val']->value['m_openid'];?>
</span></p>
                            </div>
                        </td>
                        <td>
                            <p>
                                <a class="btn btn-blueoutline btn-xs" href="/wxapp/member/memberDetailNew?id=<?php echo $_smarty_tpl->tpl_vars['val']->value['m_id'];?>
" >
                                    明细
                                </a>
                            </p>
                            <p>
                                <?php if ($_smarty_tpl->tpl_vars['val']->value['m_is_highest']==0) {?>
                                <a class="add-slide btn btn-blueoutline btn-xs" href="#" data-toggle="modal" data-target="#threeModal"  data-id="<?php echo $_smarty_tpl->tpl_vars['val']->value['m_id'];?>
">设置分销商</a>
                                <?php } else { ?>
                                <a class="del-highest btn btn-blueoutline btn-xs" href="#" data-id="<?php echo $_smarty_tpl->tpl_vars['val']->value['m_id'];?>
">取消分销商</a>
                                <?php }?>
                            ...
                            <?php if ($_smarty_tpl->tpl_vars['val']->value['m_is_highest']!=0) {?>
                            <p>
                                <a class="add-area btn btn-blueoutline btn-xs" href="#" data-toggle="modal" data-target="#threeareaModal"  data-id="<?php echo $_smarty_tpl->tpl_vars['val']->value['m_id'];?>
">增加区域</a>
                            </p>
                            <p>


                                <a class="add-level btn btn-blueoutline btn-xs" href="#" data-toggle="modal" data-target="#threelevelModal"  data-id="<?php echo $_smarty_tpl->tpl_vars['val']->value['m_id'];?>
">更改等级</a>

                            </p>
                            <?php }?>
                            <?php if ($_smarty_tpl->tpl_vars['canBan']->value) {?>
                            <p>
                                <?php if ($_smarty_tpl->tpl_vars['val']->value['m_status']==0) {?>
                                <a href="javascript:;" class="btn btn-blueoutline btn-xs" onclick="changeStatus(<?php echo $_smarty_tpl->tpl_vars['val']->value['m_id'];?>
,<?php echo $_smarty_tpl->tpl_vars['val']->value['m_status'];?>
)">封禁</a>
                                <?php }?>
                                <?php if ($_smarty_tpl->tpl_vars['val']->value['m_status']==1) {?>
                                <a href="javascript:;" class="btn btn-blueoutline btn-xs" onclick="changeStatus(<?php echo $_smarty_tpl->tpl_vars['val']->value['m_id'];?>
,<?php echo $_smarty_tpl->tpl_vars['val']->value['m_status'];?>
)">解封</a>
                                <?php }?>
                            ...
                            <?php }?>
                            <p>
                                <?php if ($_smarty_tpl->tpl_vars['val']->value['m_gold_freeze']==0) {?>
                                <a class="freeze-gold btn btn-blueoutline btn-xs" href="#" mid="<?php echo $_smarty_tpl->tpl_vars['val']->value['m_id'];?>
" status="1">冻结余额</a>
                                <?php } else { ?>
                                <a class="freeze-gold btn btn-blueoutline btn-xs"  href="#" mid="<?php echo $_smarty_tpl->tpl_vars['val']->value['m_id'];?>
" status="0">解冻余额</a>
                            ...
                            <?php if ($_smarty_tpl->tpl_vars['appletCfg']->value['ac_type']==4||$_smarty_tpl->tpl_vars['appletCfg']->value['ac_type']==32||$_smarty_tpl->tpl_vars['appletCfg']->value['ac_type']==36) {?>
                            <div class="drop-btn-box">
                                <span class="btn btn-blue btn-xs">设置<b class="arrow icon-angle-down"></b></span>
                                <div class="drop-btn-list">
                                    <?php if (!$_smarty_tpl->tpl_vars['hideLevel']->value) {?>
                                    <p>
                                        <a href="#" class="change-level-btn btn btn-lightblue btn-xs" data-toggle="modal" data-target="#levelSingleModal"  data-mid="<?php echo $_smarty_tpl->tpl_vars['val']->value['m_id'];?>
" data-type="single" data-level="<?php echo $_smarty_tpl->tpl_vars['val']->value['m_level'];?>
">设置会员</a>
                                    </p>
                                    <?php }?>
                                    <?php if ($_smarty_tpl->tpl_vars['appletCfg']->value['ac_type']==4) {?>
                                    <p>
                                        <a class="waiter-set btn btn-lightblue btn-xs" data-toggle="modal" data-target="#waiterModal"  data-mid="<?php echo $_smarty_tpl->tpl_vars['val']->value['m_id'];?>
" data-waiter="<?php echo $_smarty_tpl->tpl_vars['val']->value['m_is_waiter'];?>
" data-shop="<?php echo $_smarty_tpl->tpl_vars['val']->value['m_waiter_shop'];?>
">设置服务员</a>
                                    </p>
                                    <?php }?>
                                    <!-- 社区团购设置团长 -->
                                    ...
                                    <?php if ($_smarty_tpl->tpl_vars['val']->value['asl_status']==2) {?>
                                    <p>
                                        <a class="leader-set btn btn-lightblue btn-xs" data-mid="<?php echo $_smarty_tpl->tpl_vars['val']->value['m_id'];?>
" data-type="2">取消团长</a>
                                    </p>
                                    <?php } else { ?>
                                    <p>
...
" data-type="1">设置团长</a>
                            ...
                            <?php if (!$_smarty_tpl->tpl_vars['hideLevel']->value) {?>
                            <p>
                                <a href="#" class="change-level-btn btn btn-blueoutline btn-xs" data-toggle="modal" data-target="#levelSingleModal"  data-mid="<?php echo $_smarty_tpl->tpl_vars['val']->value['m_id'];?>
" data-type="single" data-level="<?php echo $_smarty_tpl->tpl_vars['val']->value['m_level'];?>
">设置会员</a>
                            </p>
                            <?php }?>
                            ...
                            <div class="drop-btn-box">
                                ...
                                <div class="drop-btn-list">
                                    <?php if ($_smarty_tpl->tpl_vars['sequenceShowAll']->value==1) {?>
                                    <p>
                                        <a href="#" class="js-point-btn btn btn-lightblue btn-xs" data-toggle="modal" data-target="#pointModal"  data-mid="<?php echo $_smarty_tpl->tpl_vars['val']->value['m_id'];?>
" data-type="single" data-point_now="<?php echo $_smarty_tpl->tpl_vars['val']->value['m_points'];?>
" >更改积分</a>
                                    </p>
                                    <p>
                                        <a href="#" class="js-recharge-btn btn btn-lightblue btn-xs" data-toggle="modal" data-target="#rechargeModal"  data-mid="<?php echo $_smarty_tpl->tpl_vars['val']->value['m_id'];?>
" data-coin="<?php echo $_smarty_tpl->tpl_vars['val']->value['m_gold_coin'];?>
" data-type="single" >更改余额</a>
                                    </p>
                                    <p>
                                        <a href="#" class="js-change-cate-btn btn btn-lightblue btn-xs" data-toggle="modal" data-target="#categorySingleModal"  data-mid="<?php echo $_smarty_tpl->tpl_vars['val']->value['m_id'];?>
" data-type="single" data-cate="<?php echo $_smarty_tpl->tpl_vars['val']->value['ame_cate'];?>
" <?php if ($_smarty_tpl->tpl_vars['cash']->value) {?> style="display:none;" <?php }?> >更改分类</a>
                                    </p>
                                    <?php } else { ?>
                                    <p>
                                        <a href="#" class="js-recharge-btn btn btn-lightblue btn-xs" data-toggle="modal" data-target="#rechargeModal"  data-mid="<?php echo $_smarty_tpl->tpl_vars['val']->value['m_id'];?>
    ...
    <div class="bottom-opera-fixd">
        <div class="bottom-opera">
            <div class="bottom-opera-item" style="padding: 13px 0;<?php if ($_smarty_tpl->tpl_vars['showPage']->value==0) {?>text-align: center;<?php }?>">
                ...
                <?php if (!in_array($_smarty_tpl->tpl_vars['appletCfg']->value['ac_type'],array(34,37))) {?>
                ...
                <a href="#" class="btn btn-blueoutline btn-xs" data-toggle="modal" data-target="#categoryModal" <?php if ($_smarty_tpl->tpl_vars['cash']->value) {?> style="display:none;" <?php }?> >修改用户分类</a>
            </div>
                    ...
                    <div class="control-group">
                        <div class="col-sm-8" style="width:30%;">
                            <select class="form-control" name="dc_level_id" id="dc_level_id" >
                                <option value="0">请选择等级</option>
                                <?php  $_smarty_tpl->tpl_vars['val'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['val']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['decuct']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['val']->key => $_smarty_tpl->tpl_vars['val']->value) {
$_smarty_tpl->tpl_vars['val']->_loop = true;
?>
                                <option value="<?php echo $_smarty_tpl->tpl_vars['val']->value['dc_id'];?>
"><?php echo $_smarty_tpl->tpl_vars['val']->value['dc_buy_num'];?>
</option>
                                <?php } ?>
                            </select>
                        </div>
        ...
        <div class="modal-content waiter-content">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="space-4"></div>
                    <?php if ($_smarty_tpl->tpl_vars['appletCfg']->value['ac_index_tpl']==55) {?>
                    <div class="form-group row">
...
$_smarty_tpl->tpl_vars['val']->_loop = true;
?>
                                <option value="<?php echo $_smarty_tpl->tpl_vars['val']->value['es_id'];?>
...
" <?php if ($_smarty_tpl->tpl_vars['key']->value==$_smarty_tpl->tpl_vars['searchlv']->value) {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['val']->value;?>
                        ...
                        <div class="space"></div>
                        <div class="form-group" <?php if ($_smarty_tpl->tpl_vars['addMember']->value!=1) {?>style="display:none;"<?php }?>>
                ...
                <div class="space" <?php if ($_smarty_tpl->tpl_vars['addMember']->value!=1) {?>style="display:none;"<?php }?>></div>
            <div class="form-group">
