<?php /* Smarty version Smarty-3.1.17, created on 2020-02-21 20:31:33
         compiled from "/www/wwwroot/default/yingxiaosc/sites/app/view/template/wxapp/mall/index-tpl_15.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4050730815e4fcda5090908-08167226%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f5e781c0f253e13bf88165d66215a84eecfdfe9e' => 
    array (
      0 => '/www/wwwroot/default/yingxiaosc/sites/app/view/template/wxapp/mall/index-tpl_15.tpl',
      1 => 1575621712,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4050730815e4fcda5090908-08167226',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e4fcda50e0330_38334654',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e4fcda50e0330_38334654')) {function content_5e4fcda50e0330_38334654($_smarty_tpl) {?><link rel="stylesheet" href="/public/wxapp/setup/css/spectrum.css">
                    ...
                    <div class="hot-recommend" data-left-preview data-id="3">
                        ...
                        <div class="hot-goods flex-wrap">
                            <div class="left-good border-r">
                                ...
                                <img src="/public/wxapp/mall/temp3/images/8@2x.png" alt="商品图片" ng-if="recommendGood.length<=0" />
    ...
    <div class="edit-right">
        <div class="edit-con">
            ...
            <div class="fenleinav" data-right-edit data-id="3">
                <label style="width: 100%">{{recommendtitle}}<span>(请上传白底尺寸为300px*300px的图片，否则可能影响展示效果)</span></label>
                <div class="input-group-box" style="margin-bottom: 10px;">
                ...
                <div class="fenleinav-manage">
                    <div class="edit-img">
                        ...
                        <div>
                            <img onclick="toUpload(this)"  data-limit="8" onload="changeSrc(this)" data-width="300" data-height="300" imageonload="doThis('recommendGood',0)" data-dom-id="upload-recommendGood0" id="upload-recommendGood0"  ng-src="{{recommendGood[0].imgsrc}}"  height="100%" style="display:inline-block;margin-left:0;">
                ...
                <div class="fenleinav-manage">
                    <div class="edit-img">
                        ...
                        <div>
                            <img onclick="toUpload(this)"  data-limit="8" onload="changeSrc(this)" data-width="300" data-height="300" imageonload="doThis('recommendGood',1)" data-dom-id="upload-recommendGood1" id="upload-recommendGood1"  ng-src="{{recommendGood[1].imgsrc}}"  height="100%" style="display:inline-block;margin-left:0;">
                ...
                <div class="fenleinav-manage">
                    <div class="edit-img">
                        ...
                        <div>
                            <img onclick="toUpload(this)"  data-limit="8" onload="changeSrc(this)" data-width="300" data-height="300" imageonload="doThis('recommendGood',2)" data-dom-id="upload-recommendGood2" id="upload-recommendGood2"  ng-src="{{recommendGood[2].imgsrc}}"  height="100%" style="display:inline-block;margin-left:0;">
