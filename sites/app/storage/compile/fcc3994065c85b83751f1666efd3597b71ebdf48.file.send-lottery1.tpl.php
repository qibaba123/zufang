<?php /* Smarty version Smarty-3.1.17, created on 2020-04-07 22:35:21
         compiled from "/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/meeting/send-lottery1.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19136571075e8c8fa9157f16-48796499%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fcc3994065c85b83751f1666efd3597b71ebdf48' => 
    array (
      0 => '/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/meeting/send-lottery1.tpl',
      1 => 1575621712,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19136571075e8c8fa9157f16-48796499',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e8c8fa919e300_57038043',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e8c8fa919e300_57038043')) {function content_5e8c8fa919e300_57038043($_smarty_tpl) {?><link rel="stylesheet" href="/public/manage/css/addgoods.css">
<style type="text/css">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <label id="choose-onoff" class="choose-onoff">
                                                <input class="ace ace-switch ace-switch-5" id="open"  data-type="open" type="checkbox" <?php if ($_smarty_tpl->tpl_vars['row']->value&&$_smarty_tpl->tpl_vars['row']->value['s_isopen_prize']) {?>checked<?php }?>>
                                                <span class="lbl"></span>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="form-group" id="prizeDiv" <?php if (!$_smarty_tpl->tpl_vars['row']->value['s_isopen_prize']) {?> style="display:none;" <?php }?>>
                                        <label for="firstname" class="col-sm-2 control-label text-right">赠送抽奖次数<font color="red">*</font></label>
                                        <div class="col-sm-3">
                                            <input type="number" class="form-control" id="prizeNum" value="<?php if ($_smarty_tpl->tpl_vars['row']->value) {?><?php echo $_smarty_tpl->tpl_vars['row']->value['s_send_pnum'];?>
<?php }?>" data-msg="填写订单完成试可获得抽奖次数" placeholder="填写每天分享可获得答题机会">
                                        </div>
                                    </div>
                            ...
                            <?php } else { ?>
                            <!--新增显示封面-->
                            <div class="form-group" id="coverDiv" <?php if (!$_smarty_tpl->tpl_vars['row']->value['s_isopen_prize']) {?> style="display:none;" <?php }?>>
                                ...
                                <div class="col-sm-3">
                                    <div class="cropper-box" data-width="706" data-height="220" >
                                        <img style="width: 40% !important;" src="<?php if ($_smarty_tpl->tpl_vars['row']->value&&$_smarty_tpl->tpl_vars['row']->value['s_prize_cover']) {?><?php echo $_smarty_tpl->tpl_vars['row']->value['s_prize_cover'];?>
<?php } else { ?>/public/manage/img/zhanwei/zw_fxb_75_30.png<?php }?>" onload="" />
                                        <input type="hidden" id="cover" name="cover" value="<?php if ($_smarty_tpl->tpl_vars['row']->value&&$_smarty_tpl->tpl_vars['row']->value['s_prize_cover']) {?><?php echo $_smarty_tpl->tpl_vars['row']->value['s_prize_cover'];?>
<?php }?>" />
                                    </div>
                                </div>
                            </div>
...
//					window.location.reload();
    ...
    function saveCfg() {
        ...
        if(data.isopen && '<?php echo $_smarty_tpl->tpl_vars['appletCfg']->value['ac_type'];?>
' != '32'){
            if(!data.cover){
                layer.msg('请上传封面图');
                return false;
