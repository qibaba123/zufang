<?php /* Smarty version Smarty-3.1.17, created on 2020-04-05 09:41:11
         compiled from "/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/memberCard/add-card-new.tpl" */ ?>
<?php /*%%SmartyHeaderCode:569496905e8937372f6a80-07506548%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '33903497e876132de3bcc5afe1d8ff0d7781d2dc' => 
    array (
      0 => '/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/memberCard/add-card-new.tpl',
      1 => 1575621712,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '569496905e8937372f6a80-07506548',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e89373735d3b8_50506986',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e89373735d3b8_50506986')) {function content_5e89373735d3b8_50506986($_smarty_tpl) {?><link rel="stylesheet" href="/public/wxapp/setup/css/spectrum.css">
...
"><?php echo $_smarty_tpl->tpl_vars['tal']->value['name'];?>
                ...
                <div <?php if ($_smarty_tpl->tpl_vars['showMemberDay']->value!=1) {?>style="display: none" <?php }?>>
                    <div class="input-rows">
                        <label for="">会员日：</label>
                        <div style="width: 100%">
                            <div class="input-group" style="width: 100%">
                                <input type="text" class="form-control" id="member_day" onclick="WdatePicker({dateFmt:'dd'})" style="border-radius: 4px;display: inline-block;width: 30%" value="<?php echo $_smarty_tpl->tpl_vars['row']->value['oc_member_day'];?>
">
                            </div>
                        </div>
                    </div>
                    ...
                    <div style="padding: 5px 0;width: 100%;">
                        <div class="radio-box">
                            <span data-val="0" ng-click="changeCardHidden($event)">
                                <input id='hidden_1' type="radio" name="hidden_type" value="0" <?php if ($_smarty_tpl->tpl_vars['row']->value['oc_hidden']!=1) {?>checked<?php }?> >
                                <label for="hidden_1" data-name="0">显示</label>
                            </span>
                             <span data-val="1" ng-click="changeCardHidden($event)">
                                <input id='hidden_2' type="radio" name="hidden_type" value="1" <?php if ($_smarty_tpl->tpl_vars['row']->value['oc_hidden']==1) {?>checked<?php }?> >
...
" ? "<?php echo $_smarty_tpl->tpl_vars['row']->value['oc_identity'];?>
" : 0,
            fuTitle     : "<?php echo $_smarty_tpl->tpl_vars['row']->value['oc_name_sub'];?>
",
            cardColor   : "<?php echo $_smarty_tpl->tpl_vars['row']->value['color'];?>
",
            backgroundColor : "<?php echo $_smarty_tpl->tpl_vars['row']->value['oc_background_color'];?>
",
...
",
            weight      : "<?php echo $_smarty_tpl->tpl_vars['row']->value['oc_weight'];?>
",
...
",
            returnPrice : "<?php echo $_smarty_tpl->tpl_vars['row']->value['oc_return_price'];?>
",
            memberDayDiscount : "<?php echo $_smarty_tpl->tpl_vars['row']->value['oc_member_day_discount'];?>
",
            hidden:"<?php echo $_smarty_tpl->tpl_vars['row']->value['oc_hidden'];?>
",
        };
...
',
                'type'      : '<?php echo $_smarty_tpl->tpl_vars['cardtype']->value;?>
',
