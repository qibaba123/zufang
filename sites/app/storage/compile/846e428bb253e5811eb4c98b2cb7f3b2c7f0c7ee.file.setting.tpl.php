<?php /* Smarty version Smarty-3.1.17, created on 2020-04-03 15:48:59
         compiled from "/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/sms/setting.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12216041385e86ea6b92d677-47353791%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '846e428bb253e5811eb4c98b2cb7f3b2c7f0c7ee' => 
    array (
      0 => '/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/sms/setting.tpl',
      1 => 1575621713,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '12216041385e86ea6b92d677-47353791',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e86ea6b9bc155_60350098',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e86ea6b9bc155_60350098')) {function content_5e86ea6b9bc155_60350098($_smarty_tpl) {?><link rel="stylesheet" href="/public/manage/colorPicker/spectrum.css">
            ...
            <div class="tab-content form-horizontal">
                ...
                <div id="home" class="tab-pane active">
                    <div class="alert alert-block alert-yellow">
                        ...
                        提醒1: 您店铺当前剩余短信条数为<?php echo $_smarty_tpl->tpl_vars['row']->value['sc_useable'];?>
,短信充值低至<?php echo $_smarty_tpl->tpl_vars['unit_price']->value;?>
元/条！<br/>
                    ...
                    <div class="page-header">
                        <div class="sms-view">
                            <ul class="clearfix">
                                <li>
                                    <h5 data-toggle="modal" data-target="#mySms"><?php echo $_smarty_tpl->tpl_vars['row']->value['sc_had_send'];?>
</h5>
                                    <p>总发送条数</p>
                                </li>
                                <li>
                                    <h5><?php echo $_smarty_tpl->tpl_vars['row']->value['sc_had_send'];?>
</h5>
                                    <p>成功到达量</p>
                                </li>
                                <li>
...
?>
                                        <tr>
                                            <td><?php echo $_smarty_tpl->tpl_vars['val']->value['sr_mobile'];?>
</td>
                                            <td><?php echo $_smarty_tpl->tpl_vars['val']->value['sr_text'];?>
</td>
                                            <td><?php echo $_smarty_tpl->tpl_vars['val']->value['sr_count'];?>
条</td>
                                            <td><?php echo date('Y-m-d H:i',$_smarty_tpl->tpl_vars['val']->value['sr_send_time']);?>
</td>
                                        </tr>
                                        <?php } ?>
                ...
                <div id="messset" class="tab-pane">
                    <div class="message-temp">
                        <div class="buyer-mess">
                            <p class="messtype-title">预约留言通知短信模板&nbsp;(通知短信将发送联系人<?php echo $_smarty_tpl->tpl_vars['curr_shop']->value['s_contact'];?>
：<?php echo $_smarty_tpl->tpl_vars['curr_shop']->value['s_phone'];?>
<a href="/wxapp/mall/shopSetup" style="color: blue">修改</a>)</p>
                            <ul>
                                <li>
                                    <div class="mess-temp">
                                        <h4><?php echo $_smarty_tpl->tpl_vars['sms_tpl']->value['xcxyytz']['tit'];?>
</h4>
                                        <p><?php echo $_smarty_tpl->tpl_vars['sms_tpl']->value['xcxyytz']['txt'];?>
</p>
                                    </div>
                                    <div class="state-box">
                                        <label>状态：</label>
                                        <div class="switch-box">
                                            <span class='tg-list-item'>
                                                <input class='tgl tgl-light' id='xcxyytz' type='checkbox' <?php if ($_smarty_tpl->tpl_vars['sms']->value&&$_smarty_tpl->tpl_vars['sms']->value['ss_xcxyytz_s']==1) {?>checked<?php }?>>
                                ...
                                <li>
                                    <div class="mess-temp">
                                        <h4><?php echo $_smarty_tpl->tpl_vars['sms_tpl']->value['xcxsqrz']['tit'];?>
</h4>
                                        <p><?php echo $_smarty_tpl->tpl_vars['sms_tpl']->value['xcxsqrz']['txt'];?>
</p>
                                    </div>
                                    <div class="state-box">
                                        <label>状态：</label>
                                        <div class="switch-box">
                                            <span class='tg-list-item'>
                                                <input class='tgl tgl-light' id='xcxsqrz' type='checkbox' <?php if ($_smarty_tpl->tpl_vars['sms']->value&&$_smarty_tpl->tpl_vars['sms']->value['ss_xcxsqrz_s']==1) {?>checked<?php }?>>
                                ...
                                <li>
                                    <div class="mess-temp">
                                        <h4><?php echo $_smarty_tpl->tpl_vars['sms_tpl']->value['kfxxtz']['tit'];?>
</h4>
                                        <p><?php echo $_smarty_tpl->tpl_vars['sms_tpl']->value['kfxxtz']['txt'];?>
</p>
                                    </div>
                                    <div class="state-box">
                                        <label>状态：</label>
                                        <div class="switch-box">
                                            <span class='tg-list-item'>
                                                <input class='tgl tgl-light' id='kfxxtz' type='checkbox' <?php if ($_smarty_tpl->tpl_vars['sms']->value&&$_smarty_tpl->tpl_vars['sms']->value['ss_kfxxtz_s']==1) {?>checked<?php }?>>
                        ...
                        <div class="seller-mess">
                            <p class="messtype-title">卖家短信模板&nbsp;(通知短信将发送联系人<?php echo $_smarty_tpl->tpl_vars['curr_shop']->value['s_contact'];?>
：<?php echo $_smarty_tpl->tpl_vars['curr_shop']->value['s_phone'];?>
<a href="/wxapp/mall/shopSetup" style="color: blue">修改</a>)</p>
                            <ul>
                                <li>
                                    <div class="mess-temp">
                                        <h4><?php echo $_smarty_tpl->tpl_vars['sms_tpl']->value['ddzfcg']['tit'];?>
</h4>
                                        <p><?php echo $_smarty_tpl->tpl_vars['sms_tpl']->value['ddzfcg']['txt'];?>
</p>
                                    </div>
                                    <div class="state-box">
                                        <label>状态：</label>
                                        <div class="switch-box">
                                            <span class='tg-list-item'>
                                                <input class='tgl tgl-light' id='ddzfcg' type='checkbox' <?php if ($_smarty_tpl->tpl_vars['sms']->value&&$_smarty_tpl->tpl_vars['sms']->value['ss_ddzfcg_s']==1) {?>checked<?php }?>>
                                ...
                                <li>
                                    <div class="mess-temp">
                                        <h4><?php echo $_smarty_tpl->tpl_vars['sms_tpl']->value['ddwctz']['tit'];?>
</h4>
                                        <p><?php echo $_smarty_tpl->tpl_vars['sms_tpl']->value['ddwctz']['txt'];?>
</p>
                                    </div>
                                    <div class="state-box">
                                        <label>状态：</label>
                                        <div class="switch-box">
                                            <span class='tg-list-item'>
                                                <input class='tgl tgl-light' id='ddwctz' type='checkbox' <?php if ($_smarty_tpl->tpl_vars['sms']->value&&$_smarty_tpl->tpl_vars['sms']->value['ss_ddwctz_s']==1) {?>checked<?php }?>>
                                ...
                                <li>
                                    <div class="mess-temp">
                                        <h4><?php echo $_smarty_tpl->tpl_vars['sms_tpl']->value['sqtktz']['tit'];?>
</h4>
                                        <p><?php echo $_smarty_tpl->tpl_vars['sms_tpl']->value['sqtktz']['txt'];?>
</p>
                                    </div>
                                    <div class="state-box">
                                        <label>状态：</label>
                                        <div class="switch-box">
                                            <span class='tg-list-item'>
                                                <input class='tgl tgl-light' id='sqtktz' type='checkbox' <?php if ($_smarty_tpl->tpl_vars['sms']->value&&$_smarty_tpl->tpl_vars['sms']->value['ss_sqtktz_s']==1) {?>checked<?php }?>>
                        ...
                        <div class="buyer-mess">
                            ...
                            <ul>
                                <li>
                                    <div class="mess-temp">
                                        <h4><?php echo $_smarty_tpl->tpl_vars['sms_tpl']->value['mjfhtz']['tit'];?>
</h4>
                                        <p><?php echo $_smarty_tpl->tpl_vars['sms_tpl']->value['mjfhtz']['txt'];?>
</p>
                                    </div>
                                    <div class="state-box">
                                        <label>状态：</label>
                                        <div class="switch-box">
                                            <span class='tg-list-item'>
                                                <input class='tgl tgl-light' id='mjfhtz' type='checkbox' <?php if ($_smarty_tpl->tpl_vars['sms']->value&&$_smarty_tpl->tpl_vars['sms']->value['ss_mjfhtz_b']==1) {?>checked<?php }?>>
                                ...
                                <li>
                                    <div class="mess-temp">
                                        <h4><?php echo $_smarty_tpl->tpl_vars['sms_tpl']->value['tytktz']['tit'];?>
</h4>
                                        <p><?php echo $_smarty_tpl->tpl_vars['sms_tpl']->value['tytktz']['txt'];?>
</p>
                                    </div>
                                    <div class="state-box">
                                        <label>状态：</label>
                                        <div class="switch-box">
                                            <span class='tg-list-item'>
                                                <input class='tgl tgl-light' id='tytktz' type='checkbox' <?php if ($_smarty_tpl->tpl_vars['sms']->value&&$_smarty_tpl->tpl_vars['sms']->value['ss_tytktz_b']==1) {?>checked<?php }?>>
                                ...
                                <li>
                                    <div class="mess-temp">
                                        <h4><?php echo $_smarty_tpl->tpl_vars['sms_tpl']->value['jjtktz']['tit'];?>
</h4>
                                        <p><?php echo $_smarty_tpl->tpl_vars['sms_tpl']->value['jjtktz']['txt'];?>
</p>
                                    </div>
                                    <div class="state-box">
                                        <label>状态：</label>
                                        <div class="switch-box">
                                            <span class='tg-list-item'>
                                                <input class='tgl tgl-light' id='jjtktz' type='checkbox' <?php if ($_smarty_tpl->tpl_vars['sms']->value&&$_smarty_tpl->tpl_vars['sms']->value['ss_jjtktz_b']==1) {?>checked<?php }?>>
...
<script type="text/javascript">
    ...
    var watermark = '',currSwitch = 0,currSuid = '<?php echo $_smarty_tpl->tpl_vars['curr_shop']->value['s_unique_id'];?>
',money=0;
    $(function(){
        /*短信记录弹出框出现时回调*/
