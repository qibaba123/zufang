<?php /* Smarty version Smarty-3.1.17, created on 2020-04-02 16:11:21
         compiled from "/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/limit/limit-cfg.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17088086255e859e295ee6e7-14923962%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '008aeff19a37893b280aaa6a541c781ef7fe49f3' => 
    array (
      0 => '/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/limit/limit-cfg.tpl',
      1 => 1575621712,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17088086255e859e295ee6e7-14923962',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e859e2962e771_74708367',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e859e2962e771_74708367')) {function content_5e859e2962e771_74708367($_smarty_tpl) {?><link rel="stylesheet" href="/public/wxapp/mall/temp3/css/index.css">
...
<!--<div style="margin-left:135px;"><a target="_blank" style="color:red; " href="http://p18m0a32n.bkt.clouddn.com/%E7%A7%92%E6%9D%80.mp4">该插件使用教程请点此查看</a></div>-->
<div class="preview-page" ng-app="chApp" ng-controller="chCtrl" style="margin-left: 150px">
        ...
        <div class="edit-con">
            <div class="header-top" data-right-edit data-id="0" style="display:block;">
                ...
                <div class="top-manage">
                 ...
                 <!--    <div class="input-group">
                        <label for="">是否显示优惠券</label>
                        <span class='tg-list-item'>
                                <input class='tgl tgl-light' id='showcoupon' type='checkbox' ng-checked='showcoupon==1' ng-model="showcoupon">
                                <label class='tgl-btn' for='showcoupon'></label>
                        </span>
                    </div> -->
            ...
            <div class="fenleinav" data-right-edit data-id="2">
                ...
                <div class="fenleinav-manage" ng-repeat="fenleiNav in fenleiNavs">
                    ...
                    <div class="edit-txt">
                        ...
                        <div class="input-group-box clearfix" ng-show="fenleiNav.type==11">
                            <label for="">分组详情：</label>
...
<script>
    ...
    app.controller('chCtrl', ['$scope','$http','$timeout',function($scope,$http,$timeout){
        $scope.headerTitle= "<?php echo $_smarty_tpl->tpl_vars['tpl']->value['ali_title'];?>
" ? "<?php echo $_smarty_tpl->tpl_vars['tpl']->value['ali_title'];?>
" : "微秒杀" ;
        $scope.isopen     = '<?php echo $_smarty_tpl->tpl_vars['tpl']->value['ali_isopen'];?>
';
        $scope.showcoupon = '<?php echo $_smarty_tpl->tpl_vars['tpl']->value['ali_show_coupon'];?>
';
        $scope.applyTitle     = '<?php echo $_smarty_tpl->tpl_vars['tpl']->value['ali_apply_title'];?>
';
...
;
        ...
        $scope.saveData = function(){
        	layer.confirm('确定要保存吗？', {
                ...
                var showcoupon  = $('#showcoupon:checked').val();
	            var data = {
                    ...
                    'showcoupon'    : showcoupon == 'on' ? 1 : 0,
	            };
	            console.log(data);
	            $http({
	                method: 'POST',
	                url:    '/wxapp/limit/saveCfg',
	                data:   data
