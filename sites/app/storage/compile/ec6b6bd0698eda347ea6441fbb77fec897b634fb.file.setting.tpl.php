<?php /* Smarty version Smarty-3.1.17, created on 2019-07-08 17:35:23
         compiled from "/www/wwwroot/tdtinstall/sites/app/view/template/site/setting.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6983821825d230e5b6c1b98-22380274%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ec6b6bd0698eda347ea6441fbb77fec897b634fb' => 
    array (
      0 => '/www/wwwroot/tdtinstall/sites/app/view/template/site/setting.tpl',
      1 => 1562553391,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6983821825d230e5b6c1b98-22380274',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5d230e5b6e5b08_70131819',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d230e5b6e5b08_70131819')) {function content_5d230e5b6e5b08_70131819($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                ...
                <div class="left-login-con">
                    ...
                    <div class="login-part-box js_login js_pass_login show">
                        <form name="member_login_form" >
                            ...
                            <button type="submit" class="login-btn setting-btn">保存</button>
                        </form>
                    </div>
                </div>
            </div>
...
<script>
       $(".setting-btn").click(function(){
          var appletType = '<?php echo $_smarty_tpl->tpl_vars['appletType']->value;?>
';
