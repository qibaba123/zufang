<?php /* Smarty version Smarty-3.1.17, created on 2019-12-06 17:05:36
         compiled from "/mnt/www/default/duodian/tdtinstall/sites/app/view/template/wxapp/community/mall.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18546320345dea19e0a75063-14700051%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bb952eaec5549ff944c955af4b68274c68fa7849' => 
    array (
      0 => '/mnt/www/default/duodian/tdtinstall/sites/app/view/template/wxapp/community/mall.tpl',
      1 => 1575623127,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18546320345dea19e0a75063-14700051',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5dea19e0ae9846_23222583',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5dea19e0ae9846_23222583')) {function content_5dea19e0ae9846_23222583($_smarty_tpl) {?><link rel="stylesheet" href="/public/wxapp/setup/css/spectrum.css">
...
;
        $scope.headerTitle    = "<?php echo $_smarty_tpl->tpl_vars['tpl']->value['amu_title'];?>
" ? "<?php echo $_smarty_tpl->tpl_vars['tpl']->value['amu_title'];?>
" : "店铺首页" ;
...
;
        $scope.tpl_id		  = '<?php echo $_smarty_tpl->tpl_vars['tpl']->value['amu_tpl_id'];?>
';
        $scope.recommendGood  = <?php echo $_smarty_tpl->tpl_vars['recommendGoods']->value;?>
;
        $scope.recommendtitle = '<?php echo $_smarty_tpl->tpl_vars['tpl']->value['amu_promotion_title'];?>
' ? '<?php echo $_smarty_tpl->tpl_vars['tpl']->value['amu_promotion_title'];?>
' : '热品推荐';
        $scope.recommendsign  = '<?php echo $_smarty_tpl->tpl_vars['tpl']->value['amu_promotion_sign'];?>
' ? '<?php echo $_smarty_tpl->tpl_vars['tpl']->value['amu_promotion_sign'];?>
' : '随时促销 先到先得';
...
;
        $scope.couponTitle    = '<?php echo $_smarty_tpl->tpl_vars['tpl']->value['amu_coupon_title'];?>
'?'<?php echo $_smarty_tpl->tpl_vars['tpl']->value['amu_coupon_title'];?>
':'优惠券';
        $scope.couponSign     = '<?php echo $_smarty_tpl->tpl_vars['tpl']->value['amu_coupon_sign'];?>
'?'<?php echo $_smarty_tpl->tpl_vars['tpl']->value['amu_coupon_sign'];?>
':'优惠好礼 即领即得';
        $scope.noticeTxt      = <?php echo $_smarty_tpl->tpl_vars['information']->value;?>
;
        $scope.hotImg         = '<?php echo $_smarty_tpl->tpl_vars['tpl']->value['amu_hot_img'];?>
'?'<?php echo $_smarty_tpl->tpl_vars['tpl']->value['amu_hot_img'];?>
':'/public/manage/img/zhanwei/zw_fxb_75_30.png';
        $scope.hotType        = '<?php echo $_smarty_tpl->tpl_vars['tpl']->value['amu_hot_type'];?>
';
        $scope.hotLink        = '<?php echo $_smarty_tpl->tpl_vars['tpl']->value['amu_hot_link'];?>
';
        $scope.brief          = '<?php echo $_smarty_tpl->tpl_vars['tpl']->value['amu_brief'];?>
';
        $scope.kindSelect = <?php echo $_smarty_tpl->tpl_vars['kindSelect']->value;?>
;
        $scope.shoplist = <?php echo $_smarty_tpl->tpl_vars['shoplist']->value;?>
;
        $scope.articlesSelect = <?php echo $_smarty_tpl->tpl_vars['categoryList']->value;?>
;
...
;
        $scope.plateformGroup = <?php echo $_smarty_tpl->tpl_vars['plateformGroup']->value;?>
;
        $scope.shopGoodsGroup = <?php echo $_smarty_tpl->tpl_vars['shopGoodsGroup']->value;?>
;
        $scope.secondkindSelect = <?php echo $_smarty_tpl->tpl_vars['secondkindSelect']->value;?>
;
        $scope.firstKindSelect = <?php echo $_smarty_tpl->tpl_vars['firstKindSelect']->value;?>
;
        /*$scope.address = {
            address   :'<?php echo $_smarty_tpl->tpl_vars['tpl']->value['amu_address'];?>
' ? '<?php echo $_smarty_tpl->tpl_vars['tpl']->value['amu_address'];?>
' : '郑州市郑东新区CBD商务内环11号金成东方国际24楼2402室',
            longitude :'<?php echo $_smarty_tpl->tpl_vars['tpl']->value['amu_lng'];?>
' ? '<?php echo $_smarty_tpl->tpl_vars['tpl']->value['amu_lng'];?>
' : '113.72052',
            latitude  :'<?php echo $_smarty_tpl->tpl_vars['tpl']->value['amu_lat'];?>
' ? '<?php echo $_smarty_tpl->tpl_vars['tpl']->value['amu_lat'];?>
' : '34.77485',
        };
        $scope.shopInfo = {
                    title   :"<?php echo $_smarty_tpl->tpl_vars['shopSetup']->value['s_name'];?>
" ? "<?php echo $_smarty_tpl->tpl_vars['shopSetup']->value['s_name'];?>
" : '公司名称',
                    cover   :"<?php echo $_smarty_tpl->tpl_vars['shopSetup']->value['s_logo'];?>
" ? "<?php echo $_smarty_tpl->tpl_vars['shopSetup']->value['s_logo'];?>
