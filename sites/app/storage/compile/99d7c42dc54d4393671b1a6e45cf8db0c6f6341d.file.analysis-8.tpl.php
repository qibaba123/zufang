<?php /* Smarty version Smarty-3.1.17, created on 2019-12-25 14:19:46
         compiled from "/mnt/www/default/duodian/tdtinstall/sites/app/view/template/wxapp/analysis/analysis-8.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12852298245e02ff82571bc2-58792359%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '99d7c42dc54d4393671b1a6e45cf8db0c6f6341d' => 
    array (
      0 => '/mnt/www/default/duodian/tdtinstall/sites/app/view/template/wxapp/analysis/analysis-8.tpl',
      1 => 1575621712,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '12852298245e02ff82571bc2-58792359',
  'function' => 
  array (
  ),
  'variables' => 
  array (
    ...
    'allEnterTotal' => 0,
    'todayEnterTotal' => 0,
    'yesterdayEnterTotal' => 0,
    'dayEnterPercent' => 0,
    'thisMonthEnterTotal' => 0,
    'lastMonthEnterTotal' => 0,
    'monthEnterPercent' => 0,
    'totalEnterProfit' => 0,
    'todayEnterProfit' => 0,
    'yesterdayEnterProfit' => 0,
    'dayEnterProfitPercent' => 0,
    'thisMonthEnterProfit' => 0,
    'lastMonthEnterProfit' => 0,
    'monthEnterProfitPercent' => 0,
    'daysArr' => 0,
    'fifteenOrderStatistic' => 0,
    'fifteenSaleGoodsStatistic' => 0,
    'fifteenSaleMoneyStatistic' => 0,
    'fifteenMemberStatistic' => 0,
    'fifteenEnterProfitStatistic' => 0,
    'fifteenEnterStatistic' => 0,
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.17',
  'unifunc' => 'content_5e02ff8263a800_34401314',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e02ff8263a800_34401314')) {function content_5e02ff8263a800_34401314($_smarty_tpl) {?><link rel="stylesheet" href="/public/wxapp/analysis/css/index.css">
        ...
        <div class="zczl">
            <div class="zczl-title">
                ...
                <div class="icon">
                    <i class="icon-user">
                        <span class="font-green-sharp">共：</span>
                        <span class="allMbs  counterup" data-counter="counterup" style="color:#FE2F56;" data-value="<?php echo $_smarty_tpl->tpl_vars['allEnterTotal']->value;?>
"><?php echo $_smarty_tpl->tpl_vars['allEnterTotal']->value;?>
</span>
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="mt-widget-2 mt-widget1">
                        <div class="pie-font">
                            ...
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="thisMonthNewAddPerson counterup" data-counter="counterup" data-value="<?php echo $_smarty_tpl->tpl_vars['todayEnterTotal']->value;?>
" style="color:#A3D04B;"><?php echo $_smarty_tpl->tpl_vars['todayEnterTotal']->value;?>
</span>&nbsp;人
                                </div>
                            </div>
                            ...
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="lastMonthNewAddPerson counterup" data-counter="counterup" data-value="<?php echo $_smarty_tpl->tpl_vars['yesterdayEnterTotal']->value;?>
" style="color:#A3D04B;"><?php echo $_smarty_tpl->tpl_vars['yesterdayEnterTotal']->value;?>
</span>&nbsp;人
                                </div>
                            </div>
                        </div>
                        <div class="easy-pie-chart chart-style">
                            <div class="monthAddMbsPreCentum number team" data-percent="<?php echo $_smarty_tpl->tpl_vars['dayEnterPercent']->value;?>
" data-color="#abce33" style="line-height: 144px;"><span><?php echo $_smarty_tpl->tpl_vars['dayEnterPercent']->value;?>
</span>%</div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    <div class="mt-widget-2 mt-widget1">
                        <div class="pie-font">
                            ...
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="todayNewAddPerson counterup" data-counter="counterup" data-value="<?php echo $_smarty_tpl->tpl_vars['thisMonthEnterTotal']->value;?>
" style="color:#FE2F56;"><?php echo $_smarty_tpl->tpl_vars['thisMonthEnterTotal']->value;?>
</span>&nbsp;人
                                </div>
                            </div>
                            ...
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="yestodayNewAddPerson counterup" data-counter="counterup" data-value="<?php echo $_smarty_tpl->tpl_vars['lastMonthEnterTotal']->value;?>
" style="color:#FF2C30;"><?php echo $_smarty_tpl->tpl_vars['lastMonthEnterTotal']->value;?>
</span>&nbsp;人
                                </div>
                            </div>
                        </div>
                        <div class="easy-pie-chart chart-style">
                            <div class="todayNewAddMbsPreCentum number team" data-percent="<?php echo $_smarty_tpl->tpl_vars['monthEnterPercent']->value;?>
" data-color="#f92d56" style="line-height: 144px;"><span><?php echo $_smarty_tpl->tpl_vars['monthEnterPercent']->value;?>
</span>%</div>
                        </div>
                    </div>
                </div>
        ...
        <div class="zczl">
            <div class="zczl-title">
                ...
                <div class="icon">
                    <i class="icon-user">
                        <span class="font-green-sharp">共：</span>
                        <span class="allMbs  counterup" data-counter="counterup" style="color:#FE2F56;" data-value="<?php echo $_smarty_tpl->tpl_vars['totalEnterProfit']->value;?>
"><?php echo $_smarty_tpl->tpl_vars['totalEnterProfit']->value;?>
</span>
                        <span class="font-green-sharp">元</span>
                    </i>
                </div>
                <div class="head-bottom"></div>
            </div>
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <div class="mt-widget-2 mt-widget1">
                        <div class="pie-font">
                            <span class="font-grey-salsa">今日收益</span>
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="thisMonthNewAddPerson counterup" data-counter="counterup" data-value="<?php echo $_smarty_tpl->tpl_vars['todayEnterProfit']->value;?>
" style="color:#A3D04B;"><?php echo $_smarty_tpl->tpl_vars['todayEnterProfit']->value;?>
</span>&nbsp;元
                                </div>
                            </div>
                            <span class="font-grey-salsa">昨日收益</span>
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="lastMonthNewAddPerson counterup" data-counter="counterup" data-value="<?php echo $_smarty_tpl->tpl_vars['yesterdayEnterProfit']->value;?>
" style="color:#A3D04B;"><?php echo $_smarty_tpl->tpl_vars['yesterdayEnterProfit']->value;?>
</span>&nbsp;元
                                </div>
                            </div>
                        </div>
                        <div class="easy-pie-chart chart-style">
                            <div class="monthAddMbsPreCentum number team" data-percent="<?php echo $_smarty_tpl->tpl_vars['dayEnterProfitPercent']->value;?>
" data-color="#abce33" style="line-height: 144px;"><span><?php echo $_smarty_tpl->tpl_vars['dayEnterProfitPercent']->value;?>
</span>%</div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    <div class="mt-widget-2 mt-widget1">
                        <div class="pie-font">
                            <span class="font-red-soft">本月收益</span>
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="todayNewAddPerson counterup" data-counter="counterup" data-value="<?php echo $_smarty_tpl->tpl_vars['thisMonthEnterProfit']->value;?>
" style="color:#FE2F56;"><?php echo $_smarty_tpl->tpl_vars['thisMonthEnterProfit']->value;?>
</span> 元
                                </div>
                            </div>
                            <span class="font-red-mint">上月收益</span>
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="yestodayNewAddPerson counterup" data-counter="counterup" data-value="<?php echo $_smarty_tpl->tpl_vars['lastMonthEnterProfit']->value;?>
" style="color:#FF2C30;"><?php echo $_smarty_tpl->tpl_vars['lastMonthEnterProfit']->value;?>
</span>&nbsp;元
                                </div>
                            </div>
                        </div>
                        <div class="easy-pie-chart chart-style">
                            <div class="todayNewAddMbsPreCentum number team" data-percent="<?php echo $_smarty_tpl->tpl_vars['monthEnterProfitPercent']->value;?>
" data-color="#f92d56" style="line-height: 144px;"><span><?php echo $_smarty_tpl->tpl_vars['monthEnterProfitPercent']->value;?>
</span>%</div>
                        </div>
                    </div>
                </div>
...
<div class="row">
    ...
    <div class="col-lg-6 col-xs-12 col-sm-12">
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject bold uppercase font-dark">近15日商家入驻收益</span>
                    <span class="caption-helper"></span>
                </div>
            </div>
            <div class="portlet-body">
                <div id="enterProfitAnalysis" style="height: 400px"></div>
            </div>
        </div>
    </div>
    <!-- END :  近15日商家入驻量   -->
...
;
    let fifteenEnterProfitStatistic = <?php echo $_smarty_tpl->tpl_vars['fifteenEnterProfitStatistic']->value;?>
;
    let fifteenEnterStatistic     = <?php echo $_smarty_tpl->tpl_vars['fifteenEnterStatistic']->value;?>
;
    drawAxisChart("enterProfitAnalysis", fifteenEnterProfitStatistic, daysArr, '入驻收益');
