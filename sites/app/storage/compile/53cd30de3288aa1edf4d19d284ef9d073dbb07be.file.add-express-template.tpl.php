<?php /* Smarty version Smarty-3.1.17, created on 2020-04-03 15:52:24
         compiled from "/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/delivery/add-express-template.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9436867215e86eb3816ba04-19224838%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '53cd30de3288aa1edf4d19d284ef9d073dbb07be' => 
    array (
      0 => '/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/delivery/add-express-template.tpl',
      1 => 1575621712,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9436867215e86eb3816ba04-19224838',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e86eb381a58d4_46250834',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e86eb381a58d4_46250834')) {function content_5e86eb381a58d4_46250834($_smarty_tpl) {?><link rel="stylesheet" href="/public/wxapp/mall/css/deliverRegion.css">
...
<div class="app" ng-app="areaApp" ng-controller="areaCtrl" >
    <input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['row']->value['sdt_id'];?>
" name="id" id="id">
    <input type="hidden" value="<?php if ($_smarty_tpl->tpl_vars['sendCfg']->value['acs_es_id']&&$_smarty_tpl->tpl_vars['sendCfg']->value['acs_es_id']>0) {?><?php echo $_smarty_tpl->tpl_vars['sendCfg']->value['acs_es_id'];?>
<?php } else { ?>0<?php }?>" name="esId" id="esId">
            ...
            <div id="page-trade-delivery" class="app__content page-trade-delivery" style="display: block;"><div>
                    ...
                    <form class="form-horizontal freight-add-form" onkeypress="return event.keyCode != 13;">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="js-valuation-name form-control col-xs-3" type="text" value="<?php echo $_smarty_tpl->tpl_vars['row']->value['sdt_name'];?>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <label class="inline radio">
                                    <input class="js-valuation-type" type="radio" name="valuation_type" value="1" <?php if ($_smarty_tpl->tpl_vars['row']->value['sdt_type']==1) {?> checked="checked" <?php }?> id="temp-type">
                                    按件数
                                </label>
                                <label class="inline radio" style="margin-left: 20px">
                                    <input class="js-valuation-type" type="radio" name="valuation_type" value="2" <?php if ($_smarty_tpl->tpl_vars['row']->value['sdt_type']==2) {?> checked="checked" <?php }?>>
                                    按重量
                                </label>
...
<script>
    window.LocalAreaList=<?php echo $_smarty_tpl->tpl_vars['LocalAreaList']->value;?>
;
    $(function () {
    ...
    var jsonlist = <?php echo $_smarty_tpl->tpl_vars['list']->value;?>
;
    var list = [];
