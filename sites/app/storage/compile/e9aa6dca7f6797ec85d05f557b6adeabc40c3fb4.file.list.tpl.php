<?php /* Smarty version Smarty-3.1.17, created on 2020-04-07 16:28:33
         compiled from "/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/limit/list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1057507835e8c39b1d74069-79555366%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e9aa6dca7f6797ec85d05f557b6adeabc40c3fb4' => 
    array (
      0 => '/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/limit/list.tpl',
      1 => 1575621712,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1057507835e8c39b1d74069-79555366',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e8c39b1e766c5_32101285',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e8c39b1e766c5_32101285')) {function content_5e8c39b1e766c5_32101285($_smarty_tpl) {?><link rel="stylesheet" href="/public/manage/css/bargain-list.css">
<style type="text/css">
    #goods-tr td{
        padding:8px 5px;
    ...
    <div  id="mainContent" ng-app="ShopIndex"  ng-controller="ShopInfoController">
        ...
        <div class="tabbable">
            <ul class="nav nav-tabs" id="myTab">
                <li  class="<?php if ($_smarty_tpl->tpl_vars['status']->value=='all') {?>active<?php }?>">
                    <a href="/wxapp/limit/index?status=all">
                        全部活动
                    </a>
                </li>
                <li  class="<?php if ($_smarty_tpl->tpl_vars['status']->value=='notStart') {?>active<?php }?>">
                    <a href="/wxapp/limit/index?status=notStart">
                        未开始
                    </a>
                </li>
                <li class="<?php if ($_smarty_tpl->tpl_vars['status']->value=='runing') {?>active<?php }?>">
                    <a href="/wxapp/limit/index?status=runing">
                        进行中
                    </a>
                </li>
                <li class="<?php if ($_smarty_tpl->tpl_vars['status']->value=='finish') {?>active<?php }?>">
...
?>
                            <tr id="tr_<?php echo $_smarty_tpl->tpl_vars['val']->value['la_id'];?>
">
                                <!--
                                <td class="center">
                                    <label>
                                        <input type="checkbox" class="ace" name="ids" value="<?php echo $_smarty_tpl->tpl_vars['val']->value['la_id'];?>
"/>
                                        <span class="lbl"></span>
                                    </label>
                                </td>
                                -->
                                <td><?php echo $_smarty_tpl->tpl_vars['val']->value['la_name'];?>
</td>
                                <td>
                                    <p>开始时间：<?php echo date('Y-m-d H:i:s',$_smarty_tpl->tpl_vars['val']->value['la_start_time']);?>
</p>
                                    <p>结束时间：<?php echo date('Y-m-d H:i:s',$_smarty_tpl->tpl_vars['val']->value['la_end_time']);?>
</p>
                                </td>
                                <td><?php echo $_smarty_tpl->tpl_vars['val']->value['la_label'];?>
</td>
                                <td><?php if ($_smarty_tpl->tpl_vars['val']->value['la_start_time']>time()) {?>
                                    <!--<span class="label label-sm label-danger">尚未开始</span>-->
                                    <span class="font-color-audit">尚未开始</span>
                                    <?php } elseif ($_smarty_tpl->tpl_vars['val']->value['la_start_time']<=time()&&$_smarty_tpl->tpl_vars['val']->value['la_end_time']>time()) {?>
                                    <!--<span class="label label-sm label-success">进行中</span>-->
                                    <span class="font-color-pass">进行中</span>
                                    <?php } elseif ($_smarty_tpl->tpl_vars['val']->value['la_end_time']<=time()) {?>
                                    <!--<span class="label label-sm label-green">活动结束</span>-->
                                    <span class="font-color-refuse">活动结束</span>
                                    <?php }?></td>
                                <?php if (!in_array($_smarty_tpl->tpl_vars['menuType']->value,array('aliapp','bdapp','toutiao','qq','qihoo'))) {?>
                                <td><?php if ($_smarty_tpl->tpl_vars['val']->value['la_push']) {?>已推送<?php } else { ?><span style="color:#333;">未推送</span><?php }?></td>
                                <?php }?>
                                <td style="color:#ccc;">
                                    <?php if (!in_array($_smarty_tpl->tpl_vars['menuType']->value,array('aliapp','bdapp','toutiao','qq','qihoo'))) {?>
                                	<p>
                                        <a href="javascript:;" onclick="pushLimit('<?php echo $_smarty_tpl->tpl_vars['val']->value['la_id'];?>
')" >推送</a> -
                                        <?php if (!in_array($_smarty_tpl->tpl_vars['menuType']->value,array('weixin'))) {?>
                                        <a href="javascript:;" data-toggle="modal" data-target="#tplPreviewModal" onclick="showPreview('<?php echo $_smarty_tpl->tpl_vars['val']->value['la_id'];?>
')">预览</a> -
                                        <?php }?>
                                        <a href="/wxapp/tplpreview/pushHistory?type=limit&id=<?php echo $_smarty_tpl->tpl_vars['val']->value['la_id'];?>
" >记录</a>
                                    </p>
                                    <?php }?>
                                    <p>
                                        <a href="/wxapp/limit/add/?id=<?php echo $_smarty_tpl->tpl_vars['val']->value['la_id'];?>
" >编辑</a> -
                                        <!--<a href="javascript:;" id="link_<?php echo $_smarty_tpl->tpl_vars['val']->value['la_id'];?>
" class="btn-link" data-link="<?php echo $_smarty_tpl->tpl_vars['val']->value['link'];?>
">链接</a> -->
                                        <!--
                                        <?php if ($_smarty_tpl->tpl_vars['appletCfg']->value['ac_type']!=12&&$_smarty_tpl->tpl_vars['appletCfg']->value['ac_type']!=7&&$_smarty_tpl->tpl_vars['appletCfg']->value['ac_type']!=4) {?>
                                        <a href="/wxapp/limit/limitBanner/?id=<?php echo $_smarty_tpl->tpl_vars['val']->value['la_id'];?>
" >广告设置</a>-
                                        <?php }?>
                                        -->
                                        <a href="javascript:;" data-id="<?php echo $_smarty_tpl->tpl_vars['val']->value['la_id'];?>
            ...
            <div class="modal-body">
                <div class="form-group row" style="margin-top: 10px;margin-right: 0;">
                    ...
                    <div class="col-sm-8">
                        <span class='tg-list-item'>
                            <input class='tgl tgl-light' id='wxgroupshow' type='checkbox' <?php if ($_smarty_tpl->tpl_vars['limitCfg']->value['lc_wxgroup_show']) {?>checked<?php }?>>
                ...
                <div class="form-group row" style="margin-top: 10px;margin-right: 0;">
                    ...
                    <div class="col-sm-8">
                        <div>
                            <div>
                                <img onclick="toUpload(this)" data-limit="1" data-width="200" data-height="200" data-dom-id="upload-wxgrouplogo" id="upload-wxgrouplogo"  src="<?php if ($_smarty_tpl->tpl_vars['limitCfg']->value['lc_wxgroup_logo']) {?><?php echo $_smarty_tpl->tpl_vars['limitCfg']->value['lc_wxgroup_logo'];?>
<?php } else { ?>/public/manage/img/zhanwei/zw_fxb_200_200.png<?php }?>"  width="200px" height="200px" style="display:inline-block;margin-left:0;width: 30%;height: 30%">
                                <input type="hidden" id="wxgrouplogo"  class="avatar-field bg-img" name="wxgrouplogo" value="<?php echo $_smarty_tpl->tpl_vars['limitCfg']->value['lc_wxgroup_logo'];?>
"/>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-group row" style="margin-right: 0;">
                    ...
                    <div class="col-sm-8">
                        <input id="wxgroup-title" class="form-control" placeholder="请填写加群标题" style="height:auto!important" value="<?php echo $_smarty_tpl->tpl_vars['limitCfg']->value['lc_wxgroup_title'];?>
"/>
                    </div>
                </div>
                <div class="form-group row" style="margin-right: 0;">
                    ...
                    <div class="col-sm-8">
                        <input id="wxgroup-desc" class="form-control" placeholder="请填写加群描述" style="height:auto!important" value="<?php echo $_smarty_tpl->tpl_vars['limitCfg']->value['lc_wxgroup_desc'];?>
"/>
                    </div>
                </div>
                <div class="form-group row" style="margin-right: 0;">
                    ...
                    <div class="col-sm-8">
                        <div>
                            <div>
                                <img onclick="toUpload(this)" data-limit="1" data-width="200" data-height="200" data-dom-id="upload-wxgroupqrcode" id="upload-wxgroupqrcode"  src="<?php if ($_smarty_tpl->tpl_vars['limitCfg']->value['lc_wxgroup_qrcode']) {?><?php echo $_smarty_tpl->tpl_vars['limitCfg']->value['lc_wxgroup_qrcode'];?>
<?php } else { ?>/public/manage/img/zhanwei/zw_fxb_200_200.png<?php }?>" height="200px;" width="200px;" style="display:inline-block;margin-left:0;width: 60%;height: 60%">
                                <input type="hidden" id="wxgroupqrcode"  class="avatar-field bg-img" name="wxgroupqrcode" value="<?php echo $_smarty_tpl->tpl_vars['limitCfg']->value['lc_wxgroup_qrcode'];?>
"/>
                            </div>
                        </div>
                    </div>
