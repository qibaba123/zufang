<?php /* Smarty version Smarty-3.1.17, created on 2020-04-02 16:12:52
         compiled from "/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/currency/information-list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1734176155e859e846732d9-83407638%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'eb7fe0ca6dffd0b5e66e20b0601840f2fcc2b52b' => 
    array (
      0 => '/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/currency/information-list.tpl',
      1 => 1575621712,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1734176155e859e846732d9-83407638',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e859e8470c366_09107430',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e859e8470c366_09107430')) {function content_5e859e8470c366_09107430($_smarty_tpl) {?><link rel="stylesheet" href="/public/manage/css/bargain-list.css">
...
<div id="mainContent">
	...
	<div id="content-con">
        <div class="page-header">
            ...
            <?php if ($_smarty_tpl->tpl_vars['appletCfg']->value['ac_type']==1||$_smarty_tpl->tpl_vars['appletCfg']->value['ac_type']==3||$_smarty_tpl->tpl_vars['appletCfg']->value['ac_type']==6||$_smarty_tpl->tpl_vars['appletCfg']->value['ac_type']==13||$_smarty_tpl->tpl_vars['appletCfg']->value['ac_type']==21) {?>
            <?php }?>
...
" <?php if ($_smarty_tpl->tpl_vars['key']->value==$_smarty_tpl->tpl_vars['categoryId']->value) {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['val']->value;?>
</option>
                                            <?php } ?>
                                        </select>
                                    </div>
        ...
        <div class="balance clearfix" style="border:1px solid #e5e5e5;margin-bottom: 20px;">
            <div class="balance-info">
                ...
                <div class="balance-content">
                    <span class="money"><?php echo $_smarty_tpl->tpl_vars['statInfo']->value['infoTotal'];?>
</span>
                </div>
            </div>
            <div class="balance-info">
                ...
                <div class="balance-content">
                    <span class="money"><?php echo $_smarty_tpl->tpl_vars['statInfo']->value['showSum'];?>
</span>
                </div>
            </div>
            <div class="balance-info">
            ...
            <div class="balance-info">
                ...
                <div class="balance-content">
                    <span class="money"><?php echo $_smarty_tpl->tpl_vars['statInfo']->value['commentSum'];?>
</span>
                </div>
            </div>
            <div class="balance-info">
                ...
                <div class="balance-content">
                    <span class="money"><?php echo $_smarty_tpl->tpl_vars['statInfo']->value['likeSum'];?>
</span>
                </div>
            </div>
        </div>
...
?>
                            <tr class="tr-content" >
                                <td class="center">
                                    <label>
                                        <input type="checkbox" class="ace" name="ids" value="<?php echo $_smarty_tpl->tpl_vars['val']->value['ai_id'];?>
"/>
                                        <span class="lbl"></span>
                                    </label>
                                </td>
                                <td><?php echo $_smarty_tpl->tpl_vars['val']->value['ai_title'];?>
</td>
                                <td>
                                    <?php if ($_smarty_tpl->tpl_vars['val']->value['ai_from']=='') {?>
                                        <span>后台添加</span>
                                    <?php } else { ?>
                                        <?php echo $_smarty_tpl->tpl_vars['val']->value['ai_from'];?>

                                    <?php }?>
                                </td>
               
                                <td><?php echo $_smarty_tpl->tpl_vars['category_select']->value[$_smarty_tpl->tpl_vars['val']->value['ai_category']];?>
</td>
                                <td><?php echo $_smarty_tpl->tpl_vars['val']->value['ai_show_num'];?>
</td>
                                <td>
                                    <p id="sort_<?php echo $_smarty_tpl->tpl_vars['val']->value['ai_sort'];?>
">
                                        <span class='span' style="color: #000"><?php echo $_smarty_tpl->tpl_vars['val']->value['ai_sort'];?>
</span>
                                        <img src="/public/wxapp/images/icon_edit.png" class="good-admend set-goodsinfo" data-id="<?php echo $_smarty_tpl->tpl_vars['val']->value['ai_id'];?>
" data-value="<?php echo $_smarty_tpl->tpl_vars['val']->value['ai_sort'];?>
" data-field="sort" style="margin-left: 5px"/>
                                    </p>
                                </td>

                                <td><?php if ($_smarty_tpl->tpl_vars['val']->value['ai_update_time']&&$_smarty_tpl->tpl_vars['val']->value['ai_update_time']>0) {?><?php echo date('Y-m-d H:i',$_smarty_tpl->tpl_vars['val']->value['ai_update_time']);?>
<?php } else { ?><?php echo date('Y-m-d H:i',$_smarty_tpl->tpl_vars['val']->value['ai_create_time']);?>
<?php }?></td>

                                <td>
                                    <p>
                                        <a href="/wxapp/currency/addInformation/id/<?php echo $_smarty_tpl->tpl_vars['val']->value['ai_id'];?>
" >编辑</a> -
                                        <a href="/wxapp/currency/informationCommentList?aid=<?php echo $_smarty_tpl->tpl_vars['val']->value['ai_id'];?>
" >评论</a> -
                                        <a href="#" id="delete-confirm" data-id="<?php echo $_smarty_tpl->tpl_vars['val']->value['ai_id'];?>
" onclick="deleteArticle('<?php echo $_smarty_tpl->tpl_vars['val']->value['ai_id'];?>
')" style="color:#f00;">删除</a>
                                       <?php if (!$_smarty_tpl->tpl_vars['dyyu']->value) {?>
                                        - <a href="javascript:;" id="link_<?php echo $_smarty_tpl->tpl_vars['val']->value['ai_id'];?>
" class="btn-link" data-link="<?php echo $_smarty_tpl->tpl_vars['page_link']->value;?>
?id=<?php echo $_smarty_tpl->tpl_vars['val']->value['ai_id'];?>
">页面路径</a>
                                       <?php }?>
                                    </p>

                                    <p>
                                        <?php if ($_smarty_tpl->tpl_vars['val']->value['ai_isrecommend']) {?>
                                        <a href="javascript:;" class="set-recommend" data-id="<?php echo $_smarty_tpl->tpl_vars['val']->value['ai_id'];?>
" data-recommend="0">取消推荐</a> -
                                        <?php } else { ?>
                                        <a href="javascript:;" class="set-recommend" data-id="<?php echo $_smarty_tpl->tpl_vars['val']->value['ai_id'];?>
" data-recommend="1">设置推荐</a> -
                                        <?php }?>
                                        <?php if (!in_array($_smarty_tpl->tpl_vars['menuType']->value,array('aliapp','bdapp','toutiao','qq','qihoo'))) {?>
                                        <a href="javascript:;" onclick="pushArticle('<?php echo $_smarty_tpl->tpl_vars['val']->value['ai_id'];?>
')" >推送</a> -
                                        <?php if (!in_array($_smarty_tpl->tpl_vars['menuType']->value,array('weixin'))) {?>
                                        <a href="javascript:;" data-toggle="modal" data-target="#tplPreviewModal" onclick="showPreview('<?php echo $_smarty_tpl->tpl_vars['val']->value['ai_id'];?>
')" >推送预览</a> -
                                        <?php }?>
                                        <a href="/wxapp/tplpreview/pushHistory?type=information&id=<?php echo $_smarty_tpl->tpl_vars['val']->value['ai_id'];?>
" >推送记录</a>
                                        <?php }?>
                                        <!-- 公众号资讯链接复制 -->
                                        <?php if ($_smarty_tpl->tpl_vars['article_link']->value) {?>
                                        <a href="#" class="copy-button-link" data-clipboard-action="copy" data-clipboard-text="<?php echo $_smarty_tpl->tpl_vars['article_link']->value;?>
?id=<?php echo $_smarty_tpl->tpl_vars['val']->value['ai_id'];?>
&title=<?php echo $_smarty_tpl->tpl_vars['val']->value['ai_title'];?>
" >复制链接路径</a>
                                        <?php }?>
                                    </p>
                                </td>
