<?php /* Smarty version Smarty-3.1.17, created on 2020-04-07 16:13:20
         compiled from "/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/community/trade-list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7842826045e8c3620a7f2c3-36726444%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'faf68ae44de0b859c21f947764bec9dbeca771fb' => 
    array (
      0 => '/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/community/trade-list.tpl',
      1 => 1575621712,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7842826045e8c3620a7f2c3-36726444',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e8c3620bc5e96_96808171',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e8c3620bc5e96_96808171')) {function content_5e8c3620bc5e96_96808171($_smarty_tpl) {?><link rel="stylesheet" href="/public/manage/assets/css/chosen.css" />
...
<?php }?>
	...
	<div class="page-header search-box">
		<div class="col-sm-12">
			<form class="form-inline" action="<?php echo $_smarty_tpl->tpl_vars['searchUrl']->value;?>
" method="get">
...
<?php } else { ?>0<?php }?></span>
		...
		<div class="balance-info">
			<div class="balance-title">今日消耗<span></span></div>
			<div class="balance-content">
				<span class="money"><?php if ($_smarty_tpl->tpl_vars['todayTradeInfo']->value['points']) {?><?php echo $_smarty_tpl->tpl_vars['todayTradeInfo']->value['points'];?>
<?php } else { ?>0<?php }?></span>
...
<?php } else { ?>0<?php }?></span>
		...
		<div class="balance-info">
			<div class="balance-title">店铺消耗

			</div>
			<div class="balance-content">
				<span class="money money-font"><?php if ($_smarty_tpl->tpl_vars['searchTradeInfo']->value['points']) {?><?php echo $_smarty_tpl->tpl_vars['searchTradeInfo']->value['points'];?>
<?php } else { ?>0<?php }?></span>
				<span class="unit">积分</span>
			</div>
		</div>
...
<?php if ($_smarty_tpl->tpl_vars['esId']->value) {?>&esId=<?php echo $_smarty_tpl->tpl_vars['esId']->value;?>
<?php }?>" <?php if ($_smarty_tpl->tpl_vars['status']->value&&$_smarty_tpl->tpl_vars['status']->value==$_smarty_tpl->tpl_vars['key']->value) {?>class="active"<?php }?>><?php echo $_smarty_tpl->tpl_vars['val']->value['label'];?>
</a>
		<?php } ?>
		<!---
				...
				<td colspan="6">
					<div>
						...
						<div class="help" style="display: inline-block;">
							...
							<?php } elseif ($_smarty_tpl->tpl_vars['val']->value['t_applet_type']==4) {?>
							<span class="tuan-tag">积</span>
							<?php }?>
				...
				<td colspan="2" class="text-right">
					<div class="order-opts-container">
						<div class="js-opts" style="display: block;">
							<?php if ($_smarty_tpl->tpl_vars['pointOrder']->value==1) {?>
							<a href="/wxapp/community/pointTradeDetail?order_no=<?php echo $_smarty_tpl->tpl_vars['val']->value['t_tid'];?>
" class="new-window" >查看详情</a>
							<?php } else { ?>
							<a href="/wxapp/community/tradeDetail?order_no=<?php echo $_smarty_tpl->tpl_vars['val']->value['t_tid'];?>
" class="new-window" >查看详情</a>
							<?php }?>
							<?php if ($_smarty_tpl->tpl_vars['hideDeduct']->value!=1) {?>
...
<?php if ($_smarty_tpl->tpl_vars['val']->value['t_applet_type']==4) {?> + 积分<?php echo $_smarty_tpl->tpl_vars['val']->value['t_points'];?>
<?php }?>
					</p>
...
件)</p>
				...
				<td class="aftermarket-cell" rowspan="1">
					...
					<?php if ($_smarty_tpl->tpl_vars['pointOrder']->value==1) {?>
					<a href="/wxapp/community/pointTradeRefund?order_no=<?php echo $_smarty_tpl->tpl_vars['val']->value['t_tid'];?>
<?php if ($_smarty_tpl->tpl_vars['esId']->value) {?>&esId=<?php echo $_smarty_tpl->tpl_vars['esId']->value;?>
<?php }?>" class="new-window" >处理维权</a>
					<?php } else { ?>
					<a href="/wxapp/community/tradeRefund?order_no=<?php echo $_smarty_tpl->tpl_vars['val']->value['t_tid'];?>
<?php if ($_smarty_tpl->tpl_vars['esId']->value) {?>&esId=<?php echo $_smarty_tpl->tpl_vars['esId']->value;?>
<?php }?>" class="new-window" >处理维权</a>
					<?php }?>
					<?php }?>
				...
				<td class="time-cell" rowspan="1">
					...
					<div class="td-cont">
						<p class="user-name" style="margin-top: 10px">
							<a href="/wxapp/community/pointOrder?postType=<?php echo $_smarty_tpl->tpl_vars['val']->value['t_express_method'];?>
" class="new-window" target="_blank">
...
" name="esId">
								<input type="hidden" value="<?php if ($_smarty_tpl->tpl_vars['orderType']->value) {?><?php echo $_smarty_tpl->tpl_vars['orderType']->value;?>
<?php } else { ?>-1<?php }?>" name="orderType">   <!--积分订单订单类型是4-->
								<div class="form-group">
...
"><?php echo $_smarty_tpl->tpl_vars['val']->value['label'];?>
								...
								<div class="form-group entershop-select">
									...
									<div class="col-sm-10">
										<select id="entershop" name="entershop" style="width:100%;padding: 0;text-align: left;height: 34px" class="form-control <?php if ($_smarty_tpl->tpl_vars['curr_shop']->value['s_id']==5741) {?> select2-entershop <?php }?>">
											<option value="0">全部</option>
