<?php /* Smarty version Smarty-3.1.17, created on 2020-04-02 16:07:20
         compiled from "/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/mall/index-tpl_17.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13681014685e859d382a3a34-56966095%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '24ec81318580d7b3bf4ff470ff7ba878fe790a39' => 
    array (
      0 => '/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/mall/index-tpl_17.tpl',
      1 => 1575621712,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13681014685e859d382a3a34-56966095',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e859d382fdd09_23039696',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e859d382fdd09_23039696')) {function content_5e859d382fdd09_23039696($_smarty_tpl) {?><link rel="stylesheet" href="/public/wxapp/setup/css/spectrum.css">
...
<style>
.good-list-wrap .good-view2 .item-wrap{padding: 10px 0 2px;}
...
.good-list-wrap .buy-btn { position: absolute; right: 8px; bottom: 8px; height: 30px; width: 30px; text-align: center; -webkit-border-radius: 15px; border-radius: 15px; background-color: #FF9234; color: #fff; font-size: 13px; padding: 0; }
.good-list-wrap .buy-btn img { height: 18px; width: 18px; display: block; margin: 6px auto; }
.good-list-wrap .title-name { background-color: #fff; margin-bottom: 3px; margin-top: 3px; }
.good-list-wrap .title-name p:before { background-color: #FF9234; }
.search-wrap { padding: 10px 12px; box-sizing: border-box; background-color: #fff; }
.search-container { border-radius: 5px; width: 96%; margin: 0 auto; padding: 4px 10px; box-sizing: border-box; text-align: left; border: 1px solid #dfdfdf; }
...
.paginations span{background-color: rgba(0,0,0,0.3);}
.paginations span.active{background-color: #51CBFB;}
.notice-box {
    height: 40px;
    margin-top: 5px;
}
