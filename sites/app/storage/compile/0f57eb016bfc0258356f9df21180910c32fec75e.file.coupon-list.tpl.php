<?php /* Smarty version Smarty-3.1.17, created on 2020-04-07 16:13:15
         compiled from "/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/community/coupon-list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10398969145e8c361b0ad541-80148743%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0f57eb016bfc0258356f9df21180910c32fec75e' => 
    array (
      0 => '/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/community/coupon-list.tpl',
      1 => 1575621712,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10398969145e8c361b0ad541-80148743',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e8c361b11bf88_63748499',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e8c361b11bf88_63748499')) {function content_5e8c361b11bf88_63748499($_smarty_tpl) {?><link rel="stylesheet" href="/public/manage/css/bargain-list.css">
<style>
...
使用 <?php } else { ?> 不限 <?php }?></td>
                                <td><?php echo $_smarty_tpl->tpl_vars['val']->value['cl_count'];?>
</td>
...
张<?php } else { ?> 不限 <?php }?></td>
                                <!--<td><?php if ($_smarty_tpl->tpl_vars['val']->value['cl_start_time']) {?><?php echo date('Y-m-d H:i:s',$_smarty_tpl->tpl_vars['val']->value['cl_start_time']);?>
<?php } else { ?> 不限 <?php }?></td>
...
/type/1" >兑换明细</a>
                                    <?php if (!$_smarty_tpl->tpl_vars['val']->value['cl_push']) {?>
                                     - <a href="javascript:;" onclick="pushCoupon('<?php echo $_smarty_tpl->tpl_vars['val']->value['cl_id'];?>
')" >推送</a>
                                    <?php }?>
                                    <?php if ($_smarty_tpl->tpl_vars['val']->value['edit']==1) {?>
                                     - <a href="/wxapp/community/couponAdd/?id=<?php echo $_smarty_tpl->tpl_vars['val']->value['cl_id'];?>
" >编辑</a>
                                    <?php }?>
