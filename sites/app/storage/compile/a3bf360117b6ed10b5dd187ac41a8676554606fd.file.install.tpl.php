<?php /* Smarty version Smarty-3.1.17, created on 2019-11-20 10:09:53
         compiled from "/www/wwwroot/tdtinstall/sites/app/view/template/site/install.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2380834195d19d8fdd05528-36494619%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a3bf360117b6ed10b5dd187ac41a8676554606fd' => 
    array (
      0 => '/www/wwwroot/tdtinstall/sites/app/view/template/site/install.tpl',
      1 => 1574072249,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2380834195d19d8fdd05528-36494619',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.17',
  'unifunc' => 'content_5d19d8fdd0ce62_84779961',
  'variables' => 
  array (
    'externalIp' => 0,
    'dbname' => 0,
...
<?php if ($_valid && !is_callable('content_5d19d8fdd0ce62_84779961')) {function content_5d19d8fdd0ce62_84779961($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<script>
    ...
    function analysisSetup(code, zipname, appletType, host, name, user, passwd) {
        $('.setup-package').show();
        $('.setup-package .label').css('color', '#5183fc');
        $.ajax({
            'type'  : 'post',
            'url'   : '/install/setup',
            'data'  : {zipname, host, name, user, passwd},
            'dataType' : 'json',
            success : function(data){
                if(data.ec == 200){
