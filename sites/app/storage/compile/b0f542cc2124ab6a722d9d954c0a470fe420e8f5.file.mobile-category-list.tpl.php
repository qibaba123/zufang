<?php /* Smarty version Smarty-3.1.17, created on 2020-04-03 10:11:21
         compiled from "/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/mobile/mobile-category-list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4382772305e869b490f0f93-53436964%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b0f542cc2124ab6a722d9d954c0a470fe420e8f5' => 
    array (
      0 => '/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/mobile/mobile-category-list.tpl',
      1 => 1579405884,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4382772305e869b490f0f93-53436964',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e869b491360b8_96689108',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e869b491360b8_96689108')) {function content_5e869b491360b8_96689108($_smarty_tpl) {?><link rel="stylesheet" href="/public/manage/css/bargain-list.css">
<style>
...
?>
                            <tr id="tr_<?php echo $_smarty_tpl->tpl_vars['val']->value['amc_id'];?>
">
                                <td><?php echo $_smarty_tpl->tpl_vars['val']->value['amc_title'];?>
</td>
                                <td>
                                    <?php if ($_smarty_tpl->tpl_vars['val']->value['amc_img']) {?>
                                <img src="<?php echo $_smarty_tpl->tpl_vars['val']->value['amc_img'];?>
" style="width:50px" alt="">
                                    <?php }?>
                                </td>
                                <td><?php echo $_smarty_tpl->tpl_vars['val']->value['amc_sort'];?>
</td>
                                <td><?php echo date('Y-m-d H:i:s',$_smarty_tpl->tpl_vars['val']->value['amc_update_time']);?>
</td>
                                <td class="jg-line-color">
                                    <a class="add-category" href="#" data-toggle="modal" data-target="#myModal"  data-id="<?php echo $_smarty_tpl->tpl_vars['val']->value['amc_id'];?>
" data-sort="<?php echo $_smarty_tpl->tpl_vars['val']->value['amc_sort'];?>
" data-name="<?php echo $_smarty_tpl->tpl_vars['val']->value['amc_title'];?>
" data-logo="<?php echo $_smarty_tpl->tpl_vars['val']->value['amc_img'];?>
" data-label='<?php echo $_smarty_tpl->tpl_vars['val']->value['amc_label'];?>
' >编辑</a> -
                                    <a href="#" data-id="<?php echo $_smarty_tpl->tpl_vars['val']->value['amc_id'];?>
" onclick="confirmDelete(this)" style="color:#f00;">删除</a>
                                </td>
                            </tr>
                            <?php } ?>
                        <tr><td colspan="5" style="text-align:right"><?php echo $_smarty_tpl->tpl_vars['paginator']->value;?>
</td></tr>
                        </tbody>
                    </table>
