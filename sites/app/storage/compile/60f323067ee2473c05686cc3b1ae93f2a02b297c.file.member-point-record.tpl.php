<?php /* Smarty version Smarty-3.1.17, created on 2020-04-23 11:55:36
         compiled from "/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/member/member-point-record.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2023416795ea111b8d972c4-16914408%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '60f323067ee2473c05686cc3b1ae93f2a02b297c' => 
    array (
      0 => '/www/wwwroot/default/yingxiaosc/yingxiaosc/sites/app/view/template/wxapp/member/member-point-record.tpl',
      1 => 1579405884,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2023416795ea111b8d972c4-16914408',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ea111b8dec3d1_68938568',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ea111b8dec3d1_68938568')) {function content_5ea111b8dec3d1_68938568($_smarty_tpl) {?><link rel="stylesheet" href="/public/manage/assets/css/datepicker.css">
            ...
            <div class="tab-content"  style="z-index:1;padding: 10px 0;padding-bottom: 0;">
                <div id="mainContent">
                    <!-- <div class="row" style="padding-left: 20px">
                        当前积分：<?php echo $_smarty_tpl->tpl_vars['member']->value['m_points'];?>

                        <a class="btn btn-xs btn-primary point-btn" data-toggle="modal" data-target="#pointModal"  data-mid="<?php echo $_smarty_tpl->tpl_vars['mid']->value;?>
" data-type="single" data-point_now="<?php echo $_smarty_tpl->tpl_vars['member']->value['m_points'];?>
" style="margin-left: 20px">操作</a>
                    </div> -->
...
" data-type="single">操作</a>
                    ...
                    <div class="row">
                        <!-- <div class="page-header search-box" style="width: 98%">
                            <div class="col-sm-12">
                                <form class="form-inline" action="/wxapp/member/memberPointRecord" method="get">
                            ...
                            <div class="tabbable record-tabbable">
                                <ul class="nav nav-tabs" id="myTab">
                                    ...
                                    <li <?php if ($_smarty_tpl->tpl_vars['status']->value==1) {?>class="active"<?php }?>>
                                        <a <?php if ($_smarty_tpl->tpl_vars['status']->value==1) {?>href="#"<?php } else { ?>href="/wxapp/member/memberPointRecord?mid=<?php echo $_smarty_tpl->tpl_vars['mid']->value;?>
&status=1"<?php }?>>
                                        获得
                                        </a>
                                    </li>
                                    <li <?php if ($_smarty_tpl->tpl_vars['status']->value==2) {?>class="active"<?php }?>>
                                        <a <?php if ($_smarty_tpl->tpl_vars['status']->value==2) {?>href="#"<?php } else { ?>href="/wxapp/member/memberPointRecord?mid=<?php echo $_smarty_tpl->tpl_vars['mid']->value;?>
&status=2"<?php }?>>
                                        消耗
                                        </a>
                                    </li>
...
?>
                                                        <tr id="tr_id_<?php echo $_smarty_tpl->tpl_vars['item']->value['pi_id'];?>
">
                                                            <td><?php echo $_smarty_tpl->tpl_vars['item']->value['pi_title'];?>
</td>
                                                            <td>
                                                                <?php if ($_smarty_tpl->tpl_vars['item']->value['pi_type']==1) {?>
                                                                收入
                                                                <?php }?>
                                                                <?php if ($_smarty_tpl->tpl_vars['item']->value['pi_type']==2) {?>
                                                                支出
                                                                <?php }?>
                                                            </td>
                                                            <td>
                                                                <?php echo $_smarty_tpl->tpl_vars['item']->value['pi_point'];?>

                                                            </td>
                                                            <td><?php echo date('Y-m-d H:i:s',$_smarty_tpl->tpl_vars['item']->value['pi_create_time']);?>
</td>
                                                        </tr>
                                                        <?php } ?>
                                                    </tbody>
