                    ...
                    <div class="login-part-box js_login js_pass_login show" ng-controller="MemberLoginController">
                        <form name="member_login_form" >
                            ...
                            <div class="login-input-wrap">
                                ...
                                <div class="input-box">
                                    <input required="required" type="text" class="login-input" id="db-host" placeholder="数据库地址" value="<{$externalIp}>"/>
                                </div>
                                <div class="input-box">
                                    <input required="required" type="text" class="login-input" id="db-name" placeholder="数据库名称" value="<{$dbname}>"/>
                                </div>
                                <div class="input-box">
                                    <input required="required" type="text" class="login-input" id="db-user" placeholder="数据库账号" value="<{$dbuser}>"/>
                                </div>
                                <div class="input-box">
                                    <input required="required" type="text" class="login-input" id="db-passwd" placeholder="数据库密码" value="<{$dbpasswd}>"/>
                                </div>
                            </div>
