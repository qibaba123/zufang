...
<div class="kefu-notice">
    <div class="contact-kefu">
        <{if $oem}>
        <a href="http://wpa.qq.com/msgrd?v=3&uin=<{$oem['ao_kefu']}>&site=qq&menu=yes" target="_blank">
    ...
    <div class="sys-notice">
        ...
        <div class="notice-detail" id="notice-detail">
            [公告]平台分销功能已调整完毕，可进行付费使用 <a href="<{$sys_notice[0]['sn_link']}>" target="_blank">点此查看</a>
        </div>
    </div>
</div>
<script>
