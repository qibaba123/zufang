    ...
    <div class="help-con">
        ...
        <div class="help-container-body">
            <div class="help-body-title">
                帮助中心
                <a href="<{#help_center#}>" target="_blank" class="enter">进入></a>
            </div>
            <div class="help-body-content" style="padding-bottom: 120px;">
                ...
                <div class="help-content">
                    <a href="<{$item['ha_link']}>" target="_blank"><{$item['ha_title']}></a>
                    <p><{$item['ha_brief']}></p>
                </div>
                <{/foreach}>
                <div class="anli-show">
                    ...
                    <div class="anli-item" style="width: 100%">
                        ...
                        <!--<a href="<{$help['ha_link']}>" target="_blank">3、<{$help['ha_title']}></a>-->
                    </div>
                </div>
                ...
                <div class="service-one">
                    ...
                    <div class="code-info">
                        <div>
                            <img src="<{$support['cs_wx_qrcode']}>" alt="二维码">
                        </div>
                        <p class="tel"><{$support['cs_name']}></p>
                        <p class="num">微信号：<{$support['cs_weixin']}></p>
                        <p class="num">手机号：<{$support['cs_phone']}></p>
                    </div>
                </div>
                <{/if}>
                ...
                <div class="anli-show">
                    ...
                    <{foreach $caselist as $item}>
                        <div class="anli-item case">
                            <img src="<{$item['cc_logo']}>" alt="图标"  onmouseover="showCode(this)">
                            <p><{$item['cc_name']}></p>
                            <div class="erweima" onmouseout="hideCode(this)"><img src="<{$item['cc_qrcode']}>" alt="二维码"></div>
                        </div>
                    <{/foreach}>
                </div>
