...
<div class="login-part-wrap">
    ...
    <section class="top-opera-box main-width">
        <a href="<{#main_host#}>" target="_blank" class="link">返回首页</a>
        <a href="http://bbs.fenxiaobao.xin" target="_blank" class="link">天店通商家社区</a>
        <a href="<{#main_host#}>/index/help" target="_blank" class="link">帮助中心</a>
        <a href="javascript:;" class="link">服务热线 <{#service_phone#}></a>
    </section>
    <{/if}>
