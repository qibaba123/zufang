                ...
                <div class="info-group-inner">
                    <div class="group-info" style="background-color: #fff">
                        <div class="payment-block-body js-wxpay-body-region" style="display: block;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <label id="choose-onoff" class="choose-onoff">
                                                <input class="ace ace-switch ace-switch-5" id="open"  data-type="open" type="checkbox" <{if $row && $row['asc_isopen_subject']}>checked<{/if}>>
                                                <span class="lbl"></span>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="form-group" id="prizeDiv" <{if $row && !$row['asc_isopen_subject']}> style="display:none;" <{/if}>>
                                        <label for="firstname" class="col-sm-2 control-label text-right">赠送答题次数<font color="red">*</font></label>
                                        <div class="col-sm-3">
                                            <input type="number" class="form-control" id="snum" value="<{if $row}><{$row['asc_send_snum']}><{/if}>" data-msg="填写订单完成可获得抽奖次数" placeholder="填写订单完成可获得抽奖次数">

                                        </div>
                                    </div>
                                 <div class="form-group" id="typeDiv" <{if $row && !$row['asc_isopen_subject']}> style="display:none;" <{/if}>>
                                   ...
                                   <div class="col-sm-3">
                                       ...
                                       <option value="<{$key}>" <{if $row && $row['asc_subject_type'] eq $key}>selected="selected"<{/if}> ><{$val}></option>
                                           <{/foreach}>
                                           <{/if}>
                                       </select>
                                   </div>
                            ...
                            <!--新增显示封面-->
                            <div class="form-group" id="coverDiv" <{if !$row['asc_isopen_subject']}> style="display:none;" <{/if}>>
                            ...
                            <div class="col-sm-3">
                                <div class="cropper-box" data-width="706" data-height="220" >
                                    <img style="width: 40% !important;" src="<{if $row && $row['asc_subject_cover']}><{$row['asc_subject_cover']}><{else}>/public/manage/img/zhanwei/zw_fxb_75_30.png<{/if}>" onload="" />
                                    <input type="hidden" id="cover" name="cover" value="<{if $row && $row['asc_subject_cover']}><{$row['asc_subject_cover']}><{/if}>" />
                                </div>
                            </div>
                        </div>
