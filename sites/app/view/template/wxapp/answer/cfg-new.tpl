					...
					<div class="group-info" style="background-color: #fff">
						<div class="payment-block-body js-wxpay-body-region" style="display: block;">
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<label id="choose-onoff" class="choose-onoff">
										<input class="ace ace-switch ace-switch-5" id="open"  data-type="open" type="checkbox" <{if $cfg && $cfg['asc_open']}>checked<{/if}>>
										<span class="lbl"></span>
									</label>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="number" class="form-control" id="answerTime" value="<{if $cfg}><{$cfg['asc_answer_time']}><{else}>10<{/if}>" style="width: 40%;display: inline" data-msg="请填写每道题的答题时间" placeholder="请填写每道题的答题时间" />秒(最大60秒)
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="number" class="form-control" id="oneRedPacket" value="<{if $cfg}><{$cfg['asc_one_redpacket_num']}><{/if}>" data-msg="填写每人每天最多领取红包数量" placeholder="填写每人每天最多领取红包数量">
								</div>
							</div>
							-->
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="number" class="form-control" id="shareNum" value="<{if $cfg}><{$cfg['asc_share_num']}><{/if}>" data-msg="填写每天分享可获得答题机会" placeholder="填写每天分享可获得答题机会">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-3">
									<label id="choose-onoff" class="choose-onoff">
										<input class="ace ace-switch ace-switch-5" id="question"  data-type="question" type="checkbox" <{if $cfg && $cfg['asc_open_public_question']}>checked<{/if}>>
										<span class="lbl"></span>
									</label>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="number" class="form-control" id="allowCard" value="<{if $cfg}><{$cfg['asc_allow_card']}><{/if}>" data-msg="每次答题允许使用复活卡数" placeholder="每次答题允许使用复活卡数">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-3">
									<label id="choose-onoff" class="choose-onoff">
										<input id="shareAllow" class="ace ace-switch ace-switch-5"  data-type="shareAllow" type="checkbox" <{if $cfg && $cfg['asc_open_share_card']}>checked<{/if}>>
										<span class="lbl"></span>
									</label>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="number" class="form-control" id="award_phone" value="<{if $cfg}><{$cfg['asc_award_phone']}><{/if}>" data-msg="填写获奖联系电话" placeholder="填写获奖联系电话">
								</div>
							</div>
								<div class="form-group">
									<label for="firstname" class="col-sm-2 control-label text-right">自定义分享标题</label>
									<div class="col-sm-3">
										<input type="text" class="form-control" id="share_title" value="<{if $cfg && $cfg['asc_share_title']}><{$cfg['asc_share_title']}><{else}>趣味答题<{/if}>" data-msg="填写分享标题" placeholder="填写分享标题">
									</div>
								</div>
									<div class="form-group">
										...
										<div class="cropper-box" data-width="500" data-height="400" data-dom-id="upload-share_cover" id="upload-share_cover">
											<img style="width: 15%;margin-left: 15px" src="<{if $cfg && $cfg['asc_share_cover']}><{$cfg['asc_share_cover']}><{else}>/public/manage/img/zhanwei/zw_555_480.png<{/if}>" onload="" />
											<small>（图片建议尺寸500px*400px）</small>
											<input type="hidden" id="share_cover" name="share_cover" value="<{if $cfg && $cfg['asc_share_cover']}><{$cfg['asc_share_cover']}><{/if}>" />
										</div>
									</div>
							<div class="form-group">
								<label for="firstname" class="col-sm-2 control-label text-right" >答题规则<font color="red">*</font></label>
