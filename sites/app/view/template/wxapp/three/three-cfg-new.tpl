    ...
    <div class="row"  style="margin-left: 30px;margin-right: 30px;margin-bottom: 20px">
        ...
        <div class="setting" style="width: 80%;margin: auto;">
            <div class="form-inline row ">
                <label for="inputEmail3" class="col-sm-3 control-label">是否开启分销</label>
                <label class="form-group" id="choose-yesno">
                    <input class='tgl tgl-light' id='audit_status' type='checkbox' onchange="changeAuditStatus()" <{if $tcRow && $tcRow['tc_isopen'] == 1}>checked<{/if}> >
        ...
        <div class="setting" style="width: 80%;margin: auto;">
            <div id="wxCfg" class="tab-pane">
                        ...
                        <div class="form-group">
                            <div class="input-group" style="width: 210px;">
                                ...
                                <input type="text" size="8" class="form-control member_limit" id="limitNumber"
                                       value="<{if $row && $row['cc_min_num']}><{$row['cc_min_num']}><{/if}>"
                        ...
                        <div class="form-group">
                            <div class="input-group" style="width: 210px;">
                                ...
                                <input type="text" size="8" class="form-control member_limit" id="limitMoney"
                                       value="<{if $row && $row['cc_min_amount']}><{$row['cc_min_amount']}><{/if}>"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <textarea class="form-control" rows="3" id="noqr_tip" placeholder="存在条件限制时候，会员无法获取二维码时提示语"><{if $row}><{$row['cc_noqr_tip']}><{/if}></textarea>
                    </div>
                    <div class="col-sm-4">
                        &nbsp;
                    </div>
                ...
                <div class="form-group row" >
                    ...
                    <div class="level-box col-sm-9">
                        <div class="radio-box">
                            <span>
                                <input type="radio" name="roundType" id="round_no" value="0" <{if !($tcRow['tc_round_type'] > 0)}>checked<{/if}>>
                                <label for="round_no">不取整</label>
                            </span>
                            <span>
                                <input type="radio" name="roundType" id="round_ceil" value="1" <{if $tcRow['tc_round_type'] == 1}>checked<{/if}>>
                                <label for="round_ceil">向上取整</label>
                            </span>
                            <span>
                                <input type="radio" name="roundType" id="round_floor" value="2" <{if $tcRow['tc_round_type'] == 2}>checked<{/if}>>
        ...
        <div class="setting" style="width: 80%;margin: auto;">
            ...
            <div id="wxCfg" class="tab-pane">
                ...
                <div class="form-group  row">
                    ...
                    <div class="col-sm-9">
                        <div class="form-group  row">
                            ...
                            <label class="" id="choose-yesno">
                                <input name="wc_wx_open" onchange="checkChange('wc_wx_open')" class="ace ace-switch ace-switch-5" id="wc_wx_open" <{if $withdraw && $withdraw['wc_change_open']}>checked<{/if}> type="checkbox">
                                <span class="lbl"></span>
                            </label>
                        </div>
                        <div class="form-group  row">
                            ...
                            <label class="" id="choose-yesno" >
                                <input name="wc_bank_open"  onchange="checkChange('wc_bank_open')" class="ace ace-switch ace-switch-5" id="wc_wx_open" <{if $withdraw && $withdraw['wc_bank_open']}>checked<{/if}> type="checkbox">
                                <span class="lbl"></span>
                            </label>
                        </div>
                    </div>
                 ...
                 <div class="form-group  row" id="wx_open" <{if !$withdraw['wc_change_open']}>style="display:none"<{/if}>>
                     ...
                     <div class="col-sm-9">
                        ...
                        <label class="" id="choose-yesno" style="margin-right: 20px;">
                            <input name="wc_wxmobile_open" class="ace ace-switch ace-switch-5" id="wc_wxmobile_open" <{if $withdraw && $withdraw['wc_mobile_open']}>checked<{/if}> type="checkbox">
                            <span class="lbl"></span>
                        </label>

                        <label for="inputEmail3" class="control-label" style="margin-right: 10px;" >是否填写账号</label>
                        <label class="" id="choose-yesno">
                            <input name="wc_wxaccount_open" class="ace ace-switch ace-switch-5" id="wc_wxaccount_open" <{if $withdraw && $withdraw['wc_account_open']}>checked<{/if}> type="checkbox">
                            <span class="lbl"></span>
                        </label>
                     </div>
                <div class="space"></div>
                  ...
                  <div class="form-group  row" id="bank_open" <{if !$withdraw['wc_bank_open']}>style="display:none"<{/if}>>
                    <label for="inputEmail3" class="col-sm-3 control-label">银行卡提现配置</label>
                     <div class="col-sm-9">
                         <label for="inputEmail3" class="control-label" style="margin-right: 10px;">是否填写手机号</label>

                         <label class="" id="choose-yesno">
                            <input name="wc_bank_mobile_open" class="ace ace-switch ace-switch-5" id="wc_bank_mobile_open" <{if $withdraw && $withdraw['wc_bank_mobile_open']}>checked<{/if}> type="checkbox">
                            <span class="lbl"></span>
                        </label>
                    </div>
                   <div class="space"></div>
                ...
                <div class="form-group  row">
                    ...
                    <div class="col-sm-9">
                        <input type="number" class="form-control" name="wc_min" id="wc_min" value="<{if $withdraw}><{$withdraw['wc_min']}><{/if}>" placeholder="提现最低额度">
                    </div>
                </div>
                <div class="space-4"></div>
                <!--新增提现手续百分比-->
                <div class="form-group  row">
                    ...
                    <div class="col-sm-9">
                        <input type="number" class="form-control" name="wc_rate" id="wc_rate" value="<{if $withdraw}><{$withdraw['wc_rate']}><{/if}>" placeholder="提现手续费百分比">
                    </div>
                ...
                <div class="form-group  row">
                    ...
                    <div class="col-sm-9">
                        <textarea class="form-control" rows="3" id="wc_desc" name="wc_desc"><{if $withdraw}><{$withdraw['wc_desc']}><{/if}></textarea>
                    </div>
                </div>
                <div class="space"></div>
                ...
                <div class="form-group  row">
                    ...
                    <label class="" id="choose-yesno">
                        <input name="wc_auto" class="ace ace-switch ace-switch-5" id="wc_auto" <{if $withdraw && $withdraw['wc_auto']}>checked<{/if}> type="checkbox">
                        <span class="lbl"></span>
                    </label>
                </div>
            </div>
...
<script>
    $(function(){
        $('input[name="level"][value="<{$row['tc_level']}>"]').attr('checked',true);
        $('input[name="audit"][value="<{$row['tc_f_audit']}>"]').attr('checked',true);
        $('input[name="refer"][value="<{$row['cc_show_refer']}>"]').attr('checked',true);
        $('input[name="must"][value="<{$row['cc_must_set']}>"]').attr('checked',true);
        $('input[name="recharge"][value="<{$row['cc_recharge_amount']}>"]').attr('checked',true);
        $('input[name="tip"][value="<{$row['tc_istip']}>"]').attr('checked',true);
        $('input[name="cashierOpen"][value="<{$row['tc_cashier_open']}>"]').attr('checked',true);
         $('input[name="cardDeduct"][value="<{$row['tc_card_deduct']}>"]').attr('checked',true);
        $('input[name="showDeductOpen"][value="<{$row['tc_show_deduct_open']}>"]').attr('checked',true);
        console.log(<{$row['tc_istip']}>);
    });
