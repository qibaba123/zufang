...
.good-list-wrap .title-name p { position: relative; font-size: 15px; padding: 0 10px;}
.good-list-wrap .title-name p:before { content: ''; position: absolute; left: -10px;  height: 16px; width: 2px;  background-color: #e49116; }
...
.search-wrap {  box-sizing: border-box;background-color: #222222}
.search-container { border-radius: 25px; width: 80%; margin-right: 0;padding: 5px 10px; box-sizing: border-box; background-color: #ccc; text-align: left;display: inline-block }
...
.my-new-class {    width: 60px;  margin: 5px 18px;  display: inline-block;text-align: center}
.my-new-class img { width: 74%; display:inline-block;border-radius: 30px;}
.fenlei-nav li{width:20%;}
.my-new-span-price {margin-left: 15px;font-size: 10px;color: #ccc;}
.new-my-goods-class .img-item{width:40%;height: 100%;}
.new-my-goods-class .img-item img{width:80%;height: 100%;}
.good-list-wrap{background-color:#fff;margin-bottom:10px}
.new-my-kind-name {border-top: 1px solid #e9e8e6;}
.fenlei-nav li img{width:42px;height:42px}
                ...
                <div class="index-main">
                    <div data-left-preview data-id="1">
                        <div class="search-wrap">
                            <img src="/public/wxapp/mall/temp3/images/tem48.png" style="width: 48px;height: 37px" />
                    ...
                    <div class="good-show-wrap" data-left-preview data-id="4">
                        <div class="good-list-wrap" ng-repeat="goodfl in goodFlShow">
                            ...
                            <div class="new-my-kind-name">
                                <div class="my-new-class" ng-repeat="twos in goodfl.selectTwo">
                                    <img ng-src="{{twos.cover}}" class="good-image" />
                                    <span>{{twos.name}}</span>
                                </div>
                            </div>
                            <!--<div class="good-list good-view2">
                                <div class="good-item" ng-repeat="goods in goodfl.goods">
                                    <div class="item-wrap border-l border-b">
                                        <img src="{{goods.cover}}" class="good-image" />
                                        <div class="good-intro">
                                            <div class="good-title">{{goods.name}}</div>
                                            <div class="price-buy">
                                                ￥<p class="now-price">{{goods.newPrice}}</p>
                                            </div>
                                            <!--<div class="buy-btn">
                            ...
                            <div class="recommend-img new-my-goods-class">
                                <div class="img-item"  ng-repeat="goods in goodfl.goods">
                                    <img ng-src="{{goods.cover}}" />
                                    <div class="left-good-title">{{goods.name}}</div>
                                    <div class="left-good-price">
                                        <span class="now-price" style="color: red"> ￥ {{goods.newPrice}}</span>
                                        <span class="my-new-span-price"> <s>￥ {{goods.oldPrice}}</s></span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="banner" data-right-edit data-id="1">
                ...
                <div class="banner-manage" ng-repeat="banner in banners">
                    ...
                    <div class="input-group-box clearfix" ng-show="banner.type==9">
                        ...
                        <select class="cus-input form-control" ng-model="banner.link"  ng-options="x.id as x.name for x in kindSelectNow" ></select>
                    </div>
                    ...
                    <div class="fenleinav-manage" ng-repeat="fenleiNav in fenleiNavs">
                        ...
                        <div class="edit-txt">
                            ...
                            <div class="input-group-box clearfix" ng-show="fenleiNav.type==9">
                                <label for="">分类详情：</label>
                                <select class="cus-input form-control" ng-model="fenleiNav.link"  ng-options="x.id as x.name for x in kindSelectNow" ></select>
                            </div>
                ...
                <div ui-sortable="sortableOptions" ng-model="goodFlShow">
                    <div class="fenleinav-manage" ng-repeat="goodfl in goodFlShow">
                        ...
                        <div class="input-group-box" style="margin-bottom: 10px;">
                            ...
                            <select class="cus-input" ng-model="goodfl.link" ng-change="doVal(goodfl.link,goodfl.index)" ng-options="x.id as x.name for x in kindSelect"></select>
                        </div>
            ...
            <div class="notice" data-right-edit data-id="5">
                ...
                <div class="fenleinav-manage">
                    <div class="input-group-box" style="margin-bottom: 20px;">
                        ...
                        <input type="text" class="cus-input" placeholder="请输入公告标题"  minlength="2" maxlength="4" ng-model="noticeTitle">
                    </div>
                    <div class="input-group">
...
<script>
    ...
    app.controller('chCtrl', ['$scope','$http','$timeout',function($scope,$http,$timeout){
        ...
        $scope.kindSelect     = <{$kindSelectOne}>;
        $scope.kindSelectNow  = <{$kindSelect}>;
        $scope.firstKindSelect = <{$firstKindSelect}>;
        $scope.kindSelectTwo  = [];
        $scope.headerTitle= "<{$tpl['ami_title']}>" ? "<{$tpl['ami_title']}>" : "店铺首页" ;

        $scope.searchPlaceholder = '<{$tpl['ami_search_tip']}>' ? '<{$tpl['ami_search_tip']}>' : '搜索商品';
        $scope.banners = <{$slide}>;
        ...
        /*选中事件*/
        $scope.doVal=function(kindId,indexId){
            console.log(kindId);
            console.log(indexId);
            for(var i=0;i<$scope.kindSelect.length;i++){
                if($scope.kindSelect[i].id==kindId){
                    $scope.goodFlShow[indexId].selectTwo = $scope.kindSelect[i].second;
                    $scope.goodFlShow[indexId].goods     = $scope.kindSelect[i].goods;
                    break;
                }
            }
            console.log($scope.goodFlShow);
