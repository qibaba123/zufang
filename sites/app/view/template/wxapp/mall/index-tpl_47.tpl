...
<style>
.good-list-wrap .title-name { padding: 2px 0; position: relative; margin: 10px auto 5px; }
.good-list-wrap .title-name .title-img { width: 50px; position: absolute; left: 10px; top: -4px; }
.good-list-wrap .title-name p { padding-left: 70px; }
.good-list-wrap .title-name p:before { display: none; }
...
.good-list-wrap .buy-btn { position: absolute; right: 8px; bottom: 8px; height: 30px; width: 30px; text-align: center; -webkit-border-radius: 15px; border-radius: 15px; background-color: #0095D4; color: #fff; font-size: 13px; padding: 0; }
            ...
            <div class="index-con">
                ...
                <div class="index-main">
                    ...
                    <div class="fenlei-nav" data-left-preview data-id="2">
                        ...
                        <ul ng-if="fenleiNavs.length>0" style="background-color: #fff;">
                    ...
                    <!--  推荐商品-->
                    <div class="hot-recommend" data-left-preview data-id="3" style="margin-bottom: 15px;">
                        ...
                        <div class="recommend-img">
                            ...
                            <div class="img-item" style="width:80px;height: 100%;" ng-repeat="good in recommendGood">
                                <img style="width:80px;height: 100px" ng-src="{{good.imgsrc}}" />
                                <div class="left-good-title">{{good.name}}</div>
                    ...
                    <div class="good-show-wrap" data-left-preview data-id="4" style="background-color: #fff;">
                        <div class="good-list-wrap">
                            <div style="width: 100%;white-space: nowrap;padding: 10px;border-bottom: 1px solid #EAEAEA;">
                            <span ng-repeat="kind in kindSelect">
                                <!--<img src="/public/wxapp/mall/temp3/images/ydhw-title-img.png" class="title-img" alt="标题图片">-->
                                <span class="flex-con" style="padding: 0 10px">{{kind.name}}</span>
                                <!--<div class="more-enter">
                                    <img src="/public/wxapp/mall/temp3/images/ydhw_jt.png" />
                                </div>-->
                            </span>
                            </div>
                            <div class="good-list good-view2">
                                <div class="good-item" style="float:none;width:100%;margin-left: 15px;border-bottom: 1px solid #EAEAEA;padding: 10px;">
                                    <div class="item-wrap border-l border-b" style="height:100px;position: static">
                                        <img style="float:left;width:30%;height:100px" src="/public/wxapp/mall/temp3/images/goodsView1.jpg" class="good-image" />
                                        <div class="good-intro" style="position: static;float: left;">
                                            <div class="good-title" style="height:27px">商品名称</div>
                                            <div class="good-title" style="height:27px">商品简介</div>
                                            <div class="price-buy">
                                                <span class="now-price">￥2999</span><span class="now-price" style="font-size: 12px;text-decoration: line-through;color: #999999;margin-left:10px">￥2499</span>
                                            </div>
                                            <!--<div class="buy-btn">
                                ...
                                <div class="good-item" style="float:none;width:100%;margin-left: 15px;border-bottom: 1px solid #EAEAEA;padding: 10px;">
                                    <div class="item-wrap border-l border-b" style="height:100px;position: static">
                                        <img style="float:left;width:30%;height:100px" src="/public/wxapp/mall/temp3/images/goodsView2.jpg" class="good-image" />
                                        <div class="good-intro" style="position: static;float: left;">
                                            <div class="good-title" style="height:27px">商品名称</div>
                                            <div class="good-title" style="height:27px">商品简介</div>
                                            <div class="price-buy">
                                ...
                                <div class="good-item" style="float:none;width:100%;margin-left: 15px;border-bottom: 1px solid #EAEAEA;padding: 10px;">
                                    <div class="item-wrap border-l border-b" style="height:100px;position: static">
                                        <img style="float:left;width:30%;height:100px" src="/public/wxapp/mall/temp3/images/goodsView3.jpg" class="good-image" />
                                        <div class="good-intro" style="position: static;float: left;">
                                            <div class="good-title" style="height:27px">商品名称</div>
                                            <div class="good-title" style="height:27px">商品简介</div>
                                            <div class="price-buy">
                                ...
                                <div class="good-item" style="float:none;width:100%;margin-left: 15px;border-bottom: 1px solid #EAEAEA;padding: 10px;">
                                    <div class="item-wrap border-l border-b" style="height:100px;position: static">
                                        <img style="float:left;width:30%;height:100px" src="/public/wxapp/mall/temp3/images/goodsView4.jpg" class="good-image" />
                                        <div class="good-intro" style="position: static;float: left;">
                                            <div class="good-title" style="height:27px">商品名称</div>
                                            <div class="good-title" style="height:27px">商品简介</div>
                                            <div class="price-buy">
    ...
    <div class="edit-right">
        <div class="edit-con">
            ...
            <div class="fenleinav" data-right-edit data-id="3">
                <label style="width: 100%">{{recommendtitle}}<span>(推荐最多添加8个,滑动展示)</span></label>
                <div class="input-group-box" style="margin-bottom: 10px;">
                ...
                <div class="fenleinav-manage recommend-manage" ng-repeat="good in recommendGood">
                    ...
                    <div class="edit-img" style="width: 18%;height:100%">
                        ...
                        <div>
                            <img onclick="toUpload(this)"  data-limit="8" onload="changeSrc(this)" data-width="180" data-height="240" imageonload="doThis('recommendGood',good.index)" data-dom-id="upload-good{{$index}}" id="upload-good{{$index}}"  ng-src="{{good.imgsrc}}"  height="100%" style="display:inline-block;margin-left:0;">
            ...
            <!--
                    <div class="fenleinav" data-right-edit data-id="3">
                <label style="width: 100%">{{recommendtitle}}<span>(请上传白底尺寸为230px*230px的图片，否则可能影响展示效果)</span></label>
                <div class="input-group-box" style="margin-bottom: 10px;">
                    <label style="width: 70px">标题名称：</label>
                    <input type="text" class="cus-input" ng-model="recommendtitle" maxlength="5">
                </div>
                <div class="fenleinav-manage">
                    <div class="edit-img">
                        <div class="cropper-box" data-width="400" data-height="260" style="height:100%;">
                            <img ng-src="{{recommendGood[0].imgsrc}}"  onload="changeSrc(this)" imageonload="doThis('recommendGood',0)" alt="导航图标">
                    ...
                    <div class="edit-txt">
                        <div class="input-group-box clearfix">
                            <label for="">商品名称：</label>
                            <input type="text" class="cus-input"  ng-model="recommendGood[0].name">
                        </div>
                        <div class="input-group-box clearfix">
                            <label for="">商品价格：</label>
                            <input type="text" class="cus-input"  ng-model="recommendGood[0].price">
                        </div>
                        <div class="input-group-box clearfix">
                            <label for="">链接到：</label>
                            <select class="cus-input" ng-model="recommendGood[0].link" ng-options="x.id as x.name for x in goodsList"></select>
                        </div>
                    </div>
                </div>
                <div class="fenleinav-manage">
            ...
            <div class="fenleinav" data-right-edit data-id="4">
                <label style="width: 100%">商品分类滑动展示</label>
                <label style="width: 100%">从对应分类中取出最多6个商品显示~</label>
                <!--<div class="fenleinav-manage" ng-repeat="goodfl in goodFlShow">
                    <div class="delete" ng-click="delIndex('goodFlShow',goodfl.index)">×</div>
                    <div class="input-group-box" style="margin-bottom: 10px;">
                        <label style="width: 70px">标题名称：</label>
                        <input type="text" class="cus-input" ng-model="goodfl.title" maxlength="5">
                    </div>
                    <div class="input-group-box" style="margin-bottom: 10px;">
...
<script>
    ...
    app.controller('chCtrl', ['$scope','$http','$timeout',function($scope,$http,$timeout){
        ...
        $scope.headerTitle= "<{$tpl['ami_title']}>" ? "<{$tpl['ami_title']}>" : "店铺首页" ;
        $scope.searchPlaceholder = '<{$tpl['ami_search_tip']}>' ? '<{$tpl['ami_search_tip']}>' : '请输入关键字';
        $scope.banners = <{$slide}>;
        $scope.fenleiNavs = <{$shortcut}>;
        $scope.tpl_id		= '<{$tpl['ami_tpl_id']}>';
        $scope.recommendGood = <{$recommendGoods}>;
        $scope.recommendtitle = '<{$tpl['ami_recommend_tip']}>' ? '<{$tpl['ami_recommend_tip']}>' : '热品推荐';
