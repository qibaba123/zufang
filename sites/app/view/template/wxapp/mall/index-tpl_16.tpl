...
.good-list-wrap .title-name .title-img {
    height: 36.6px;
}
</style>
                ...
                <div class="index-main">
                    ...
                    <div class="good-show-wrap" data-left-preview data-id="4">
                        <div class="good-list-wrap" ng-repeat="goodfl in goodFlShow">
                            <div class="title-name flex-wrap" style="background: #393939;">
                                <img ng-src="{{goodfl.imgsrc?goodfl.imgsrc:'/public/wxapp/mall/temp3/images/ydhw-title-img.png'}}" class="title-img" alt="标题图片">
                                <p class="flex-con" style="color: white;">{{goodfl.title}}</p>
            ...
            <div class="fenleinav" data-right-edit data-id="4">
                ...
                <div ui-sortable="sortableOptions" ng-model="goodFlShow">
                    <div class="fenleinav-manage" ng-repeat="goodfl in goodFlShow">
                        ...
                        <div class="edit-img" style="width: 100%;text-align: center;">
                            <div>
                                <img onclick="toUpload(this)"  data-limit="8" onload="changeSrc(this)" data-width="400" data-height="288" imageonload="doThis('goodFlShow',goodfl.index)" data-dom-id="upload-goodfl{{$index}}" id="upload-goodfl{{$index}}"  ng-src="{{goodfl.imgsrc}}"  height="100%" style="display:inline-block;margin-left:0;width: 100px;height: 73px;">
                                <input type="hidden" id="goodfl{{$index}}"  class="avatar-field bg-img" name="goodfl{{$index}}" ng-value="goodfl.imgsrc"/>
                            </div>
                        </div>
                        <div class="input-group-box" style="margin-bottom: 10px;">
                            <label style="width: 70px">标题名称：</label>
        ...
        $scope.addNewfenleiNav = function(){
            ...
            if(fenleiNav_length>=8){
                ...
                var fenleiNav_Default = {
                    ...
                    title: '默认标题',
                    articleId: $scope.goodsList?$scope.goodsList[0].id:''
                };
        ...
        $scope.addNewGoodfl = function(){
            ...
            if(goodfl_length>=8){
                ...
                var goodfl_Default = {
                    index: defaultIndex,
                    title:'默认分类名称',
                    imgsrc: '/public/wxapp/mall/temp3/images/ydhw-title-img.png',
