                            ...
                            <div class="widget-main">
                                <div class="step-content row-fluid position-relative" id="step-container">
                                    <form class="form-horizontal" id="goods-form"  enctype="multipart/form-data" style="overflow: hidden;">
                                        ...
                                        <input type="hidden" id="g_type" name="g_type" value="<{if $row}><{$row['g_type']}><{else}>50<{/if}>">
                                                ...
                                                <div class="info-group-inner">
                                                    ...
                                                    <div class="group-info">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="control-group">
                                                                <input type="text" class="form-control" id="g_label" name="g_label" placeholder="请填写作者"  value="<{if $row}><{$row['g_label']}><{/if}>"  style="width:160px;">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="control-group">
                                                                <input type="text" class="form-control" id="g_points" name="g_points" onblur="mathVIp()" placeholder="请填写课程所需积分"  value="<{if $row}><{$row['g_points']}><{/if}>"  style="width:160px;">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <label  class="col-sm-3 control-label"><font color="red">*</font>课程封面图：</label>
                                                            <div>
                                        ...
                                        <!-- 此处添加为积分商品 -->
                                        <input type="hidden" name="is_point" value="1">
                                    </form>
                                </div>
