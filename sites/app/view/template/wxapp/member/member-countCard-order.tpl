                ...
                <div id="mainContent">
                    ...
                    <div class="cur-remain">
                        ...
                        <div class="cur-remain-val">
                            <span><{$offlineCard['cardTitle']}><span style="font-size: 12px;">(剩余<{$offlineCard['leftNum']}>次)</span></span>
                            <{if $offlineCard['expireStatus'] == 1}>
                        ...
                        <div class="end-date">卡号：<{$offlineCard['cardNum']}></div>
                        <div class="end-date"><{$offlineCard['expireTime']}>到期</div>
                    </div>
                    <{/if}>
                    <div class="row">
                        <div class="col-sm-12">
                                            ...
                                            <div class="table-responsive">
                                                <table id="sample-table-1" class="table" style="margin-bottom: 0;">
                                                    ...
                                                    <{foreach $list as $item}>
                                                        <tr id="tr_id_<{$item['oo_id']}>">
                                                            <td><{$item['oo_title']}></td>
                                                            <td><{$item['oo_amount']}></td>
                                                            <td>
                                                                <{if $appletCfg['ac_type'] == 6}>
                                                                <{if $storeList[$item['oo_st_id']]['acs_name']}>
                                                                <{$storeList[$item['oo_st_id']]['acs_name']}>
                                                                <{/if}>
                                                                <{if $storeListOld[$item['oo_st_id']]['os_name']}>
                                                                <{$storeListOld[$item['oo_st_id']]['os_name']}>
                                                                <{/if}>
                                                                <{else}>
                                                                <{$storeList[$item['oo_st_id']]['os_name']}>
                                                                <{/if}>
                                                            </td>
                                                            <td><{if $item['oo_pay_type'] == 1}>微信支付<{elseif $item['oo_pay_type'] == 2}>余额支付<{/if}></td>
                                                            <td><{date('Y-m-d H:i:s',$item['oo_pay_time'])}></td>
                                                        </tr>
                                                        <{/foreach}>
                                                    </tbody>
                                                </table>
