            ...
            <div class="tab-content"  style="z-index:1;padding: 10px 0;padding-bottom: 0;">
                <div id="mainContent">
                    <!-- <div class="row" style="padding-left: 20px">
                        当前余额：<{$member['m_gold_coin']}>
                        <a class="btn btn-xs btn-primary recharge-btn" data-toggle="modal" data-target="#rechargeModal"  data-mid="<{$mid}>" data-coin="<{$member['m_gold_coin']}>" data-type="single" style="margin-left: 20px">操作</a>
                    </div> -->
                            ...
                            <div class="tabbable record-tabbable">
                                <ul class="nav nav-tabs" id="myTab">
                                    ...
                                    <li <{if $status == 1}>class="active"<{/if}>>
                                        <a <{if $status == 1}>href="#"<{else}>href="/wxapp/member/memberCoinRecord?mid=<{$mid}>&status=1"<{/if}>>
                                        收入
                                        </a>
                                    </li>
                                    <li <{if $status == 2}>class="active"<{/if}>>
                                        <a <{if $status == 2}>href="#"<{else}>href="/wxapp/member/memberCoinRecord?mid=<{$mid}>&status=2"<{/if}>>
                                        支出
                                        </a>
                                    </li>
                                </ul>
                                                    ...
                                                    <{foreach $list as $item}>
                                                        <tr id="tr_id_<{$item['rr_id']}>">
                                                            ...
                                                            <td>
                                                                ...
                                                                管理员充值
                                                                <{/if}>
                                                                <{if $item['rr_pay_type'] == 10}>
                                                                订单退款
                                                                <{/if}>
                                                                <{if $item['rr_pay_type'] == 11}>
                                                                红包收入
                                                                <{/if}>
                                                                <{if $item['rr_pay_type'] == 12}>
                                                                积分兑换
                                                                <{/if}>
                                                                ...
                                                                订单关闭退款
                                                                <{/if}>
                                                                <{if $item['rr_pay_type'] == 15}>
                                                                订单退款
                                                                <{/if}>
                                                                <{if $item['rr_pay_type'] == 18}>
                                                                收银台退款
                                                                <{/if}>
                                                            </td>
                                                            <td class="remark">
