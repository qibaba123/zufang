...
<div id="content-con">
                                ...
                                <{foreach $list as $val}>
                                    <tr id="tr_<{$val['m_id']}>" class="tr-content">
                                        ...
                                        <td style="position:relative">
                                            ...
                                            <!--<{if $val['m_is_follow'] eq 0 && $val['m_is_slient'] eq 0}>
                                            <span style="position: absolute; bottom: 8px;width:60px;top: 8px; left: 50%;margin-left: -30px; background-color: rgba(255, 255, 255, 0.7); filter:progid:DXImageTransform.Microsoft.gradient(startColorstr=#B2ffffff,endColorstr=#B2ffffff);  text-align: center; line-height: 60px; font-size: 13px; font-weight: bold; color: #777; letter-spacing:1px;">取消关注</span>
                                            <{elseif $val['m_is_slient'] eq 1}>
                                            <span style="position: absolute; bottom: 8px;width:60px;top: 8px; left: 50%;margin-left: -30px; background-color: rgba(255, 255, 255, 0.7); filter:progid:DXImageTransform.Microsoft.gradient(startColorstr=#B2ffffff,endColorstr=#B2ffffff);  text-align: center; line-height: 60px; font-size: 13px; font-weight: bold; color: #777; letter-spacing:1px;">未关注</span>
                                            <{/if}>-->
                                        </td>
                                        <td>
                                            <p>
                                        ...
                                        <{/if}>
                                        <td style="min-width: 100px; position: relative" class="recharge-td">
                                            <{$val['m_gold_coin']}>
                                        ...
                                        <td style="min-width: 100px"><{$val['m_traded_num']}>
                                            <{if $val['m_traded_num']}>
                                            <!--<a href="/wxapp/order/index?mid=<{$val['m_id']}>" class="label label-sm label-info">订单</a>-->
                                            <{/if}>
                                        </td>
                                        <!--
                                        <td style="min-width: 100px"><{$val['m_traded_money']}></td>
                                        -->
                                        <!--
                                        <td >
                                        ...
                                        <!--
                                        <{if $appletCfg['ac_type'] != 8 && $appletCfg['ac_type'] != 3 && $appletCfg['ac_type'] != 26}>
                                            <td><{if isset($mLevel[$val['m_level']])}><{$mLevel[$val['m_level']]}><{/if}></td>
                                        <{/if}>
                                        -->
 ...
 <!--<a href="#" class="btn btn-primary btn-xs multi-recharge-btn" data-toggle="modal" style="padding-top: 2px;padding-bottom: 2px;">余额批量充值</a>-->
...
<!-- Modal -->    <div class="modal fade" id="categoryModal" tabindex="-1" role="dialog" aria-labelledby="categoryModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    <label class="col-sm-3 control-label no-padding-right" for="qq-num" style="text-align: center"><font color="red">*</font>密码：</label>
                    <div class="col-sm-8">
                        <input type="password" id="pwd" class="form-control" placeholder="请填写登录密码" style="height:auto!important" />
                    </div>
                </div>
                </form>
            </div>
            ...
            <div class="modal-body" style="overflow: inherit;text-align: center;margin-bottom: 45px">
                <div class="modal-plan p_num clearfix shouhuo">
                    <form enctype="multipart/form-data" action="/wxapp/member/importMember" method="post">
                        ...
                        <{/if}>
                        <button type="button" class="btn btn-normal" data-dismiss="modal" style="margin-right: 30px;margin-top: 25px;margin-bottom: 10px">取消</button>
                        <button type="submit" class="btn btn-primary" role="button" style="margin-top: 25px;margin-bottom: 10px">导出</button>
                    </form>
                </div>
            </div>
        </div>
