            ...
            <div class="index-con">
                ...
                <div class="index-main">
                    <div class="mobile-content">
                        <div class="member-info" ng-style="{'background-image':'url('+centerInfo.bgSrc+')'}" style="display: block;">
                            <div class="base-info">
                       ...
                       <ul class="user-operation">
                           <li class="border-b"><a href="#" class="icon29">全部订单<span></span></a></li>
                       </ul>
                        <div class="order-info flex-wrap" >
                            <div>
                                <img src="/public/mobile/center/images/icon-order0.png" alt="">
                                <span>待付款</span>
                            </div>
                            <div>
                                <img src="/public/wxapp/icon/wjd/icon_yuyue.png" alt="" style="width: 45px">
                                <span>待入住</span>
                            </div>
                            <div>
                                <img src="/public/mobile/center/images/icon-yfk.png" alt="">
                                <span>已完成</span>
                            </div>
                        </div>
    ...
    <div class="edit-right">
        <div class="edit-con">
            <div class="header-top" data-right-edit data-id="0" style="display:block;">
                <div class="top-manage" style="display: block;">
