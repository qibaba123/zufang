            ...
            <div class="tab-content"  style="z-index:1;padding: 10px 0;padding-bottom: 0;">
                <div id="mainContent">
                    <!-- <div class="row" style="padding-left: 20px">
                        当前积分：<{$member['m_points']}>
                        <a class="btn btn-xs btn-primary point-btn" data-toggle="modal" data-target="#pointModal"  data-mid="<{$mid}>" data-type="single" data-point_now="<{$member['m_points']}>" style="margin-left: 20px">操作</a>
                    </div> -->
                    <div class="cur-remain">
                        <div class="cur-remain-label">当前余额（元）</div>
                        <div class="cur-remain-val">
                            <span><{$member['m_gold_coin']}></span>
                            <a href="javascript:;" class="recharge-btn" data-toggle="modal" data-target="#rechargeModal"  data-mid="<{$mid}>" data-coin="<{$member['m_gold_coin']}>" data-type="single">操作</a>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="tabbable record-tabbable">
                                <ul class="nav nav-tabs" id="myTab">
                                    ...
                                    <li <{if $status == 1}>class="active"<{/if}>>
                                        <a <{if $status == 1}>href="#"<{else}>href="/wxapp/member/memberPointRecord?mid=<{$mid}>&status=1"<{/if}>>
                                        获得
                                        </a>
                                    </li>
                                    <li <{if $status == 2}>class="active"<{/if}>>
                                        <a <{if $status == 2}>href="#"<{else}>href="/wxapp/member/memberPointRecord?mid=<{$mid}>&status=2"<{/if}>>
                                        消耗
                                        </a>
                                    </li>
                                </ul>
                                                ...
                                                <table id="sample-table-1" class="table" style="margin-bottom: 0;">
                                                    ...
                                                    <{foreach $list as $item}>
                                                        <tr id="tr_id_<{$item['pi_id']}>">
                                                            ...
                                                            <td><{date('Y-m-d H:i:s',$item['pi_create_time'])}></td>
                                                        </tr>
                                                        <{/foreach}>
                                                    </tbody>
                                                </table>
