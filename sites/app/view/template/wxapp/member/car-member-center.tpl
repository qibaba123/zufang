                        ...
                        <div class="style-type-new" >
                            ...
                            <div class="fenlei-nav">
                                ...
                                <ul class="border-t border-b service-nav" style="white-space: normal;">
                                    ...
                                    <li ng-hide="centerInfo.showlist.carshopcollect.isShow==0">
                                        <img ng-src="/public/wxapp/images/center/new_pl.png" width="100%" height="100%"  alt="图标">
                                        <span>{{centerInfo.showlist.carshopcollect.name}}</span>
                                    </li>
                                    ...
                                    <li ng-hide="centerInfo.showlist.carbargain.isShow==0">
                                        <img ng-src="/public/wxapp/images/center/new_pt.png" width="100%" height="100%"  alt="图标">
                                        <span>{{centerInfo.showlist.carbargain.name}}</span>
                                    </li>
                                    <!--
                                    ...
                                    -->
                                    <li ng-hide="centerInfo.showlist.carshare.isShow==0">
                                        <img ng-src="/public/wxapp/images/center/new_coupon.png" width="100%" height="100%"  alt="图标">
                                        <span>{{centerInfo.showlist.carshare.name}}</span>
                                    </li>
            ...
            <div class="header-top" data-right-edit data-id="0" style="display:block;">
                ...
                <div class="showlist-manage">
                    ...
                    <div class="check-row">
                        ...
                        <div class="check-box">
                            <p>
                                <input type="checkbox" id="showcarshopcollect" data-id="carshopcollect" ng-checked="centerInfo.showlist.carshopcollect.isShow==1" ng-click="checked($event)">
                                <label for="showcarshopcollect">显示</label>
                            </p>
                            <p class="text"><input type="text" class="form-control" maxlength="10" ng-model="centerInfo.showlist.carshopcollect.name"></p>
                        </div>
                    </div>
                    <div class="check-row">
                        <span>收藏服务</span>
                    ...
                    <div class="check-row">
                        ...
                        <div class="check-box">
                            <p>
                                <input type="checkbox" id="showcarbargain" data-id="carbargain" ng-checked="centerInfo.showlist.carbargain.isShow==1" ng-click="checked($event)">
                                <label for="showcarbargain">显示</label>
                            </p>
                            <p class="text"><input type="text" class="form-control" maxlength="10" ng-model="centerInfo.showlist.carbargain.name"></p>
                        </div>
                    </div>
                    <!--
                    <div class="check-row">
...
<script>
    ...
    app.controller('chCtrl',  ['$scope', '$http', function($scope, $http){
        ...
        showlist:{
            ...
            carshopcollect : {
                isShow : <{$row['ct_carshopcollect_show']}>,
                name : "<{if $row['ct_carshopcollect_name']}><{$row['ct_carshopcollect_name']}><{else}>关注服务商<{/if}>"
            },
            carbargain : {
                isShow : <{$row['ct_carbargain_show']}>,
                name : "<{if $row['ct_carbargain_name']}><{$row['ct_carbargain_name']}><{else}>我的砍价<{/if}>"
            },
        }
    };
