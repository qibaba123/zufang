...
.input-inline-block{white-space: nowrap;}
.input-inline-block .inline-block{display: inline-block;}
</style>
            ...
            <div class="index-con">
                ...
                <div class="index-main">
                    <div class="mobile-content">
                        ...
                        <div class="numshow-box flex-wrap" style="">
                        ...
                        <div class="fenlei-nav new-fenlei-nav" style="">
                            <ul class="border-t border-b" style="white-space: normal;">
                                ...
                                <li ng-hide="centerInfo.showlist.myfx.isShow==0">
                                    <img src="{{centerInfo.showlist.myfx.icon}}" width="100%" height="100%"  alt="图标">
                                    <span>{{centerInfo.showlist.myfx.name}}</span>
                                </li>
                                <li ng-hide="centerInfo.showlist.mydy.isShow==0">
                                    <img src="{{centerInfo.showlist.mydy.icon}}" width="100%" height="100%"  alt="图标">
                                    <span>{{centerInfo.showlist.mydy.name}}</span>
                                </li>
                                <li ng-hide="centerInfo.showlist.myft.isShow==0">
                                    <img src="{{centerInfo.showlist.myft.icon}}" width="100%" height="100%"  alt="图标">
                                    <span>{{centerInfo.showlist.myft.name}}</span>
                                </li>
                                <li ng-hide="centerInfo.showlist.mypl.isShow==0">
                                    <img src="{{centerInfo.showlist.mypl.icon}}" width="100%" height="100%"  alt="图标">
                        ...
                        <ul class="user-operation">
                            ...
                            <li class="border-b" ng-hide="centerInfo.showlist.mygd.isShow==0"><a href="#" style="background-image: url(/public/mobile/center/images/mine/icon_mine_gd.png);" >{{centerInfo.showlist.mygd.name}}<span></span></a></li>
                            <li class="border-b" ng-hide="centerInfo.showlist.mygdp.isShow==0"><a href="#" style="background-image: url(/public/mobile/center/images/mine/icon_mine_gdp.png);"  >{{centerInfo.showlist.mygdp.name}}<span></span></a></li>
                            <{/if}>
                            <li class="border-b" ng-hide="centerInfo.showlist.step.isShow==0"><a href="#" style="background-image: url(/public/wxapp/images/center/new_wxbs.png);"  >{{centerInfo.showlist.step.name}}<span></span></a></li>
                        </ul>
                        <!--
                        <ul class="user-operation">
                            ...
                            <li>
                                <div class="edit-img">
                                    <div style="height:100%;">
                                        <img onclick="toUpload(this)"  data-limit="1" onload="changeSrc(this)" data-width="200" data-height="200"  imageonload="changemycardIcon()" data-dom-id="upload-icon-mycard" id="upload-icon-mycard"  ng-src="{{centerInfo.showlist.mycard.icon}}"  height="100%" style="display:inline-block;margin-left:0;">
                                        <input type="hidden" id="icon-mycard"  class="avatar-field bg-img" name="icon-mycard" ng-value="centerInfo.showlist.mycard.icon"/>
                                    </div>
                                </div>
                                <input type="text" ng-model="centerInfo.showlist.mycard.name" class="form-control"/>
                                <span class='tg-list-item'>
                                <input class='tgl tgl-light' id='icon-mycard_start' type='checkbox' ng-model="centerInfo.showlist.mycard.isShow">
                                <label class='tgl-btn' for='icon-mycard_start'></label>
                                </span>
                            </li>
                            <li>
                                <div class="edit-img">
                                    <div style="height:100%;">
                                        <img onclick="toUpload(this)"  data-limit="1" onload="changeSrc(this)" data-width="200" data-height="200"  imageonload="changemyyqmIcon()" data-dom-id="upload-icon-myyqm" id="upload-icon-myyqm"  ng-src="{{centerInfo.showlist.myyqm.icon}}"  height="100%" style="display:inline-block;margin-left:0;">
                                        <input type="hidden" id="icon-myyqm"  class="avatar-field bg-img" name="icon-myyqm" ng-value="centerInfo.showlist.myyqm.icon"/>
                                    </div>
                                </div>
                                <input type="text" ng-model="centerInfo.showlist.myyqm.name" class="form-control"/>
                                <span class='tg-list-item'>
                                <input class='tgl tgl-light' id='icon-myyqm_start' type='checkbox' ng-model="centerInfo.showlist.myyqm.isShow">
                                <label class='tgl-btn' for='icon-myyqm_start'></label>
                                </span>
                            </li>
                            <li>
                                <div class="edit-img">
                                    <div style="height:100%;">
                                        <img onclick="toUpload(this)"  data-limit="1" onload="changeSrc(this)" data-width="200" data-height="200"  imageonload="changejfshopIcon()" data-dom-id="upload-icon-jfshop" id="upload-icon-jfshop"  ng-src="{{centerInfo.showlist.jfshop.icon}}"  height="100%" style="display:inline-block;margin-left:0;">
                                        <input type="hidden" id="icon-jfshop"  class="avatar-field bg-img" name="icon-jfshop" ng-value="centerInfo.showlist.jfshop.icon"/>
                                    </div>
                                </div>
                                <input type="text" ng-model="centerInfo.showlist.jfshop.name" class="form-control"/>
                                <span class='tg-list-item'>
                                <input class='tgl tgl-light' id='icon-jfshop_start' type='checkbox' ng-model="centerInfo.showlist.jfshop.isShow">
                                <label class='tgl-btn' for='icon-jfshop_start'></label>
                                </span>
                            </li>
                            <li>
                                <div class="edit-img">
                                    <div style="height:100%;">
                                        <img onclick="toUpload(this)"  data-limit="1" onload="changeSrc(this)" data-width="200" data-height="200"  imageonload="changemyfxIcon()" data-dom-id="upload-icon-myfx" id="upload-icon-myfx"  ng-src="{{centerInfo.showlist.myfx.icon}}"  height="100%" style="display:inline-block;margin-left:0;">
                                        <input type="hidden" id="icon-myfx"  class="avatar-field bg-img" name="icon-myfx" ng-value="centerInfo.showlist.myfx.icon"/>
                                    </div>
                                </div>
                                <input type="text" ng-model="centerInfo.showlist.myfx.name" class="form-control"/>
                                <span class='tg-list-item'>
                                <input class='tgl tgl-light' id='icon-myfx_start' type='checkbox' ng-model="centerInfo.showlist.myfx.isShow">
                                <label class='tgl-btn' for='icon-myfx_start'></label>
                                </span>
                            </li>
                            <li>
                                <div class="edit-img">
                                    <div style="height:100%;">
                                        <img onclick="toUpload(this)"  data-limit="1" onload="changeSrc(this)" data-width="200" data-height="200"  imageonload="changemydyIcon()" data-dom-id="upload-icon-mydy" id="upload-icon-mydy"  ng-src="{{centerInfo.showlist.mydy.icon}}"  height="100%" style="display:inline-block;margin-left:0;">
                                        <input type="hidden" id="icon-mydy"  class="avatar-field bg-img" name="icon-mydy" ng-value="centerInfo.showlist.mydy.icon"/>
                                    </div>
                                </div>
                                <input type="text" ng-model="centerInfo.showlist.mydy.name" class="form-control"/>
                                <span class='tg-list-item'>
                                <input class='tgl tgl-light' id='icon-mydy_start' type='checkbox' ng-model="centerInfo.showlist.mydy.isShow">
                                <label class='tgl-btn' for='icon-mydy_start'></label>
                                </span>
                            </li>
                            <li>
                                <div class="edit-img">
                                    <div style="height:100%;">
                                        <img onclick="toUpload(this)"  data-limit="1" onload="changeSrc(this)" data-width="200" data-height="200"  imageonload="changemyftIcon()" data-dom-id="upload-icon-myft" id="upload-icon-myft"  ng-src="{{centerInfo.showlist.myft.icon}}"  height="100%" style="display:inline-block;margin-left:0;">
                                        <input type="hidden" id="icon-myft"  class="avatar-field bg-img" name="icon-myft" ng-value="centerInfo.showlist.myft.icon"/>
                                    </div>
                                </div>
                                <input type="text" ng-model="centerInfo.showlist.myft.name" class="form-control"/>
                                <span class='tg-list-item'>
                                <input class='tgl tgl-light' id='icon-myft_start' type='checkbox' ng-model="centerInfo.showlist.myft.isShow">
                                <label class='tgl-btn' for='icon-myft_start'></label>
                                </span>
                            </li>
                            <li>
                                <div class="edit-img">
                                    <div style="height:100%;">
                                        <img onclick="toUpload(this)"  data-limit="1" onload="changeSrc(this)" data-width="200" data-height="200"  imageonload="changemyplIcon()" data-dom-id="upload-icon-mypl" id="upload-icon-mypl"  ng-src="{{centerInfo.showlist.mypl.icon}}"  height="100%" style="display:inline-block;margin-left:0;">
                                        <input type="hidden" id="icon-mypl"  class="avatar-field bg-img" name="icon-mypl" ng-value="centerInfo.showlist.mypl.icon"/>
                                    </div>
                                </div>
                                <input type="text" ng-model="centerInfo.showlist.mypl.name" class="form-control"/>
                                <span class='tg-list-item'>
                                <input class='tgl tgl-light' id='icon-mypl_start' type='checkbox' ng-model="centerInfo.showlist.mypl.isShow">
                                <label class='tgl-btn' for='icon-mypl_start'></label>
                                </span>
                            </li>
                            <li>
                                <div class="edit-img">
                                    <div style="height:100%;">
                                        <img onclick="toUpload(this)"  data-limit="1" onload="changeSrc(this)" data-width="200" data-height="200"  imageonload="changeshopapplyIcon()" data-dom-id="upload-icon-shopapply" id="upload-icon-shopapply"  ng-src="{{centerInfo.showlist.shopapply.icon}}"  height="100%" style="display:inline-block;margin-left:0;">
                                        <input type="hidden" id="icon-shopapply"  class="avatar-field bg-img" name="icon-shopapply" ng-value="centerInfo.showlist.shopapply.icon"/>
                                    </div>
                                </div>
                                <div class="input-inline-block">
                                    <div class="inline-block">讲师申请前</div>
                                    <div class="inline-block"><input type="text" ng-model="centerInfo.showlist.shopapply.name" class="form-control"/></div>
                                    <div class="inline-block">讲师申请后</div>
                                    <div class="inline-block"><input type="text" ng-model="centerInfo.showlist.expertcenter.name" class="form-control"/></div>
                                </div>
                                <span class='tg-list-item'>
                                <input class='tgl tgl-light' id='icon-shopapply_start' type='checkbox' ng-model="centerInfo.showlist.shopapply.isShow">
                                <label class='tgl-btn' for='icon-shopapply_start'></label>
                                </span>
                            </li>
                        </ul>
                    </div>
...
<script>
    ...
    app.controller('chCtrl',  ['$scope', '$http', function($scope, $http){
        ...
        $scope.changemycardIcon = function(){
            $scope.centerInfo.showlist.mycard.icon = imgNowsrc;
        };

        $scope.changemyyqmIcon = function(){
            $scope.centerInfo.showlist.myyqm.icon = imgNowsrc;
        };
