                ...
                <div class="index-main">
                    <div class="mobile-content">
                        ...
                        <ul class="user-operation">
                            ...
                            <li class="border-b" ng-hide="centerInfo.showlist.mymalldd.isShow==0"><a href="#" class="icon29">{{centerInfo.showlist.mymalldd.name}}<span></span></a></li>
                            ...
                            <li class="border-b" ng-hide="centerInfo.showlist.mybespeak.isShow==0"><a href="#" class="icon28">{{centerInfo.showlist.mybespeak.name}}<span></span></a></li>
                            <{if $menuType neq 'toutiao'}>
                            ...
                            <li class="border-b" ng-hide="centerInfo.showlist.mycard.isShow==0"><a href="#" class="icon3">{{centerInfo.showlist.mycard.name}}<span></span></a></li>
                            <li class="border-b" ng-hide="centerInfo.showlist.jfshop.isShow==0"><a href="#" class="icon25">{{centerInfo.showlist.jfshop.name}}<span></span></a></li>
                            <{if $menuType neq 'toutiao'}>
    ...
    app.controller('chCtrl',  ['$scope', '$http', function($scope, $http){
        ...
        showlist:{
            ...
            mybespeak :{
                ...
                name: "<{if $row['ct_mybespeak_name']}><{$row['ct_mybespeak_name']}><{else}>我的预定<{/if}>"
            },
            myyhq : {
                isShow : <{$row['ct_myyhq_show']}>,
                name : "<{if $row['ct_myyhq_name']}><{$row['ct_myyhq_name']}><{else}>代金券<{/if}>"
            },
            myaddr : {
                isShow : <{$row['ct_myaddr_show']}>,
                name : "<{if $row['ct_myaddr_name']}><{$row['ct_myaddr_name']}><{else}>我的收货地址<{/if}>"
            },
            myact : {
