...
<div  id="content-con">
    ...
    <div class="page-header search-box">
        <div class="col-sm-12">
            <form action="/wxapp/car/goodsList" method="get" class="form-inline">
                        ...
                        <{foreach $list as $val}>
                            <tr id="tr_<{$val['g_id']}>">
                                ...
                                <td>
                                    ...
                                    <p>
                                        <a href="javascript:;" class="btn-tuiguang" data-link="pages/productDetail/productDetail?id=<{$val['g_id']}>" data-share="<{$val['g_qrcode']}>" data-id="<{$val['g_id']}>">商品推广</a>
                                    </p>
                                </td>
                            </tr>
                            <{/foreach}>
