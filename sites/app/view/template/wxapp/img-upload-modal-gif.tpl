...
//			    });
    ...
    function initUploadBox(){
        ...
        html += '</div>';
        html += '<div class="origin-box" style="width: 250px;display: inline-block;height:265px;position:relative">';
    ...
    function uploadGif(e){
        ...
        if(isImageFile){
            var url = "/admin/image/upload/common/default?dir=image&suid=<{$curr_shop['s_unique_id']}>",
                data = new FormData();
    ...
    function fetchPageData(page, type){
        if(type == 'common'){
            var data = {
                'page'   : page,
                'height' : height,
