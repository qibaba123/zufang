...
<div class="password-redpack">
    ...
    <div class="code">
        <div class="item-wrap">
            <span>拍下未付款订单</span>
            <span class="line-display"><input type="number" id="close_trade" value="<{if $curr_shop['s_close_trade']}><{$curr_shop['s_close_trade']}><{else}>60<{/if}>" class="form-control"></span>
    ...
    <div class="code">
        <div class="item-wrap">
           <span class='tg-list-item'>
               <input class='tgl tgl-light' id='auto_finish' type='checkbox' <{if $curr_shop['s_auto_finish']}>checked<{/if}>>
    ...
    <div class="code">
        <div class="item-wrap">
            ...
            <span>发货后</span>
            <{/if}>
            <span class="line-display"><input type="number" id="finish_trade" value="<{if $curr_shop['s_finish_trade']}><{$curr_shop['s_finish_trade']}><{else}>7<{/if}>" class="form-control"></span>
            <span>天，自动确认收货</span>
            <div style="color:red">
    ...
    <div class="code">
        <div class="item-wrap">
            <span>确认收货后</span>
            <span class="line-display"><input type="number" id="return_time" value="<{if $curr_shop['s_return_time']}><{$curr_shop['s_return_time']}><{else}>0<{/if}>" class="form-control"></span>
            <span>天，无法退货</span>
        </div>
    </div>
    ...
    <div class="code">
        <div class="item-wrap">
            <span>订单返现比例</span>
            <span class="line-display"><input type="number" id="return_ratio" value="<{if $curr_shop['s_order_return_ratio']}><{$curr_shop['s_order_return_ratio']}><{/if}>" class="form-control"></span>
            <span>%</span>
        </div>
        <div style="color: red">提示：订单完成后将按实际付款金额比例返现至用户余额，0表示不返现，与分销返现互不影响。</div>
    </div>
    <{/if}>
    <{if $appletCfg['ac_type'] == 32 || $appletCfg['ac_type'] == 36 || $appletCfg['ac_type'] == 21 || $appletCfg['ac_type'] == 8}>
    <h4 class="info-title"><span style="width: 100%">订单提示设置</span></h4>
    <div class="code">
        <div class="item-wrap">
            <span>首页订单提示</span>
            <label id="choose-onoff" class="choose-onoff">
                <input class="ace ace-switch ace-switch-5" id="s_order_tip" data-type="open" type="checkbox" <{if $curr_shop['s_order_tip']}>checked<{/if}> >
                <span class="lbl"></span>
            </label>
        </div>
    ...
    <div class="code">
        <div class="item-wrap">
            <span>允许评价订单</span>
            <label id="choose-onoff" class="choose-onoff">
                <input class="ace ace-switch ace-switch-5" id="s_order_comment" data-type="open" type="checkbox" <{if $curr_shop['s_order_comment']}>checked<{/if}> >
                <span class="lbl"></span>
            </label>
        </div>
        <div style="color: red"></div>
    ...
    <div class="code">
        <div class="item-wrap">
            <span>付款后</span>
            <span class="line-display"><input type="number" id="auto_refund" value="<{if $curr_shop['s_auto_refund']}><{$curr_shop['s_auto_refund']}><{else}>0<{/if}>" class="form-control"></span>
    ...
    <div class="code">
        <div class="item-wrap">
           <span class='tg-list-item'>
               <input class='tgl tgl-light' id='auto_receive_order' type='checkbox' <{if $curr_shop['s_auto_receive_order']}>checked<{/if}>>
    ...
    <div class="code">
        <div class="item-wrap">
            ...
            <label id="choose-onoff" class="choose-onoff" style="margin-bottom: 10px">
                <input class="ace ace-switch ace-switch-5" id="s_entershop_finish_open" data-type="open" type="checkbox" <{if $curr_shop['s_entershop_finish_open']}>checked<{/if}> >
                <span class="lbl"></span>
            </label>
        </div>
        <div style="color: red"></div>
    ...
    <{if $appletCfg['ac_type'] == 4 || $appletCfg['ac_type'] == 6 || $appletCfg['ac_type'] == 8}>
    <h4 class="info-title"><span style="width: 100%">商家订单结算</span></h4>
    <div class="code">
        <div class="item-wrap">
            <span>商家订单完成</span>
            <span class="line-display"><input type="number" id="enter_settle" value="<{if $curr_shop['s_enter_settle']}><{$curr_shop['s_enter_settle']}><{else}>0<{/if}>" class="form-control"></span>
...
<script>
    ...
    var appletType = '<{$appletCfg['ac_type']}>';
