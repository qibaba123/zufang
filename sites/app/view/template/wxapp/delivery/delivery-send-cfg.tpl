...
<div class="payment-style" ng-app="chApp" ng-controller="chCtrl" style="margin-left: 130px">
    <div class="page-header" style="min-height: 50px">
            ...
            <span style="">
                    ...
                    <label id="choose-onoff" class="choose-onoff">
                        <input name="sms_start" class="ace ace-switch ace-switch-5" id="sendOpen" data-type="open" onchange="changeOpen()" type="checkbox" <{if $sendCfg && $sendCfg['acs_send']}> checked<{/if}>>
                    <span class="lbl"></span>
                    </label>
            </span>
        <div class="watermrk-show">
            ...
            <div class="watermark-box">
                <div class="input-group">
                    <input type="number" style="width: 60px" maxlength="2" class="form-control" id="delivery-sort" value="<{$sendCfg['acs_send_sort']}>" data-type="send" oninput="if(value.length>2)value=value.slice(0,2)">
    ...
    <div class="payment-block-body js-wxpay-body-region" style="display: block;">
        <div class="row">
                    <form action="">
                        <{if $appletCfg['ac_type'] eq 13}>
                        <div class="form-group">
                            <label for="firstname" class="col-sm-2 control-label title-col-2">是否当日配送<font color="red">*</font></label>
                            <div class="col-sm-10">
                                <div class="radio-box">
                                    <span>
                                        <input type="radio" name="g_is_global" id="global1" value="1" <{if $sendCfg && $sendCfg['acs_today_send'] eq 1}>checked<{/if}>>
                                        <label for="global1">是</label>
                                    </span>
                                    <span>
                                        <input type="radio" name="g_is_global" id="global2" value="0"  <{if $sendCfg && $sendCfg['acs_today_send'] eq 0}>checked<{/if}>>
                        ...
                        <{/if}>
                        <{if $appletCfg['ac_type'] neq 1 && $appletCfg['ac_type'] neq 21 && $appletCfg['ac_type'] neq 24}>
                        <div class="form-group">
                            ...
                            <div class="timeDian" style="margin-left: 17%;margin-top: 10px">
                                <input type="text" class="time form-control" id="start<{$k}>" data-id="<{$k}>" value="<{$v[0]}>" onchange="" style="width: 10%;margin-right:4%">--<input class="time form-control" type="text" id="end<{$k}>" data-id="<{$k}>" value="<{$v[1]}>" style="width: 10%;margin-left:4%" onchange="">
        ...
        <div class="form-group col-sm-8">
            <input type="text" class="form-control" id="addr" name="addr" placeholder="请填写详细地址" value="<{if $sendCfg}><{$sendCfg['acs_shop_address']}><{/if}>">
        </div>

        <div class="form-group col-sm-2 text-left">
            <input type="hidden" id="lng" name="lng" placeholder="请在地图中标注分店位置" value="<{if $sendCfg}><{$sendCfg['acs_shop_lng']}><{/if}>">
            <input type="hidden" id="lat" name="lat" placeholder="请在地图中标注分店位置" value="<{if $sendCfg}><{$sendCfg['acs_shop_lat']}><{/if}>">
...
<script>
    $(function(){
        console.log('work');
        //首次进入默认选择位置
        var address = '<{$sendCfg['acs_shop_address']}>' ? '<{$sendCfg['acs_shop_address']}>' : '公司地址';
        var lng = '<{$sendCfg['acs_shop_lng']}>' ? '<{$sendCfg['acs_shop_lng']}>' : '113.72052';
        var lat = '<{$sendCfg['acs_shop_lat']}>' ? '<{$sendCfg['acs_shop_lat']}>' : '34.77485';
        //高德地图引入
