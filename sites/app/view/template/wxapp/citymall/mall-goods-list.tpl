...
<div  id="content-con" style="margin-left: 130px">
    ...
    <div class="page-header search-box">
        <div class="col-sm-12">
            <form action="/wxapp/citymall/goodsList" method="get" class="form-inline">
                    ...
                    <div class="form-container">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="shop" value="<{$shop}>" placeholder="店铺名称">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group">
                        ...
                        <{foreach $list as $val}>
                            <tr id="tr_<{$val['g_id']}>">
                                ...
                                <td class="proimg-name" style="min-width: 270px;">
                                    ...
                                    <{/if}>
                                    <div>
                                        <p class="pro-name" style="margin-bottom:5px;">
                                        ...
                                        <p>
                                            ...
                                            <span style="color: #82af6f;border: 1px solid #82af6f;border-radius: 4px;padding: 0px 8px;">首页推荐</span>
                                            <{/if}>
                                        </p>
                                    </div>
                                ...
                                <td class="jg-line-color">
                                	<p>
                                        <a href="javascript:;" onclick="shopGoodsToOwn(<{$val['g_id']}>, <{$val['g_has_format']}>, <{$val['g_price']}>)">导入商品库</a>

                                        - <a href="javascript:;" class="btn-tuiguang" data-link="subpages/shopgoodsDetail/shopgoodsDetail?id=<{$val['g_id']}>" data-share="<{$val['g_qrcode']}>" data-id="<{$val['g_id']}>">商品二维码</a>
                                    </p>
                                    <p>
                                    	<a href="javascript:;" onclick="showVipPriceModal(<{$val['g_id']}>, <{$val['g_has_format']}>, <{$val['g_price']}>)">会员价</a>
                                         - <a href="/wxapp/citymall/editGoods?id=<{$val['g_id']}>" >编辑</a>
...
<script type="text/javascript">
    ...
    $("#content-con").on('click', 'table td a.btn-tuiguang', function(event) {
        ...
        $('#download-goods-qrcode').attr('href', 'pages/shopgoodsDetail/shopgoodsDetail?id='+id);
    ...
    function reCreateQrcode(){
        ...
        $.ajax({
            'type'  : 'post',
            'url'   : '/wxapp/citymall/createQrcode',
            'data'  : {id:id},
            'dataType' : 'json',
            'success'   : function(ret){
                if(ret.ec == 200){
    ...
    function shopGoodsToOwn(id) {
        var index = layer.load(10, {
            shade: [0.6,'#666']
        });
        $.ajax({
            'type'  : 'post',
            'url'   : '/wxapp/citymall/shopGoodsToOwn',
            'data'  : {id:id},
            'dataType' : 'json',
            'success'   : function(ret){
                layer.msg(ret.em);
