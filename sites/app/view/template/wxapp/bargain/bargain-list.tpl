    ...
    <div  id="mainContent" style="margin-left: 130px;" ng-app="ShopIndex"  ng-controller="ShopInfoController">
        ...
        <div class="balance clearfix" style="border:1px solid #e5e5e5;margin-bottom: 20px;">
            ...
            <div class="balance-info">
                ...
                <div class="balance-content">
                    <span class="money"><{$statInfo['total_kjcg']}></span>
                </div>
            </div>
            <div class="balance-info">
                <div class="balance-title">砍价失败<span></span></div>
                <div class="balance-content">
                    <span class="money"><{$statInfo['total_kjsb']}></span>
                </div>
            </div>
                    ...
                    <table id="sample-table-1" class="table table-hover table-avatar">
                        ...
                        <{foreach $list as $val}>
                            <tr>
                                ...
                                -->
                                <td><a style="" href="/wxapp/bargain/join?id=<{$val['ba_id']}>" ><B>查看</B></a></td>
                                <td><{date('Y-m-d',$val['ba_create_time'])}></td>
                                <{if !in_array($menuType,['aliapp','bdapp','toutiao','qq','qihoo'])}>
                                <td><{if $val['ba_push']}>已推送<{else}><span style="color:#333;">未推送</span><{/if}></td>
                                <{/if}>
                                <td style="color:#ccc;">
                                    <p>
                                        <a href="/wxapp/bargain/add/?id=<{$val['ba_id']}>" >编辑</a>

                                        <{if $val['ba_start_time'] <= time() && $val['ba_end_time'] > time() }>
                                        - <a href="javascript:;" class="btn-end" data-id="<{$val['ba_id']}>" >结束</a>
                                        <{/if}>
                                        <{if $val['ba_status'] eq 2 }>
    - <a href="/wxapp/bargain/add/?id=<{$val['ba_id']}>&restart=1" >重新开始</a>
                                        <{/if}>
                                        - <a href="javascript:;" id="link_<{$val['ba_id']}>" class="btn-link" data-link="<{$bargainPath}>?id=<{$val['ba_id']}>">路径</a>
                                    </p>
                                    <{if !in_array($menuType,['aliapp','bdapp','toutiao','qq','qihoo'])}>
                                    <p>
                                    ...
                                    <p>
                                        <a href="javascript:;"  class="info-btn" id="msg_a_<{$val['ba_id']}>"
                                           data-id="<{$val['ba_id']}>"
                                           data-kjwc-msg="<{$val['ba_kjwc_msgid']}>" data-bkcg-msg="<{$val['ba_bkcg_msgid']}>"   data-toggle="modal" data-target="#myMessageMuban"
                                        >模版消息</a>
            ...
            <div class="modal-body">
                <div class="form-group row" style="margin-top: 10px;margin-right: 0;">
                    ...
                    <div class="col-sm-8">
                        <span class='tg-list-item'>
                            <input class='tgl tgl-light' id='wxgroupshow' type='checkbox' <{if $bargainCfg['bc_wxgroup_show']}>checked<{/if}>>
                ...
                <div class="form-group row" style="margin-top: 10px;margin-right: 0;">
                    ...
                    <div class="col-sm-8">
                        <div>
                            <div>
                                <img onclick="toUpload(this)" data-limit="1" data-width="200" data-height="200" data-dom-id="upload-wxgrouplogo" id="upload-wxgrouplogo"  src="<{if $bargainCfg['bc_wxgroup_logo']}><{$bargainCfg['bc_wxgroup_logo']}><{else}>/public/manage/img/zhanwei/zw_fxb_200_200.png<{/if}>"  width="200px" height="200px" style="display:inline-block;margin-left:0;width: 30%;height: 30%">
                                <input type="hidden" id="wxgrouplogo"  class="avatar-field bg-img" name="wxgrouplogo" value="<{$bargainCfg['bc_wxgroup_logo']}>"/>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="form-group row" style="margin-right: 0;">
                    ...
                    <div class="col-sm-8">
                        <input id="wxgroup-title" class="form-control" placeholder="请填写加群标题" style="height:auto!important" value="<{$bargainCfg['bc_wxgroup_title']}>"/>
                    </div>
                </div>
                <div class="form-group row" style="margin-right: 0;">
                    <label class="col-sm-3 control-label no-padding-right" for="qq-num" style="text-align: center">加群描述：</label>
                    <div class="col-sm-8">
                        <input id="wxgroup-desc" class="form-control" placeholder="请填写加群描述" style="height:auto!important" value="<{$bargainCfg['bc_wxgroup_desc']}>"/>
                    </div>
                </div>
                <div class="form-group row" style="margin-right: 0;">
                    ...
                    <div class="col-sm-8">
                        <div>
                            <div>
                                <img onclick="toUpload(this)" data-limit="1" data-width="200" data-height="200" data-dom-id="upload-wxgroupqrcode" id="upload-wxgroupqrcode"  src="<{if $bargainCfg['bc_wxgroup_qrcode']}><{$bargainCfg['bc_wxgroup_qrcode']}><{else}>/public/manage/img/zhanwei/zw_fxb_200_200.png<{/if}>" height="200px;" width="200px;" style="display:inline-block;margin-left:0;width: 60%;height: 60%">
                                <input type="hidden" id="wxgroupqrcode"  class="avatar-field bg-img" name="wxgroupqrcode" value="<{$bargainCfg['bc_wxgroup_qrcode']}>"/>
                            </div>
                        </div>
                    </div>
                </div>
