				...
				<div class="banner-manage" ng-repeat="goods in goodsList">
					<div class="edit-img">
						<div style="text-align: center">
							<img onclick="toUpload(this)"  data-limit="8" onload="changeSrc(this)" style="width: 100px;" data-width="200" data-height="200" imageonload="doThis('goodsList',{{$index}})" data-dom-id="upload-goodsList{{$index}}" id="upload-goodsList{{$index}}"  ng-src="{{goods.img}}"  height="100%" style="display:inline-block;margin-left:0;">
					...
					<div class="edit-txt" style="margin-top: 15px">
						...
						<div class="input-group-box"  style="margin-top: 10px">
							<label for="" style="display: inline-block; width: 20%;">商品名称：</label>
			...
			<div data-right-edit data-id="2">
				<div>
					<div class="input-groups" style="margin-top: 10px;margin-bottom:15px">
						...
						<input type="number" id="frequency" placeholder="请输入最多可抽奖次数" maxlength="10" value="<{$row['amll_frequency']}>" style="border: 1px solid #ddd;padding: 0 10px;">
					</div>
