...
<link rel="stylesheet" href="/public/wxapp/index/temp9/css/style.css?2">
<style>
				...
				<div class="index-main">
					...
					<div class="service-wrap" data-left-preview data-id="4">
					    <div class="title-name">
					        <img src="/public/wxapp/images/title_bg.png" />
					    ...
					    <div class="service-list">
					        <div class="service-item"  ng-repeat="service in serviceInfo.serviceList">
					            <div class="img-box"><img ng-src="{{service.imgsrc}}" /></div>
					            <div class="intro-txt">
					                <span class="title-txt">{{service.name}}</span>
					                <span class="txt">{{service.intro}}</span>
					            </div>
					        </div>
					    </div>
					</div>
					    ...
					    <div class="active-list">
					        <div class="active-item flex-wrap" ng-repeat="active in activeInfo.activeList">
					            ...
					            <div class="active-intro flex-con">
					                ...
					                <span class="intro-txt">{{active.intro}}</span>
					                <span class="time">7月1日 12:22</span>
					            </div>
					        </div>
					    </div>
					</div>
	...
	<div class="edit-right">
		<div class="edit-con">
			...
			<div class="banner" data-right-edit data-id="1" ng-model="banners">
				<label style="width: 100%">幻灯管理<span>(幻灯图片尺寸：750px*360px)</span></label>
			...
			<div class="fenleinav" data-right-edit data-id="2">
				<label style="width: 100%">分类导航<span>(分类多于3个时手机端可横向滑动，管理界面不做展示)</span></label>
				<div class="fenleinav-manage" ng-repeat="fenleiNav in fenleiNavs">
					...
					<div class="edit-txt">
						...
						<div class="input-group clearfix">
							<label for="">链接到：</label>
							<select class="cus-input" ng-model="fenleiNav.articleTitle" ng-options="x.title as x.title for x in articles" ng-change="getSelectId('fenleiNavs',fenleiNav.index,fenleiNav.articleTitle)"></select>
						</div>
						-->
			...
			<div class="service" data-right-edit data-id="4">
				...
				<div class="service-manage" ng-repeat="service in serviceInfo.serviceList">
					...
					<div class="edit-img">
                        <!--<div class="cropper-box" data-width="360" data-height="220" style="height:100%;">
						...
						<div style="text-align: center">
							<img onclick="toUpload(this)"  data-limit="1000" onload="changeSrc(this)" data-width="360" data-height="220" imageonload="doThis('serviceInfo.serviceList',service.index)" data-dom-id="upload-service{{$index}}" id="upload-service{{$index}}"  ng-src="{{service.imgsrc}}"  height="100%" style="display:inline-block;margin-left:0;">
							<input type="hidden" id="service{{$index}}"  class="avatar-field bg-img" name="service{{$index}}" ng-value="service.imgsrc"/>
						</div>
                    </div>
					<p class="tips">图片建议尺寸:360px*220px</p>
					<div class="edit-txt">
						<div class="input-group">
							<label for="">标　题：</label>
						...
						<div class="input-group">
							<label for="">简　介：</label>
							<textarea rows="3" class="cus-input" ng-model="service.intro"></textarea>
						</div>
						<div class="input-group">
							<label for="">链接到：</label>
			...
			<div class="active" data-right-edit data-id="5">
				<div class="input-group" style="margin-bottom: 10px;">
					<label for="">标题</label>
				...
				<div class="service-manage" ng-repeat="active in activeInfo.activeList">
					...
					<div class="edit-img">
						...
						<div style="text-align: center">
							<img onclick="toUpload(this)"  data-limit="1000" onload="changeSrc(this)" data-width="360" data-height="220" imageonload="doThis('activeInfo.activeList',active.index)" data-dom-id="upload-active{{$index}}" id="upload-active{{$index}}"  ng-src="{{active.imgsrc}}"  height="100%" style="display:inline-block;margin-left:0;">
					...
					<div class="edit-txt active-edit">
						...
						<div class="input-group">
							<label for="">简　介：</label>
							<textarea rows="3" class="cus-input" ng-model="active.intro"></textarea>
						</div>
						<!--
						<div class="input-group">
							<label for="">链接到：</label>
			...
			<div class="shopintrobg" data-right-edit data-id="6">
				<div class="input-group">
					<label for="">标题</label>
...
<script>
	...
	app.controller('chCtrl', ['$scope','$http','$timeout',function($scope,$http,$timeout){
	    ...
	    $scope.coopera = {
            ...
            imgsrc: '<{$tpl['at_head_img']}>' ? '<{$tpl['at_head_img']}>' :'/public/wxapp//public/wxapp/images/hzqy.png',
