...
<link rel="stylesheet" href="/public/wxapp/index/temp44/css/index.css?6">
<link rel="stylesheet" href="/public/wxapp/index/temp44/css/style.css?6">
<style>
            ...
            <div class="index-con">
                ...
                <div class="index-main">
                    <div class="banner-box" data-left-preview data-id="1">
                        ...
                        <div class="pagination" style="margin-bottom: 18px">
                    ...
                    <!--全部产品-->
                    <div class="service-wrap" data-left-preview data-id="5" style="background-color: #EFEFEF">
                            <div class="title-name" style="background-color: #fff;margin-bottom:0">
                                <span>全部产品</span>
                            </div>
                            <div class="type">
                                <span ng-repeat="category in categoryList">{{category.name}}</span>
                                <!--<span>网站建设</span>-->
                            </div>
    ...
    <div class="edit-right">
        <div class="edit-con">
            ...
            <div class="active" data-right-edit data-id="5">
                <div><span>产品分类最多展示4个</span></div>
                <div><span>具体产品在产品服务模块添加</span></div>
                <!--<div class="input-group" style="margin-bottom: 10px;">
                    <label for="">标题</label>
                    <input type="text" class="cus-input" placeholder="请输入页面标题" maxlength="4" ng-model="activeInfo.title">
                </div>
                <div class="service-manage" ng-repeat="active in activeInfo.activeList">
                    ...
                    <div class="edit-img">-->
                        ...
                        <!--<div style="text-align: center">
                            <img onclick="toUpload(this)"  data-limit="1000" onload="changeSrc(this)" data-width="220" data-height="220" imageonload="doThis('activeInfo.activeList',active.index)" data-dom-id="upload-active{{$index}}" id="upload-active{{$index}}"  ng-src="{{active.imgsrc}}"  height="100%" style="display:inline-block;margin-left:0;">
                            <input type="hidden" id="active{{$index}}"  class="avatar-field bg-img" name="active{{$index}}" ng-value="active.imgsrc"/>
                        </div>
                    </div>
                    <p class="tips">图片建议尺寸:220px*220px</p>
                    <div class="edit-txt">
                        <div class="input-group">
                            <label for="">标　题：</label>
...
<script>
    ...
    app.controller('chCtrl', ['$scope','$http','$timeout',function($scope,$http,$timeout){
        ...
        $scope.articleServices =  <{$articleService}>;
