...
<link rel="stylesheet" href="/public/wxapp/index/temp45/css/index.css?5">
<link rel="stylesheet" href="/public/wxapp/index/temp45/css/style.css?4">
<style>
...
<div class="preview-page" ng-app="chApp" ng-controller="chCtrl">
        ...
        <div class="mobile-con">
            ...
            <div class="index-con">
                ...
                <div class="index-main">
                    <div class="banner-box" data-left-preview data-id="1">
                        <div class="search-wrap">
                            <div class="search-container">
                                ...
                                <p style="color: #333">{{searchPlaceholder}}</p>
                            </div>
                        </div>
                    ...
                    <div class="fenlei-nav" style="padding-top: 15px;background-color: #fff;" data-left-preview data-id="2">
                        <div class="no-nav" ng-if="fenleiNavs.length<=0">
                            暂无导航哦~
                        </div>
                        <ul ng-if="fenleiNavs.length>0" style="border-radius: 4px;margin-bottom: 6px;">
                    ...
                    <!--优选品牌-->
                    <div class="service-wrap" data-left-preview data-id="3" style="background-color: #EFEFEF">
                        <div class="title-name" style="background-color: #fff;">
                            <span>{{brandInfo.title}}</span>
                            <!--<span class="more">更多</span>-->
                        </div>
                        <div class="no-data-tip" ng-if="brandInfo.brandList<=0">点此添加内容~</div>
                        <div class="service-list">
                            <div class="service-item"  ng-repeat="brand in brandInfo.brandList" style="width: 156px">
                    ...
                    <div class="service-wrap" style="background-color: #fff;margin-bottom: 6px" data-left-preview data-id="6">
                        ...
                        <div class="active-list master-list">
                            <div class="active-item master-item flex-wrap" ng-repeat="active in activeInfo.activeList">
                                ...
                                <span class="title-txt " style="color:#E52503">￥{{active.intro}}</span>
                                <!--<span class="title-txt " style="color: #E62704;">￥47</span>-->
                            </div>
                        </div>
                    </div>
    ...
    <div class="edit-right">
        <div class="edit-con">
            ...
            <div class="service" data-right-edit data-id="3"  ui-sortable ng-model="serviceInfo.serviceList">
                <label>{{brandInfo.title}}<span></span></label>
                ...
                <div class="service-manage" ng-repeat="brand in brandInfo.brandList">
                    ...
                    <div class="edit-txt">
                        <div class="input-group-box clearfix">
                            <label for="">链接类型：</label>
                            <select class="cus-input" ng-model="brand.type"  ng-options="x.id as x.name for x in linkTypes" style="width:82%;margin-bottom: 5px" ></select>
                        </div>
                        ...
                        <div class="input-group-box clearfix" ng-show="brand.type==18">
                            <label for="">分　　类：</label>
                            <select class="cus-input" ng-model="brand.link"  ng-options="x.id as x.name for x in categoryList" style="width:82%"></select>
                        </div>
                        <div class="input-group-box clearfix" ng-show="brand.type==19">
                            <label for="">服务详情：</label>
                            <select class="cus-input" ng-model="brand.link"  ng-options="x.id as x.title for x in serviceArticles" style="width:82%"></select>
                        </div>
            ...
            <div class="active" data-right-edit data-id="6"  ui-sortable ng-model="activeInfo.activeList">
                ...
                <div class="service-manage" ng-repeat="active in activeInfo.activeList">
                    ...
                    <div class="edit-img">
                        <div style="text-align: center">
                            <img onclick="toUpload(this)"  data-limit="1000" onload="changeSrc(this)" data-width="300" data-height="300" imageonload="doThis('activeInfo.activeList',active.index)" data-dom-id="upload-active{{$index}}" id="upload-active{{$index}}"  ng-src="{{active.imgsrc}}"  height="100%" style="display:inline-block;margin-left:0;">
                            <input type="hidden" id="active{{$index}}"  class="avatar-field bg-img" name="active{{$index}}" ng-value="active.imgsrc"/>
                        </div>
                    </div>
                    <p class="tips" style="text-align:center">图片建议尺寸:300px*300px</p>
                    <div class="edit-txt active-edit">
                        ...
                        <div class="input-group-box clearfix" ng-show="active.type==55">
                            <label for="">表　　单：</label>
                            <select class="cus-input" ng-model="active.link"  ng-options="x.id as x.name for x in formlist"></select>
                        </div>

                        <div class="input-group-box clearfix" ng-show="active.type==56">
                            <label for="">模　　板：</label>
...
<script>
    ...
    app.controller('chCtrl', ['$scope','$http','$timeout',function($scope,$http,$timeout){
        ...
        $scope.searchPlaceholder = '<{$tpl['at_search_tip']}>' ? '<{$tpl['at_search_tip']}>' : '请输入关键字';
    ...
    $scope.addMaster = function(){
        ...
        var activeList_Default = {
            ...
            name: '姓名',
            title: '称号',
            imgsrc: '/public/manage/img/zhanwei/zw_fxb_334_426.png',
            brief:'大咖简介'
        };
