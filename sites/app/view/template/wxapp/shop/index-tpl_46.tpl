...
<link rel="stylesheet" href="/public/wxapp/index/temp46/css/index.css?5">
<link rel="stylesheet" href="/public/wxapp/index/temp46/css/style.css?13">
<style>
    .service_first{
        width:100%;
    }
    .edit-con .active-edit select{
        width: 82%;
    }
    .edit-con .clearfix{
        margin-bottom: 5px;
...
<div class="preview-page" ng-app="chApp" ng-controller="chCtrl">
        ...
        <div class="mobile-con">
            ...
            <div class="index-con">
                ...
                <div class="index-main">
                    ...
                    <div class="address-show flex-wrap" style="background-color: #2BC390"data-left-preview data-id="2">
                        <p class="flex-con" style="color: #CCFAE5;" >{{address.address}}</p><!--ng-style="addressStyle"-->
                        <img src="/public/wxapp/images/icon_dw.png" />
                    </div>
                    <div class="banner-box" data-left-preview data-id="3">
                    ...
                    <div class="service-wrap" style="background-color: #fff" data-left-preview data-id="4">
                        <div class="title-name">
                            <!--<span>主营品牌</span>-->
                            <span>{{brandInfo.title}}</span>
                            <!--<span class="more">更多</span>-->
                        </div>
                        <div class="no-data-tip" ng-if="brandInfo.brandList<=0">点此添加内容~</div>
                        <div class="service-list">
                            <div class="service-item"  ng-repeat="brand in brandInfo.brandList">
                                <img ng-src="{{brand.imgsrc}}" />
                                <span class="title-txt brief">{{brand.intro}}</span>
                                <!--<span class="title-txt name">{{service.name}}</span>-->
                            </div>
                        </div>
                    </div>

                    <div class="service-wrap" style="background-color: #fff" data-left-preview data-id="5">
                        <div class="title-name">
                        ...
                        <div class="service-list">
                            <div  ng-if="$first==true" style="width:283px;height:143px;margin-bottom: 10px;" ng-repeat="service in serviceInfo.serviceList">
                                <img ng-src="{{service.imgsrc}}" style="width:283px;height:143px;" />
                                <!--<span class="title-txt brief">{{service.name}}</span>
                                <span class="title-txt brief">{{service.intro}}</span>-->
                            </div>
                            <div class="service-item" ng-if="$first!==true"  ng-repeat="service in serviceInfo.serviceList">
                                <img ng-src="{{service.imgsrc}}" />
                                <span class="title-txt brief">{{service.name}} <!--<span class="active-label">{{active.label}}</span>--></span>
                                <span class="brief" style="color:#F4B318">￥{{service.intro}}起</span><span style="color:#F4B318;border: 1px solid;margin-left: 39px;">预约</span>
                            </div>

                        </div>
                    </div>
                    <div class="service-wrap" style="background-color: #fff;margin-bottom: 6px" data-left-preview data-id="6">
                        <div class="title-name">
                            <span>{{activeInfo.title}}</span>
                            <span class="more">更多</span>
                        </div>
                        <div class="no-data-tip" ng-if="activeInfo.activeList<=0">点此添加内容~</div>
                        <div class="active-list master-list" style="width:95%">
                            <div class="active-item master-item flex-wrap" style="width:100%" ng-repeat="active in activeInfo.activeList">
                                <img ng-src="{{active.imgsrc}}" />

                                <span style="font-size: 13px; width:95%;" class="title-txt ">{{active.name}}</span>
                                <span style="color:#F4B318;margin-left:12px;">￥{{active.intro}}起</span><span style="color:#F4B318;border: 1px solid;margin-left: 180px;">预约</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <!--<div class="service-wrap" style="background-color: #fff" data-left-preview data-id="7">
                        <div class="title-name">
                            <span>{{noticeInfo.title}}</span>
                        </div>
                        <div class="no-data-tip" ng-if="noticeInfo.noticeTxt.length<=0">点此添加内容~</div>
                        <div class="active-list master-list">
                            <div class="active-item master-item flex-wrap" ng-repeat="notice in noticeInfo.noticeTxt" style="width:260px">
                                <span class="title-txt ">{{notice.title}} </span>
                            </div>
                        </div>
                    </div>-->
    ...
    <div class="edit-right">
        <div class="edit-con">
                ...
                <div class="fenleinav-manage" ng-repeat="fenleiNav in fenleiNavs">
                    ...
                    <div class="edit-txt">
                        ...
                        <div class="input-group-box clearfix">
                            ...
                            <select class="cus-input" ng-model="fenleiNav.type"  ng-options="x.id as x.name for x in linkTypes" style="margin-bottom: 5px"></select>
                        </div>
            ...
            <div class="banner" data-right-edit data-id="3" ng-model="banners">
            ...
            <div class="service" data-right-edit data-id="4"  ui-sortable ng-model="brandInfo.brandList">
                <label style="width: 100%">{{brandInfo.title}}<span>(首页展示2个，其它在滑动展示)</span></label>
                <span>（首页显示2个超过向右滑动，图标尺寸350*210）</span>
                <div class="input-group" style="margin-bottom: 10px;">
                    <label for="">标题</label>
                    <input type="text" class="cus-input" placeholder="请输入页面标题" maxlength="15" ng-model="brandInfo.title">
                </div>
                <div class="service-manage" ng-repeat="brand in brandInfo.brandList">
                    <div class="delete" ng-click="delIndex('brandList',brand.index,'brandInfo')">×</div>
                    <div class="edit-img">
                        ...
                        <div style="text-align: center">
                            <img onclick="toUpload(this)"  data-limit="1000" onload="changeSrc(this)" data-width="350" data-height="210" imageonload="doThis('brandInfo.brandList',brand.index)" data-dom-id="upload-brand{{$index}}" id="upload-brand{{$index}}"  ng-src="{{brand.imgsrc}}"  height="100%" style="display:inline-block;margin-left:0;">
                    ...
                    <div class="edit-txt">
                        <div class="input-group">
                            <label for="">简　介：</label>
                            <textarea rows="2" class="cus-input" ng-model="brand.intro"></textarea>
                        </div>
                        <!--<div class="input-group-box clearfix">
                            <label for="">链接类型：</label>
                            <select class="cus-input" ng-model="brand.type"  ng-options="x.id as x.name for x in linkTypes" style="width:82%" ></select>
                        </div>
                        <div class="input-group-box clearfix" ng-show="brand.type==1">
                            <label for="">单　　页：</label>
                            <select class="cus-input" ng-model="brand.link"  ng-options="x.id as x.title for x in articles" style="width:82%"></select>
                        </div>
                        <div class="input-group-box clearfix" ng-show="brand.type==2">
                            <label for="">列　　表：</label>
                            <select class="cus-input" ng-model="brand.link"  ng-options="x.path as x.name for x in linkList" style="width:82%"></select>
                        </div>
                        <div class="input-group-box clearfix" ng-show="brand.type==3">
                            <label for="">外　　链：</label>
                            <input type="text" class="cus-input" ng-value="brand.link" ng-model="brand.link" style="width:82%"/>
                        </div>-->
                        <div class="input-group">
                            <label for="">链接到：</label>
            ...
            <div class="active" data-right-edit data-id="5"  ui-sortable ng-model="serviceInfo.serviceList">
                <label style="width: 100%">{{serviceInfo.title}}<span>(首页最多展示3个，其它滑动展示)</span></label>
                <span></span>
                <div class="input-group" style="margin-bottom: 10px;">
                    <label for="">标题</label>
                ...
                <div class="service-manage" ng-repeat="service in serviceInfo.serviceList">
                    ...
                    <div class="edit-img">
                        ...
                        <div style="text-align: center" ng-if="$index==0">
                            <img onclick="toUpload(this)"  data-limit="1000" onload="changeSrc(this)" data-width="750" data-height="320" imageonload="doThis('serviceInfo.serviceList',service.index)" data-dom-id="upload-service{{$index}}" id="upload-service{{$index}}"  ng-src="{{service.imgsrc}}"  height="100%" style="display:inline-block;margin-left:0;">
                            <input type="hidden" id="service{{$index}}"  class="avatar-field bg-img" name="service{{$index}}" ng-value="service.imgsrc"/>
                        </div>
                        <div style="text-align: center" ng-if="$index>0">
                            <img onclick="toUpload(this)"  data-limit="1000" onload="changeSrc(this)" data-width="350" data-height="235" imageonload="doThis('serviceInfo.serviceList',service.index)" data-dom-id="upload-service{{$index}}" id="upload-service{{$index}}"  ng-src="{{service.imgsrc}}"  height="100%" style="display:inline-block;margin-left:0;">
                            <input type="hidden" id="service{{$index}}"  class="avatar-field bg-img" name="service{{$index}}" ng-value="service.imgsrc"/>
                        </div>
                    </div>
                    <p class="tips" style="text-align:center" ng-if="$index==0">图片建议尺寸:750*320px</p>
                    <p class="tips" style="text-align:center" ng-if="$index>0">图片建议尺寸:350px*235px</p>
                    <div class="edit-txt">
                        <div class="input-group">
                            <label for="">标　题：</label>
                        ...
                        <div class="input-group">
                            <label for="">价 格：</label>
                            <textarea name="" id="" class="cus-input" ng-model="service.intro"></textarea>
                        </div>
                        <div class="input-group">
                            <label for="">链接到：</label>
                            <select class="cus-input" ng-model="service.articleId" ng-options="x.id as x.title for x in serviceArticles"></select>
                        </div>
                    </div>
                </div>
                <div class="add-box" title="添加" ng-click="addNewservice()"></div>
            </div>
            <div class="active" data-right-edit data-id="6"  ui-sortable ng-model="activeInfo.activeList">
                <label style="width: 100%">{{activeInfo.title}}<span>(首页展示2个，其它在更多中展示)</span></label>
                <div class="input-group" style="margin-bottom: 10px;">
                    <label for="">标题</label>
                ...
                <div class="service-manage" ng-repeat="active in activeInfo.activeList">
                    ...
                    <div class="edit-img">
                        <div style="text-align: center">
                            <img onclick="toUpload(this)"  data-limit="1000" onload="changeSrc(this)" data-width="750" data-height="360" imageonload="doThis('activeInfo.activeList',active.index)" data-dom-id="upload-active{{$index}}" id="upload-active{{$index}}"  ng-src="{{active.imgsrc}}"  height="100%" style="display:inline-block;margin-left:0;">
                            <input type="hidden" id="active{{$index}}"  class="avatar-field bg-img" name="active{{$index}}" ng-value="active.imgsrc"/>
                        </div>
                    </div>
                    <p class="tips" style="text-align:center">图片建议尺寸:750px*360px</p>
                    <div class="edit-txt active-edit">
                        ...
                        <div class="input-group">
                            <label for="">价 格：</label>
                            <textarea name="" id="" class="cus-input" ng-model="active.intro"></textarea>
                        </div>
                        <!--
                        <div class="input-group">
                            <label for="">链接到：</label>
                            <select class="cus-input" ng-model="active.articleId" ng-options="x.id as x.title for x in serviceArticles"></select>
                            <!--
            ...
            <!--<div class="active" data-right-edit data-id="7"  ui-sortable ng-model="noticeInfo.noticeTxt">
                <label style="width: 100%">常见问题</label>
                <div class="input-group" style="margin-bottom: 10px;">
                    <label for="">标题</label>
                    <input type="text" class="cus-input" placeholder="请输入页面标题" maxlength="5" ng-model="noticeInfo.title">
                </div>
                <div class="service-manage" ng-repeat="notice in noticeInfo.noticeTxt">
                    <div class="delete" ng-click="delIndex('noticeTxt',notice.index,'noticeInfo')">×</div>
                    <div class="edit-txt">
                        <div class="input-group">
                            <label for="">问 题：</label>
...
<script>
    ...
    app.controller('chCtrl', ['$scope','$http','$timeout',function($scope,$http,$timeout){
        ...
        $scope.serviceInfo = {
            title:"<{$tpl['at_service_title']}>" ? "<{$tpl['at_service_title']}>" : '装饰风格',
            serviceList:<{$serviceList}>
        };
        $scope.activeInfo = {
            title:"<{$tpl['at_active_title']}>" ? "<{$tpl['at_active_title']}>" : '精选案例',
            activeList:<{$activeList}>
        };

        $scope.masterInfo = {
            title:"<{$tpl['at_master_title']}>" ? "<{$tpl['at_master_title']}>" : '设计大咖',
            masterList:<{$masterList}>
        };
        $scope.noticeInfo = {
            title:"<{$tpl['at_master_title']}>" ? "<{$tpl['at_master_title']}>" : '常见问题',
            noticeTxt:<{$noticeList}>
        };
        $scope.brandInfo = {
            title:"<{$tpl['at_brand_title']}>" ? "<{$tpl['at_brand_title']}>" : '主营品牌',
            brandList:<{$navList}>
        };
        $scope.appointInfo = {
    ...
    $scope.addNewservice = function(){
        ...
        if(serviceList_length>0){
            for (var i=0;i<serviceList_length;i++){
                if(defaultIndex < parseInt($scope.serviceInfo.serviceList[i].index)){
    ...
    $scope.addNewactive = function(){
        ...
        if(activeList_length>0){
            for (var i=0;i<activeList_length;i++){
                if(defaultIndex < parseInt($scope.activeInfo.activeList[i].index)){
    ...
    $scope.addMaster = function(){
        var masters_length = $scope.masterInfo.masterList.length;
        var defaultIndex = 0;
        if(masters_length>0){
            for (var i=0;i<masters_length;i++){
                if(defaultIndex < parseInt($scope.masterInfo.masterList[i].index)){
                    defaultIndex = $scope.masterInfo.masterList[i].index;
                }
            }
            defaultIndex++;
        }
        ...
        $scope.masterInfo.masterList.push(activeList_Default);
        $timeout(function(){
            //卸载掉原来的事件
            $(".cropper-box").unbind();
            new $.CropAvatar($("#crop-avatar"));
   ...
   $scope.addNotice = function(){
        var activeList_length = $scope.noticeInfo.noticeTxt.length;
        var defaultIndex = 0;
        if(activeList_length>0){
            for (var i=0;i<activeList_length;i++){
                if(defaultIndex < parseInt($scope.noticeInfo.noticeTxt[i].index)){
                    defaultIndex = $scope.noticeInfo.noticeTxt[i].index;
                }
            }
            defaultIndex++;
        }
        ...
        $scope.noticeInfo.noticeTxt.push(activeList_Default);
        $timeout(function(){
            //卸载掉原来的事件
            $(".cropper-box").unbind();
            new $.CropAvatar($("#crop-avatar"));
        ...
        console.log($scope.noticeInfo);
    };
        /*添加品牌*/
        $scope.addNewBrand = function(){
            var brandList_length = $scope.brandInfo.brandList.length;
            var defaultIndex = 0;
            if(brandList_length>0){
                for (var i=0;i<brandList_length;i++){
                    if(defaultIndex < parseInt($scope.brandInfo.brandList[i].index)){
                        defaultIndex = $scope.brandInfo.brandList[i].index;
                    }
                }
                defaultIndex++;
            }
            ...
            var brands_Default = {
                ...
                name: '默认标题',
                intro:'品牌简介',
                linkTitle:$scope.articles.length>0?$scope.articles[0].title:'',
                /*articleId:$scope.articles.length>0?$scope.articles[0].id:'',*/
                link : $scope.articles.length > 0 ? $scope.articles[0].id : '',
                type : '1'
            };
            $scope.brandInfo.brandList.push(brands_Default);
            $timeout(function(){
                //卸载掉原来的事件
                $(".cropper-box").unbind();
                new $.CropAvatar($("#crop-avatar"));
    ...
    /*获取真正索引*/
        ...
        $scope.saveData = function(){
            ...
            var data = {
                ...
                'masterList' : $scope.masterInfo.masterList,
                'brandList'   :$scope.brandInfo.brandList,
                'servicetitle': $scope.serviceInfo.title,
                'activetitle' : $scope.activeInfo.title,
                'mastertitle' : $scope.noticeInfo.title,
                'brandtitle'  : $scope.brandInfo.title,
                'notice'      : $scope.noticeInfo.noticeTxt,
