...
<link rel="stylesheet" href="/public/wxapp/index/temp25/css/index.css?5">
<link rel="stylesheet" href="/public/wxapp/index/temp25/css/style.css?4">
<style>
...
<div class="preview-page" ng-app="chApp" ng-controller="chCtrl">
                    ...
                    <div class="service-wrap" data-left-preview data-id="5">
                        ...
                        <div class="active-list">
                            <div class="active-item flex-wrap" ng-repeat="active in activeInfo.activeList">
                                ...
                                <span class="title-txt ">{{active.name}} <span class="active-label">{{active.label}}</span></span>
                                <span class="title-txt brief">{{active.intro}}</span>
                            </div>
                        </div>
                    </div>
                    <div class="service-wrap" data-left-preview data-id="6">
                        <div class="title-name">
                            <span>{{masterInfo.title}}</span>
                            <span class="more">更多</span>
                        </div>
                        <div class="no-data-tip" ng-if="masterInfo.masterList<=0">点此添加内容~</div>
                        <div class="active-list master-list">
                            <div class="active-item master-item flex-wrap" ng-repeat="master in masterInfo.masterList">
                                <div class="master-img">
                                    <img ng-src="{{master.imgsrc}}" />
                                </div>
                                <div class="master-info">
                                    <span class="title-txt title">{{master.title}}</span>
                                    <span class="title-txt name">{{master.name}}</span>
                                    <span class="title-txt brief">{{master.brief}}</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="edit-right">
        <div class="edit-con">
            ...
            <div class="service" data-right-edit data-id="4"  ui-sortable ng-model="serviceInfo.serviceList">
                <span>首页最多展示5个，其它在更多中展示</span>
            ...
            <div class="active" data-right-edit data-id="5"  ui-sortable ng-model="activeInfo.activeList">
                <span>首页最多展示3个，其它在更多中展示</span>
                <div class="input-group" style="margin-bottom: 10px;">
                    <label for="">标题</label>
                ...
                <div class="service-manage" ng-repeat="active in activeInfo.activeList">
                    ...
                    <div class="edit-txt active-edit">
                        ...
                        <div class="input-group">
                            <label for="">标  签：</label>
                            <input type="text" class="cus-input" ng-model="active.label">
                        </div>
                        <div class="input-group">
                            <label for="">简  介：</label>
            ...
            <div class="active" data-right-edit data-id="6"  ui-sortable ng-model="masterInfo.masterList">
                <span>首页最多展示2个，其它在更多中展示</span>
                <div class="input-group" style="margin-bottom: 10px;">
                    <label for="">标题</label>
                    <input type="text" class="cus-input" placeholder="请输入页面标题" maxlength="15" ng-model="masterInfo.title">
                </div>
                <div class="service-manage" ng-repeat="master in masterInfo.masterList">
                    <div class="delete" ng-click="delIndex('masterList',master.index,'masterInfo')">×</div>
                    <div class="edit-img">
                        <!--<div class="cropper-box" data-width="300" data-height="320" style="height:100%;">
                            <img ng-src="{{master.imgsrc}}"  onload="changeSrc(this)"  imageonload="doThis('masterInfo.masterList',master.index)" alt="导航图标">
                            <input type="hidden" class="avatar-field bg-img" name="center_bg" ng-value="master.imgsrc"/>
                        </div>-->
                        <div style="text-align: center">
                            <img onclick="toUpload(this)"  data-limit="1000" onload="changeSrc(this)" data-width="300" data-height="320" imageonload="doThis('masterInfo.masterList',master.index)" data-dom-id="upload-master{{$index}}" id="upload-master{{$index}}"  ng-src="{{master.imgsrc}}"  height="100%" style="display:inline-block;margin-left:0;">
                            <input type="hidden" id="master{{$index}}"  class="avatar-field bg-img" name="master{{$index}}" ng-value="master.imgsrc"/>
                        </div>
                    </div>
                    <p class="tips" style="text-align:center">图片建议尺寸:300px*320px</p>
                    <div class="edit-txt">
                        <div class="input-group">
                            <label for="">资 质：</label>
                            <input type="text" class="cus-input" ng-model="master.title">
                        </div>
                        <div class="input-group">
                            <label for="">姓 名：</label>
                            <input type="text" class="cus-input" ng-model="master.name">
                        </div>
                        <div class="input-group">
                            <label for="">简 介：</label>
                            <textarea name="" id="" class="cus-input" ng-model="master.brief"></textarea>
                        </div>
                        <div class="input-group">
                            <label for="">链接到：</label>
                            <select class="cus-input" ng-model="master.link" ng-options="x.id as x.title for x in articles"></select>
                            <!--
                            <select class="cus-input" ng-model="active.articleTitle"   ng-options="x.title as x.title for x in articles"  ng-change="getSelectId('activeList',active.index,active.articleTitle,'activeInfo')"></select>
                            -->
                        </div>
                ...
                <div class="add-box" title="添加" ng-click="addMaster()"></div>
            </div>
    ...
    /*获取真正索引*/
        ...
        $scope.saveData = function(){
            ...
            var data = {
                ...
                'mastertitle' : $scope.masterInfo.title,
