...
<link rel="stylesheet" href="/public/wxapp/index/temp43/css/index.css?5">
<link rel="stylesheet" href="/public/wxapp/index/temp43/css/style.css?4">
<style>
    ...
    <div class="edit-right">
        <div class="edit-con">
            ...
            <div class="service" data-right-edit data-id="3"  ui-sortable ng-model="serviceInfo.serviceList">
                <label>{{serviceInfo.title}}<span>(预览只展示2个，多余两个手机端将会左右滑动)</span></label>
            ...
            <!--理财资讯-->
            <div class="active" data-right-edit data-id="4"  ui-sortable ng-model="activeInfo.activeList">
                <label>{{activeInfo.title}}<span>首页最多展示3个，其它在更多中展示</span></label>
                <div class="input-group" style="margin-bottom: 10px;">
                    <label for="">标题</label>
            ...
            <div class="shopintrobg" data-right-edit data-id="5">
                <div class="input-group">
                    <label for="">标题</label>
                    <input type="text" class="cus-input" placeholder="请输入页面标题" maxlength="15" ng-model="coopera.title">
                </div>
                <label style="width: auto;font-weight: normal;">{{coopera.title}}配图</label>
                <!--<div class="shopintrobg-manage cropper-box" data-width="750" data-height="280">
					...
					<a href="#" class="change-bg">修改图片<span>(建议尺寸750*任意)</span></a>
				</div>-->
                <div class="shopintrobg-manage">
                    <img onclick="toUpload(this)"  data-limit="1" onload="changeSrc(this)" data-width="750" data-height="280" imageonload="changeBg()" data-dom-id="upload-coopera" id="upload-coopera"  ng-src="{{coopera.imgsrc}}"  height="100%" style="display:inline-block;margin-left:0;">
                    <input type="hidden" id="coopera"  class="avatar-field bg-img" name="coopera{{$index}}" ng-value="coopera.imgsrc"/>
                    <!--<a href="#" class="change-bg" onclick="toUpload(this)"  data-limit="1" data-width="750" data-height="280" data-dom-id="upload-coopera">修改图片<span>(建议尺寸750*任意)</span></a>-->
                </div>
                <div class="input-group clearfix">
                    <label for="">链接到：</label>
