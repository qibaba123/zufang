        ...
        <li <{if $val['it_id'] == $row['it_id']}>class="usingtem" <{/if}>>
            <div class="temp-img">
                ...
                <div class="use-edit">
                    ...
                    <a href="javascript:;" class="btn btn-xs btn-success btn-start" data-id="<{$val['it_id']}>">启用</a>
                    <a href="/wxapp/shop/indexTpl?tpl=<{$val['it_id']}>" class="btn btn-xs btn-primary">编辑</a>
                </div>
            </div>
            <p><{$val['it_name']}></p>
            </li>
