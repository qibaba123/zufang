...
<link rel="stylesheet" href="/public/wxapp/index/temp41/css/index.css?6">
<link rel="stylesheet" href="/public/wxapp/index/temp41/css/style.css?12">
<style>
        ...
        <div class="mobile-con">
            ...
            <div class="index-con">
                ...
                <div class="index-main">
                    ...
                    <div class="address-show flex-wrap" style="background-color: #fff"data-left-preview data-id="3">
                    ...
                    <div class="service-wrap" data-left-preview data-id="5">
                        ...
                        <div class="active-list">
                            <div class="active-item flex-wrap" ng-repeat="service in serviceInfo.serviceList">
                                <img ng-src="{{service.imgsrc}}" />
                                <span class="title-txt ">{{service.name}} <!--<span class="active-label">{{active.label}}</span>--></span>
                                <span class="title-txt brief">{{service.intro}}</span>
                            </div>
                        </div>
                    </div>
                    <div class="service-wrap" style="background-color: #fff;height: 150px;margin-bottom: 6px" data-left-preview data-id="6">
                        <div class="title-name">
                        ...
                        <div class="active-list master-list">
                            <div class="active-item master-item flex-wrap" ng-repeat="active in activeInfo.activeList">
    ...
    <div class="edit-right">
        <div class="edit-con">
            ...
            <div class="service" data-right-edit data-id="4"  ui-sortable ng-model="brandInfo.brandList">
                <label>主营品牌<span>（品牌超过5个向右滑动，图标尺寸200*200）</span></label>
                ...
                <div class="service-manage" ng-repeat="brand in brandInfo.brandList">
                    ...
                    <div class="edit-img">
                        ...
                        <div style="text-align: center">
                            <img onclick="toUpload(this)"  data-limit="1000" onload="changeSrc(this)" data-width="200" data-height="200" imageonload="doThis('brandInfo.brandList',brand.index)" data-dom-id="upload-brand{{$index}}" id="upload-brand{{$index}}"  ng-src="{{brand.imgsrc}}"  height="100%" style="display:inline-block;margin-left:0;">
                    ...
                    <div class="edit-txt">
                        <div class="input-group-box clearfix">
                            <label for="">标　　题：</label>
                            <input type="text" class="cus-input" ng-model="brand.name" style="width:82%">
                        </div>
                        <div class="input-group-box clearfix">
                            <label for="">链接类型：</label>
                        ...
                        <div class="input-group-box clearfix" ng-show="brand.type==18">
                            <label for="">分　　类：</label>
                            <select class="cus-input" ng-model="brand.link" style="width:82%"  ng-options="x.id as x.name for x in categoryList" style="width:82%"></select>
                        </div>
                        <div class="input-group-box clearfix" ng-show="brand.type==32">
                            <label for="">资讯分类：</label>
                            <select class="cus-input" ng-model="brand.link"  ng-options="x.id as x.name for x in informationCategory" style="width:82%"></select>
                        </div>
                        <div class="input-group-box clearfix" ng-show="brand.type==19">
                            <label for="">服务列表：</label>
                            <select class="cus-input" ng-model="brand.link" style="width:82%"  ng-options="x.id as x.title for x in serviceArticles" style="width:82%"></select>
                        </div>
                        <div class="input-group-box clearfix" ng-show="brand.type==106">
                            <label for="">小 程 序：</label>
                            <select class="cus-input" ng-model="brand.link"  ng-options="x.appid as x.name for x in jumpList" style="width:82%"></select>
                        </div>

                        <div class="input-group-box clearfix" ng-show="brand.type==55">
                            <label for="">表　　单：</label>
                            <select class="cus-input" ng-model="brand.link"  ng-options="x.id as x.name for x in formlist" style="width:82%"></select>
                        </div>

                        <div class="input-group-box clearfix" ng-show="brand.type==56">
                            <label for="">模　　板：</label>
                            <select class="cus-input" ng-model="brand.link"  ng-options="x.id as x.name for x in templateList" style="width:82%"></select>
                        </div>

                        <!--<div class="input-group">
                            <label for="">链接到：</label>
                            <select class="cus-input" ng-model="active.articleId" ng-options="x.id as x.title for x in articles"></select>
                        </div>-->
                    </div>
                </div>
            ...
            <div class="active" data-right-edit data-id="5"  ui-sortable ng-model="serviceInfo.serviceList">
                <label style="width: 100%">热销产品<span>(首页最多展示6个，其它在更多中展示)</span></label>
                <span></span>
                <div class="input-group" style="margin-bottom: 10px;">
                    <label for="">标题</label>
            ...
            <div class="active" data-right-edit data-id="6"  ui-sortable ng-model="activeInfo.activeList">
                <span>首页展示2个，多余两个将会左右滑动，此处不再做效果展示</span>
                <div class="input-group" style="margin-bottom: 10px;">
                    <label for="">标题</label>
                ...
                <div class="service-manage" ng-repeat="active in activeInfo.activeList">
                    ...
                    <div class="edit-img">
                        <div style="text-align: center">
                            <img onclick="toUpload(this)"  data-limit="1000" onload="changeSrc(this)" data-width="350" data-height="210" imageonload="doThis('activeInfo.activeList',active.index)" data-dom-id="upload-active{{$index}}" id="upload-active{{$index}}"  ng-src="{{active.imgsrc}}"  height="100%" style="display:inline-block;margin-left:0;">
                    ...
                    <div class="edit-txt active-edit">
                        <div class="input-group">
                            ...
                            <input type="text" class="cus-input" ng-model="active.name" style="width: 80%">
                        </div>
                        <div class="input-group-box clearfix">
                            <label for="">链接类型：</label>
            ...
            <div class="active" data-right-edit data-id="7"  ui-sortable ng-model="noticeInfo.noticeTxt">
                ...
                <div class="input-group" style="margin-bottom: 10px;">
                    <label for="">标题</label>
                    <input type="text" class="cus-input" placeholder="请输入页面标题" maxlength="15" ng-model="noticeInfo.title">
                </div>
