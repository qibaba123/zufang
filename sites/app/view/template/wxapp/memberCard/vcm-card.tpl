        ...
        <div class="payment-block">
            <div class="payment-block-header js-wxpay-header-region">
                ...
                <label id="choose-onoff" class="choose-onoff" style="left: 150px;">
                    <input name="sms_start" class="ace ace-switch ace-switch-5" id="vw_isopen" data-type="vw_isopen" type="checkbox" <{if $vcmCfg['vw_isopen']}> checked<{/if}>>
                    <span class="lbl"></span>
                </label>
            </div>
                ...
                <div>
                    <form action="">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="appid" value="<{if $appletCfg && $appletCfg['ac_appid']}><{$appletCfg['ac_appid']}><{/if}>" readonly />
                                <p>微信小程序AppID</p>
                            </div>
                        </div>
                        <!--
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="mchid" value="<{if $vcmCfg}><{$vcmCfg['vw_mchid']}><{/if}>" data-msg="填写您的微信支付的商户号，并保存" placeholder="填写您的支付商户号">
                                <p>请填写微信商户平台商户号</p>
                            </div>
                        </div>
                        -->
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="deviceId" value="<{if $vcmCfg && $vcmCfg['vw_device_id']}><{$vcmCfg['vw_device_id']}><{else}><{$vcmData['deviceid']}><{/if}>" readonly />
                                <p>微财猫设备号</p>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="password" autocomplete="off" class="form-control" id="paySecret" value="<{if $vcmCfg && $vcmCfg['vw_pay_secret']}><{$vcmCfg['vw_pay_secret']}><{else}><{$vcmData['paysecret']}><{/if}>" readonly />
                                <p>微财猫支付秘钥</p>
                            </div>
                        </div>
                        <div class="form-group">
