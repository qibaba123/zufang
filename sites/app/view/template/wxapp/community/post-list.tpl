...
<div style="display: inline-block;vertical-align:  middle;margin-top: 15px;">
    ...
    <label id="choose-onoff" class="choose-onoff">
        <input class="ace ace-switch ace-switch-5" id="showPublicBtn" data-type="open" onchange="showPublicBtn()" type="checkbox" <{if $tpl['aci_show_public_btn']}>checked<{/if}>>
        <span class="lbl"></span>
    </label>
</div>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <select class="form-control" name="cate">
                                ...
                                <option value="<{$val['id']}>" <{if $val['id'] eq $cate}> selected <{/if}>><{$val['name']}></option>
                                <{/foreach}>
                            </select>
                        </div>
                    </div>
                    ...
                    <table id="sample-table-1" class="table table-hover table-avatar">
                        ...
                        <{foreach $list as $val}>
                            <tr id="tr_<{$val['acp_id']}>" class="tr-content">                                
                                ...
                                <td>
                                    <{if $val['acp_istop_expiration'] > 0}><{date('Y-m-d H:i',$val['acp_istop_expiration'])}><{/if}>
                                </td>
                                ...
                                <td class="jg-line-color">                                   
                                    <p>
                                        ...
                                        <a href="/wxapp/tplpreview/pushHistory?type=cpost&id=<{$val['acp_id']}>" >记录</a>
                                    </p>
                                    <p>
                                        <a href="/wxapp/community/postDetails/id/<{$val['acp_id']}>">详情</a> -                                      
                                        <a href="#" data-toggle="modal" data-target="#myModal" onclick="updatePost('<{$val['acp_id']}>','<{$val['acp_cate']}>')">修改</a> - 
                                    	<a href="#" id="delete-confirm" data-id="<{$val['acp_id']}>" onclick="deletePost('<{$val['acp_id']}>')" >删除</a>
                                    </p>
                                </td>
                            </tr>
                            <{/foreach}>
