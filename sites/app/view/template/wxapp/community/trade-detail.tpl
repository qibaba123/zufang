        	    ...
        	    <table class="info-table">
        	        <tbody>
        	            ...
        	            <tr style="display: table-row;">
        	                <th>订单类型：</th>
        	                <td><{$tradeType[$row['t_applet_type']]}></td>
        	            </tr>
        ...
        <table class="ui-table ui-table-simple goods-table">
            ...
            <tbody>
				...
				<{foreach $list as $val}>
					<tr class="test-item">
						...
						<td><{$val['gf_name']}></td>
						<td><{$val['to_price']}><{if $row['t_applet_type'] == 4}> + 积分<{$val['to_points']}><{/if}></td>
						<td><{$val['to_num']}></td>
						<td>
							<p><{$val['to_total']}><{if $row['t_applet_type'] == 4}> + 积分<{$val['to_points']}><{/if}></p>
							<div></div>
						</td>
            ...
            <tr>
                ...
                <{/if}>
                    ...
                    <p class="real-price"><span class="c-gray">实收总价：</span><span class="real-pay ui-money-income right-price">￥ <{$row['t_total_fee']}><{if $row['t_applet_type'] == 4}> + 积分<{$row['t_points']}><{/if}></span></p>
                </td>
            </tr>
            </tfoot>
        </table>
...
<script type="text/javascript" src="/public/manage/controllers/order.js"></script>
<script>
