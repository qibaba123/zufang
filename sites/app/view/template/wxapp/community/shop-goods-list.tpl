...
<div  id="content-con" >
    ...
    <div class="page-header search-box">
        <div class="col-sm-12">
            <form action="/wxapp/community/shopGoodsList" method="get" class="form-inline">
                    ...
                    <div class="form-container">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <select id="shop" name="shop" style="height:34px;width:100%" class="form-control">
                                    <option value="0">全部</option>
                                    <{foreach $selectShop as $key => $val}>
                                    <option <{if $shop eq $key}>selected<{/if}> value="<{$key}>"><{$val}></option>
                                    <{/foreach}>
                                </select>
                            </div>
                        </div>
