...
<table class="input-table">
    ...
    <tr>
        <td class="label-td"><label>活动标签:</label></td>
        <td><input type="text" id="label"  class="form-control" placeholder="限时折扣" value="<{if $row}><{$row['la_label']}><{/if}>"/></td>
    </tr>
    <!--
    <{if $sid eq 5655}>
    <tr>
        ...
        <td class="text-left">
            <div class="choose-goodrange">
                ...
                <div class="add-good-box">
                    ...
                    <{else}>
                    <div class="btn btn-xs btn-primary" data-toggle="modal" data-target="#goodsList" onclick="addMealGood()">+添加<{$goodsName}></div>
                    <{/if}>
                </div>
            </div>
            </div>
