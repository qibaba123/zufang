...
<div id="content-con">
    <div  id="mainContent" >
        <div class="page-header">
            <a class="btn btn-green btn-xs add-activity" href="/wxapp/city/addOrdinaryShop"><i class="icon-plus bigger-80"></i>添加店铺</a>
        </div><!-- /.page-header -->
        <div class="row">
            <div class="col-xs-12">
                    ...
                    <table id="sample-table-1" class="table table-striped table-hover table-avatar">
                        ...
                        <{foreach $list as $val}>
                            <tr id="tr_<{$val['acs_id']}>">
                                ...
                                <td>
                                    <a class="confirm-handle" href="/wxapp/city/addOrdinaryShop/id/<{$val['acs_id']}>">编辑</a>
