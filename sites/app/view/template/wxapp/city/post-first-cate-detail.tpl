            ...
            <div class="index-con">
                ...
                <div class="index-main">
                    ...
                    <div class="banner-wrap cur-edit" data-left-preview data-id="1">
                        <img src="/public/manage/img/zhanwei/zw_fxb_75_20.png" alt="轮播图" ng-if="banners.length<=0">
                    ...
                    <div class="notice-box classify-preiview-page" data-left-preview data-id="2">
                        ...
                        <div class="classify-name" ng-show="secondCate.length == 0">
                            <span style="color: red;text-align: center;font-size: 16px">点此添加二级分类</span>
                        </div>
                    </div>
            ...
            <div class="banner" data-right-edit data-id="1"  style="display:block;">
                ...
                <div class="banner-manage" ng-repeat="banner in banners">
                    ...
                    <div class="edit-img">
                        ...
                        <div>
                            <img onclick="toUpload(this)"  data-limit="5" onload="changeSrc(this)" data-width="750" data-height="200" imageonload="doThis('banners',banner.index)" data-dom-id="upload-slide{{$index}}" id="upload-slide{{$index}}"  ng-src="{{banner.imgsrc}}"  height="100%" style="display:inline-block;margin-left:0;">
                            <input type="hidden" id="slide{{$index}}"  class="avatar-field bg-img" name="slide{{$index}}" ng-value="banner.imgsrc"/>
                        </div>
                    </div>
                    <div class="input-group clearfix" style="width: 100%;margin-bottom: 10px;">
                        <label for="" style="width: 20%;float: left;">链接类型：</label>
                        <select class="cus-input" ng-model="banner.type"  ng-options="x.id as x.name for x in linkTypesNew" style="padding:2px 15px; width: 80%"></select>
                    </div>
                    <div class="input-group clearfix" ng-show="banner.type==1" style="width: 100%;">
                        <label for="" style="width: 20%;float: left;">单　　页：</label>
                        <select class="cus-input" ng-model="banner.link"  ng-options="x.id as x.title for x in articles" style="padding:2px 15px; width: 80%"></select>
                    </div>
                    <div class="input-group clearfix" ng-show="banner.type==2" style="width: 100%;">
                        <label for="" style="width: 20%;float: left;">列　　表：</label>
                        <select class="cus-input" ng-model="banner.link"  ng-options="x.path as x.name for x in linkList" style="padding:2px 15px; width: 80%"></select>
                    </div>
                    <div class="input-group clearfix" ng-show="banner.type==3" style="width: 100%;">
                        <label for="" style="width: 20%;float: left;">外　　链：</label>
                        <input type="text" class="cus-input" ng-value="banner.link" ng-model="banner.link" style="padding:2px 15px; width: 80%"/>
                    </div>
                    <div class="input-group-box clearfix" ng-show="banner.type==5" style="width: 100%;">
                    ...
                    <div class="input-group-box clearfix" ng-show="banner.type==20" style="width: 100%;">
                    ...
                    <div class="input-group clearfix" ng-show="banner.type==34" style="width: 100%;">
                        <label for="" style="width: 20%;float: left;">店铺分类：</label>
                        <select class="cus-input" style="padding:2px 15px; width: 80%" ng-model="banner.link"  ng-options="x.id as x.name for x in shopCategory"></select>
                    </div>
                    <!-- 自营商品一级分类 -->
                    <div class="input-group clearfix" ng-show="banner.type==23" style="width: 100%;">
                        <label for="" style="width: 20%;float: left;">商品分类：</label>
                        <select class="cus-input" ng-model="banner.link"  ng-options="x.id as x.name for x in currFirstKindSelect" style="padding:2px 15px; width: 80%"></select>
                    </div>
                    <!-- 自营商品二级分类 -->
                    <div class="input-group clearfix" ng-show="banner.type==9" style="width: 100%;">
                        <label for="" style="width: 20%;float: left;">商品分类：</label>
                        <select class="cus-input" ng-model="banner.link"  ng-options="x.id as x.name for x in currSecondKindSelect" style="padding:2px 15px; width: 80%"></select>
                    </div>

                    <div class="input-group clearfix" ng-show="banner.type==106" style="width: 100%;">
                        <label for="" style="width: 20%;float: left;">小 程 序：</label>
                        <select class="cus-input" ng-model="banner.link"  ng-options="x.appid as x.name for x in jumpList" style="padding:2px 15px; width: 80%"></select>
                    </div>
                    <div class="input-group clearfix" ng-show="banner.type==32" style="width: 100%;">
                        <label for="" style="width: 20%;float: left;">资讯分类：</label>
                        <select class="cus-input" ng-model="banner.link"  ng-options="x.id as x.name for x in infocateList" style="padding:2px 15px; width: 80%"></select>
                    </div>
                    <div class="input-group clearfix" ng-show="banner.type==40" style="width: 100%;">
                        <label for="" style="width: 20%;float: left;">帖子分类：</label>
                        <select class="cus-input" ng-model="banner.link"  ng-options="x.id as x.title for x in postCategory" style="padding:2px 15px; width: 80%"></select>
                    </div>
                </div>
...
<script>
    ...
    app.controller('chCtrl',['$scope','$http','$timeout', function($scope,$http,$timeout){
        ...
        $scope.banners = <{$slide}>;
        $scope.secondCate = <{$secondCate}>;
        console.log($scope.secondCate);
        $scope.id                   = '<{$row['acc_id']}>';
        ...
        $scope.addNewBanner = function(){
            ...
            if(banner_length>=5){
                ...
                var banner_Default = {
                    index: defaultIndex,
                    imgsrc: '/public/manage/img/zhanwei/zw_fxb_75_20.png',
                };
        ...
        $scope.saveData = function(){
        	layer.confirm('确定要保存吗？', {
	            ...
	            $http({
	                method: 'POST',
	                url:    '/wxapp/city/saveFirstCateDetail',
	                data:   data
