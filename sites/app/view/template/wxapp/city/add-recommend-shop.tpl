...
<div class="container">
    ...
    <div class="group-info">
        ...
        <div class="form-group">
            ...
            <div class="cropper-box" data-width="750" data-height="593" >
        ...
        <div class="form-group">
            ...
            <div class="control-group">
                <select id="acs_istop"  class="form-control">
                    <option value="0" <{if $row && $row['acs_istop'] eq 0}>selected<{/if}> >否</option>
                    <option value="1" <{if ($row && $row['acs_istop'] eq 1) || !$row}>selected<{/if}> >是</option>
                </select>
            </div>
        </div>
        <div class="form-group">
    ...
    $('.btn-save').click(function(){
        ...
        $.ajax({
            ...
            'success'   : function(ret){
                ...
                if(ret.ec == 200){
                    window.location.href='/wxapp/city/recommendShopList';
                }else{
                    layer.msg(ret.em);
                }
            }
