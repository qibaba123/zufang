    ...
    <div class="wechat-setting" style="max-width: 1200px;">
        <div class="bind-wechat">
            <div class="left">
                ...
                <div class="opera-btn">
                    <a onclick="openAuthuri(this, event)" href="javascript:void(0)" data-authuri="<{$auth_uri}>" class="have-btn">一键授权接入</a>
                    <a href="/wxapp/guide/editAuth" class="no-btn">手动接入(不推荐使用)</a>
                </div>
            </div>
            <div class="right">
                <ul>
