	            ...
	            <div class="index-con">
	                ...
	                <div class="index-main">
	                    ...
	                    <div data-left-preview data-id="5">
	                        <{if in_array($appletCfg['ac_type'],$companyInfoImg)}>
	                        <img src="/public/wxapp/images/company-info.png" alt="" style="width: 100%">
	                        <{else}>
	        ...
	        <div class="edit-con" style="margin-top: 20px;">
	            ...
	            <div class="activity" data-right-edit data-id="2">
	                ...
	                <div class="color-set-box" style="float:left;margin: 25px 0;width: 100%;">
	                    <label class="label-name" style="font-size: 16px;font-weight: bold;float: left;">折叠菜单图标（80*80）：</label>
	                    <div class="right-color" style="float: left;width: 80px;">
	                        <div class="cropper-box" style="width: 100%;" data-width="80" data-height="80" >
	                            <img style="margin: inherit!important; width: 100%;" src="<{if $zdIcon}><{$zdIcon}><{else}>/public/manage/img/zhanwei/zw_fxb_45_45.png<{/if}>" width=15%>
	                            <input type="hidden" id="applet-logo"  class="avatar-field bg-img" id="cd-bg-img" name="applet-logo" value="<{if $zdIcon}><{$zdIcon}><{/if}>"/>
	                        </div>
	                    </div>
	                    <div style="float: left;">
	                        <a href="javascript:;" id="del-zdcdtb" style="color: #00ABFB; padding: 0 0 0 10px; line-height: 80px;">删除</a>
	                    </div>
	                </div>
	
	                <div ui-sortable ng-model="footNavs.list" style="margin-top: 150px;">
	                    <div class="activity-manage" ng-repeat="fenleiNav in fenleiNavs track by $index">
	                ...
	                <div class="isOn" style="overflow: hidden">
	                    ...
	                    <span class='tg-list-item' style="width: 82%;float: right;margin-bottom: 10px;">
	                        ...
	                        <label class='tgl-btn' for='menu_start'></label>
	                          <span style="color: red;font-size: 14px;float: left;margin-top:-25px;margin-left:70px;">注:该模块在选择固定首页模板时显示，启用自定义首页模板则不显示（自定义左边组件库组件可实现该效果）</span>
	                    </span>
	                </div>
	                ...
	                <div ui-sortable ng-model="indexNavs">
	                    <div class="activity-manage" ng-repeat="indexNav in indexNavs track by $index">
	                        ...
	                        <div class="edit-txt">
	                            <div class="input-group-box clearfix">
	                                <label for="">菜单名称：</label>
	                                <input type="text" class="cus-input" minlength="1" maxlength="5" ng-model="indexNav.title">
	                            </div>
	                            <div class="input-group-box clearfix">
	                                <label for="">链接类型：</label>
...
//        }
    ...
    //删除菜单图标
    $('#del-zdcdtb').on('click',function(){
        var _this = this;
        var index = layer.confirm('删除该图标后将使用默认图标，确认要删除？', {
            btn: ['确认', '取消']
        }, function(){
            layer.closeAll();
            $(_this).parent().siblings('.right-color').find('input').val('').siblings('img').attr('src','/public/manage/img/zhanwei/zw_fxb_45_45.png');
        });
    });
