            ...
            <div class="header-top" data-right-edit data-id="0" style="display:block;">
                ...
                <div class="top-manage">
                 ...
                 <!--    <div class="input-group">
                    ...
                    <{if $shopType eq 6 || $shopType eq 8}>
                    <div class="input-group">
...
<script>
    ...
    app.controller('chCtrl', ['$scope','$http','$timeout',function($scope,$http,$timeout){
        $scope.headerTitle= "<{$tpl['ali_title']}>" ? "<{$tpl['ali_title']}>" : "微秒杀" ;
        $scope.isopen     = '<{$tpl['ali_isopen']}>';
        $scope.showcoupon = '<{$tpl['ali_show_coupon']}>';
        $scope.applyTitle     = '<{$tpl['ali_apply_title']}>';
        $scope.banners = <{$slide}>;
