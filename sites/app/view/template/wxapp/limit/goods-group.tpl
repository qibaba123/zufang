            ...
            <div class="table-responsive" id="content-con">
                <table id="sample-table-1" class="table table-hover table-button">
                    ...
                    <tr>
                        ...
                        <th class="hidden-480">关联<{$goodsName}></th>
                        <th>
                    ...
                    <{foreach $list as $key => $val}>
                        <tr id="tr_<{$val['alg_id']}>" <{if ($key % 2 == 1)}>class="info"<{else}><{/if}>>
                            <td id="name_<{$val['alg_id']}>"><{$val['alg_name']}></td>
                            <td>
                                <{$val['alg_total']}>
                                <div class="pull-right" style="font-size:0">
                                    <{if $val['alg_total'] > 0}>
                                    <a class="btn btn-xs btn-success btn-goods" href="javascript:;" data-mk="look" data-id="<{$val['alg_id']}>">查看</a>
                                    <{/if}>
                                    <a class="btn btn-xs btn-info btn-goods" href="javascript:;" data-mk="add"  data-id="<{$val['alg_id']}>">增加关联</a>
                                </div>
                            </td>
                            <td><{date('Y-m-d H:i',$val['alg_create_time'])}></td>
                            <td style="color:#ccc;">
                                <a class="btn-group" href="javascript:;" data-mk="edit" data-id="<{$val['alg_id']}>" data-name="<{$val['alg_name']}>" data-style="<{$val['alg_list_type']}>" data-img="<{$val['alg_bg']}>" data-brief="<{$val['alg_brief']}>">编辑</a>
                                -
                                <a class="btn-group" href="javascript:;" data-mk="del" data-id="<{$val['alg_id']}>" style="color:#f00;">删除</a>

                                <!--
                                - <a href="javascript:;" id="link_<{$val['alg_id']}>" class="btn-link" data-link="<{$val['link']}>">链接</a>
-->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h3 class="modal-title" style="font-size: 18px"><{$goodsName}>分组</h3>
                </div>
    ...
    <div id="goods-modal"  class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">关联<{$goodsName}></h4>
                </div>
                <div class="modal-body">
                    <div class="good-search">
                        <div class="input-group">
                            <input type="text" id="keyword" class="form-control" placeholder="搜索<{$goodsName}>">
                        <span class="input-group-btn">
                    ...
                    <table  class="table-responsive">
                        ...
                        <tr>
                            <th><{$goodsName}>图片</th>
                            <th style="text-align:left"><{$goodsName}>名称</th>
