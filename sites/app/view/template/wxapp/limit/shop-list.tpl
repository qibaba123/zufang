                        ...
                        <{foreach $list as $val}>
                            <tr id="tr_<{$val['la_id']}>">
                                ...
                                <td>
                                    <p>
                                        <{if !$val['la_index_show']}>
                                        <a href="javascript:;"  onclick="changeShow(1, <{$val['la_id']}>)">展示</a> -
                                        <{else}>
                                        <a href="javascript:;" style="color: red;" onclick="changeShow(0, <{$val['la_id']}>)">不展示</a> -
                                        <{/if}>
