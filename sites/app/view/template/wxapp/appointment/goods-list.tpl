                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <select name="kind" class="form-control">
                                    ...
                                    <option value="<{$key}>" <{if $key eq $kind}>selected<{/if}>><{$val}></option>
                                    <{/foreach}>
                                </select>
                            </div>
                        </div>
                    ...
                    <table class="table table-hover table-avatar">
                        <thead>
                            <tr>
                                ...
                                -->
                                <{if !in_array($menuType,['aliapp','bdapp','toutiao'])}>
                                <th>是否已推送</th>
                                <{/if}>
                                <th>操作</th>
                            </tr>
                        ...
                        <{foreach $list as $val}>
                            <tr id="tr_<{$val['g_id']}>">
                                ...
                                <td class="proimg-name" style="min-width: 270px;">
                                    ...
                                    <img src="<{$val['g_cover']}>" width="144px" height="82px" alt="封面图">
                                    <{/if}>
                                    <div>
                                        <p class="pro-name">
                                        ...
                                        <p class="pro-price"><{if $val['g_price'] > 0}><{$val['g_price']}><{else}>免费<{/if}></p>
                                        <p>
                                ...
                                <td><{$category_select[$val['g_appointment_kind']]}></td>
                                <!--
                                <td>
                                    <{if $val['g_is_top'] eq 1}>
                                    <span class="label label-sm label-success">首页推荐</span>
                                ...
                                -->
                                <td><{$val['g_appointment_length']}></td>
                                <td><{$val['g_appointment_time']}></td>
                                <td><{$val['g_appointment_date']}></td>
                                <!--
                                ...
                                <td style="color:#ccc;">
                                    <{if !in_array($menuType,['aliapp','bdapp','toutiao','qq','qihoo'])}>
                                	<p>
                                        <a href="javascript:;" onclick="pushAppointment('<{$val['g_id']}>')" >推送</a> -
                                        <{if !in_array($menuType,['weixin'])}>
                                        <a href="javascript:;" data-toggle="modal" data-target="#tplPreviewModal" onclick="showPreview('<{$val['g_id']}>')">预览</a> -
                                        <{/if}>
                                        <a href="/wxapp/tplpreview/pushHistory?type=appointment&id=<{$val['g_id']}>" >记录</a>
                                    </p>
                                    <{/if}>
                                    <p>
                                        <a href="/wxapp/appointment/addGood?id=<{$val['g_id']}>" >编辑</a> -
                            ...
                            <tr><td colspan="2">
                                    ...
                                    <{/if}>
                                </td><td colspan="10" style="text-align:right"><{$paginator}></td></tr>
                        </tbody>
                    </table>
                </div>
            </div>
