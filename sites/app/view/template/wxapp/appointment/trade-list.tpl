...
<div class="trade-list">
	<table class="ui-table-order" style="padding: 0px;">
			...
			<td colspan="2" class="text-right">
				<div class="order-opts-container">
					<div class="js-opts" style="display: block;">
						<a href="/wxapp/appointment/tradeDetail?order_no=<{$val['t_tid']}>" class="new-window" >查看详情</a> 
		...
		<tr class="content-row">
			...
			<td class="title-cell">
				<p class="goods-title">
					<a href="/wxapp/appointment/tradeList?title=<{$val['t_title']}>"class="new-window" title="<{$val['t_title']}>">
						<{$val['t_title']}>
					</a>
				</p>
				<p>
			...
			<td class="aftermarket-cell" rowspan="1">
				...
				<a href="/wxapp/appointment/tradeRefund?order_no=<{$val['t_tid']}>&&tradeType=appo" class="new-window" >处理维权</a>
				<{/if}>
			</td>
			<td class="customer-cell" rowspan="1">
				<p>
					<a href="/wxapp/appointment/tradeList?buyer=<{$val['t_buyer_nick']}>" class="new-window" target="_blank">
						<{$val['t_buyer_nick']}>
					</a>
				</p>
				<!--
			...
			<td class="time-cell" rowspan="1">
				<div class="td-cont">
					<{date('Y-m-d H:i:s',$val['t_appointment_time'])}>
				</div>
			</td>
			-->
			<td class="time-cell" rowspan="1">
				...
				<div class="td-cont text-center">
					<div>
						...
						<p class="user-name"  style="margin-top: 10px">
							<{if ($val['t_status'] == 2 || $val['t_status'] == 3 || $val['t_status'] == 4) && $val['t_payment'] > 0}>
