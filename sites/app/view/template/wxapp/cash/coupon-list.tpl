...
<a href="/wxapp/coupon/add&cash=cash" class="btn btn-green btn-xs"><i class="icon-plus bigger-80"></i> 新增</a>
<a href="javascript:;" class="btn btn-green btn-xs btn-excel" ><i class="icon-download"></i>统计数据导出</a>
<a href="/wxapp/coupon/couponType" class="btn btn-green btn-xs">优惠券配置</a>
<{if $couponCenter == 1}>
...
<div class="page-header search-box">
    <div class="col-sm-12">
        <form action="/wxapp/coupon/cash" method="get" class="form-inline">
                        ...
                        <tr class="tr-content">
                            ...
                            <td style="color:#ccc;">
                                <p>
                                    ...
                                    <{else}>
                                    <a href="/wxapp/coupon/receive/cid/<{$val['cl_id']}>/&cash=cash" >领取明细</a> -
                                    <{/if}>
...
<script type="text/javascript">
    ...
    function fetchGoodsHtml(data){
        ...
        for(var i=0 ; i < data.length ; i++){
            var ava = data[i].m_avatar;
            if(!ava) {
                ava = '/public/wxapp/images/member.png';
            }

            html += '<tr id="member_tr_'+data[i].m_id+'">';
            html += '<td><img src="'+ava+'"/></td>';
