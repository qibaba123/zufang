                                ...
                                <li style="width: 100%;max-width: inherit">
                                    <div class="state-box" style="height: 60px;">
                                        ...
                                        <label id="choose-onoff" class="choose-onoff">
                                            <input name="sms_start" class="ace ace-switch ace-switch-5" id="sendOpen" data-type="open" onchange="changeLegworkOpen()" type="checkbox" <{if $sendCfg && $sendCfg['aolc_open']}> checked<{/if}>>
                                            <span class="lbl"></span>
                                        </label>
                                    </div>
                                    <div class="state-box">
                                        <span>绑定appid：</span>
                                        <input type="text" id="appid" style="display: inline-block;width: 300px;" class="form-control" name="appid" value="<{if $sendCfg['aolc_appid']}><{$sendCfg['aolc_appid']}><{/if}>">
                                        <span class="tips">请填写绑定跑腿小程序的appid</span>
                                    </div>
                                    <div class="state-box">
                                        <span>当前绑定：</span>
                                        <span style="color:blue;"><{$bindName}></span>
                                    </div>
                                    <div class="state-box" style="margin-top: 10px">
                                        ...
                                        <div class="section-box">
                                            ...
                                            <div class="section-item">运费<input type="number" class="form-control section-min" value="<{$item['min']}>">元至<input type="number" class="form-control section-max" value="<{$item['max']}>">元，补贴<input type="number" class="form-control section-value" value="<{$item['value']}>">元<button class="btn btn-xs btn-danger remove-section" onclick="removeSection(this)" style="margin-left: 20px">删除</button>
                                            </div>
                                            <{/foreach}>
                                        </div>
                                    </div>
