...
<section class="custom-tempwrap">
    ...
    <section class="bottom-part">
        <div class="left-component">
            ...
            <{if $appletCfg['ac_type'] != 3 && $appletCfg['ac_type'] != 30 && $appletCfg['ac_type'] != 28 && $appletCfg['ac_type'] != 36}>
            <div class="component-area-title">
                <div class="component-title">
                        ...
                        <div class="ui-widgets-item" data-left-preview ng-repeat="component in showComponentData track by $index" setclick data-type="{{component.type}}" data-id="{{$index}}">
                            ...
                            <div class="shop-component" ng-if="component.type=='shoplist'">
                                ...
                                <div class="shop-list style{{component.shopStyle}}" stylesheet style="{{component.style}}" ng-if="component.getType!=3">
                                    <{if $appletCfg['ac_type'] == 6 && $appletCfg['ac_s_id'] == 4546}>
            ...
            <div class="tab-con-wrap">
                <div class="tab-con-item" data-type="set1" style="display: block;">
                    <div data-right-edit data-id="-1" style="display: block;">
                        ...
                        <{if $appletCfg['ac_type'] == 6 || $appletCfg['ac_type'] == 3}>
                        <div class="input-group-box">
                ...
                <div class="tab-con-item" data-type="set2">
                    ...
                    <div ng-repeat="component in showComponentData track by $index" data-right-edit data-id="{{$index}}">
                        ...
                        <div class="good-set" ng-if="component.type=='goodlist'">
                            ...
                            <div class="input-group-box" <{if !in_array($appletCfg['ac_type'],[8])}> style="display:none" <{/if}> >
                        ...
                        <div class="good-set" ng-if="component.type=='shoplist'">
                            ...
                            <{if $appletCfg['ac_type'] != 33 && $appletCfg['ac_type'] != 6}>
                            <div class="input-group-box" ng-if="component.shopStyle!=3">
                            ...
                            <{/if}>
                            <{if $appletCfg['ac_type'] != 6 && $appletCfg['ac_type'] != 33}>
                            <div class="input-group-box">
...
<script>
    ...
    app.controller('custempCtrl', ['$scope', '$http', '$timeout', function($scope, $http, $timeout) {
        ...
        $scope.headerTitle          = '<{$headerTitle}>'?'<{$headerTitle}>':'自定义模板';
        $scope.showpostlist         = <{$showpostlist}>?<{$showpostlist}>:false;
        $scope.showpostbtn          = <{$showpostbtn}>?<{$showpostbtn}>:false;
        $scope.pagebgColor          = '<{$pagebgColor}>'?'<{$pagebgColor}>':'#f3f4f5';
        ...
        $scope.recommendTypeList    = <{$recommendTypeList}>;
        $scope.mealActivityList     = <{$mealActivityList}>;
        ...
        $scope.goodsActivityList=<{$goodsActivityList}>;
        <{/if}>
        //console.log('类型类型类型'+<{$ac_type_aaa}>);

        $scope.goodSourceType       = <{$goodSourceType}>;
        $scope.shoplist             = <{$shoplist}>;
        $scope.storelist            = <{$storelist}>;
        $scope.shopKindSelect       = <{$shopKindSelect}>;
        $scope.browseNum            = '<{$community['aci_browse_num']}>';
        $scope.issueNum             = '<{$community['aci_issue_num']}>';
        $scope.shopNum              = '<{$community['aci_shop_num']}>';
        $scope.addMemberNum         = '<{$community['aci_add_member']}>';
        $scope.statIcon             = '<{$community['aci_stat_icon']}>' ? '<{$community['aci_stat_icon']}>' : '/public/wxapp/customtpl/images/icon_tj.png';
        ...
        $scope.carShopKindList      = <{$carShopKindList}>;
        $scope.postType             = <{$tpl['aci_post_type']}>;
        $scope.carCfg               = <{$carCfg['acc_index_tab']}>;
        ...
        $scope.positionType         = <{$jobTpl['aji_position_type']}>;
        ...
        $scope.articleCoverType     = "<{$articleCoverType}>";
        $scope.audioCoverType       = "<{$audioCoverType}>";
        $scope.videoCoverType       = "<{$videoCoverType}>";
        $scope.lessonType           = <{$lessonType}>;
        $scope.limitGoodsGroup      = <{$limitGoodsGroup}>
        $scope.menuList      = <{$menuList}>
        //基础组件
        var componentData = <{$baseComponent}>;
        var cityCategory = <{$cityCategory}>;
        <{if $appletCfg['ac_type'] == 6}>
        componentData[2]['flitems'] =cityCategory;
        <{/if}>
        //营销组件
        var marketComponent = <{$marketComponent}>

        $scope.showComponentData = <{$template}>;
...
<{include file="../customtpl-img-upload-modal.tpl"}>
<{include file="../goods-select-modal.tpl"}>
<{include file="../information-select-modal.tpl"}>
<{include file="../coupon-select-modal.tpl"}>
<{include file="../group-select-modal.tpl"}>
<{include file="../seckill-select-modal.tpl"}>
<{include file="../bargain-select-modal.tpl"}>
<{include file="../points-select-modal.tpl"}>
<{include file="../shop-select-modal.tpl"}>
<{include file="../store-select-modal.tpl"}>
<{include file="../car-select-modal.tpl"}>
</body>
