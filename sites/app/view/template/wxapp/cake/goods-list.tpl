...
<div  id="content-con" >
    ...
    <a href="/wxapp/cake/addGood" class="btn btn-green btn-xs"><i class="icon-plus bigger-80"></i> 新增</a>
    ...
    <div class="page-header search-box">
        <div class="col-sm-12">
            <form action="/wxapp/cake/goods" method="get" class="form-inline">
                        ...
                        <{foreach $list as $val}>
                            <tr id="tr_<{$val['g_id']}>">
                                ...
                                <td class="jg-line-color">
                                    ...
                                    <p>
                                    	<a href="/wxapp/cake/addGood/?id=<{$val['g_id']}>" >编辑</a> -
