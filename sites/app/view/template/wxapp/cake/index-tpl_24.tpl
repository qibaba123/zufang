...
<link rel="stylesheet" href="/public/wxapp/cake/template/temp3/css/index.css?2">
<link rel="stylesheet" href="/public/wxapp/cake/template/temp3/css/style.css?4">
<style>
    .fenleinav-manage{
        padding: 10px;
        ...
        <div class="mobile-con">
            ...
            <div class="index-con">
                ...
                <div class="index-main">
                    ...
                    <div class="top-img cur-edit" data-left-preview data-id="4" style="margin:10px 0">
                        <img ng-src="{{img==''?'/public/wxapp/card/certificate/images/zhanwei_750_225.jpg':img}}" alt="报名封面图" style="width: 100%" />
                    </div>

                    <div class="goods-part recommend" data-left-preview data-id="5">
                        <div class="title">—· {{shortcutTitle}} ·—</div>
                        <ul class="good-list">
                            <li class="good" ng-repeat="good in special">
                                <div class="good-box">
                                    <img src="{{good.cover}}" alt="" class="good-cover">
                                    <div class="good-name text">{{good.name}}</div>
                                    <div class="good-brief text">{{good.brief}}</div>
                    ...
                    <div class="goods-part goods" data-left-preview data-id="6">
                        ...
                        <div class="good" ng-repeat="good in goods">
                            <div class="good-box">
                                ...
                                <div class="good-name text">{{good.name}}</div>
                                <div class="good-brief text">{{good.brief}}</div>
                                <div class="good-price text" style="color: red;font-size: 14px;">￥{{good.price}}<del>￥{{good.oriPrice}}</del></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="edit-right">
        <div class="edit-con">
            ...
            <div class="fenleinav" data-right-edit data-id="3" ui-sortable ng-model="fenleiNavs">
                <label style="width: 100%">分类导航<span>(分类超过8个向右滑动，此处不做展示，图标尺寸200*200)</span></label>
            ...
            <div class="coursepart" data-right-edit data-id="4">
                <label>图片<span>（图片建议尺寸750px*220px）</span></label>
                <div class="hornor-covers-manage">
                    <div class="edit-img">
                        <!--<div class="cropper-box" data-width="750" data-height="220" style="height:100%;">
                            <img ng-src="{{img?img:'/public/wxapp/card/certificate/images/zhanwei_750_225.jpg'}}"  onload="changeSrc(this)"  imageonload="changeBg()" alt="图片" style="width: 100%">
                        </div>-->
                        <div>
                            <img onclick="toUpload(this)"  data-limit="1" onload="changeSrc(this)" data-width="750" data-height="220" imageonload="changeBg()" data-dom-id="upload-img" id="upload-img{{$index}}"  ng-src="{{img?img:'/public/wxapp/card/certificate/images/zhanwei_750_225.jpg'}}"  width="100%" style="display:inline-block;margin-left:0;">
...
<script>
    ...
    app.controller('chCtrl', ['$scope','$http','$timeout',function($scope, $http, $timeout){
        ...
        $scope.shortcutTitle   = '<{$tpl['aci_shortcut_title']}>' ? '<{$tpl['aci_shortcut_title']}>' : '今日特价';
        $scope.goodsTitle      = '<{$tpl['aci_goods_title']}>' ? '<{$tpl['aci_goods_title']}>' : '今日推荐';
