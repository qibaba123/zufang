...
<link rel="stylesheet" href="/public/wxapp/cake/template/temp6/css/index.css?2">
<link rel="stylesheet" href="/public/wxapp/cake/template/temp6/css/style.css?3">
<style>
    .fenleinav-manage{
        padding: 10px;
                    ...
                    <div class="goods-part goods" data-left-preview data-id="6">
                        ...
                        <div class="good" ng-repeat="good in goods">
                            <div class="good-box">
                                ...
                                <div class="good-name text" style="font-size: 12px;color: #999">{{good.brief}}</div>
                                <div class="good-price text" style="font-size: 14px;color: red">{{good.price}}元起<span style="font-size: 12px;color: #aaa;display: inline-block;margin-left: 10px;font-weight: 100;">已有{{good.sold}}使用</span></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="edit-right">
        <div class="edit-con">
            ...
            <div class="fenleinav" data-right-edit data-id="3" ui-sortable ng-model="fenleiNavs">
                ...
                <div class="fenleinav-manage nav-box" ng-repeat="fenleiNav in fenleiNavs">
            ...
            <div class="brands" data-right-edit data-id="5">
                ...
                <div class="fenleinav-manage" ng-repeat="brand in brands">
                    ...
                    <div class="edit-img">
                        ...
                        <div>
                            <img onclick="toUpload(this)"  data-limit="8" onload="changeSrc(this)" data-width="750" data-height="510" imageonload="doThis('brands',brand.index)" data-dom-id="upload-brand{{$index}}" id="upload-brand{{$index}}"  ng-src="{{brand.imgsrc}}"  height="100%" style="display:inline-block;margin-left:0;">
...
<script>
    ...
    app.controller('chCtrl', ['$scope','$http','$timeout',function($scope, $http, $timeout){
        ...
        $scope.shortcutTitle   = '<{$tpl['aci_shortcut_title']}>' ? '<{$tpl['aci_shortcut_title']}>' : '门店展示';
        $scope.goodsTitle      = '<{$tpl['aci_goods_title']}>' ? '<{$tpl['aci_goods_title']}>' : '服务项目';
        ...
        $scope.addNewBrand = function(){
            ...
            var brands_Default = {
                index: defaultIndex,
                imgsrc: '/public/wxapp/train/images/zhanwei_750_510.png',
            };
