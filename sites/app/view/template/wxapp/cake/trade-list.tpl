...
<div class="page-header search-box">
	<div class="col-sm-12">
		<form class="form-inline" action="/wxapp/cake/tradeList" method="get">
...
<div class="choose-state">
	...
	<a href="/wxapp/cake/tradeList?status=<{$key}>" <{if $status && $status eq $key}>class="active"<{/if}>><{$val['label']}></a>
	<{/foreach}>
</div>
	...
	<table class="ui-table-order" style="padding: 0px;">
		<thead class="js-list-header-region tableFloatingHeaderOriginal" style="position: static; top: 0px; margin-top: 0px; left: 225px; z-index: 1; width: 794px;">
		    <tr class="widget-list-header">
		        ...
		        <th class="price-cell" style="min-width: 87px; max-width: 87px;">配送方式</th>
		        <th class="price-cell" style="min-width: 121px; max-width: 121px;">取货/送达时间</th>
			...
			<td colspan="2" class="text-right">
				<div class="order-opts-container">
					<div class="js-opts" style="display: block;">
						<a href="/wxapp/cake/tradeDetail?order_no=<{$val['t_tid']}>" class="new-window" >查看详情</a> 
		...
		<tr class="content-row">
			...
			<td class="title-cell">
				<p class="goods-title">
					<a href="/wxapp/cake/tradeList?title=<{$val['t_title']}>"class="new-window" title="<{$val['t_title']}>">
						<{$val['t_title']}>
					</a>
				</p>
				<p>
			...
			<td class="aftermarket-cell" rowspan="1" style="min-width: 110px">
				<{if $val['t_express_method'] == 1}>
				专人配送
				<{elseif $val['t_express_method'] == 3}>
				快递发货
				<{else}>
				门店自取
				<div style="padding-top: 15px;"><{$val['os_name']}></div>
				<{/if}>
			</td>
			<td class="aftermarket-cell" rowspan="1">
				<{date("Y-m-d", $val['t_receive_start_time'])}> 
				<{date("H:i", $val['t_receive_start_time'])}>~
				<{date("H:i", $val['t_receive_end_time'])}>
			</td>
			<td class="aftermarket-cell" rowspan="1">
			...
			<td class="customer-cell" rowspan="1">
				<p>
					<a href="/wxapp/cake/tradeList?buyer=<{$val['t_buyer_nick']}>" class="new-window" target="_blank">
						<{$val['t_buyer_nick']}>
					</a>
				</p>
				<{if $val['t_express_method'] == 1}>
				...
				<div class="td-cont text-center">
					<div>
						...
						<span id="refund_<{$val['t_tid']}>" class="btn btn-primary btn-xs refund-btn"
							...
							<{if $val['t_status'] == 4 || ($val['t_status'] == 3 && $val['t_express_method'] == 2)}>
