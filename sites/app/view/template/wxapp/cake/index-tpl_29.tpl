...
<link rel="stylesheet" href="/public/wxapp/cake/template/temp5/css/index.css?2">
<link rel="stylesheet" href="/public/wxapp/cake/template/temp5/css/style.css?4">
<style>
    .fenleinav-manage{
        padding: 10px;
            ...
            <div class="index-con">
                ...
                <div class="index-main">
                    ...
                    <div class="new-activity" data-left-preview data-id="4" style="margin:10px 0">
                        <div class="no-nav" ng-if="activityList.length<=0">
                            点击添加~
                        </div>
                        <div class="new-info" ng-repeat="activity in activityList" ng-if="activityList.length>0">
                    ...
                    <div class="goods-part goods" data-left-preview data-id="6">
                        ...
                        <div class="good" ng-repeat="good in goods">
                            <div class="good-box">
                                ...
                                <div class="good-price text" style="font-size: 14px;text-align: center">￥{{good.price}}</div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="edit-right">
        <div class="edit-con">
            ...
            <div class="coursepart" data-right-edit data-id="4">
                <label style="width: 100%"><span>(图标尺寸750*400)</span></label>
                <div class="fenleinav-manage" ng-repeat="activity in activityList">
                    ...
                    <div class="edit-txt">
                        ...
                        <div class="input-group clearfix">
                            <label for="">链接到：</label>
                            <select class="form-control" ng-model="activity.articleTitle" ng-options="x.name as x.name for x in categoryGoods" ng-change="getActivityId(activity.index,activity.articleTitle)"></select>
                        </div>
                        -->
                        <div class="input-group-box clearfix">
                            <label for="">链接类型：</label>
            ...
            <div class="brands" data-right-edit data-id="5">
                <div class="input-groups">
                    ...
                    <span>(超过向右滑动，此处不做展示，图标尺寸200*200)</span>
                </div>
...
<script>
    ...
    app.controller('chCtrl', ['$scope','$http','$timeout',function($scope, $http, $timeout){
        ...
        $scope.shortcutTitle   = '<{$tpl['aci_shortcut_title']}>' ? '<{$tpl['aci_shortcut_title']}>' : '流行趋势';
        $scope.goodsTitle      = '<{$tpl['aci_goods_title']}>' ? '<{$tpl['aci_goods_title']}>' : '热卖单品';
        ...
        $scope.getActivityId = function(index,title){
            var realIndex=-1;
            /*获取要删除的真正索引*/
            realIndex = $scope.getRealIndex($scope.activityList,index);
            var categoryGoods = $scope.categoryGoods;
            var curId = '';
            for(var i in categoryGoods){
                if(categoryGoods[i].name == title){
            ...
            $scope.activityList[realIndex].articleId = curId;
