    ...
    <div class="app-init-container">
        ...
        <div class="content-region clearfix">
        	<div class="info-region">
        	    ...
        	    <table class="info-table">
        	        <tbody>
        	            ...
        	            <tr>
        	                <th>买家：</th>
        	                <td><a href="/wxapp/cake/tradeList?buyer=<{$row['t_buyer_nick']}>" class="new-window" ><{if $row}><{$row['t_buyer_nick']}><{/if}></a></td>
        	            </tr>
        	        </tbody>
        	    </table>
        	    ...
        	    <table class="info-table">
        	        <tbody>
                        ...
                        <tr>
                            <th>取货/送达时间：</th>
                            <td>
                            <{date("Y-m-d", $row['t_receive_start_time'])}> 
                            <{date("H:i", $row['t_receive_start_time'])}>~
                            <{date("H:i", $row['t_receive_end_time'])}>
                            </td>
                        </tr>
        	            <tr>
                            <{if $row['t_express_method'] == 1}>
        	...
        	<div class="state-region">
        	    <div style="padding: 0px 0px 30px 40px;">
                    ...
                    <{if $needSend && $row['t_express_method'] == 1}>
                    <div class="state-btn">
        ...
        <table class="ui-table ui-table-simple goods-table">
            ...
            <tr>
                ...
                <{/foreach}>
                <{/if}>
                    <{if $row['t_post_fee'] && $row['t_express_method'] == 1}>
                    <p class="text-right">
