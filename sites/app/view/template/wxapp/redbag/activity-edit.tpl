...
<div class="payment-style" ng-app="chApp" ng-controller="chCtrl" style="margin-left: 150px">
    <div class="payment-block-body js-wxpay-body-region" style="display: block;">
        <input type="hidden" id="hid_id" value="<{if $row['ara_id']}><{$row['ara_id']}><{else}>0<{/if}>">
        <div class="row">
            ...
            <div class="form-group col-sm-10">
                <div class="radio-box">
                    <span>
                        <input type="radio" name="status" id="recommend1" value="1" <{if $row && $row['ara_status'] eq 1}>checked<{/if}>>
                        <label for="recommend1">是</label>
                    </span>
                    <span>
                        <input type="radio" name="status" id="recommend2" value="2"  <{if !($row && $row['ara_status'] eq 1)}>checked<{/if}>>
       ...
       <div class="row">
        ...
        <div class="form-group col-sm-10">
            <input type="text" class="form-control" id="activityName" name="activityName" placeholder="请填写活动名称" value="<{if $row}><{$row['ara_name']}><{/if}>" style="width:15%;display: inline-block">
        </div>
       </div>
        <div class="row">
            <div class="form-group col-sm-2 text-right" style="width: 135px;text-align: left;padding-left: 20px">
            ...
            <div class="form-group col-sm-10">
                <input type="number" class="form-control" id="money" name="money" placeholder="请填写活动奖励" value="<{if $row}><{$row['ara_money']}><{/if}>" style="width:15%;display: inline-block" <{if $row['ara_id']}> disabled="disabled" <{/if}>>
                <span>元</span>
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-10">
                <input type="number" class="form-control" id="num" name="num" placeholder="请填写组队人数" value="<{if $row}><{$row['ara_num']}><{/if}>" style="width:15%;display: inline-block" <{if $row['ara_id']}> disabled="disabled" <{/if}>>
                <span>人</span>
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-10">
                <input type="number" class="form-control" id="limit" name="limit" placeholder="请填写每人每日组队次数" value="<{if $row}><{$row['ara_limit']}><{/if}>" style="width:15%;display: inline-block" >
                <span></span>
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-10">
                <input type="number" class="form-control" id="limit_total" name="limit_total" placeholder="请填写每人总组队次数" value="<{if $row}><{$row['ara_limit_total']}><{/if}>" style="width:15%;display: inline-block" >
                <span></span>
                <span class="input-tip">不填或填0为无限制</span>
            </div>
        </div>
        <div class="row">
            ...
            <div class="form-group col-sm-10">
                <input type="number" class="form-control" id="limit_group" name="limit_group" placeholder="请填写总组队次数" value="<{if $row}><{$row['ara_limit_group']}><{/if}>" style="width:15%;display: inline-block" >
                <span></span>
                <span class="input-tip">不填或填0为无限制</span>
            </div>
        </div>
        <div class="row">
            ...
            <div class="form-group col-sm-10">
                <input type="number" class="form-control" id="hour" name="hour" placeholder="请填写组队时间" value="<{if $row}><{$row['ara_hour']}><{/if}>" style="width:15%;display: inline-block" <{if $row['ara_id']}> disabled="disabled" <{/if}>>
                <span>小时</span>
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-10">
                <input type="text" class="form-control" id="share_title" name="share_title" placeholder="分享标题" value="<{if $row}><{$row['ara_share_title']}><{/if}>" style="width:60%;display: inline-block">
                <span></span>
                <span class="input-tip"></span>
            </div>
        </div>
        <div class="row">
            ...
            <div class="form-group col-sm-10">
                <div class="form-group col-sm-10" style="padding-left: 0">
                    <img onclick="toUpload(this)"   data-limit="1" data-width="500" data-height="400" data-dom-id="upload-shareImg" id="upload-shareImg"  src="<{if $row['ara_share_img']}><{$row['ara_share_img']}><{else}>/public/manage/img/zhanwei/zw_555_480.png<{/if}>"  height="100%" style="display:inline-block;height: 200px;margin: 0">
                    <input type="hidden" id="shareImg"  class="avatar-field bg-img" name="shareImg" ng-value="shareImg" value="<{if $row['ara_share_img']}><{$row['ara_share_img']}><{/if}>"/>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="form-group col-sm-10">
            <textarea class="form-control" style="height:250px;text-align: left; resize:vertical;width: 60%" id="rule" name="rule" placeholder="请填写活动规则"  rows="15"><{$row['ara_rule']}></textarea>
        </div>
    </div>
