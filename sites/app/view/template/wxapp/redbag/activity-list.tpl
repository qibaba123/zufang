                ...
                <div class="form-container">
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="activityName" value="<{$activityName}>"  placeholder="活动名称">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <table id="sample-table-1" class="table table-hover table-avatar">
                        ...
                        <{foreach $list as $val}>
                            <tr id="tr_<{$val['ara_id']}>">
                                ...
                                <td>
                                    <{date('Y-m-d H:i',$val['ara_update_time'])}>
                                </td>
                                <td class="jg-line-color">
                                    <p>
                                        <a href="/wxapp/redbag/activityEdit?id=<{$val['ara_id']}>" >编辑</a>
                                         - <a href="#" class="delete-shop" data-id="<{$val['ara_id']}>" style="color: red">删除</a>
                                         - <a href="javascript:;"  class="info-btn" id="msg_a_<{$val['ara_id']}>"
                                           data-id="<{$val['ara_id']}>"
                                           data-zdcg-msg="<{$val['ara_zdcg_msgid']}>" data-toggle="modal" data-target="#myMessageMuban"
                                        >模版消息</a>
                                    </p>
                                </td>
                            </tr>
