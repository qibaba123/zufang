                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <select name="status" id="status" class="form-control">
                                ...
                                <option value="3" <{if $status == 3}>selected<{/if}>>已失败</option>
                            </select>
                        </div>
                    </div>
                </div>
                    ...
                    <table id="sample-table-1" class="table table-hover table-avatar">
                        ...
                        <{foreach $list as $val}>
                            <tr id="tr_<{$val['arg_id']}>">
                                ...
                                <td>
                                    <{date('Y-m-d H:i',$val['arg_overtime_time'])}>
                                </td>
                                <td>
                                    <{date('Y-m-d H:i',$val['arg_create_time'])}>
                                </td>
                                <td>
                                    <p>
                                        <a href="/wxapp/redbag/groupDetail?groupId=<{$val['arg_id']}>" >查看详情</a>
                                    </p>
                                </td>
                            </tr>
                            <{/foreach}>
