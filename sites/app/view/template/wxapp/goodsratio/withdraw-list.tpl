...
<div  id="mainContent">
    ...
    <div class="balance clearfix" style="border:1px solid #e5e5e5;margin-bottom: 20px;">
        ...
        <div class="balance-info">
            ...
            <div class="balance-content">
                <span class="money">￥<{$statInfo['total_money']}></span>
            </div>
        </div>
        <div class="balance-info">
        ...
        <div class="balance-info">
            ...
            <div class="balance-content">
                <span class="money">￥<{$statInfo['total_dsh_money']}></span>
            </div>
        </div>
        ...
        <div class="balance-info">
            ...
            <div class="balance-content">
                <span class="money">￥<{$statInfo['total_ytg_money']}></span>
            </div>
        </div>
    ...
    <div ng-app="Withdraw"  ng-controller="WithdrawList">
        ...
        <div class="choose-state">
            <a href="/wxapp/goodsratio/withdraw" <{if !$audit}> class="active" <{/if}>>全部提现申请</a>
            <a href="/wxapp/goodsratio/withdraw?audit=audit" <{if $audit eq 'audit'}> class="active" <{/if}>>待审核</a>
            <a href="/wxapp/goodsratio/withdraw?audit=pass" <{if $audit eq 'pass'}> class="active" <{/if}>>已通过</a>
            <a href="/wxapp/goodsratio/withdraw?audit=refuse" <{if $audit eq 'refuse'}> class="active" <{/if}>>已拒绝</a>
        </div>
        <div class="row">
            <div class="col-xs-12">
