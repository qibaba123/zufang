...
<div class="video-box">
    <div style="text-align: center;margin-bottom: 30px;">
        <div class="isOn">
            ...
            <span class='tg-list-item'>
                            <input class='tgl tgl-light' id='music_is_open' type='checkbox' onclick="changeOpen()" <{if $row && $row['av_music_isopen']}>checked<{/if}> >
    ...
    <div class="cfg-box" <{if !$row || $row['av_music_isopen'] == 0}>style="display:none"<{/if}>>
    <div class="part1">
    	<div class="video-con " >
	        <{if $row && $row['av_music_url']}>
	        <audio style="width: 500px" class="playvideo" src="<{$row['av_music_url']}>?v=<{$smarty.now}>" preload="preload" controls="controls" loop="loop"></audio>
	        <{/if}>
	    </div>
	    <div class="btn-area " style="padding: 22px 0 10px 0;">
	        <span class="btn btn-md btn-green" onclick="toUpload()"><{if $row && $row['av_music_url']}>重新上传<{else}>添加音频<{/if}></span>
	    </div>
    </div>
    ...
    <div class="part2">
    	<div style="width: 545px;margin:0 auto;" class="">
	        ...
	        <input style="display: inline-block;width: 82%" type="text" id="music_title" value="<{$row['av_music_title']}>" class="form-control" placeholder="请填写音乐名称">
	    </div>
	    <div class="btn-area " style="width:600px;">
	        <span class="form-title">填写音频链接</span>
	        <input style="display: inline-block;width: 75%" type="text" id="video-url" value="<{$row['av_music_url']}>" class="form-control" placeholder="请填写音乐链接">
    ...
    <!--<div style="width: 640px;margin: auto;" class="">
        <span class="form-title" style="margin-right: 5px">填写音乐名称</span>
        <input style="display: inline-block;width: 75%" type="text" id="music_title" value="<{$row['av_music_title']}>" class="form-control" placeholder="请填写音乐名称">
    </div>
    <div class="btn-area ">
        <span class="form-title">填写音频链接</span>
        <input style="display: inline-block;width: 75%" type="text" id="video-url" value="<{$row['av_music_url']}>" class="form-control" placeholder="请填写音乐链接">
