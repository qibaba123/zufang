...
<div class="payment-style">
		...
		<div class="payment-block">
			<div class="payment-block-header js-wxpay-header-region">
				...
				<label id="choose-onoff" class="choose-onoff">
					<input class="ace ace-switch ace-switch-5" id="wxpay_ds" data-type="wxpay_ds" type="checkbox" <{if $payType['pt_wxpay_ds']}> checked<{/if}>>
					<span class="lbl"></span>
				</label>
			</div>
	...
	<div class="page-header" style="min-height: 50px">
		<div class="watermrk-show">
			...
			<div class="watermark-box">
				<input type="number" style="width: 60px" maxlength="2" class="form-control" id="wxpay_sort" value="<{$paySort['wxpay']}>" oninput="if(value.length>2)value=value.slice(0,2)">
		...
		<div class="watermrk-show">
			...
			<div class="watermark-box">
				<input type="number" style="width: 60px" maxlength="2" class="form-control" id="coin_sort" value="<{$paySort['coin']}>" oninput="if(value.length>2)value=value.slice(0,2)">
		...
		<div class="watermrk-show">
			...
			<div class="watermark-box">
				<input type="number" style="width: 60px" maxlength="2" class="form-control" id="cash_sort" value="<{$paySort['cash']}>" oninput="if(value.length>2)value=value.slice(0,2)">
		...
		<div class="watermrk-show">
			...
			<div class="watermark-box">
				<input type="number" style="width: 60px" maxlength="2" class="form-control" id="vcmwx_sort" value="<{$paySort['vcmwx']}>" oninput="if(value.length>2)value=value.slice(0,2)">
			</div>
		</div>
		...
		<div class="watermrk-show">
			...
			<div class="watermark-box">
				<input type="number" style="width: 60px" maxlength="2" class="form-control" id="vcmcoin_sort" value="<{$paySort['vcmcoin']}>" oninput="if(value.length>2)value=value.slice(0,2)">
		...
		<div class="payment-block">
			<div class="payment-block-header js-wxpay-header-region">
		        ...
		        <label id="choose-onoff" class="choose-onoff" style="left: 300px;">
		        	<input name="sms_start" class="ace ace-switch ace-switch-5" id="wxpay_applet" data-type="wxpay_applet" type="checkbox" <{if $payType['pt_wxpay_applet']}> checked<{/if}>>
		        	<span class="lbl"></span>
		        </label>
		    </div>
		    	...
		    	<div>
		    		<form action="">
		    			<div class="form-group">
		    			    ...
		    			    <div class="col-sm-10">
		    			        <input type="text" class="form-control" id="appid" value="<{if $applet_cfg && $applet_cfg['ac_appid']}><{$applet_cfg['ac_appid']}><{/if}>" data-msg="填写您的AppID，并保存" readonly placeholder="填写您的AppID">
		    			            <{if true}><p>微信小程序AppID</p><{else}>微信公众号AppID<{/if}>
		    			    </div>
		    			</div>
		    			<!---
		    			<div class="form-group">
		    			    ...
		    			    <div class="col-sm-10">
		    			        <input type="text" class="form-control" id="appsecret" value="<{if $appletPay}><{$appletPay['ap_appsecret']}><{/if}>" data-msg="填写您的AppleSecret，并保存" placeholder="填写您的AppleSecret">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="mchid" value="<{if $appletPay}><{$appletPay['ap_mchid']}><{/if}>" data-msg="填写您的支付商户号，并保存" placeholder="填写您的支付商户号">
								<p>请填写微信商户平台商户号</p>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10" style="position: relative;">
								<input type="password" class="form-control" id="mchkey" value="<{if $appletPay}><{$appletPay['ap_mchkey']}><{/if}>" data-msg="填写您的API秘钥，并保存" placeholder="请填写您的API秘钥">
								...
								<p>请填写微信商户平台的API秘钥<a href="https://bbs.tiandiantong.net/forum.php?mod=viewthread&tid=362&extra=page%3D1" target="_blank">查看教程</a>&nbsp;&nbsp;&nbsp;
									<!--
									<span style="display: inline-flex;"><span id="show-secretKey" style="background-color: #d3eafb;padding: 2px 5px;border-radius: 3px;color: #1f94e9;margin-right:6px;font-size: 13px;">生成秘钥</span><span id="secretKey" style="display: none;line-height: 28px;"><{$secretKey}></span></span>
									-->
								</p>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<div  class="form-control" style="position: relative;">
									<span><{if $appletPay && $appletPay['ap_sslcert']}> 已上传 <{else}> 未上传 <{/if}></span>
									...
									<input type="hidden" name="sslcert" id="sslcert" data-msg="填上传证书路径" value="<{if $appletPay}><{$appletPay['ap_sslcert']}><{/if}>">
								</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<div class="form-control" style="position: relative;">
									<span><{if $appletPay && $appletPay['ap_sslkey']}> 已上传 <{else}> 未上传 <{/if}></span>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
									<p><span style="display: inline-flex;"><span id="show-secretKey" style="background-color: #d3eafb;padding: 2px 5px;border-radius: 3px;color: #1f94e9;margin-right:6px;font-size: 13px;">生成秘钥</span><span id="secretKey" style="display: none;line-height: 28px;"><{$secretKey}></span></span></p>
								<p>此功能为商户平台辅助功能</p>
							</div>
						</div>
		    			<div class="form-group">
		...
		<div class="payment-block">
			<div class="payment-block-header js-wxpay-header-region">
				...
				<label id="choose-onoff" class="choose-onoff" style="left: 110px">
					<input name="alipay_applet" class="ace ace-switch ace-switch-5" id="alipay_applet" data-type="alipay_applet" type="checkbox" <{if $payType['pt_alipay_applet']}> checked<{/if}>>
					<span class="lbl"></span>
				</label>
			</div>
			<div class="payment-block-body js-wxpay-body-region">
	...
	<div class="payment-block-wrap" <{if $appletCfg['ac_type'] == 34 || $sequenceShowAll == 0}> style="display:none;"<{/if}>>
		<div class="payment-block">
			<div class="payment-block-header js-wxpay-header-region">
		        <h3>货到付款</h3>
		        <label id="choose-onoff" class="choose-onoff" style="left: 110px">
		        	<input name="cash" class="ace ace-switch ace-switch-5" id="cash" data-type="cash" type="checkbox" <{if $payType['pt_cash']}> checked<{/if}>>
		        	<span class="lbl"></span>
		        </label>
		    </div>
		    <div class="payment-block-body js-wxpay-body-region">
	...
	<div class="payment-block-wrap">
		<div class="payment-block">
			<div class="payment-block-header js-wxpay-header-region">
				<h3>余额支付</h3>
				<label id="choose-onoff" class="choose-onoff" style="left: 110px">
					<input name="coin" class="ace ace-switch ace-switch-5" id="coin" data-type="coin" type="checkbox" <{if $payType['pt_coin']}> checked<{/if}>>
					<span class="lbl"></span>
				</label>
			</div>
			<div class="payment-block-body js-wxpay-body-region">
	...
	<div class="payment-block-wrap">
		<div class="payment-block">
			<div class="payment-block-header js-wxpay-header-region">
				...
				<label id="choose-onoff" class="choose-onoff" style="left: 300px;">
				<input name="sms_start" class="ace ace-switch ace-switch-5" id="baidu_pay" data-type="baidu_pay" type="checkbox" <{if $payType['pt_baidu_pay'] || $appletCfg['ac_type'] == 32}> checked<{/if}>>
				<span class="lbl"></span>
				</label>
			</div>
			<div class="payment-block-body js-wxpay-body-region" style="display: block;">
				<div>
					<form action="">
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="dealid" value="<{if $baiduPay && $baiduPay['abp_dealid']}><{$baiduPay['abp_dealid']}><{/if}>" data-msg="填写您的百度支付配置的dealId，并保存" placeholder="填写您的支付配置的dealId">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="appkey" value="<{if $baiduPay}><{$baiduPay['abp_appkey']}><{/if}>" data-msg="填写您的支付APP KEY，并保存" placeholder="填写您的百度支付的APP KEY">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="position: relative;">
								<textarea type="text" rows="4" class="form-control" id="public_key" data-msg="百度支付的平台公钥，并保存" placeholder="百度支付的平台公钥"><{if $baiduPay && $baiduPay['abp_public_key']}><{$baiduPay['abp_public_key']}><{/if}></textarea>
								<p>百度支付的平台公钥</p>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<div  class="form-control" style="position: relative;">
									<span><{if $baiduPay && $baiduPay['abp_public_rsa_key']}> 已上传 <{else}> 未上传 <{/if}></span>
									...
									<input type="hidden" name="publicKey" id="public_rsa_key" data-msg="填上传证书路径" value="<{if $baiduPay}><{$baiduPay['abp_public_rsa_key']}><{/if}>">
								</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<div class="form-control" style="position: relative;">
									<span><{if $baiduPay && $baiduPay['abp_private_rsa_key']}> 已上传 <{else}> 未上传 <{/if}></span>
									...
									<input type="hidden" name="privateKey" id="private_rsa_key" data-msg="填上传秘钥路径" value="<{if $baiduPay}><{$baiduPay['abp_private_rsa_key']}><{/if}>">
								</div>
	...
	<div class="payment-block-wrap">
		<div class="payment-block">
			<div class="payment-block-header js-wxpay-header-region">
		        ...
		        <span class="tips-txt">支持信用卡付款</span>
		        <label id="choose-onoff" class="choose-onoff">
		        	<input name="alipay" class="ace ace-switch ace-switch-5" id="alipay" data-type="alipay" type="checkbox" <{if $payType['pt_alipay']}> checked<{/if}>>
		        	<span class="lbl"></span>
		        </label>
		    </div>
		    <div class="payment-block-body js-wxpay-body-region">
		    	...
		    	<div>
		    		<form action="">
		    						<div class="form-group">
		    							...
		    							<div class="col-sm-10">
		    								<input type="text" class="form-control" id="pid" value="<{if $alipay}><{$alipay['ap_pid']}><{/if}>" placeholder="填写合作者身份（PID）">
		    						...
		    						<div class="form-group">
		    							...
		    							<div class="col-sm-10">
		    								<input type="text" class="form-control" id="account" value="<{if $alipay}><{$alipay['ap_account']}><{/if}>" placeholder="填写您的支付宝账号">
		    								<p>请填写您的支付宝账号</p>
		    							</div>
		    						</div>
		    						<div class="form-group">
		    							...
		    							<div class="col-sm-10">
		    								<input type="text" class="form-control" id="key" value="<{if $alipay}><{$alipay['ap_key']}><{/if}>"  placeholder="填写您的安全校验码">
		    								<p>请填写您的安全校验码（Key）</p>
		    							</div>
		    						</div>
		    						<div class="form-group">
		    							...
		    							<div class="col-sm-10">
		    								<textarea class="form-control" id="ssl_pub" placeholder="填写您的合作支付宝公钥"><{if $alipay}><{$alipay['ap_ssl_pub']}><{/if}></textarea>
		    						...
		    						<div class="form-group">
		    							...
		    							<div class="col-sm-10">
		    								<textarea class="form-control" id="ssl_pri" placeholder="填写您的商户 RSA 私钥"><{if $alipay}><{$alipay['ap_ssl_pri']}><{/if}></textarea>
		    								<p>（非 PKCS8 编码）</p>
		    							</div>
		    						</div>
