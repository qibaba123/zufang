                ...
                <div class="table-responsive">
                    <table id="sample-table-1" class="table table-hover table-avatar" style="border: none">
                        ...
                        <{foreach $list as $val}>
                            <tr id="tr_<{$val['ap_id']}>">
                                <td>
                                    <img src="<{if $val['ap_path']}><{$val['ap_path']}><{else}>/public/manage/img/zhanwei/zw_fxb_350_425.png<{/if}>" style="width:80px" alt="">
                                </td>
                                <!--
                                <td>
                                ...
                                <td>
                                    ...
                                    <a href="#" class="btn btn-sm btn-red" onclick="changeShow(<{$val['ap_id']}>,0)" style="padding: 3px 5px">关闭</a>
                                    <{else}>
                                    <span style="color: red">未启用</span>
                                    <a href="#" class="btn btn-sm btn-green" onclick="changeShow(<{$val['ap_id']}>,1)" style="padding: 3px 5px">启用</a>
                                    <{/if}>
                                </td>
                                <td>
                                    每<{$val['ap_time_value']}><{$timeTypeNote[$val['ap_time_type']]}>弹出一次
                                </td>
                                <td><{date('Y-m-d H:i:s', $val['ap_update_time'])}></td>
                                <td>
                                    <!--
                                    <a class="confirm-handle" href="#" data-toggle="modal" data-target="#myModal"  data-id="<{$val['ap_id']}>" data-cover="<{if $val['ap_path']}><{$val['ap_path']}><{else}>/public/manage/img/zhanwei/zw_fxb_350_425.png<{/if}>" data-showindex="<{$val['ap_show']}>" data-showtype="<{$val['ap_show_type']}>" data-link="<{$val['ap_link']}>" data-linktype="<{$val['ap_link_type']}>" ng-click="editPopup(<{$val['ap_id']}>,'<{$val['ap_path']}>',<{$val['ap_link_type']}>,'<{$val['ap_link']}>',<{$val['ap_show_type']}>,<{$val['ap_show']}>)">编辑</a>
                                    -->
                                    <a class="confirm-handle btn btn-xs btn-green" href="#" data-toggle="modal" data-target="#myModal" ng-click="editPopup(<{$val['ap_id']}>,'<{$val['ap_path']}>',<{$val['ap_link_type']}>,'<{$val['ap_link']}>',<{$val['ap_show_type']}>,<{$val['ap_show']}>,<{$val['ap_time_type']}>,<{$val['ap_time_value']}>)">编辑</a>

                                    <a data-id="<{$val['ap_id']}>" onclick="confirmDelete(this)" class="btn btn-xs btn-danger del-btn">删除</a>
                                </td>
                            </tr>
                            <{/foreach}>
...
<script>
    ...
    app.controller('chCtrl',['$scope','$http','$timeout', function($scope,$http,$timeout){
        ...
        $scope.hotelLinkLists = <{$hotelLinkLists}>;
