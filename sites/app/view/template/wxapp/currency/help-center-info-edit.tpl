...
<div class="preview-page">
    <div class="mobile-page">
        ...
        <div class="mobile-con">
            ...
            <div class="article">
                <h4 class="article-title" id="article-title"><{if $row && $row['ahci_title']}><{$row['ahci_title']}><{else}>这里是帮助标题<{/if}>！</h4>
                <div class="date"><{$now}> <span class="link-name"><{$shop['s_name']}></span></div>
                <div class="article-con" id="article-con">
                    <{if $row && $row['ahci_content']}>
                    <!-- <{$row['ahci_content']}> -->
                    <{else}>
                    <p>这里将会显示帮助内容</p>
                    <{/if}>
    ...
    <div class="edit-right">
        <div class="edit-con">
            ...
            <input type="hidden" id="hid_id"  class="avatar-field bg-img" name="hid_key" value="<{if $row && $row['ahci_id']}><{$row['ahci_id']}><{/if}>"/>
            <div class="topic">
                <label for="">标题<font color="red">*</font></label>
                <input type="text" id="title" value="<{if $row && $row['ahci_title']}><{$row['ahci_title']}><{/if}>" placeholder="这里添加标题" oninput="previewTitle(this)" onpropertychange="previewTitle(this)">
            </div>
            <div class="topic">
                <label for="">排序权重</label>
                <input class="form-control" type="number" id="sort" value="<{if $row && $row['ahci_sort']}><{$row['ahci_sort']}><{/if}>" placeholder="越大越靠前">
            </div>
            <div class="contxt">
                <label for="">内容<font color="red">*</font></label>
                <div>
                    <div class="form-textarea">
                        <textarea style="width:100%;height:350px;" id="article-detail" name="article-detail" placeholder="内容"  rows="20" style=" text-align: left; resize:vertical;" ><{if $row && $row['ahci_content']}><{$row['ahci_content']}><{/if}></textarea>
