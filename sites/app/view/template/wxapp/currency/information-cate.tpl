        ...
        <div class="page-header">
            ...
            <span style="margin-left: 40px">
                    ...
                    <label id="choose-onoff" class="choose-onoff">
                        <input class="ace ace-switch ace-switch-5" id="rewardOpen"  data-type="open" onchange="changeOpen()" type="checkbox" <{if $curr_shop && $curr_shop['s_information_reward']}>checked<{/if}>>
                        <span class="lbl"></span>
                    </label>
                </span>
            <{/if}>-->
                    ...
                    <div class="modal-content" style="padding: 20px">
                        <div class="table-responsive">
                            <table id="sample-table-1" class="table table-hover">
                                ...
                                <tbody>
                                    <{foreach $categoryListSelect as $key=>$val}>
                                    <tr >
                                        <td><{$val['name']}></td>
                                        <td><{$val['page']}></td>
                                        <input class="input-hidden" type="text" id="copy<{$key}>" value="<{$val['page']}>">
                                        <td>
                                            <button type="button"  class="btn btn-xs btn-green copy-button" data-clipboard-action="copy"  data-clipboard-target="#copy<{$key}>">
                                                复制链接
                                            </button>
                                        </td>
                                    </tr>
