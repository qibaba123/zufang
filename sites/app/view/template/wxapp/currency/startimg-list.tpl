            ...
            <div class="col-xs-12">
                <div class="table-responsive">
                    <table id="sample-table-1" class="table table-hover table-avatar" style="border: none">
                        ...
                        <tbody>
                        <{foreach $list as $val}>
                            <tr id="tr_<{$val['asi_id']}>">
                                <td>
                                    <img src="<{if $val['asi_path']}><{$val['asi_path']}><{else}>/public/manage/img/zhanwei/zw_fxb_750_1334.png<{/if}>" style="width:80px" alt="">
                                </td>
                                <td>
                                    <{$val['asi_time']}>秒
                                </td>
                                <td>
                                    ...
                                    <a href="#" class="btn btn-sm btn-red" onclick="changeShow(<{$val['asi_id']}>,0)" style="padding: 3px 5px">关闭</a>
                                    <{else}>
                                    <span style="color: red">未启用</span>
                                    <a href="#" class="btn btn-sm btn-green" onclick="changeShow(<{$val['asi_id']}>,1)" style="padding: 3px 5px">启用</a>
                                    <{/if}>
                                </td>
                                <td><{date('Y-m-d H:i:s', $val['asi_update_time'])}></td>
                                <td>
                                    <a class="confirm-handle btn btn-xs btn-green" href="#" data-toggle="modal" data-target="#myModal"  data-id="<{$val['asi_id']}>" data-cover="<{if $val['asi_path']}><{$val['asi_path']}><{else}>/public/manage/img/zhanwei/zw_fxb_750_1334.png<{/if}>" data-indexshow="<{$val['asi_show']}>" data-time="<{$val['asi_time']}>" >编辑</a>
                                    <a data-id="<{$val['asi_id']}>" onclick="confirmDelete(this)" class="btn btn-xs btn-danger del-btn">删除</a>
                                </td>
                            </tr>
                            <{/foreach}>
