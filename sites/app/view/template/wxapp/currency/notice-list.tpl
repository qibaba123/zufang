                    ...
                    <table id="sample-table-1" class="table table-hover table-avatar">
                        ...
                        <{foreach $list as $val}>
                            <tr id="tr_<{$val['ca_id']}>">
                                ...
                                <td style="color:#ccc;">
                                    <a class="confirm-handle btn btn-xs btn-success" href="#" data-toggle="modal" data-target="#myModal"  data-id="<{$val['sn_id']}>" data-name="<{$val['sn_brief']}>" data-weight="<{$val['sn_weight']}>" >编辑</a>
                                    - <a  class=" btn btn-xs btn-primary"  href="#" data-id="<{$val['sn_id']}>" onclick="confirmDelete(this)" style="color:#f00;">删除</a>
                                </td>
                            </tr>
                            <{/foreach}>
