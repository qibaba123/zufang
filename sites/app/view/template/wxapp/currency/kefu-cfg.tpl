                ...
                <li style="margin-top: 5px">
                    <span style="">
                        ...
                        <label id="choose-onoff" class="choose-onoff">
                            <input class="ace ace-switch ace-switch-5" id="kefuMobile"  data-type="open" onchange="kefuMobileOpen()" type="checkbox" <{if $row && $row['ac_kefu_mobile'] eq 1}>checked<{/if}>>
                            <span class="lbl"></span>
                        </label>
                ...
                <div class="group-info">
                    <div class="form-group">
                        ...
                        <div class="control-group">
                            <input type="text" class="form-control" id="g_name" name="g_name" placeholder="请填写关键字" required="required" value="<{if $row}><{$row['g_name']}><{/if}>">
                        </div>
                    </div>
