...
<div class="payment-style" ng-app="chApp" ng-controller="chCtrl">
    ...
    -->
    <input type="hidden" value="<{$cfg['aps_id']}>" id="hid_id">
        <!--
        <div class="row">
            ...
            <div class="form-group col-sm-10">
                    <span style="">
                        <label id="choose-onoff" class="choose-onoff">
                            <input name="sms_start" class="ace ace-switch ace-switch-5" id="step_open"  type="checkbox" <{if $cfg && $cfg['aps_step_open']}> checked<{/if}>>
                        <span class="lbl"></span>
                        </label>
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-10">
                每<input type="number" class="form-control" id="step" name="step" placeholder="" value="<{if $cfg}><{$cfg['aps_step']}><{/if}>" style="width:10%;display: inline-block">步兑换1积分
                <span></span>
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-10">
                <input type="number" class="form-control" id="step_total" name="step_total" placeholder="自动取消时间" value="<{if $cfg}><{$cfg['aps_step_total']}><{/if}>" style="width:10%;display: inline-block">
                <span>分</span>
                <span class="input-tip"></span>
            </div>
        </div>
