                ...
                <div class="index-main">
                    <div class="" data-id="1" style="height: 100%;display: block">
                        <div class="banner-wrap" style="position: relative">
                            ...
                            <div>
                                <img src="<{$applet['ac_avatar']}>" style="width: 28px;position: relative;top: 332px;border-radius: 50%;left: 57px;display: inline-block;" />
                                <span style="width: 175px;position: relative;top: 332px;left: 63px;display: inline-block;font-size: 12px;"><{$applet['ac_name']}></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    app.controller('chCtrl', ['$scope','$http','$timeout',function($scope,$http,$timeout){
        $scope.demoImg = '<{$row['acp_demo_img']}>'? '<{$row['acp_demo_img']}>' : '/public/manage/img/zhanwei/zw_fxb_75_30.png';
        $scope.couponId = '<{$row['acp_coupon_id']}>';
        $scope.couponList = <{$coupon}>;
        $scope.couponJson = <{$couponJson}>;
