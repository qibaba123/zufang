                        ...
                        <{foreach $list as $val}>
                            <tr>
                                ...
                                <td>
                                    <p>
                                    失效时间：
                                        <{if $val['cl_use_time_type'] == 1}>
                                            <{date('Y-m-d H:i:s',$val['cl_use_end_time'])}>
                                        <{/if}>
                                        <{if $val['cl_use_time_type'] == 2}>
                                            自领取<{$val['cl_use_days']}>天后
                                        <{/if}>
                                </td>
                                <td style="color:#ccc;">
                                    <a href="/wxapp/coupon/receive/cid/<{$val['cl_id']}>/type/2" >发放明细</a>
                                     - <a href="/wxapp/collectionprize/couponAdd/?id=<{$val['cl_id']}>" >编辑</a>
