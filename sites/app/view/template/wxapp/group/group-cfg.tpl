            ...
            <div class="index-con">
                ...
                <div class="index-main">
                    ...
                    <div class="hot-recommend" data-left-preview data-id="3" style="margin-top: 5px">
                        ...
                        <div class="recommend-img list-type_1" <{if $tpl['agi_list_type'] == 1}> style="display:block" <{else}> style="display:none" <{/if}>>
                        ...
                        <div class="recommend-img list-type_2" <{if $tpl['agi_list_type'] == 2}> style="display:block" <{else}> style="display:none" <{/if}>>
...
<script>
    ...
    app.controller('chCtrl', ['$scope','$http','$timeout',function($scope,$http,$timeout){
        ...
        $scope.headerTitle= "<{$tpl['agi_title']}>" ? "<{$tpl['agi_title']}>" : "微拼团" ;
        $scope.listTitle= "<{$tpl['agi_list_title']}>" ? "<{$tpl['agi_list_title']}>" : "限时特惠拼团" ;
        $scope.proShowstyle = '<{$tpl['agi_list_type']}>';
        $scope.isopen     = '<{$tpl['agi_isopen']}>';
        $scope.applyTitle     = '<{$tpl['agi_apply_title']}>';
        //$scope.memberCenter = '<{$tpl['agi_member_center']}>';
        $scope.banners = <{$slide}>;
        $scope.fenleiNavs = <{$shortcut}>;
        // $scope.category  = <{$goodsGroup}>;
        $scope.category  = <{$activityGroup}>;
