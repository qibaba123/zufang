        ...
        <div class="tabbable">
            <ul class="nav nav-tabs" id="myTab">
                <li  class="<{if $type eq all}>active<{/if}>">
                    <a href="/wxapp/group/shopGroup">
                        全部拼团
                    </a>
                </li>
                <li  class="<{if $type eq ptpt}>active<{/if}>">
                    <a href="/wxapp/group/shopGroup/type/ptpt">
                        普通拼团
                    </a>
                </li>
                ...
                <li class="<{if $type eq tzyht}>active<{/if}>">
                    <a href="/wxapp/group/shopGroup/type/tzyht">
                        团长优惠团
                    </a>
                </li>
            </ul>
                        ...
                        <table id="sample-table-1" class="table table-hover table-avatar">
                            ...
                            <{foreach $list as $val}>
                                <tr id="tr_<{$val['gb_id']}>">
                                    ...
                                    <td>
                                        <p>
                                            <{if !$val['gb_index_show']}>
                                            <a href="javascript:;"  onclick="changeShow(1, <{$val['gb_id']}>)">展示</a> -
                                            <{else}>
                                            <a href="javascript:;" style="color: red;" onclick="changeShow(0, <{$val['gb_id']}>)">不展示</a> -
                                            <{/if}>
                                            <a href="/wxapp/group/partake/pid/<{$val['gb_id']}>" >参与详情</a> -
                                        ...
                                        <p>
                                            ...
                                            <a href="javascript:;" data-toggle="modal" data-target="#tplPreviewModal" onclick="showPreview('<{$val['gb_id']}>')">推送预览</a> -
                                            <a href="/wxapp/tplpreview/pushHistory?type=group&id=<{$val['gb_id']}>" >推送记录</a>
                                        </p>
                                    </td>
                                </tr>
                                <{/foreach}>
...
<script>
    ...
    function deal_luck_html(data){
        ...
        for(var i=0 ; i < data.length ; i++){
            ...
            html += '<div class="tuan-name"><span>第'+i+'抽奖团</span></div>';
