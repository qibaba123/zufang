...
<div id="mainContent">
    ...
    <div class="tabbable">
        <ul class="nav nav-tabs" id="myTab">
            <li  class="<{if $gtype eq pt}>active<{/if}>">
                <a href="/wxapp/group/order/gtype/pt?independent=<{$independent}>">
                    普通拼团
                </a>
            </li>
            <{if $appletCfg['ac_type'] != 27}>
            <li class="<{if $gtype eq cj}>active<{/if}>">
                <a href="/wxapp/group/order/gtype/cj?independent=<{$independent}>">
                    抽奖团
                </a>
            </li>
            <{/if}>
            <li class="<{if $gtype eq md}>active<{/if}>">
                <a href="/wxapp/group/order/gtype/md?independent=<{$independent}>">
                    团长优惠团
                </a>
            </li>
            <{if $appletCfg['ac_type'] != 27}>
            <li class="<{if $gtype eq jt}>active<{/if}>">
                <a href="/wxapp/group/order/gtype/jt?independent=<{$independent}>">
                    阶梯拼团
                </a>
            </li>
            <{/if}>
...
<div class="choose-state">
	...
	<a href="/wxapp/group/order?gtype=<{$gtype}>&status=<{$key}>&independent=<{$independent}>" <{if $status && $status eq $key}>class="active"<{/if}>><{$val['label']}></a>
	<{/foreach}>
    <!---
...
<div class="trade-list">
    <table class="ui-table-order" style="padding: 0px;">
        ...
        <tr class="header-row">
            <td colspan="<{if $appletCfg['ac_type'] == 12}>5<{else}>6<{/if}>">
                <div>
                    订单号: <{$val['t_tid']}>
            ...
            <td colspan="2" class="text-right">
                <div class="order-opts-container">
                    <div class="js-opts" style="display: block;">
                            <{if $appletCfg['ac_type'] == 4}>
                            <a href="/wxapp/group/tradeDetail?order_no=<{$val['t_tid']}>" class="new-window" >查看详情</a>
        ...
        <tr class="content-row">
            ...
            <td class="title-cell">
                <p class="goods-title">
                    <a href="/wxapp/group/order?gtype=<{$gtype}>&title=<{$val['t_title']}>&independent=<{$independent}>"class="new-window" title="<{$val['t_title']}>">
                        <{$val['t_title']}>
                    </a>
                </p>
                <p>
            ...
            <td class="aftermarket-cell" rowspan="1">
                ...
                <a href="/manage/order/tradeRefund?order_no=<{$val['t_tid']}>" class="new-window" >处理维权</a>
                <{/if}>
            </td>
            -->
            <td class="customer-cell" rowspan="1">
                <p>
                    <a href="/wxapp/group/order?gtype=<{$gtype}>&buyer=<{$val['t_buyer_nick']}>&independent=<{$independent}>" class="new-window" target="_blank">
                        <{$val['t_buyer_nick']}>
                    </a>
                </p>
                ...
                <div class="td-cont text-center">
                    <div>
                        ...
                        <p class="user-name">
							...
							<{/if}>
                            <!--
                            <{if $val['t_status'] == 3 && $val['t_meal_type'] == 2 && $appletCfg['ac_type'] == 4}>
