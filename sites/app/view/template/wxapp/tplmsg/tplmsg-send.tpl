...
<div class="content">
    ...
    <div class="row" >
        <div class="col-xs-10">
            <form class="form-horizontal" role="form">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <span style="line-height: 30px;"><{$row['awt_title']}></span>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <{include file="../layer/ajax-tplmsg-select-input.tpl"}>
                        <!--
                ...
                <div class="form-group">
                    <label for="amount" class="col-sm-2 control-label">可推送会员数量</label>
                    <div class="col-sm-10">
                        <span style="line-height: 30px;"><{count($member)}>人</span>
                    </div>
                </div>
                <!-- <div class="form-group">
        ...
        <div class="col-xs-2">
            <div style="padding-top: 88px;"><a href="javascript:;" style="height: 34px;line-height: 12px;font-size: 16px;" class="btn btn-green btn-lg btn-save"> 立即发送 </a></div>
        </div>
    </div>
    <hr>
    <div class="row">
                ...
                <table id="sample-table-1" class="table table-striped table-hover">
                    ...
                    <{foreach $list as $val}>
                        <tr id="tr_<{$val['awt_id']}>">
                            ...
                            <td><span class="label label-sm label-<{$color[$val['awt_status']]}>"><{$status[$val['awt_status']]}></span></td>
