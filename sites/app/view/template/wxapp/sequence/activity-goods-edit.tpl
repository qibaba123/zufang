...
<div  id="content-con">
    ...
    <div class="page-header search-box">
        <div class="col-sm-12">
            <form action="/wxapp/sequence/activityGoodsEdit" method="get" class="form-inline">
                        ...
                        <{foreach $list as $val}>
                            <tr id="tr_<{$val['g_id']}>">
                                ...
                                <td>
                                    ...
                                    <{else}>
                                    <a href="#" class="btn btn-xs btn-primary select-goods" data-type="add" data-id="<{$val['g_id']}>">添加</a>
                                    <{/if}>
                                </td>
                            </tr>
                            <{/foreach}>
                            <tr><td colspan="2">
                                    ...
                                    <span class="btn btn-xs btn-name select-goods-multi btn-primary" data-type="add">批量添加</span>
