...
<div id="content-con">
    <div  id="mainContent" >
        ...
        <div class="page-header search-box">
            <div class="col-sm-12">
                <form class="form-inline" action="/wxapp/sequence/communityLeaderGoodsSum" method="get">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="overflow: auto;text-align: center;margin-bottom: 45px;height: 220px">
                <div class="modal-plan p_num clearfix shouhuo">
                    <form enctype="multipart/form-data" action="/wxapp/sequence/comLeaderGoodsExcel?id=<{$id}>&leader=<{$leader}>" method="post">
                        <div class="space"></div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">开始日期</label>
                            <div class="col-sm-4">
                                <input class="form-control date-picker" type="text" id="startDate" data-date-format="yyyy-mm-dd" name="startDate" placeholder="请输入开始日期" autocomplete="false" />
                            </div>
                            <label class="col-sm-2 control-label">开始时间</label>
                            <div class="col-sm-4 bootstrap-timepicker">
                                <input class="form-control" type="text" id="timepicker1" name="startTime" placeholder="请输入开始时间" autocomplete="false" />
                            </div>
                        </div>
                        <div class="space"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input class="form-control date-picker" type="text" id="endDate" data-date-format="yyyy-mm-dd" name="endDate" placeholder="请输入结束日期" autocomplete="false" />
                            </div>
                            <label class="col-sm-2 control-label">结束时间</label>
                            <div class="col-sm-4 bootstrap-timepicker">
                                <input class="form-control" type="text" id="timepicker2" name="endTime" placeholder="请输入结束时间" autocomplete="false" />
                            </div>
                        </div>
