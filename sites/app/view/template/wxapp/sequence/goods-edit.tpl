                ...
                <div class="span12">
                    <div class="widget-box">
                        <div class="widget-header widget-header-blue widget-header-flat">
                            <h4 class="lighter"><small><a href="/wxapp/sequence/goodsList"> 返回 </a></small> | 新增/编辑商品信息</h4>
                        ...
                        <div class="widget-body" >
                                                ...
                                                <div class="info-group-inner">
                                                    ...
                                                    <div class="group-info">
                                                        ...
                                                        <div class="form-group price-form" ng-show=" isDiscuss != '1' ">
                                                            ...
                                                            <div class="control-group">
                                                                <input type="text" class="form-control" id="g_price" name="g_price" onblur="mathVIp()" placeholder="请填写商品售价"  value="<{if $row}><{$row['g_price']}><{/if}>"  required="required" style="width:160px;">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <span style="position: relative;left: 168px;top: -24px;font-weight: bold;">Kg</span>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="info-group-inner">
                                                    ...
                                                    <div class="group-info">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="control-group">
                                                                <label style="padding: 4px 0;margin: 0;">
                                                                    <input name="g_show_num_show" class="ace ace-switch ace-switch-5" id="g_show_num_show" <{if $row && $row['g_show_num_show']}>checked<{/if}> type="checkbox">
                                                                    <span class="lbl"></span>
                                                                </label>
                                                            </div>
                                                        </div>
                            ...
                            <button class="btn btn-primary" ng-click="saveData()" style="margin: 3px auto;display: block">
                                保存
                            </button>
                        </div>
                                    </form>
