...
<div  id="content-con" >
    ...
    <a href="/wxapp/reservation/addGood?type=2" class="btn btn-green btn-xs"><i class="icon-plus bigger-80"></i> 新增</a>
    <a href="/wxapp/reservation/expertCategory?type=2" class="btn btn-primary btn-xs">专家分类</a>
    <{if $import}>
    <a href="<{$import['link']}>" class="btn btn-pink btn-xs"><i class="icon-exchange bigger-80"></i> <{$import['name']}></a>
    <{/if}>
    <div class="page-header search-box">
        <div class="col-sm-12">
            <form action="/wxapp/reservation/experts" method="get" class="form-inline">
                <div class="col-xs-11 form-group-box">
                    <div class="form-container">
                        <div class="form-group">
                            <div class="input-group">
                                <div class="input-group-addon">名称</div>
                                <input type="text" class="form-control" name="name" value="<{$name}>" placeholder="专家名称">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group">
                    ...
                    <table id="sample-table-1" class="table table-striped table-hover table-avatar">
                        ...
                        <{foreach $list as $val}>
                            <tr id="tr_<{$val['g_id']}>">
                                ...
                                <td>
                                    <a href="/wxapp/reservation/addGood/?id=<{$val['g_id']}>&type=2" >编辑</a> -
                            ...
                            <{/foreach}>
                            <tr>
                                <td colspan="8" style="text-align:right"><{$paginator}></td></tr>
                        </tbody>
                    </table>
                </div>
            </div>
