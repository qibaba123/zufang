...
<link rel="stylesheet" href="/public/wxapp/reservation/template/temp1/css/index.css?2">
<link rel="stylesheet" href="/public/wxapp/reservation/template/temp1/css/style.css?4">
<style>
...
<div class="preview-page" ng-app="chApp" ng-controller="chCtrl">
			...
			<div class="index-con">
				...
				<div class="index-main">
					...
					<div class="notice-box" data-left-preview data-id="4">
						<div style="display: inline-block;font-size: 18px;height: 100%;float:left;line-height: 40px;margin:0 10px;color: red;">{{noticeTitle}}</div>
					...
					<div class="new-activity" data-left-preview data-id="5" style="margin:10px 0">
						<div class="big-activity">
							<img ng-src="{{activityList[0].imgsrc}}" alt=""/>
						</div>
						<div class="small-activity">
							<div class="small-item">
								<img ng-src="{{activityList[1].imgsrc}}" alt=""/>
							</div>
							<div class="small-item">
								<img ng-src="{{activityList[2].imgsrc}}" alt=""/>
							</div>
						</div>
					</div>

					<div class="top-img" data-left-preview data-id="6" style="margin:10px 0;position: relative">
						<div class="title-name" style="position: absolute;color: cornflowerblue;width: 100%;text-align: center;">{{teamTitle}}</div>
						<img ng-src="{{teamImg==''?'/public/manage/img/zhanwei/zw_fxb_75_30.png':teamImg}}" alt="专家团队" style="width: 100%" />
					</div>

					<!--日志-->
					<div class="service-wrap" data-left-preview data-id="8">
						<div class="title-name" style="text-align: center;color: cornflowerblue;background: #fff;">
							{{journalInfo.title}}
						</div>
						<div class="no-data-tip" ng-if="journalInfo.journalList<=0">点此添加内容~</div>
						<div class="active-list">
							<div class="active-item" ng-repeat="journal in journalInfo.journalList">
								<img ng-src="{{journal.imgsrc}}" />
								<div class="active-intro flex-con">
									<div class="title-txt">{{journal.name}}</div>
									<div class="intro-txt" style="color: #999;">{{journal.brief}}</div>
									<div class="times" style="text-align: right;color: #ccc;">7月1日 12:22</div>
								</div>
	...
	<div class="edit-right">
		<div class="edit-con">
			...
			<div class="journalpart" data-right-edit data-id="5">
				<label style="width: 100%">最新活动</label>
				<div class="fenleinav-manage activity-box">
					<div class="big-activity">
						<div class="edit-img">
							<div>
								<img onclick="toUpload(this)"  data-limit="8" onload="changeSrc(this)" data-width="350" data-height="380" imageonload="doThis('activityList',0)" data-dom-id="upload-activity0" id="upload-activity0"  ng-src="{{activityList[0].imgsrc}}"  height="100%" style="display:inline-block;margin-left:0;">
								<input type="hidden" id="activity0"  class="avatar-field bg-img" name="activity0" ng-value="activityList[0].imgsrc"/>
							</div>
						</div>
						<!--
						<div class="edit-txt">
							<div class="input-group-box clearfix">
								<label  class="label-name" for="">链接到：</label>
								<select class="cus-input" ng-model="activityList[0].link" ng-options="x.id as x.name for x in goods" ></select>                        </div>
						</div>
						-->
						<div class="input-group-box clearfix">
							<label  class="label-name" for="">链接类型：</label>
							<select class="cus-input" ng-model="activityList[0].type"  ng-options="x.id as x.name for x in linkTypes" ></select>
						</div>
						<div class="input-group-box clearfix" ng-show="activityList[0].type==1">
							<label  class="label-name" for="">单　　页：</label>
							<select class="cus-input" ng-model="activityList[0].link"  ng-options="x.id as x.title for x in articles" ></select>
						</div>
						<div class="input-group-box clearfix" ng-show="activityList[0].type==2">
							<label  class="label-name" for="">列　　表：</label>
							<select class="cus-input" ng-model="activityList[0].link"  ng-options="x.path as x.name for x in linkList" ></select>
						</div>
						<div class="input-group-box clearfix" ng-show="activityList[0].type==3">
							<label  class="label-name" for="">外　　链：</label>
							<input type="text" class="cus-input" ng-value="activityList[0].link" ng-model="activityList[0].link" />
						</div>
						<div class="input-group-box clearfix" ng-show="activityList[0].type==6">
							<label  class="label-name" for="">分　　类：</label>
							<select class="cus-input" ng-model="activityList[0].link"  ng-options="x.id as x.name for x in category" ></select>
						</div>
						<div class="input-group-box clearfix" ng-show="activityList[0].type==5">
							<label  class="label-name" for="">产品详情：</label>
							<select class="cus-input" ng-model="activityList[0].link"  ng-options="x.id as x.name for x in goods" ></select>
						</div>
						<div class="input-group-box clearfix" ng-show="activityList[0].type==37">
							<label  class="label-name" for="">专家详情：</label>
							<select class="cus-input" ng-model="activityList[0].link"  ng-options="x.id as x.name for x in expertList" ></select>
						</div>
						<div class="input-group-box clearfix" ng-show="activityList[0].type==38">
							<label  class="label-name" for="">专家分类：</label>
							<select class="cus-input" ng-model="activityList[0].link"  ng-options="x.id as x.name for x in expertCategory" ></select>
						</div>
						<div class="input-group-box clearfix" ng-show="activityList[0].type==106">
							<label  class="label-name" for="">小 程 序：</label>
							<select class="cus-input" ng-model="activityList[0].link"  ng-options="x.appid as x.name for x in jumpList" ></select>
						</div>
					</div>
					...
					<div class="big-activity">
						<div class="edit-img">
							<div>
								<img onclick="toUpload(this)"  data-limit="8" onload="changeSrc(this)" data-width="350" data-height="185" imageonload="doThis('activityList',1)" data-dom-id="upload-activity1" id="upload-activity1"  ng-src="{{activityList[1].imgsrc}}"  height="100%" style="display:inline-block;margin-left:0;">
								<input type="hidden" id="activity1"  class="avatar-field bg-img" name="activity1" ng-value="activityList[1].imgsrc"/>
							</div>
						</div>
						<!--
						<div class="edit-txt">
							<div class="input-group-box clearfix">
								<label  class="label-name" for="">链接到：</label>
								<select class="cus-input" ng-model="activityList[1].link" ng-options="x.id as x.name for x in goods" ></select>                        </div>
						</div>
						-->
						<div class="input-group-box clearfix">
							<label  class="label-name" for="">链接类型：</label>
							<select class="cus-input" ng-model="activityList[1].type"  ng-options="x.id as x.name for x in linkTypes" ></select>
						</div>
						<div class="input-group-box clearfix" ng-show="activityList[1].type==1">
							<label  class="label-name" for="">单　　页：</label>
							<select class="cus-input" ng-model="activityList[1].link"  ng-options="x.id as x.title for x in articles" ></select>
						</div>
						<div class="input-group-box clearfix" ng-show="activityList[1].type==2">
							<label  class="label-name" for="">列　　表：</label>
							<select class="cus-input" ng-model="activityList[1].link"  ng-options="x.path as x.name for x in linkList" ></select>
						</div>
						<div class="input-group-box clearfix" ng-show="activityList[1].type==3">
							<label  class="label-name" for="">外　　链：</label>
							<input type="text" class="cus-input" ng-value="activityList[1].link" ng-model="activityList[0].link" />
						</div>
						<div class="input-group-box clearfix" ng-show="activityList[1].type==6">
							<label  class="label-name" for="">分　　类：</label>
							<select class="cus-input" ng-model="activityList[1].link"  ng-options="x.id as x.name for x in category" ></select>
						</div>
						<div class="input-group-box clearfix" ng-show="activityList[1].type==5">
							<label  class="label-name" for="">产品详情：</label>
							<select class="cus-input" ng-model="activityList[1].link"  ng-options="x.id as x.name for x in goods" ></select>
						</div>
						<div class="input-group-box clearfix" ng-show="activityList[1].type==37">
							<label  class="label-name" for="">专家详情：</label>
							<select class="cus-input" ng-model="activityList[1].link"  ng-options="x.id as x.name for x in expertList" ></select>
						</div>
						<div class="input-group-box clearfix" ng-show="activityList[1].type==38">
							<label  class="label-name" for="">专家分类：</label>
							<select class="cus-input" ng-model="activityList[1].link"  ng-options="x.id as x.name for x in expertCategory" ></select>
						</div>
						<div class="input-group-box clearfix" ng-show="activityList[1].type==106">
							<label  class="label-name" for="">小 程 序：</label>
							<select class="cus-input" ng-model="activityList[1].link"  ng-options="x.appid as x.name for x in jumpList" ></select>
						</div>
					</div>
					...
					<div class="big-activity">
						<div class="edit-img">
							<div>
								<img onclick="toUpload(this)"  data-limit="8" onload="changeSrc(this)" data-width="350" data-height="185" imageonload="doThis('activityList',2)" data-dom-id="upload-activity2" id="upload-activity2"  ng-src="{{activityList[2].imgsrc}}"  height="100%" style="display:inline-block;margin-left:0;">
								<input type="hidden" id="activity2"  class="avatar-field bg-img" name="activity2" ng-value="activityList[2].imgsrc"/>
							</div>
						</div>
						<!--
						<div class="edit-txt">
							<div class="input-group-box clearfix">
								<label  class="label-name" for="">链接到：</label>
								<select class="cus-input" ng-model="activityList[2].link" ng-options="x.id as x.name for x in goods" ></select>                        </div>
						</div>
						-->
						<div class="input-group-box clearfix">
							<label  class="label-name" for="">链接类型：</label>
							<select class="cus-input" ng-model="activityList[2].type"  ng-options="x.id as x.name for x in linkTypes" ></select>
						</div>
						<div class="input-group-box clearfix" ng-show="activityList[2].type==1">
							<label  class="label-name" for="">单　　页：</label>
							<select class="cus-input" ng-model="activityList[2].link"  ng-options="x.id as x.title for x in articles" ></select>
						</div>
						<div class="input-group-box clearfix" ng-show="activityList[2].type==2">
							<label  class="label-name" for="">列　　表：</label>
							<select class="cus-input" ng-model="activityList[2].link"  ng-options="x.path as x.name for x in linkList" ></select>
						</div>
						<div class="input-group-box clearfix" ng-show="activityList[2].type==3">
							<label  class="label-name" for="">外　　链：</label>
							<input type="text" class="cus-input" ng-value="activityList[2].link" ng-model="activityList[0].link" />
						</div>
						<div class="input-group-box clearfix" ng-show="activityList[2].type==6">
							<label  class="label-name" for="">分　　类：</label>
							<select class="cus-input" ng-model="activityList[2].link"  ng-options="x.id as x.name for x in category" ></select>
						</div>
						<div class="input-group-box clearfix" ng-show="activityList[2].type==5">
							<label  class="label-name" for="">产品详情：</label>
							<select class="cus-input" ng-model="activityList[2].link"  ng-options="x.id as x.name for x in goods" ></select>
						</div>
						<div class="input-group-box clearfix" ng-show="activityList[2].type==37">
							<label  class="label-name" for="">专家详情：</label>
							<select class="cus-input" ng-model="activityList[2].link"  ng-options="x.id as x.name for x in expertList" ></select>
						</div>
						<div class="input-group-box clearfix" ng-show="activityList[2].type==38">
							<label  class="label-name" for="">专家分类：</label>
							<select class="cus-input" ng-model="activityList[2].link"  ng-options="x.id as x.name for x in expertCategory" ></select>
						</div>
						<div class="input-group-box clearfix" ng-show="activityList[2].type==106">
							<label  class="label-name" for="">小 程 序：</label>
							<select class="cus-input" ng-model="activityList[2].link"  ng-options="x.appid as x.name for x in jumpList" ></select>
						</div>
					</div>
				</div>

			</div>
			<div class="journalpart" data-right-edit data-id="6">
				<label style="width: 100%;">标题</label>
				<div class="input-group-box" style="margin-bottom: 10px;">
					<input type="text" class="cus-input" placeholder="请输入页面标题" maxlength="6" ng-model="teamTitle">
				</div>
				<label>专家团队图片<span>（图片建议尺寸750px*300px）</span></label>
				<div class="hornor-covers-manage">
					<div class="edit-img">
						<div>
							<img onclick="toUpload(this)"  data-limit="1" onload="changeSrc(this)" data-width="750" data-height="300" imageonload="changeBg()" data-dom-id="upload-teamImg" id="upload-teamImg{{$index}}"  ng-src="{{teamImg?teamImg:'/public/manage/img/zhanwei/zw_fxb_75_30.png'}}"  width="100%" style="display:inline-block;margin-left:0;">
							<input type="hidden" id="teamImg"  class="avatar-field bg-img" name="teamImg" ng-value="teamImg"/>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="service" data-right-edit data-id="8">
				<label style="width: 100%;">标题</label>
				<div class="input-group-box" style="margin-bottom: 10px;">
					<input type="text" class="cus-input" placeholder="请输入页面标题" maxlength="6" ng-model="journalInfo.title">
				</div>
				<div class="service-manage" ng-repeat="journal in journalInfo.journalList">
					...
					<div class="edit-img">
						<div>
							<img onclick="toUpload(this)"  data-limit="8" onload="changeSrc(this)" data-width="750" data-height="360" imageonload="doThis('journalList',journal.index,'journalInfo')" data-dom-id="upload-journal{{$index}}" id="upload-journal{{$index}}"  ng-src="{{journal.imgsrc}}"  height="100%" style="display:inline-block;margin-left:0;">
							<input type="hidden" id="journal{{$index}}"  class="avatar-field bg-img" name="journal{{$index}}" ng-value="journal.imgsrc"/>
						</div>
					</div>
					<p class="tips">图片建议尺寸:750px*360px</p>
					<div class="edit-txt">
						<div class="input-group-box">
							<label  class="label-name" for="">标　题：</label>
						...
						<div class="input-group-box">
							<label  class="label-name" for="">简  介：</label>
