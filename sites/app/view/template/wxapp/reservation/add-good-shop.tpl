                ...
                <div class="span12">
                    <div class="widget-box">
                        <div class="widget-header widget-header-blue widget-header-flat">
                            <h4 class="lighter"><small><a href="/wxapp/reservation/goodsShop"> 返回 </a></small> | 新增/编辑商品信息</h4>
                                            ...
                                            <div class="info-group-box">
                                                <div class="info-group-inner">
                                                    ...
                                                    <div class="group-info">
                                                        ...
                                                        <div class="form-group">
                                                            <label  class="col-sm-3 control-label"><font color="red">*</font>商品幻灯图:</label>
                                                            <div>
                                                                <span style="display: block;margin: 7px 0">最多5张，建议尺寸640 x 640</span>
                                                                <div id="slide-img" class="pic-box" style="display:inline-block;margin-left: 150px">
                                                            ...
                                                            <span onclick="toUpload(this)" data-limit="5" data-width="640" data-height="640" data-dom-id="slide-img" class="btn btn-success btn-xs" style="margin-left: 150px;margin-top: 10px;">添加幻灯</span>
...
<script type="text/javascript">
    ...
    function saveGoods(type){
        ...
        $.ajax({
            'type'  : 'post',
            'url'   : '/wxapp/reservation/saveGoodShop',
            'data'  : $('#goods-form').serialize(),
            'dataType'  : 'json',
            'success'   : function(ret){
                layer.close(load_index);
                if(ret.ec == 200){
                    window.location.href='/wxapp/reservation/goodsShop';
                }else{
                    layer.msg(ret.em);
                }
            }
