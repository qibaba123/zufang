...
<style>
    ...
    .service-wrap .service-item .name{
        position: absolute;
        bottom: 13px;
        left: 0;
        width: 100%;
        ...
        <div class="mobile-con">
            ...
            <div class="index-con">
                ...
                <div class="index-main">
                    ...
                    <!-- 公告 -->
                    <div class="notice-box" data-left-preview data-id="4" style="margin-bottom: 4px;">
                        <div style="display: inline-block;font-size: 18px;float:left;margin:0 10px;color: #b39665;margin-top: 8px">{{noticeTitle}}</div>
...
<script>
    ...
    app.controller('chCtrl', ['$scope','$http','$timeout',function($scope, $http, $timeout){
        ...
        $scope.noticeTitle    = '<{$tpl['ari_notice_title']}>'?'<{$tpl['ari_notice_title']}>':'热门活动';
        ...
        $scope.teamTitle  = '<{$tpl['ari_team_title']}>'?'<{$tpl['ari_team_title']}>':'特色服务';
        $scope.journalInfo = {
                title:'<{$tpl['ari_journal_title']}>' ? '<{$tpl['ari_journal_title']}>' : '热门活动',
