        ...
        <div class="mobile-con">
            ...
            <div class="index-con">
                ...
                <div class="index-main">
                    ...
                    <!-- 公告 -->
                    <div class="notice-box" data-left-preview data-id="4" style="height: 60px;">
                        <div style="display: inline-block;font-size: 18px;width: 40px;float:left;margin:0 10px;color: #6ab6bb;margin-top: 8px">{{noticeTitle}}</div>
                        <div class="notice-txt" style="line-height: 20px;">
                            <p ng-if="noticeTxt.length<=0">最新公告内容</p>
                            <p ng-repeat="notice in noticeTxt" style="margin-top: 8px;">{{notice.title}}</p>
                        </div>
                    </div>
                    ...
                    <div class="service-wrap" data-left-preview data-id="7">
                        ...
                        <div class="no-data-tip" >此处为团队内容展示，请到相关管理页面添加~</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="edit-con">
            ...
            <div class="banner" data-right-edit data-id="1">
                ...
                <div class="banner-manage" ng-repeat="banner in banners">
                    ...
                    <div class="edit-img">
                        <div>
                            <img onclick="toUpload(this)"  data-limit="1" onload="changeSrc(this)" data-width="750" data-height="400" imageonload="doThis('banners',banner.index)" data-dom-id="upload-slide{{$index}}" id="upload-slide{{$index}}"  ng-src="{{banner.imgsrc}}"  height="100%" style="display:inline-block;margin-left:0;">
