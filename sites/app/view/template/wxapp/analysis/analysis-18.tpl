...
<div class="row">
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a class="order-stat dashboard-stat dashboard-stat-v2 blue" href="#">
            ...
            <div class="details">
                <div class="number">
                    <span class="todayOrders counterup" data-counter="counterup" data-value="<{$todaySaleReservationTotal}>"><{$todaySaleReservationTotal}></span>
                </div>
                <div class="desc"> 今日售出服务数 </div>
            </div>
        </a>
    </div>
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a class="dashboard-stat dashboard-stat-v2  order-stat-bg" href="#">
            ...
            <div class="details">
                <div class="number">
                    <span class="yestodayOrders counterup" data-counter="counterup" data-value="<{$yesterdaySaleReservationTotal}>"><{$yesterdaySaleReservationTotal}></span>
                </div>
                <div class="desc"> 昨日售出服务数 </div>
            </div>
        </a>
    </div>
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a class="order-stat  dashboard-stat dashboard-stat-v2 green" href="#">
            ...
            <div class="details">
                <div class="number">
                    <span class="thisMonthOrders  counterup" data-counter="counterup" data-value="<{$thisMonthSaleReservationTotal}>"><{$thisMonthSaleReservationTotal}></span>
                </div>
                <div class="desc"> 本月售出服务数 </div>
            </div>
        </a>
    </div>
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a class="order-stat dashboard-stat dashboard-stat-v2 purple" href="#">
            ...
            <div class="details">
                <div class="number">
                    <span class="allOrders  counterup" data-counter="counterup" data-value="<{$saleReservationGoodsTotal}>"><{$saleReservationGoodsTotal}></span>
                </div>
                <div class="desc">总售出服务数 </div>
            </div>
        </a>
    </div>
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a class="order-stat dashboard-stat dashboard-stat-v2 red" href="#">
            ...
            <div class="details">
                <div class="number">
                    <span class="todayAllTotals counterup" data-counter="counterup" data-value="<{$todaySaleReservationMoneyTotal}>"><{$todaySaleReservationMoneyTotal}></span>
                </div>
                <div class="desc"> 今日服务销售金额</div>
            </div>
        </a>
    </div>
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a class="dashboard-stat dashboard-stat-v2   order-sales" href="#">
            ...
            <div class="details">
                <div class="number">
                    <span class="yestodayAllTotals  counterup" data-counter="counterup" data-value="<{$yesterdaySaleReservationMoneyTotal}>"><{$yesterdaySaleReservationMoneyTotal}></span>
                </div>
                <div class="desc"> 昨日服务销售金额 </div>
            </div>
        </a>
    </div>
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a class="dashboard-stat dashboard-stat-v2   order-month-sales" href="#">
            ...
            <div class="details">
                <div class="number">
                    <span class="thisMonthTotals  counterup" data-value="<{$thisMonthSaleReservationMoneyTotal}>" data-counter="counterup"><{$thisMonthSaleReservationMoneyTotal}></span>
                </div>
                <div class="desc"> 本月服务销售金额 </div>
            </div>
        </a>
    </div>
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a class="dashboard-stat dashboard-stat-v2   order-total" href="#">
            ...
            <div class="details">
                <div class="number">
                    <span data-value="<{$saleReservationMoneyTotal}>" data-counter="counterup" class="allTotals  counterup"><{$saleReservationMoneyTotal}></span></div>
                <div class="desc">总服务销售金额 </div>
            </div>
        </a>
    </div>
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a class="order-stat dashboard-stat dashboard-stat-v2 red" href="#">
            ...
            <div class="details">
                <div class="number">
                    <span class="todayAllsales counterup" data-counter="counterup" data-value="<{$saleingReservationTotal}>"><{$saleingReservationTotal}></span>
                </div>
                <div class="desc"> 在售服务数 </div>
            </div>
        </a>
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a class="order-stat  dashboard-stat dashboard-stat-v2 green" href="#">
            ...
            <div class="details">
                <div class="number">
                    <span class="thisMonthAllsales  counterup" data-counter="counterup" data-value="<{$nosaleReservationTotal}>"><{$nosaleReservationTotal}></span>
                </div>
                <div class="desc"> 下架服务数 </div>
            </div>
        </a>
    </div>
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a class="dashboard-stat dashboard-stat-v2   order-month-sales" href="#">
            ...
            <div class="details">
                <div class="number">
                    <span class="thisAllsales  counterup" data-value="<{$saleingGoodsTotal}>" data-counter="counterup"><{$saleingGoodsTotal}></span>
                </div>
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a class="dashboard-stat dashboard-stat-v2   order-month-sales" href="#">
            ...
            <div class="details">
                <div class="number">
                    <span class="thisAllsales  counterup" data-value="<{$nosaleGoodsTotal}>" data-counter="counterup"><{$nosaleGoodsTotal}></span>
                </div>
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="mt-widget-2 mt-widget1">
                        ...
                        <div class="easy-pie-chart chart-style">
                            <div class="todayAddRegimentalPreCentum number team" data-percent="10" data-color="#ff2828" style="line-height: 144px;"><span>17.27</span>%</div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    <div class="mt-widget-2 mt-widget1">
                        ...
                        <div class="easy-pie-chart chart-style">
                            <div class="monthAddRegimentalPreCentum number team" data-percent="10" data-color="#3598dc" style="line-height: 144px;"><span>17.27</span>%</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="zczl">
            <div class="zczl-title">
                ...
                <div class="icon">
                    <i class="icon-user">
                        <span class="font-green-sharp">共：</span>
                        <span class="allMbs  counterup" data-counter="counterup" style="color:#FE2F56;" data-value="965">965</span>
                        <span class="font-green-sharp">会员</span>
                    </i>
                </div>
                <div class="head-bottom"></div>
            </div>
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="mt-widget-2 mt-widget1">
                        <div class="pie-font">
                            ...
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="thisMonthNewAddPerson counterup" data-counter="counterup" data-value="129" style="color:#A3D04B;">129</span>&nbsp;人
                                </div>
                            </div>
                            <span class="font-grey-salsa">上月新增</span>
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="lastMonthNewAddPerson counterup" data-counter="counterup" data-value="110" style="color:#A3D04B;">110</span>&nbsp;人
                                </div>
                            </div>
                        </div>
                        <div class="easy-pie-chart chart-style">
                            <div class="monthAddMbsPreCentum number team" data-percent="17.27" data-color="#abce33" style="line-height: 144px;"><span>17.27</span>%</div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    <div class="mt-widget-2 mt-widget1">
                        <div class="pie-font">
                            <span class="font-red-soft">今日新增</span>
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="todayNewAddPerson counterup" data-counter="counterup" data-value="1" style="color:#FE2F56;">1</span>&nbsp;人
                                </div>
                            </div>
                            <span class="font-red-mint">昨日新增</span>
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="yestodayNewAddPerson counterup" data-counter="counterup" data-value="9" style="color:#FF2C30;">9</span>&nbsp;人
                                </div>
                            </div>
                        </div>
                        <div class="easy-pie-chart chart-style">
                            <div class="todayNewAddMbsPreCentum number team" data-percent="-88.89" data-color="#f92d56" style="line-height: 144px;"><span>-88.89</span>%</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="zczl">
            <div class="zczl-title">
                ...
                <div class="icon">
                    <i class="icon-user">
                        <span class="font-green-sharp">共：</span>
                        <span class="allMbs  counterup" data-counter="counterup" style="color:#FE2F56;" data-value="<{$reservationOrderTotal}>"><{$reservationOrderTotal}></span>
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="mt-widget-2 mt-widget1">
                        <div class="pie-font">
                            ...
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="thisMonthNewAddPerson counterup" data-counter="counterup" data-value="<{$todayReservationOrderTotal}>" style="color:#A3D04B;"><{$todayReservationOrderTotal}></span>&nbsp;单
                                </div>
                            </div>
                            <span class="font-grey-salsa">昨日订单</span>
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="lastMonthNewAddPerson counterup" data-counter="counterup" data-value="<{$yesterdayReservationOrderTotal}>" style="color:#A3D04B;"><{$yesterdayReservationOrderTotal}></span>&nbsp;单
                                </div>
                            </div>
                        </div>
                        <div class="easy-pie-chart chart-style">
                            <div class="monthAddMbsPreCentum number team" data-percent="<{$dayReservationOrderPercent}>" data-color="#abce33" style="line-height: 144px;"><span><{$dayReservationOrderPercent}></span>%</div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    <div class="mt-widget-2 mt-widget1">
                        <div class="pie-font">
                            ...
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="todayNewAddPerson counterup" data-counter="counterup" data-value="<{$thisMonthReservationOrderTotal}>" style="color:#FE2F56;"><{$thisMonthReservationOrderTotal}></span>&nbsp;单
                                </div>
                            </div>
                            <span class="font-red-mint">上月订单</span>
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="yestodayNewAddPerson counterup" data-counter="counterup" data-value="<{$lastMonthReservationOrderTotal}>" style="color:#FF2C30;"><{$lastMonthReservationOrderTotal}></span>&nbsp;单
                                </div>
                            </div>
                        </div>
                        <div class="easy-pie-chart chart-style">
                            <div class="todayNewAddMbsPreCentum number team" data-percent="<{$monthReservationOrderPercent}>" data-color="#f92d56" style="line-height: 144px;"><span><{$monthReservationOrderPercent}></span>%</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="zczl">
            <div class="zczl-title">
                ...
                <div class="icon">
                    <i class="icon-user">
                        <span class="font-green-sharp">共：</span>
                        <span class="allMbs  counterup" data-counter="counterup" style="color:#FE2F56;" data-value="<{$refundReservationTotal}>"><{$refundReservationTotal}></span>
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="mt-widget-2 mt-widget1">
                        <div class="pie-font">
                            ...
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="thisMonthNewAddPerson counterup" data-counter="counterup" data-value="<{$todayReservationRefundTotal}>" style="color:#A3D04B;"><{$todayReservationRefundTotal}></span>&nbsp;人
                                </div>
                            </div>
                            <span class="font-grey-salsa">昨日退款</span>
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="lastMonthNewAddPerson counterup" data-counter="counterup" data-value="<{$yesterdayReservationRefundTotal}>" style="color:#A3D04B;"><{$yesterdayReservationRefundTotal}></span>&nbsp;人
                                </div>
                            </div>
                        </div>
                        <div class="easy-pie-chart chart-style">
                            <div class="monthAddMbsPreCentum number team" data-percent="<{$dayReservationRefundPercent}>" data-color="#abce33" style="line-height: 144px;"><span><{$dayReservationRefundPercent}></span>%</div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    <div class="mt-widget-2 mt-widget1">
                        <div class="pie-font">
                            ...
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="todayNewAddPerson counterup" data-counter="counterup" data-value="<{$thisMonthReservationRefundTotal}>" style="color:#FE2F56;"><{$thisMonthReservationRefundTotal}></span>&nbsp;人
                                </div>
                            </div>
                            <span class="font-red-mint">上月退款</span>
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="yestodayNewAddPerson counterup" data-counter="counterup" data-value="<{$lastMonthReservationRefundTotal}>" style="color:#FF2C30;"><{$lastMonthReservationRefundTotal}></span>&nbsp;人
                                </div>
                            </div>
                        </div>
                        <div class="easy-pie-chart chart-style">
                            <div class="todayNewAddMbsPreCentum number team" data-percent="<{$monthReservationRefundPercent}>" data-color="#f92d56" style="line-height: 144px;"><span><{$monthReservationRefundPercent}></span>%</div>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="row">
    ...
    <div class="col-lg-6 col-xs-12 col-sm-12">
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject bold uppercase font-dark">近15日服务订单量</span>
                    <span class="caption-helper"></span>
                </div>
            </div>
            <div class="portlet-body">
                <div id="reservationOrderAnalysis" style="height: 400px"></div>
            </div>
        </div>
    </div>
    <!-- END :  近15日订单量   -->
    ...
    <div class="col-lg-6 col-xs-12 col-sm-12">
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject bold uppercase font-dark">近15日售出服务量</span>
                </div>
            </div>
            <div class="portlet-body">
                <div id="reservationSaleAnalysis" style="height: 400px"></div>
            </div>
        </div>
    </div>
    <!-- END : 近15日商品销售数  -->
    ...
    <div class="col-lg-6 col-xs-12 col-sm-12">
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject bold uppercase font-dark">近15日服务销售额</span>
                </div>
            </div>
            <div class="portlet-body">
                <div id="reservationMoneyAnalysis" style="height: 400px"></div>
            </div>
        </div>
    </div>
    <!-- END : 近15日销售额  -->
    ...
    <div class="col-lg-6 col-xs-12 col-sm-12">
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject bold uppercase font-dark">近15日商品订单量</span>
                    <span class="caption-helper"></span>
                </div>
            </div>
            <div class="portlet-body">
    ...
    <div class="col-lg-6 col-xs-12 col-sm-12">
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject bold uppercase font-dark">近15日售出商品量</span>
                </div>
            </div>
            <div class="portlet-body">
...
<script>
    ...
    let fifteenReservationOrderStatistic = <{$fifteenReservationOrderStatistic}>;
    let fifteenSaleReservationStatistic  = <{$fifteenSaleReservationStatistic}>;
    let fifteenSaleReservationMoneyStatistic = <{$fifteenSaleReservationMoneyStatistic}>;

    drawAxisChart("reservationOrderAnalysis", fifteenReservationOrderStatistic, daysArr, '服务订单量');
    drawAxisChart("reservationSaleAnalysis", fifteenSaleReservationStatistic, daysArr, '售出服务量');
    drawAxisChart("reservationMoneyAnalysis", fifteenSaleReservationMoneyStatistic, daysArr, '服务销售额');

    drawAxisChart("orderAnalysis", fifteenOrderStatistic, daysArr, '商品订单量');
