...
<div class="row">
    ...
    <div class="col-lg-6 col-xs-12 col-sm-12">
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject bold uppercase font-dark">近15日售出课程数</span>
                </div>
            </div>
            <div class="portlet-body">
    ...
    <div class="col-lg-6 col-xs-12 col-sm-12">
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject bold uppercase font-dark">近15日课程销售额</span>
                </div>
            </div>
            <div class="portlet-body">
...
<script>
    ...
    drawAxisChart("saleAnalysis", fifteenSaleGoodsStatistic, daysArr, '售出课程数');
    drawAxisChart("moneyAnalysis", fifteenSaleMoneyStatistic, daysArr, '课程销售额');
