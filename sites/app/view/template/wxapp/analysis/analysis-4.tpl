    ...
    <div class="col-lg-6  col-xs-12  col-sm-6">
        <div class="zczl">
            <div class="zczl-title">
                <div class="number">
                    <h3 class="font-red-mint">
                        <span>餐桌/包间使用增长率</span>
                    </h3>
                </div>
                <div class="icon">
                    <i class="icon-user">
                        <span class="font-green-sharp">共：</span>
                        <span class="allMbs  counterup" data-counter="counterup" style="color:#FE2F56;" data-value="965"><{$tableTotal}></span>
                        <span class="font-green-sharp">张餐桌/包间</span>
                    </i>
                </div>
                <div class="head-bottom"></div>
            </div>
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="mt-widget-2 mt-widget1">
                        <div class="pie-font">
                            ...
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="thisMonthNewAddPerson counterup" data-counter="counterup" data-value="<{$todayTableUseTotal}>" style="color:#A3D04B;"><{$todayTableUseTotal}></span>&nbsp;次
                                </div>
                            </div>
                            <span class="font-grey-salsa">昨日使用</span>
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="lastMonthNewAddPerson counterup" data-counter="counterup" data-value="<{$yesterdayTableUseTotal}>" style="color:#A3D04B;"><{$yesterdayTableUseTotal}></span>&nbsp;次
                                </div>
                            </div>
                        </div>
                        <div class="easy-pie-chart chart-style">
                            <div class="monthAddMbsPreCentum number team" data-percent="<{$dayTableUsePercent}>" data-color="#abce33" style="line-height: 144px;"><span><{$dayTableUsePercent}></span>%</div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    <div class="mt-widget-2 mt-widget1">
                        <div class="pie-font">
                            ...
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="todayNewAddPerson counterup" data-counter="counterup" data-value="<{$thisMonthTableUseTotal}>" style="color:#FE2F56;"><{$thisMonthTableUseTotal}></span>&nbsp;次
                                </div>
                            </div>
                            <span class="font-red-mint">上月使用</span>
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="yestodayNewAddPerson counterup" data-counter="counterup" data-value="<{$lastMonthTableUseTotal}>" style="color:#FF2C30;"><{$lastMonthTableUseTotal}></span>&nbsp;次
                                </div>
                            </div>
                        </div>
                        <div class="easy-pie-chart chart-style">
                            <div class="todayNewAddMbsPreCentum number team" data-percent="<{$monthTableUsePercent}>" data-color="#f92d56" style="line-height: 144px;"><span><{$monthTableUsePercent}></span>%</div>
                        </div>
                    </div>
                </div>
            </div>
