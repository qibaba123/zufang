...
<div class="row">
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a class="order-stat dashboard-stat dashboard-stat-v2 blue" href="#">
            ...
            <div class="details">
                <div class="number">
                    <span class="todayOrders counterup" data-counter="counterup" data-value="<{$todayPostProfit}>"><{$todayPostProfit}></span>
                </div>
                <div class="desc"> 今日发帖收益金额 </div>
            </div>
        </a>
    </div>
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a class="order-stat dashboard-stat dashboard-stat-v2 blue" href="#">
            ...
            <div class="details">
                <div class="number">
                    <span class="todayOrders counterup" data-counter="counterup" data-value="<{$yesterdayPostProfit}>"><{$yesterdayPostProfit}></span>
                </div>
                <div class="desc"> 昨日发帖收益金额 </div>
            </div>
        </a>
    </div>
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a class="order-stat dashboard-stat dashboard-stat-v2 blue" href="#">
            ...
            <div class="details">
                <div class="number">
                    <span class="todayOrders counterup" data-counter="counterup" data-value="<{$thisMonthPostProfit}>"><{$thisMonthPostProfit}></span>
                </div>
                <div class="desc"> 本月发帖收益金额 </div>
            </div>
        </a>
    </div>
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a class="order-stat dashboard-stat dashboard-stat-v2 blue" href="#">
            ...
            <div class="details">
                <div class="number">
                    <span class="todayOrders counterup" data-counter="counterup" data-value="<{$totalPostProfit}>"><{$totalPostProfit}></span>
                </div>
                <div class="desc"> 总发帖收益金额 </div>
            </div>
        </a>
    </div>
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a class="order-stat dashboard-stat dashboard-stat-v2 blue" href="#">
            ...
            <div class="details">
                <div class="number">
                    <span class="todayOrders counterup" data-counter="counterup" data-value="<{$todayEnterProfit}>"><{$todayEnterProfit}></span>
                </div>
                <div class="desc"> 今日入驻商家收益 </div>
            </div>
        </a>
    </div>
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a class="order-stat dashboard-stat dashboard-stat-v2 blue" href="#">
            ...
            <div class="details">
                <div class="number">
                    <span class="todayOrders counterup" data-counter="counterup" data-value="<{$yesterdayEnterProfit}>"><{$yesterdayEnterProfit}></span>
                </div>
                <div class="desc"> 昨日入驻商家收益 </div>
            </div>
        </a>
    </div>
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a class="order-stat dashboard-stat dashboard-stat-v2 blue" href="#">
            ...
            <div class="details">
                <div class="number">
                    <span class="todayOrders counterup" data-counter="counterup" data-value="<{$thisMonthEnterProfit}>"><{$thisMonthEnterProfit}></span>
                </div>
                <div class="desc"> 本月入驻商家收益 </div>
            </div>
        </a>
    </div>
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a class="order-stat dashboard-stat dashboard-stat-v2 blue" href="#">
            ...
            <div class="details">
                <div class="number">
                    <span class="todayOrders counterup" data-counter="counterup" data-value="<{$totalEnterProfit}>"><{$totalEnterProfit}></span>
                </div>
                <div class="desc"> 总入驻商家收益 </div>
            </div>
        </a>
    </div>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="alert alert-danger" role="alert">下面统计包含平台及商家</div>
    </div>
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a class="order-stat dashboard-stat dashboard-stat-v2 blue" href="#">
            <div class="visual_metteyya visual">
        ...
        <div class="zczl">
            <div class="zczl-title">
                ...
                <div class="icon">
                    <i class="icon-user">
                        <span class="font-green-sharp">共：</span>
                        <span class="allMbs  counterup" data-counter="counterup" style="color:#FE2F56;" data-value="965"><{$totalDistribMember}></span>
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="mt-widget-2 mt-widget1">
                        <div class="pie-font">
                            ...
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="thisMonthNewAddPerson counterup" data-counter="counterup" data-value="<{$todayDistribMember}>" style="color:#A3D04B;"><{$todayDistribMember}></span>&nbsp;人
                                </div>
                            </div>
                            <span class="font-grey-salsa">昨日新增</span>
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="lastMonthNewAddPerson counterup" data-counter="counterup" data-value="<{$yesterdayDistribMember}>" style="color:#A3D04B;"><{$yesterdayDistribMember}></span>&nbsp;人
                                </div>
                            </div>
                        </div>
                        <div class="easy-pie-chart chart-style">
                            <div class="monthAddMbsPreCentum number team" data-percent="<{$dayDistribMemberPercent}>" data-color="#abce33" style="line-height: 144px;"><span><{$dayDistribMemberPercent}></span>%</div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    <div class="mt-widget-2 mt-widget1">
                        <div class="pie-font">
                            ...
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="todayNewAddPerson counterup" data-counter="counterup" data-value="<{$thisMonthDistribMember}>" style="color:#FE2F56;"><{$thisMonthDistribMember}></span>&nbsp;人
                                </div>
                            </div>
                            <span class="font-red-mint">上月新增</span>
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="yestodayNewAddPerson counterup" data-counter="counterup" data-value="<{$lastMonthDistribMember}>" style="color:#FF2C30;"><{$lastMonthDistribMember}></span>&nbsp;人
                                </div>
                            </div>
                        </div>
                        <div class="easy-pie-chart chart-style">
                            <div class="todayNewAddMbsPreCentum number team" data-percent="<{$monthDistribMemberPercent}>" data-color="#f92d56" style="line-height: 144px;"><span><{$monthDistribMemberPercent}></span>%</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="zczl">
            <div class="zczl-title">
                ...
                <div class="icon">
                    <i class="icon-user">
                        <span class="font-green-sharp">共：</span>
                        <span class="allMbs  counterup" data-counter="counterup" style="color:#FE2F56;" data-value="<{$allPostTotal}>"><{$allPostTotal}></span>
                        <span class="font-green-sharp">篇帖子</span>
                    </i>
                </div>
                <div class="head-bottom"></div>
            </div>
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <div class="mt-widget-2 mt-widget1">
                        <div class="pie-font">
                            <span class="font-grey-salsa">今日发帖</span>
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="thisMonthNewAddPerson counterup" data-counter="counterup" data-value="<{$todayPostTotal}>" style="color:#A3D04B;"><{$todayPostTotal}></span>&nbsp;人
                                </div>
                            </div>
                            <span class="font-grey-salsa">昨日发帖</span>
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="lastMonthNewAddPerson counterup" data-counter="counterup" data-value="<{$yesterdayPostTotal}>" style="color:#A3D04B;"><{$yesterdayPostTotal}></span>&nbsp;人
                                </div>
                            </div>
                        </div>
                        <div class="easy-pie-chart chart-style">
                            <div class="monthAddMbsPreCentum number team" data-percent="<{$dayPostPercent}>" data-color="#abce33" style="line-height: 144px;"><span><{$dayPostPercent}></span>%</div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    <div class="mt-widget-2 mt-widget1">
                        <div class="pie-font">
                            <span class="font-red-soft">本月发帖</span>
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="todayNewAddPerson counterup" data-counter="counterup" data-value="<{$thisMonthPostTotal}>" style="color:#FE2F56;"><{$thisMonthPostTotal}></span>&nbsp;人
                                </div>
                            </div>
                            <span class="font-red-mint">上月发帖</span>
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="yestodayNewAddPerson counterup" data-counter="counterup" data-value="<{$lastMonthPostTotal}>" style="color:#FF2C30;"><{$lastMonthPostTotal}></span>&nbsp;人
                                </div>
                            </div>
                        </div>
                        <div class="easy-pie-chart chart-style">
                            <div class="todayNewAddMbsPreCentum number team" data-percent="<{$monthPostPercent}>" data-color="#f92d56" style="line-height: 144px;"><span><{$monthPostPercent}></span>%</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="zczl">
            <div class="zczl-title">
                ...
                <div class="icon">
                    <i class="icon-user">
                        <span class="font-green-sharp">共：</span>
                        <span class="allMbs  counterup" data-counter="counterup" style="color:#FE2F56;" data-value="<{$allEnterTotal}>"><{$allEnterTotal}></span>
                        <span class="font-green-sharp">商家</span>
                    </i>
                </div>
                <div class="head-bottom"></div>
            </div>
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <div class="mt-widget-2 mt-widget1">
                        <div class="pie-font">
                            <span class="font-grey-salsa">今日入驻</span>
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="thisMonthNewAddPerson counterup" data-counter="counterup" data-value="<{$todayEnterTotal}>" style="color:#A3D04B;"><{$todayEnterTotal}></span>&nbsp;人
                                </div>
                            </div>
                            <span class="font-grey-salsa">昨日入驻</span>
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="lastMonthNewAddPerson counterup" data-counter="counterup" data-value="<{$yesterdayEnterTotal}>" style="color:#A3D04B;"><{$yesterdayEnterTotal}></span>&nbsp;人
                                </div>
                            </div>
                        </div>
                        <div class="easy-pie-chart chart-style">
                            <div class="monthAddMbsPreCentum number team" data-percent="<{$dayEnterPercent}>" data-color="#abce33" style="line-height: 144px;"><span><{$dayEnterPercent}></span>%</div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    <div class="mt-widget-2 mt-widget1">
                        <div class="pie-font">
                            <span class="font-red-soft">本月入驻</span>
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="todayNewAddPerson counterup" data-counter="counterup" data-value="<{$thisMonthEnterTotal}>" style="color:#FE2F56;"><{$thisMonthEnterTotal}></span>&nbsp;人
                                </div>
                            </div>
                            <span class="font-red-mint">上月入驻</span>
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="yestodayNewAddPerson counterup" data-counter="counterup" data-value="<{$lastMonthEnterTotal}>" style="color:#FF2C30;"><{$lastMonthEnterTotal}></span>&nbsp;人
                                </div>
                            </div>
                        </div>
                        <div class="easy-pie-chart chart-style">
                            <div class="todayNewAddMbsPreCentum number team" data-percent="<{$monthEnterPercent}>" data-color="#f92d56" style="line-height: 144px;"><span><{$monthEnterPercent}></span>%</div>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="row">
    ...
    <div class="col-lg-6 col-xs-12 col-sm-12">
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject bold uppercase font-dark">近15日发帖量</span>
                    <span class="caption-helper"></span>
                </div>
            </div>
            <div class="portlet-body">
                <div id="postAnalysis" style="height: 400px"></div>
            </div>
        </div>
    </div>
    <!-- END :  近15日发帖量   -->
    ...
    <div class="col-lg-6 col-xs-12 col-sm-12">
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject bold uppercase font-dark">近15日商家入驻量</span>
                    <span class="caption-helper"></span>
                </div>
            </div>
            <div class="portlet-body">
                <div id="enterAnalysis" style="height: 400px"></div>
            </div>
        </div>
    </div>
    <!-- END :  近15日商家入驻量   -->
...
<script>
    ...
    let fifteenPostStatistic      = <{$fifteenPostStatistic}>;
    let fifteenEnterStatistic     = <{$fifteenEnterStatistic}>;
    drawAxisChart("postAnalysis", fifteenPostStatistic, daysArr, '发帖量');
    drawAxisChart("enterAnalysis", fifteenEnterStatistic, daysArr, '商家入驻量');
