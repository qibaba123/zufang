        ...
        <div class="zczl">
            <div class="zczl-title">
                ...
                <div class="icon">
                    <i class="icon-user">
                        <span class="font-green-sharp">共：</span>
                        <span class="allMbs  counterup" data-counter="counterup" style="color:#FE2F56;" data-value="<{$totalEnterProfit}>"><{$totalEnterProfit}></span>
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="mt-widget-2 mt-widget1">
                        <div class="pie-font">
                            ...
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="thisMonthNewAddPerson counterup" data-counter="counterup" data-value="<{$todayEnterProfit}>" style="color:#A3D04B;"><{$todayEnterProfit}></span>&nbsp;元
                                </div>
                            </div>
                            <span class="font-grey-salsa">昨日收益</span>
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="lastMonthNewAddPerson counterup" data-counter="counterup" data-value="<{$yesterdayEnterProfit}>" style="color:#A3D04B;"><{$yesterdayEnterProfit}></span>&nbsp;元
                                </div>
                            </div>
                        </div>
                        <div class="easy-pie-chart chart-style">
                            <div class="monthAddMbsPreCentum number team" data-percent="<{$dayEnterProfitPercent}>" data-color="#abce33" style="line-height: 144px;"><span><{$dayEnterProfitPercent}></span>%</div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    <div class="mt-widget-2 mt-widget1">
                        <div class="pie-font">
                            ...
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="todayNewAddPerson counterup" data-counter="counterup" data-value="<{$thisMonthEnterProfit}>" style="color:#FE2F56;"><{$thisMonthEnterProfit}></span> 元
                                </div>
                            </div>
                            <span class="font-red-mint">上月收益</span>
                            <div class="details" style="margin-bottom: 15px;">
                                <div class="number">
                                    <span class="yestodayNewAddPerson counterup" data-counter="counterup" data-value="<{$lastMonthEnterProfit}>" style="color:#FF2C30;"><{$lastMonthEnterProfit}></span>&nbsp;元
                                </div>
                            </div>
                        </div>
                        <div class="easy-pie-chart chart-style">
                            <div class="todayNewAddMbsPreCentum number team" data-percent="<{$monthEnterProfitPercent}>" data-color="#f92d56" style="line-height: 144px;"><span><{$monthEnterProfitPercent}></span>%</div>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    let fifteenEnterProfitStatistic = <{$fifteenEnterProfitStatistic}>;
