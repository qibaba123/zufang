...
<div class="container">
    ...
    <input type="hidden" id="hid_id"  class="avatar-field bg-img" name="hid_key" value="<{if $row && $row['g_id']}><{$row['g_id']}><{/if}>"/>
    <div class="group-info">
        <div class="form-group">
            <label for="">商品名称</label>
            <div class="control-group">
                <span style="color: #428bca"><{$row['g_name']}></span>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="control-group">
                <{$val['name']}>：
                <input type="hidden" id="format_key_<{$key}>" class="format-key" value="<{$val['name']}>">
                <select name="format_value_<{$key}>" id="format_value_<{$key}>" style="" class="form-control small-input format-value">
