                ...
                <div class="span12">
                    <div class="widget-box">
                        <div class="widget-header widget-header-blue widget-header-flat">
                            <h4 class="lighter"><small><a href="<{$backUrl}>"> 返回 </a></small> | 新增/编辑商品信息</h4>
                                ...
                                <div class="step-content row-fluid position-relative" id="step-container">
                                    <form class="form-horizontal" id="goods-form"  enctype="multipart/form-data" style="overflow: hidden;">
                                        ...
                                        <div class="step-pane active" id="step1" >
                                            ...
                                            <div class="info-group-box">
                                                <div class="info-group-inner">
                                                    ...
                                                    <div class="group-info">
                                                        ...
                                                        <{if ($appletCfg['ac_type'] == 8 ) || ($appletCfg['ac_type'] == 6 && $row['g_es_id'] > 0 ) }>
                                                        <div class="form-group">
                                                            <label class="control-label"><font color="red">*</font>价格是否面议：</label>
                                                            <div class="control-group">
                                                                <div class="radio-box">
                                                                    <span>
                                                                        <input type="radio" ng-model="isDiscuss" name="g_is_discuss" id="discuss1" value="1" <{if $row && $row['g_is_discuss'] eq 1}>checked<{/if}>>
                                                                        <label for="discuss1">是</label>
                                                                    </span>
                                                                    <span>
                                                                        <input type="radio" name="g_is_discuss" ng-model="isDiscuss" id="discuss2" value="0"  <{if !($row && $row['g_is_discuss'] eq 1)}>checked<{/if}>>
                                                        ...
                                                        <div class="form-group ori-price-form" ng-show=" isDiscuss == '1' ">
                                                            ...
                                                            <div class="control-group">
                                                                <input type="text" class="form-control" id="g_discuss_info" name="g_discuss_info" placeholder="面议补充提示" value="<{if $row}><{$row['g_discuss_info']}><{/if}>" style="width:160px;">
                                                            </div>
                                                        </div>
                                                        <{/if}>
                                                    <!--<div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="control-group">
                                                                <input type="text" class="form-control" id="g_unit_name" name="g_unit_name" placeholder="" maxlength="5" value="<{if $row}><{$row['g_unit_name']}><{/if}>"  style="width:160px;">
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="control-group">
                                                                <label style="padding: 4px 0;margin: 0;">
                                                                    <input name="g_sequence_day_show" class="ace ace-switch ace-switch-5" id="g_sequence_day_show" <{if ($row && $row['g_sequence_day_show']) || !$row}>checked<{/if}> type="checkbox">
                                                                    <span class="lbl"></span>
                                                                </label>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="info-group-inner">
                                                    ...
                                                    <div class="group-info">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="control-group">
                                                                <label style="padding: 4px 0;margin: 0;">
                                                                    <input name="g_sold_show" class="ace ace-switch ace-switch-5" id="g_sold_show" <{if ($row && $row['g_sold_show']) || !$row}>checked<{/if}> type="checkbox">
                                                                    <span class="lbl"></span>
                                                                </label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="control-group">
                                                                <label style="padding: 4px 0;margin: 0;">
                                                                    <input name="g_show_num_show" class="ace ace-switch ace-switch-5" id="g_show_num_show" <{if ($row && $row['g_show_num_show']) || !$row}>checked<{/if}> type="checkbox">
                                                                    <span class="lbl"></span>
                                                                </label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="control-group">
                                                                <input type="text" class="form-control" id="g_small_num" name="g_small_num" placeholder="请填写起购数量" required="required" value="<{if $row}><{$row['g_small_num']}><{else}>1<{/if}>" style="width: 160px;">
                                                            </div>
                                                        </div>
                                                        <{/if}>
                                                        ...
                                                        <{if !($appletCfg['ac_type'] == 8 && $row['g_es_id'] > 0) && !($appletCfg['ac_type'] == 6 && $row['g_es_id'] > 0) && !($appletCfg['ac_type'] == 33 && $row['g_es_id'] > 0)}>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label"><font color="red">*</font><{if $independent != 1}>首页<{/if}>推荐商品：</label>
                                                            <div class="control-group">
                                                                <div class="radio-box">
                                                                    <span>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="control-group">
                                                                <input type="text" class="form-control" id="g_list_label" name="g_list_label" placeholder="请填写商品列表标签，最多4个字"  value="<{if $row}><{$row['g_list_label']}><{/if}>" >
                                                        ...
                                                        <{if !($appletCfg['ac_type'] == 6 && $row['g_es_id'] > 0)}>
                                                        <div class="form-group">
                                                    ...
                                                    <div class="group-info">
                                                        ...
                                                        <div ng-show="hasFormat==0">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="control-group">
                                                                    <input type="text" class="form-control" id="g_stock" name="g_stock" placeholder="商品库存数量" required="required" value="<{if $row}><{$row['g_stock']}><{else}>99<{/if}>"  style="width:160px;">
                                                                    <!--
                                                                    <p class="tip">
                                                                        添加规格以后库存数量不更手动更改
                                                                    </p>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="control-group">
                                                                <label style="padding: 4px 0;margin: 0;">
                                                                    <input class="ace ace-switch ace-switch-5" name="g_stock_show" id="g_stock_show" <{if ($row && $row['g_stock_show']) || !$row}>checked<{/if}> type="checkbox">
                                                                    <span class="lbl"></span>
                                                                </label>
                                                            </div>
                                                        </div>
                                            ...
                                            <{if $appletCfg['ac_type'] == 1 || $appletCfg['ac_type'] == 21 || $appletCfg['ac_type'] == 6 || $appletCfg['ac_type'] == 8 || $appletCfg['ac_type'] == 4 || $appletCfg['ac_type'] == 7}>
                                            <div class="info-group-box">
                                                <div class="info-group-inner">
                                                    <div class="group-title">
                                                        <span>下单留言</span>
                                                                ...
                                                                <div class="control-group">
                                                                    <div class="col-xs-4">
                                                                        <label class="radio-inline">
                                                                            ...
                                                                            <{if $row.g_pick_self == 1 || $row.g_pick_self==''}>checked<{/if}>
                                                                            > 是
                                                                        </label>
                                                                        <label class="radio-inline">
                                                                            <input type="radio" name="pick_goods_self" value="2"
                                                                             <{if $row.g_pick_self ==2}>checked<{/if}>
                                                                            > 否
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="info-group-inner">
                                                        ...
                                                        <div class="group-info">
                                                            ...
                                                            <div class="control-group" style="margin-left: 0px">
                                                                ...
                                                                <textarea style="width:100%;height:350px;" id="g_parameter" name="g_parameter" placeholder="商品参数"  rows="20" style=" text-align: left; resize:vertical;" ><{if $row && $row['g_parameter']}><{$row['g_parameter']}><{/if}></textarea>
                                                                <input type="hidden" name="sub_dir" id="sub-dir" value="default" />
                                                                <input type="hidden" name="ke_textarea_name" value="g_parameter" />
                                                            </div>
                                                </div>
                                        ...
                                        <div class="step-pane" id="step3">
                                                    ...
                                                    <div class="group-info">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <textarea style="width:100%;height:350px;" id="g_detail" name="g_detail" placeholder="商品详情"  rows="20" style=" text-align: left; resize:vertical;" ><{if $row && $row['g_detail']}><{$row['g_detail']}><{/if}></textarea>
                                                                <input type="hidden" name="sub_dir" id="sub-dir" value="default" />
                                                                <input type="hidden" name="ke_textarea_name" value="g_detail" />
                                                            </div>
                                                        </div>
                                            ...
                                            <{if $appletCfg['ac_type'] == 1 || $appletCfg['ac_type'] == 21}>
                                            <div class="info-group-box">
                                                <div class="info-group-inner">
                                                    <div class="group-title">
                                                        <span>推荐商品</span>
...
<script type="text/javascript">
    ...
    app.controller('chCtrl', ['$scope','$http','$timeout',function($scope, $http, $timeout){
        ...
        $scope.hasFormat ='<{$row['g_has_format']}>'!=0?1:0;
        $scope.messageType = [
            {
                'type': 'text',
                'name': '文本格式'
        ...
        $scope.saveData = function(){
            ...
            var data = $('#goods-form').serialize()+'&formatType='+JSON.stringify($scope.spec)+'&formatList='+JSON.stringify($scope.dataList)+'&gids='+JSON.stringify(gids)+g_applay_goods_show;
            console.log(data);
            // $.ajax({
            //     'type'   : 'post',
