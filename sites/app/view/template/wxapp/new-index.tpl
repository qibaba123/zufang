...
<div class="index-wrap">
        ...
        <div class="base-info">
            <div class="row" style="position: relative;">
                <div class="col-xs-12">
                    ...
                    <div class="kt-time">
                        <{if $menuType!='aliapp'}>
                        <a href="/wxapp/index/tplImg/?id=<{$kind}>" style="color: red;text-decoration:underline;font-size:15px;line-height: 1.8;" target="_blank">点此查看功能导图</a>
                        <{/if}>
                        <!--
                        <{if $articleHref}>
                        <a href="<{$articleHref}>" style="color: #409FE6;text-decoration:underline;font-size:15px;line-height: 1.8;margin-left:25px;" target="_blank">点此查看制作视频教程
                        </a>
                        <{else}>
                        <a href="javascript:;" onclick="msgTip()" style="color: #409FE6;text-decoration:underline;font-size:15px;line-height: 1.8;margin-left:25px;" target="_blank">点此查看制作视频教程</a>
                        <{/if}>
                        -->
                    </div>
                </div>
    ...
    <div class="tool-wrap">
        ...
        <ul class="tool-list">
            ...
            <{if $menuType=='aliapp' && $item.name=='广告位配置'}><{continue}><{/if}>
            <li>
        ...
        <ul class="service-list">
            <li class="service-item">
                ...
                <a href="#" class="hyfa-item increment-service">
                    <img src="/public/wxapp/images/service/zhengshu.png" alt="ssl证书">
                    <p>ssl证书</p>
                </a>
            </li>
            <li class="service-item">
                ...
                <a href="#" class="hyfa-item increment-service">
                    <img src="/public/wxapp/images/service/icon_vr.png" alt="vr全景拍摄">
                    <p>VR全景拍摄</p>
                </a>
            </li>
        </ul>
