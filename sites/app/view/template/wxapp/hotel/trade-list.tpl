...
<div class="page-header search-box">
	<div class="col-sm-12">
		<form class="form-inline" action="/wxapp/hotel/tradeList" method="get">
			<div class="col-xs-11 form-group-box">
				<div class="form-container">
					...
					<div class="form-group">
						<div class="input-group">
							<div class="input-group-addon">买家姓名</div>
							<input type="text" class="form-control" name="realName" value="<{$realName}>"  placeholder="买家姓名">
						</div>
					</div>
					<div class="form-group">
						<div class="input-group">
...
<div class="trade-list">
	<table class="ui-table-order" style="padding: 0px;">
			...
			<td colspan="2" class="text-right">
				<div class="order-opts-container">
					<div class="js-opts" style="display: block;">
						<a href="/wxapp/hotel/tradeDetail?order_no=<{$val['t_tid']}>" class="new-window" >查看详情</a>
		...
		<tr class="content-row">
			...
			<td class="title-cell">
				<p class="goods-title">
					<a href="/wxapp/hotel/tradeList?title=<{$val['t_title']}>"class="new-window" title="<{$val['t_title']}>">
						<{$val['t_title']}>
					</a>
				</p>
				<p>
			...
			<td class="aftermarket-cell" rowspan="1">
				...
				<a href="/wxapp/hotel/tradeRefund?order_no=<{$val['t_tid']}>" class="new-window" >处理维权</a>
				<{/if}>
			</td>
			<td class="customer-cell" rowspan="1">
				<p>
					<a href="/wxapp/hotel/tradeList?buyer=<{$val['t_buyer_nick']}>" class="new-window" target="_blank">
						<{$val['t_buyer_nick']}>
					</a>
				</p>
				<{foreach json_decode($val['t_express_company']) as $value}>
				<p class="user-name"><{$value}></p>
				<{/foreach}>
				<p class="user-name"><{$val['t_express_code']}></p>
			</td>
			...
			<div class="modal-content">
				...
				<div class="modal-body" style="text-align: center;margin-bottom: 45px">
					<div class="modal-plan p_num clearfix shouhuo">
						<form enctype="multipart/form-data" action="/wxapp/hotel/excelOrder" method="post">
							<div class="form-group">
