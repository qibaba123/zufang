        	...
        	<div class="info-region">
        	    ...
        	    <table class="info-table">
        	        <tbody>
        	            ...
        	            <tr>
        	                <th>买家：</th>
        	                <td><a href="/wxapp/hotel/tradeList?buyer=<{$row['t_buyer_nick']}>" class="new-window" ><{if $row}><{$row['t_buyer_nick']}><{/if}></a></td>
        	            </tr>
        	        </tbody>
        	    </table>
                        ...
                        <table class="ui-table" style="margin-bottom:20px;">
                            ...
                            <{foreach $list as $val}>
                                <tr>
                                    ...
                                    <td class="cell-5"><{$val['to_num']}>晚</td>
                                    <td class="cell-5"><{$row['t_room_num']}>晚</td>
