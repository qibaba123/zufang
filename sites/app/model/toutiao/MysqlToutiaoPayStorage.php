...
class App_Model_Toutiao_MysqlToutiaoPayStorage extends Libs_Mvc_Model_BaseModel {

    private $sid;
    public function __construct($sid) {
        parent::__construct();
        $this->_table   = 'applet_toutiao_pay';
        $this->_pk      = 'atp_id';
        $this->_shopId  = 'atp_s_id';
        $this->sid      = $sid;
    }
