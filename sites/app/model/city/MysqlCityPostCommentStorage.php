 ...
 * Time: 上午10:39
 */
class App_Model_City_MysqlCityPostCommentStorage extends Libs_Mvc_Model_BaseModel
{
    ...
    {
        parent::__construct();
        $this->_table = 'applet_city_comment';
        $this->_pk = 'acc_id';
     ...
     * 获取帖子评论及评论会员信息
     */
    public function getCommentMember($pid,$index=0,$count=20,$verify =false){
        $where = array();
        $where[] = array('name'=>'acc_acp_id','oper'=>'=','value'=>$pid);
        $where[] = array('name'=>$this->_shopId,'oper'=>'=','value'=>$this->sid);
        if($verify){
            $where[] = array('name'=>'acc_show','oper'=>'=','value'=>1); //未被封禁
        }
