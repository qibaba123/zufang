...
app.controller('chCtrl', ['$scope', '$http',function($scope,$timeout) {
    $scope.headerTitle = "<{$tpl['st_title']}>";
    $scope.headerPlaceholder = "<{$tpl['st_search_tip']}>";
    $scope.banners = [
    	{
    		index: 0,
    		imgsrc: '/public/manage/shopfixture/images/1.jpg',
    		link: 'http://www.fenxiaobao.xin/manage/index/index'
    	},
    	{
    		index: 1,
    		imgsrc: '/public/manage/shopfixture/images/2.jpg',
    		link: ''
    	}
    ];
    $scope.fenleiNavs = [
    	{
    		index: 0,
    		imgsrc: '/public/manage/shopfixture/images/icon_index_yongpin.png',
    		title: '餐饮用品',
    		link: 'http://www.caihewang.cn/mobile/index'
    	},
    	{
    		index: 1,
    		imgsrc: '/public/manage/shopfixture/images/icon_index_dingzhi.png',
    		title: '品牌定制',
    		link: ''
    	},
    	{
    		index: 2,
    		imgsrc: '/public/manage/shopfixture/images/icon_index_anli.png',
    		title: '案例精选',
    		link: ''
    	},
    	{
    		index: 3,
    		imgsrc: '/public/manage/shopfixture/images/icon_index_weihuo.png',
    		title: '尾货特卖',
    		link: ''
    	}
    ];
    ...
    $scope.productLists = [
    	{
    		index: 0,
    		imgsrc: '/public/manage/shopfixture/images/sxjg_06.png',
    		name:'双层热饮杯 防烫 环保 新款',
    		price: '￥120',
    		link: ''
    	},
    ...
    $scope.addNewBanner = function(){
        ...
        if(banner_length>=8){
            ...
            var banner_Default = {
                index: banner_length,
                imgsrc: '/public/manage/shopfixture/images/banner.jpg',
                link: 'http://www.fenxiaobao.xin/manage/index/index'
            };
