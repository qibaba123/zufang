...
var isSupportSocket = (function(ws){
    return ws.toString() == "function WebSocket() { [native code] }";
})(window.WebSocket || function(){});

var PLUMRongIMLib = null, PLUMRongIMClient = null;

if(isSupportSocket){
    require.config({
        paths: {
            protobuf: '//cdn.ronghub.com/protobuf-2.1.5.min',
            RongIMLib: '//cdn.ronghub.com/RongIMLib-2.2.5.min'
        }
    });
