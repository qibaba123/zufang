...
function dTree(objName) {
	...
	this.icon = {
		root				: '/public/dtree/img/base.gif',
		folder				: '/public/dtree/img/folder.gif',
		folderOpen			: '/public/dtree/img/folderopen.gif',
		node				: '/public/dtree/img/page.gif',
		empty				: '/public/dtree/img/empty.gif',
		line				: '/public/dtree/img/line.gif',
		join				: '/public/dtree/img/join.gif',
		joinBottom			: '/public/dtree/img/joinbottom.gif',
		plus				: '/public/dtree/img/plus.gif',
		plusBottom			: '/public/dtree/img/plusbottom.gif',
		minus				: '/public/dtree/img/minus.gif',
		minusBottom			: '/public/dtree/img/minusbottom.gif',
		nlPlus				: '/public/dtree/img/nolines_plus.gif',
		nlMinus				: '/public/dtree/img/nolines_minus.gif'
	};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
